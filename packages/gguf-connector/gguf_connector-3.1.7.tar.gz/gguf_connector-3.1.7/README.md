...
[![Static Badge](https://img.shields.io/badge/version-3.1.7-green?logo=github)](https://github.com/calcuis/gguf-connector/releases)
...
ggc w6
```
Frontend [test.gguf.org](https://test.gguf.org) or localhost (open a new console/terminal: `ggc b`)
