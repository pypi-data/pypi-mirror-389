import os
import glob
from test_model import keras_mlp
from test_data import *
import wp21_train as train

def test_tuner_keras():
    ...
    trainer = train.training.trainers.KerasTrainer(test_file, ds, keras_mlp)
    tune = train.training.Tuner("hat", trainer)
    tune.run()
