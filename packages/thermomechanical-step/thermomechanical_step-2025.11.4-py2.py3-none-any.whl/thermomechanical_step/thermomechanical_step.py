...
class ThermomechanicalStep(object):
    ...
    comments. The felds are as follows:
        ...
        my_description["description"] : tuple
            A description of the Thermomechanical step. It must be
    ...
    def create_node(self, flowchart=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return thermomechanical_step.Thermomechanical(flowchart=flowchart, **kwargs)
    ...
    def create_tk_node(self, canvas=None, **kwargs):
        ...
        **kwargs : keyword arguments
        ...
        return thermomechanical_step.TkThermomechanical(canvas=canvas, **kwargs)
    ...
    def description(self):
        ...
        """
        return ThermomechanicalStep.my_description
