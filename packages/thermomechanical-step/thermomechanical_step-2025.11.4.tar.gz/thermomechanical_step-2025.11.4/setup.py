...
setup(
    ...
    url='https://github.com/molssi-seamm/thermomechanical_step',
    ...
    packages=find_packages(include=['thermomechanical_step']),
    ...
    entry_points={
        'org.molssi.seamm': [
            'Thermomechanical = thermomechanical_step:ThermomechanicalStep',
        ],
        'org.molssi.seamm.tk': [
            'Thermomechanical = thermomechanical_step:ThermomechanicalStep',
        ],
