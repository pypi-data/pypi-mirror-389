...
class PaginatedQueryResultModelW9FormBaseResponse(BaseModel):
    """
    ...
    value: Optional[List[CreateW9Form201Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [CreateW9Form201Response.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None,
