...
class TaxIdentifierResponse(BaseModel):
    ...
    value: Optional[TaxIdentifierResponseValue] = None
    __properties: ClassVar[List[str]] = ["countryCode", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": TaxIdentifierResponseValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
