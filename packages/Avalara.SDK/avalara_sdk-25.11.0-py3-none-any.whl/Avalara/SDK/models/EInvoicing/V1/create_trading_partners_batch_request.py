...
class CreateTradingPartnersBatchRequest(BaseModel):
    """
    CreateTradingPartnersBatchRequest
    """ # noqa: E501
    value: Optional[List[TradingPartner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [TradingPartner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
