...
class EntryStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="The form status.")
    time: Optional[datetime] = Field(default=None, description="The timestamp for the latest status update.")
