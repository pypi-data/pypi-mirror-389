...
class Form1099Int(BaseModel):
    ...
    early_withdrawal_penalty: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Early Withdrawal Penalty", alias="earlyWithdrawalPenalty")
    ...
    tax_exempt_bond_cusip_number: Optional[StrictStr] = Field(default=None, description="Tax exempt bond CUSIP no.   Enter VARIOUS if the tax-exempt interest is reported in the aggregate for multiple bonds or accounts.", alias="taxExemptBondCusipNumber")
