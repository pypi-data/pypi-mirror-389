...
class PaginatedQueryResultModelForm1099Base(BaseModel):
    """
    ...
    value: Optional[List[Get1099Form200Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Get1099Form200Response.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None,
