...
class BatchErrorDetail(BaseModel):
    ...
    """ # noqa: E501
    index: Optional[StrictInt] = Field(default=None, description="The index of the request that caused the error in the batch.")
    validation_errors: Optional[List[ValidationError]] = Field(default=None, alias="validationErrors")
    __properties: ClassVar[List[str]] = ["index", "validationErrors"]
