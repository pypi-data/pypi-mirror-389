#ifndef __AIDGE_EXPORT_CPP_KERNELS_RECIPROCAL__
#define __AIDGE_EXPORT_CPP_KERNELS_RECIPROCAL__
    ...
    Output_T* __restrict outputs)
{
    ...
    for (size_t i = 0; i < NB_ELTS; ++i) {
        ...
        outputs[outOffset + i] = 1/inputs[inOffset + i];
    }
}

#endif  // __AIDGE_EXPORT_CPP_KERNELS_RECIPROCAL__