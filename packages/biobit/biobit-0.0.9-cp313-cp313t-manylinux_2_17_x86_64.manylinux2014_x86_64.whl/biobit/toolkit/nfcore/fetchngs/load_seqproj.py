...
def load_seqproj(
...
) -> tuple[seqproj.Project, ...]:
    """
    Load a samplesheet.csv generated by nf-core/fetchngs and return a tuple of parsed seqproj.Project objects.
    ...
    :return: A tuple of parsed seqproj.Project objects.
    """
    # SeqRun
    ...
    for prjind, data in projects.items():
        ...
        result.append(seqproj.Project(prjind, experiments, samples, description))
