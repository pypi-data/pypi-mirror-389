    ...
    try:
        ...
        if verbose:
            ...
            if description:
                print(f"\nDescription:")
                try:
                    print(f"{description + '...' if len(description) > 300 else description}")
                except UnicodeEncodeError:
                    print(f"{description.encode('ascii', 'ignore').decode('ascii')[:300] + '...'}")
            else:
    ...
    try:
        ...
        if verbose:
            ...
            if description:
                print(f"\nDescription:")
                try:
                    print(description + "..." if len(description) > 300 else description)
                except UnicodeEncodeError:
