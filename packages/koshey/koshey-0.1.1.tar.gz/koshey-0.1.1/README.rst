...
Internal immortal PyPI index — Koshey, the package keeper.

``Koshey`` is a corporate PyPI index and package quarantine system.
...
who hid his soul inside an egg. ``Koshey`` likewise protects the soul of
...
``Koshey`` can act both as a transparent proxy to public Python repositories
...
Koshey is built with reliability and transparency in mind.
...
* PyPI: https://pypi.org/project/koshey/
* Source: https://github.com/yourusername/koshey
* Issues: https://github.com/yourusername/koshey/issues
