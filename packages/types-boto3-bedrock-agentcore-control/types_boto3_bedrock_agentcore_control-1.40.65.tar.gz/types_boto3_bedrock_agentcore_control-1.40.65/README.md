...
[boto3 BedrockAgentCoreControl 1.40.65](https://pypi.org/project/boto3/)
...
3. Add `BedrockAgentCoreControl` service.
...
`BedrockAgentCoreControlClient` provides annotations for
`boto3.client("bedrock-agentcore-control")`.

```python
from boto3.session import Session

from types_boto3_bedrock_agentcore_control import BedrockAgentCoreControlClient
...
Full list of `BedrockAgentCoreControl` Literals can be found in
...
def check_value(value: AgentManagedRuntimeTypeType) -> bool: ...
```
...
Full list of `BedrockAgentCoreControl` TypeDefs can be found in
