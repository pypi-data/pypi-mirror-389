...
import aidge_core
from aidge_core import Log, Node, GlobalAveragePoolingOp
import onnx
...
def import_global_average_pooling(
    onnx_node: NodeProto,
    ...
    global_average_pooling_node = Node(GlobalAveragePoolingOp(), name=node_name)
