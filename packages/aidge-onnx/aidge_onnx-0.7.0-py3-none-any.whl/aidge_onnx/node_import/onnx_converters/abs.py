...
@auto_register_import("abs")
def import_abs(onnx_node: NodeProto, input_nodes: List[Tuple[aidge_core.Node, int]], opset: int) -> aidge_core.Node:
    """
    ...
    my_node = aidge_core.Abs(name=node_name)
