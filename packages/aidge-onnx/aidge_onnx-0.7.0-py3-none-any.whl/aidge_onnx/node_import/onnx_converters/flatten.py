...
def import_reshape(onnx_node: NodeProto, input_nodes: List[Tuple[aidge_core.Node, int]], opset: int) -> aidge_core.Node:
    """
    ...
    my_node = aidge_core.Flatten(**flatten_attrs, name=node_name)
