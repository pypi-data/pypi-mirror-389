...
def import_round(onnx_node: NodeProto, input_nodes: List[Tuple[aidge_core.Node, int]], opset: int) -> aidge_core.Node:
    """
    ...
    my_node = aidge_core.Round(name=node_name, rounding_mode=aidge_core.RoundingMode.HALF_TO_EVEN)
