...
This step is really crucial - and I cannot stress enough how important it is to actually LOOK at the parameters and think about them. 

```math
lambda_human ~ 2 mu L T_human
```
