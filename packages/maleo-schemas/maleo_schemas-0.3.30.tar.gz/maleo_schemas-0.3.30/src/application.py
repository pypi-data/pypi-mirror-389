...
class ApplicationSettings(BaseSettings):
    ...
    PUBLISH_OPERATION: Annotated[
        OptBool, Field(None, description="Whether to publish operation")
    ] = None

    @cached_property
    def publish_operation(self) -> bool:
        if self.PUBLISH_OPERATION is not None:
