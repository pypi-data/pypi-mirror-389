...
export default [
  {
    ...
    component: ComponentCreator('/solace-agent-mesh/docs', 'ff4'),
    routes: [
      {
        path: '/solace-agent-mesh/docs',
        component: ComponentCreator('/solace-agent-mesh/docs', 'a50'),
        routes: [
          {
            path: '/solace-agent-mesh/docs',
            component: ComponentCreator('/solace-agent-mesh/docs', 'd19'),
            routes: [
              {
