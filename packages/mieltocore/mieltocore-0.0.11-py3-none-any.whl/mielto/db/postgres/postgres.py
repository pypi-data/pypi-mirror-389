...
class PostgresDb(BaseDb):
    ...
    def get_user_memories(
        ...
        Args:
            ...
            before_memory_id (Optional[str]): The ID of the memory to filter by.
            deserialize (Optional[bool]): Whether to serialize the memories. Defaults to True.
        ...
        try:
            ...
            with self.Session() as sess, sess.begin():
                ...
                if before_memory_id is not None:
                    stmt = stmt.where(table.c.memory_id < before_memory_id)
    ...
    def get_knowledge_content_by_content_hash(self, content_hash: str, workspace_id: Optional[str] = None) -> Optional[KnowledgeRow]:
        """Get a knowledge row from the database.

        Args:
            content_hash (str): The content hash of the knowledge row to get.
            workspace_id (Optional[str]): The workspace ID of the knowledge row to get.
    ...
    def get_knowledge_contents(
        ...
        Args:
            filters (Optional[Dict[str, Any]]): The filters to apply to the knowledge contents.
