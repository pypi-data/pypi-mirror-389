...
[![pypi](https://img.shields.io/pypi/v/fern-fai-sdk)](https://pypi.python.org/pypi/fern-fai-sdk)
...
response = client.analytics.with_raw_response.generate_all_insights(...)
...
```python
client.analytics.generate_all_insights(..., request_options={
    "max_retries": 1
})
```
