...
if typing.TYPE_CHECKING:
    ...
    from .editing_sessions.client import AsyncEditingSessionsClient, EditingSessionsClient
...
class FernAI:
    ...
    def __init__(
        ...
        *,
        ...
        self._editing_sessions: typing.Optional[EditingSessionsClient] = None
    ...
    @property
    def editing_sessions(self):
        if self._editing_sessions is None:
            from .editing_sessions.client import EditingSessionsClient  # noqa: E402

            self._editing_sessions = EditingSessionsClient(client_wrapper=self._client_wrapper)
        return self._editing_sessions
    ...
    def scribe(self):
        if self._scribe is None:
            from .scribe.client import ScribeClient  # noqa: E402

            self._scribe = ScribeClient(client_wrapper=self._client_wrapper)
        return self._scribe
    ...
    def slack(self):
        if self._slack is None:
            ...
            self._slack = SlackClient(client_wrapper=self._client_wrapper)
        return self._slack
    ...
    def upstash(self):
        if self._upstash is None:
            from .upstash.client import UpstashClient  # noqa: E402

            self._upstash = UpstashClient(client_wrapper=self._client_wrapper)
...
class AsyncFernAI:
    ...
    def __init__(
        ...
        *,
        ...
        self._editing_sessions: typing.Optional[AsyncEditingSessionsClient] = None
    ...
    def editing_sessions(self):
        if self._editing_sessions is None:
            from .editing_sessions.client import AsyncEditingSessionsClient  # noqa: E402

            self._editing_sessions = AsyncEditingSessionsClient(client_wrapper=self._client_wrapper)
        return self._editing_sessions
    ...
    def scribe(self):
        if self._scribe is None:
            from .scribe.client import AsyncScribeClient  # noqa: E402

            self._scribe = AsyncScribeClient(client_wrapper=self._client_wrapper)
        return self._scribe
    ...
    def slack(self):
        if self._slack is None:
            from .slack.client import AsyncSlackClient  # noqa: E402

            self._slack = AsyncSlackClient(client_wrapper=self._client_wrapper)
        return self._slack
    ...
    def upstash(self):
        if self._upstash is None:
            from .upstash.client import AsyncUpstashClient  # noqa: E402

            self._upstash = AsyncUpstashClient(client_wrapper=self._client_wrapper)
        return self._upstash
