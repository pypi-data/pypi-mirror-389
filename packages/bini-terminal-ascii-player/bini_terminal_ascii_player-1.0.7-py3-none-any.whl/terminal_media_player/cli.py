...
from .player import FullScreenColorVideoPlayer, AdaptiveFullScreenColorPlayer, FullScreenColorImageDisplay
...
def main():
    parser = argparse.ArgumentParser(
        description="BINI Terminal ASCII Player - Play videos and images as ASCII art",
