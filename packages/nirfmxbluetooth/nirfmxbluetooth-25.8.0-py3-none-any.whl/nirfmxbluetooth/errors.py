...
class Error(Exception):
    """Base error class for NI-RFmxBT."""
...
class DriverNotInstalledError(Error):
    ...
    def __init__(self):
        """An error due to using this module without the driver runtime installed."""
        super(DriverNotInstalledError, self).__init__("The NI-RFmxBT runtime could not be loaded. Make sure it is installed and its bitness matches that of your Python interpreter. Please visit http://www.ni.com/downloads/drivers/ to download and install it.")  # type: ignore


class DriverTooOldError(Error):
    """An error due to using this module with an older version of the NI-RFmxBT driver runtime."""

    def __init__(self):
        """An error due to using this module with an older version of the NI-RFmxBT driver runtime."""
        super(DriverTooOldError, self).__init__("A function was not found in the NI-RFmxBT runtime. Please visit http://www.ni.com/downloads/drivers/ to download a newer version and install it.")  # type: ignore


class DriverTooNewError(Error):
    """An error due to the NI-RFmxBT driver runtime being too new for this module."""

    def __init__(self):
        """An error due to the NI-RFmxBT driver runtime being too new for this module."""
        super(DriverTooNewError, self).__init__("The NI-RFmxBT runtime returned an unexpected value. This can occur if it is too new for the nirfmxbluetooth Python module. Upgrade the nirfmxbluetooth Python module.")  # type: ignore
...
def handle_error(
    ...
    r"""Helper function for handling errors returned by NI-RFmxBT Library.
