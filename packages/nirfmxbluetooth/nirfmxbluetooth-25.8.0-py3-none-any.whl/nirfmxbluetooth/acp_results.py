...
class AcpResults(object):
    ...
    def fetch_mask_trace(
        ...
        a valid trace only if you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.OFFSET_CHANNEL_MODE` attribute to
        **In-band**.
    ...
    def fetch_measurement_status(self, selector_string, timeout):
        ...
        :py:attr:`~nirfmxbluetooth.attributes.AttributeID.OFFSET_CHANNEL_MODE` attribute to **In-Band**. This method is not
        ...
        Returns:
            ...
            measurement_status (enums.AcpResultsMeasurementStatus):
                ...
                :py:attr:`~nirfmxbluetooth.attributes.AttributeID.MEASUREMENT_STATUS` attribute for more information about measurement
                status.
    ...
    def fetch_offset_measurement_array(self, selector_string, timeout):
        ...
        Returns:
            ...
            lower_margin (float):
                ...
                :py:attr:`~nirfmxbluetooth.attributes.AttributeID.OFFSET_CHANNEL_MODE` attribute to **In-band**. This parameter returns
                NaN if you set the ACP Offset Channel Mode attribute to **Symmetric**.
    ...
    def fetch_offset_measurement(self, selector_string, timeout):
        ...
        Args:
            selector_string (string):
                ...
                You can use the `RFmxBT Build Offset String <rfmxbtvi.chm/RFmxBT_Build_Offset_String.html>`_ method to build
                the selector string.
        ...
        Returns:
            ...
            lower_margin (float):
                ...
                parameter is valid only if you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.OFFSET_CHANNEL_MODE` attribute
                to **In-band**. This parameter returns NaN if you set the ACP Offset Channel Mode attribute to **Symmetric**.
