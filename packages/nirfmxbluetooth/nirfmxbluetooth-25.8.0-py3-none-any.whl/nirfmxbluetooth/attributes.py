...
class AttributeID(Enum):
    ...
    **SYNC**.
    ...
    r"""Returns the packet type detected by the RFmxBT Auto Detect Signal method. This attribute can be queried only after
    ...
    r"""Returns the data rate detected by the RFmxBT Auto Detect Signal method. This attribute returns a valid data rate only
    ...
    r"""Returns the payload length detected by the RFmxBT Auto Detect Signal method. This attribute can be queried only after
    calling the RFmxBT Auto Detect Signal method.
    ...
    r"""Specifies whether to enable the I/Q origin offset correction for EDR and LE-HDT packet. If you set this attribute to
    **True**, the DEVM and EVM results are computed after correcting for the I/Q origin offset.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean of the
    df1avg results computed for each averaging count. This value is expressed in Hz.
    ...
    Refer to the `df1 and df2 <www.ni.com/docs/en-US/bundle/rfmx-bt/page/df1-and-df2.html>`_ concept topic for more
    details.
    """

    MODACC_RESULTS_DF1AVG_MAXIMUM = 11550730
    r"""Returns the df1avg value computed on the signal. When you set the
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the maximum of
    the df1avg results computed for each averaging count. This value is expressed in Hz.
    ...
    r"""Returns the df1avg value computed on the signal. When you set the
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the minimum of
    the df1avg results computed for each averaging count. This value is expressed in Hz.
    ...
    reports the peak value. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute
    to **True**, it returns the maximum of the peak df1max results computed for each averaging count. This value is
    expressed in Hz.
    ...
    and reports the minimum value. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED`
    attribute to **True**, it returns the minimum of the Min df1max results computed for each averaging count. This value
    is expressed in Hz.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it computes this result
    using the df1max values from all averaging counts. This value expressed as a percentage.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean of the
    df2avg results computed for each averaging count. This value is expressed in Hz.
    ...
    r"""Returns the df2avg value computed on the signal. When you set the
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the maximum of
    the df2avg results computed for each averaging count. This value is expressed in Hz.
    ...
    reports the peak value. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute
    to **True**, it returns the maximum of the peak df2max results computed for each averaging count. This value is
    expressed in Hz.
    ...
    and reports the minimum value. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED`
    attribute to **True**, it returns the minimum of the Min df2max results computed for each averaging count. This value
    is expressed in Hz.
    ...
    standard. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**,
    it computes this result using the df2max values from all averaging counts. This value is expressed as a percentage.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean of the
    df3avg results computed for each averaging count. This value is expressed in Hz. This result is valid only for LE-CS
    packet with data rate 2 Mbps and when bandwidth bit period product is set to 2.
    
    You do not need to use a selector string to read this result for the default signal and result instance. Refer
    to the `Selector String <https://www.ni.com/docs/en-US/bundle/rfmx/page/selector-strings-net.html>`_ topic for
    information about the string syntax for named signals and results.
    Refer to the `Frequency Error Measurement
    <www.ni.com/docs/en-US/bundle/rfmx-bt/page/frequency-error-measurement.html>`_ concept topic for more details.
    """
    ...
    standard. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**,
    it computes this result using the df4avg values from all averaging counts. This value is expressed as a percentage.
    This result is valid only for LE-CS packet with data rate 2 Mbps and when bandwidth bit period product is set to 2.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the value
    ...
    error. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it
    returns the value corresponding to the maximum absolute of the peak frequency error values computed for each averaging
    count. This value is expressed in Hz.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns a value
    corresponding to the maximum of the absolute initial frequency error values computed for each averaging count. This
    value is expressed in Hz.
    ...
    packet. When you set :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it
    returns the maximum of the peak RMS differential EVM (DEVM) values computed for each averaging count. This value is
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean of the
    RMS differential EVM (DEVM) values computed for each averaging count. This value is expressed as a percentage.
    ...
    you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the
    maximum of the peak symbol differential EVM (DEVM) values computed for each averaging count. This value is expressed as
    a percentage.
    ...
    you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it computes
    this result using the symbol DEVM values from all averaging counts. This value is expressed as a percentage.
    ...
    When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns
    the mean of the average RMS magnitude error values computed for each averaging count. This value is expressed as a
    percentage.
    ...
    you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**,  it returns the
    maximum of the peak RMS Magnitude error values computed for each averaging count. This value is expressed as a
    percentage.
    ...
    you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the
    mean of the average RMS phase error values computed for each averaging count. This value is expressed in degrees.
    ...
    set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the
    maximum of the peak RMS phase error values computed for each averaging count. This value is expressed in degrees.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean of the
    RMS EVM values computed for each averaging count. This value is expressed in dB. This result is valid only for LE-HDT
    packet.
    ...
    set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean
    ...
    r"""Returns the I/Q origin offset estimated over the EDR portion of the EDR packets. This value is expressed in dB. When
    you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the
    mean of the I/Q origin offset values computed for each averaging count.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean of the
    clock drift values computed for each averaging count.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean of the
    preamble start time values computed for each averaging count.
    ...
    expressed in seconds. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute
    to **True**, it returns the mean of the fractional time offset values for each averaging count.
    ...
    (ACP) measurement when you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.OFFSET_CHANNEL_MODE` attribute to
    **Symmetric**. This attribute also returns the actual number of offsets used in the ACP measurement when you set the
    ...
    only if you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.OFFSET_CHANNEL_MODE` attribute to **In-band**.
    This attribute returns NaN if you set the ACP Offset Channel Mode attribute to **Symmetric**.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.HIGH_FREQUENCY`  and
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.LOW_FREQUENCY` . This value is expressed in Hz.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **Angle of Departure** for LE
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean of the
    average power results computed for each averaging count.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the maximum of
    the peak power results computed for each averaging count. This value is expressed in dBm.
    ...
    beginning of the payload portion. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED`
    attribute to **True**, it returns the maximum of the peak to average power ratio results computed for each averaging
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean of the
    GFSK average power results computed for each averaging count. This value is expressed in dBm.
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean of the
    DPSK average power results computed for each averaging count. This value is expressed in dBm.
    ...
    When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns
    the mean of the DPSK GFSK average power ratio results computed for each averaging count. This value is expressed in dB.
    ...
    **Angle of Departure**. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute
    to **True**, it returns the mean of the CTE reference period average power results computed for each averaging count.
    ...
    Departure**. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to
    ...
    **LE-CS** and the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.CHANNEL_SOUNDING_PACKET_FORMAT` attribute to any
    value other than **SYNC**. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED`
    ...
    **Disabled** for one or more of the named signal configurations. This allows RFmx to precompute the acquisition
    ...
    r"""Specifies the time, in seconds, to wait before results are available in the `RFmxBT Attribute
