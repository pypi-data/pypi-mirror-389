"""nirfmxbluetooth package."""

__version__ = "25.8.0b0"

from nirfmxbluetooth.attributes import *  # noqa: F403
from nirfmxbluetooth.bt import BT, _BTSignalConfiguration
from nirfmxbluetooth.enums import *  # noqa: F403
...
def get_diagnostic_information():
    ...
    if platform.system() == "Windows":
        ...
        os_name = "Windows"
        try:
            driver_version_key = winreg.OpenKey(winreg.HKEY_LOCAL_MACHINE, r"SOFTWARE\National Instruments\RFmx\BT\C Runtime Support")  # type: ignore
    ...
    info["driver"]["name"] = "NI-RFmxBT"
    info["driver"]["version"] = driver_version
    info["module"]["name"] = "nirfmxbluetooth"
    info["module"]["version"] = "25.8.0b0"
