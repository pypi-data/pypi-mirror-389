...
class TxpConfiguration(object):
    ...
    def get_measurement_enabled(self, selector_string):
        r"""Gets whether to enable the transmit power (TxP) measurements.
    ...
    def set_measurement_enabled(self, selector_string, value):
        r"""Sets whether to enable the transmit power (TxP) measurements.
    ...
    def get_burst_synchronization_type(self, selector_string):
        r"""Gets the type of synchronization used for detecting the start of packet in the transmit power (TXP) measurement.
        ...
        try:
            ...
            attr_val, error_code = self._interpreter.get_attribute_i32(
                updated_selector_string, attributes.AttributeID.TXP_BURST_SYNCHRONIZATION_TYPE.value
            )
            attr_val = enums.TxpBurstSynchronizationType(attr_val)
    ...
    def set_burst_synchronization_type(self, selector_string, value):
        r"""Sets the type of synchronization used for detecting the start of packet in the transmit power (TXP) measurement.
        ...
        Args:
            ...
            value (enums.TxpBurstSynchronizationType, int):
                Specifies the type of synchronization used for detecting the start of packet in the transmit power (TXP) measurement.
        ...
        try:
            ...
            value = value.value if type(value) is enums.TxpBurstSynchronizationType else value
            error_code = self._interpreter.set_attribute_i32(
                updated_selector_string,
                attributes.AttributeID.TXP_BURST_SYNCHRONIZATION_TYPE.value,
                value,
            )
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def get_averaging_enabled(self, selector_string):
        r"""Gets whether to enable averaging for the transmit power (TxP) measurements.
    ...
    def set_averaging_enabled(self, selector_string, value):
        r"""Sets whether to enable averaging for the transmit power (TxP) measurements.
    ...
    def get_all_traces_enabled(self, selector_string):
        r"""Gets whether to enable all the traces used for transmit power (TxP) measurements.
    ...
    def set_all_traces_enabled(self, selector_string, value):
        r"""Sets whether to enable all the traces used for transmit power (TxP) measurements.
    ...
    def configure_averaging(self, selector_string, averaging_enabled, averaging_count):
        ...
        Args:
            ...
            averaging_enabled (enums.TxpAveragingEnabled, int):
                ...
                | False (0)    | The measurement is performed on a single acquisition.                                                                    |
                +--------------+--------------------------------------------------------------------------------------------------------------------------+
                | True (1)     | The measurement uses the TXP Averaging Count parameter as the number of acquisitions over which the TXP measurement is   |
                |              | averaged.                                                                                                                |
                +--------------+--------------------------------------------------------------------------------------------------------------------------+

            averaging_count (int):
                This parameter specifies the number of acquisitions used for averaging when you set the **TXP Averaging Enabled**
                parameter to **True**. The default value is 10.
    ...
    def configure_burst_synchronization_type(self, selector_string, burst_synchronization_type):
        r"""Configures the type of synchronization used for detecting the start of the packet in the transmit power (TXP)
        measurement.
        ...
        try:
            ...
            burst_synchronization_type = (
                ...
                if type(burst_synchronization_type) is enums.TxpBurstSynchronizationType
                else burst_synchronization_type
            )
            updated_selector_string = _helper.validate_and_update_selector_string(
                selector_string, self._signal_obj
            )
            error_code = self._interpreter.txp_configure_burst_synchronization_type(
