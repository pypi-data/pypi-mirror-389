...
class ModAccResults(object):
    ...
    def get_iq_origin_offset_mean(self, selector_string):
        r"""Gets the I/Q origin offset estimated over the EDR portion of the EDR packets. This value is expressed in dB. When
        you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the
        ...
        Returns:
            ...
            attr_val (float):
                Returns the I/Q origin offset estimated over the EDR portion of the EDR packets. This value is expressed in dB. When
                you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the
                mean of the I/Q origin offset values computed for each averaging count.
    ...
    def fetch_devm(self, selector_string, timeout):
        ...
        Returns:
            ...
            peak_rms_devm_maximum (float):
                ...
                packet. When you set :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it
                returns the maximum of the peak RMS DEVM values computed for each averaging count. This value is expressed in
                percentage.
    ...
    def fetch_devm_magnitude_error(self, selector_string, timeout):
        ...
        Returns:
            ...
            average_rms_magnitude_error_mean (float):
                ...
                EDR packet. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to
    ...
    def fetch_devm_phase_error(self, selector_string, timeout):
        ...
        Returns:
            ...
            average_rms_phase_error_mean (float):
                ...
                packet. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it
    ...
    def fetch_df1(self, selector_string, timeout):
        ...
        Returns:
            ...
            df1avg_maximum (float):
                ...
                :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the maximum of
                the df1avg results computed for each averaging count.
