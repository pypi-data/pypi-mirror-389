    ...
    def fetch_le_cte_reference_period_powers(self, selector_string, timeout):
        ...
        Returns:
            ...
            reference_period_average_power_mean (float):
                ...
                mean of the CTE reference period average power results computed for each averaging count. This value is expressed in
                dBm.
            ...
            reference_period_peak_absolute_power_deviation_maximum (float):
                ...
                reference period. When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to
                **True**, it returns the maximum of the CTE reference period absolute power deviation results computed for each
    ...
    def fetch_le_cte_transmit_slot_powers_array(self, selector_string, timeout):
        ...
        Returns:
            ...
            transmit_slot_average_power_mean (float):
                ...
                When you set the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns
                an array of mean of the CTE transmit slot average power results computed for each averaging count. This value is
                expressed in dBm.
    ...
    def fetch_le_cte_transmit_slot_powers(self, selector_string, timeout):
        ...
        Returns:
            ...
            transmit_slot_average_power_mean (float):
                ...
                the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean of
                the CTE transmit slot average power results computed for each averaging count. This value is expressed in dBm.
    ...
    def fetch_powers(self, selector_string, timeout):
        ...
        Returns:
            ...
            average_power_mean (float):
                ...
                average power is calculated from beginning of the payload portion. When you set the
                :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, it returns the mean of the
                average power results computed for each averaging count. This value is expressed in dBm.
