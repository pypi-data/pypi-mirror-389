...
class ModAccConfiguration(object):
    ...
    def get_iq_origin_offset_correction_enabled(self, selector_string):
        r"""Gets whether to enable the I/Q origin offset correction for EDR and LE-HDT packet. If you set this attribute to
        **True**, the DEVM and EVM results are computed after correcting for the I/Q origin offset.
        ...
        Returns:
            ...
            attr_val (enums.ModAccIQOriginOffsetCorrectionEnabled):
                Specifies whether to enable the I/Q origin offset correction for EDR and LE-HDT packet. If you set this attribute to
                **True**, the DEVM and EVM results are computed after correcting for the I/Q origin offset.
    ...
    def set_iq_origin_offset_correction_enabled(self, selector_string, value):
        r"""Sets whether to enable the I/Q origin offset correction for EDR and LE-HDT packet. If you set this attribute to
        **True**, the DEVM and EVM results are computed after correcting for the I/Q origin offset.
