...
class ModAccAveragingEnabled(Enum):
    ...
    TRUE = 1
    r"""The measurement uses the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_COUNT` attribute as the number of
    acquisitions over which the ModAcc measurement is averaged."""
...
class AcpOffsetChannelMode(Enum):
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.NUMBER_OF_OFFSETS` attribute. In symmetric mode, the
...
class AcpResultsMeasurementStatus(Enum):
    ...
    :py:attr:`~nirfmxbluetooth.attributes.AttributeID.OFFSET_CHANNEL_MODE` attribute to **Symmetric**."""
...
class TwentydBBandwidthAveragingEnabled(Enum):
    ...
    TRUE = 1
    r"""The 20dBBandwidth measurement uses the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_COUNT` attribute as
    the number of acquisitions over which the 20dBBandwidth measurement is averaged."""
...
class FrequencyRangeAveragingEnabled(Enum):
    ...
    TRUE = 1
    r"""The FrequencyRange measurement uses the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_COUNT` attribute as
    the number of acquisitions over which the FrequencyRange measurement is averaged."""
...
class ModSpectrumAveragingEnabled(Enum):
    ...
    TRUE = 1
    r"""The measurement uses the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_COUNT` attribute as the number of
    acquisitions over which the ModSpectrum measurement is averaged."""
...
class PowerRampAveragingEnabled(Enum):
    ...
    TRUE = 1
    r"""The measurement uses the :py:attr:`~nirfmxbluetooth.attributes.AttributeID.AVERAGING_COUNT` attribute as the number of
    acquisitions over which the PowerRamp measurement is averaged."""
