...
@external.route('/technical-ability-certificate/<authentication_id>/auth')
def authenticate_technical_ability_certificate(authentication_id):
    raise NotImplementedError()
...
@external.route('/admin/compliance-communication/<int:communication_id>')
def admin_view_compliance_communication(communication_id):
    raise NotImplementedError()
