...
def SortedMapToProto(state: SortedMap.State, protobuf_state: rbt.std.collections.v1.sorted_map_pb2.SortedMap):
    pass

def SortedMapFromProto(
    state: rbt.std.collections.v1.sorted_map_pb2.SortedMap,
    validate: bool = True,
) -> SortedMap.State:
    return state
def SortedMapInsertResponseToProto(
    response: SortedMap.InsertResponse
) -> rbt.std.collections.v1.sorted_map_pb2.InsertResponse:
    return response

def SortedMapInsertResponseFromProto(
    response: rbt.std.collections.v1.sorted_map_pb2.InsertResponse
) -> SortedMap.InsertResponse:
    return response

def SortedMapInsertRequestToProto(
    request: SortedMap.InsertRequest
) -> rbt.std.collections.v1.sorted_map_pb2.InsertRequest:
    return request

def SortedMapInsertRequestFromProto(
    request: rbt.std.collections.v1.sorted_map_pb2.InsertRequest
) -> SortedMap.InsertRequest:
    return request

def SortedMapRemoveResponseToProto(
    response: SortedMap.RemoveResponse
) -> rbt.std.collections.v1.sorted_map_pb2.RemoveResponse:
    return response

def SortedMapRemoveResponseFromProto(
    response: rbt.std.collections.v1.sorted_map_pb2.RemoveResponse
) -> SortedMap.RemoveResponse:
    return response

def SortedMapRemoveRequestToProto(
    request: SortedMap.RemoveRequest
) -> rbt.std.collections.v1.sorted_map_pb2.RemoveRequest:
    return request

def SortedMapRemoveRequestFromProto(
    request: rbt.std.collections.v1.sorted_map_pb2.RemoveRequest
) -> SortedMap.RemoveRequest:
    return request

def SortedMapGetResponseToProto(
    response: SortedMap.GetResponse
) -> rbt.std.collections.v1.sorted_map_pb2.GetResponse:
    return response

def SortedMapGetResponseFromProto(
    response: rbt.std.collections.v1.sorted_map_pb2.GetResponse
) -> SortedMap.GetResponse:
    return response

def SortedMapGetRequestToProto(
    request: SortedMap.GetRequest
) -> rbt.std.collections.v1.sorted_map_pb2.GetRequest:
    return request

def SortedMapGetRequestFromProto(
    request: rbt.std.collections.v1.sorted_map_pb2.GetRequest
) -> SortedMap.GetRequest:
    return request

def SortedMapRangeResponseToProto(
    response: SortedMap.RangeResponse
) -> rbt.std.collections.v1.sorted_map_pb2.RangeResponse:
    return response

def SortedMapRangeResponseFromProto(
    response: rbt.std.collections.v1.sorted_map_pb2.RangeResponse
) -> SortedMap.RangeResponse:
    return response

def SortedMapRangeRequestToProto(
    request: SortedMap.RangeRequest
) -> rbt.std.collections.v1.sorted_map_pb2.RangeRequest:
    return request

def SortedMapRangeRequestFromProto(
    request: rbt.std.collections.v1.sorted_map_pb2.RangeRequest
) -> SortedMap.RangeRequest:
    return request

def SortedMapReverseRangeResponseToProto(
    response: SortedMap.ReverseRangeResponse
) -> rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse:
    return response

def SortedMapReverseRangeResponseFromProto(
    response: rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse
) -> SortedMap.ReverseRangeResponse:
    return response

def SortedMapReverseRangeRequestToProto(
    request: SortedMap.ReverseRangeRequest
) -> rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest:
    return request

def SortedMapReverseRangeRequestFromProto(
    request: rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest
) -> SortedMap.ReverseRangeRequest:
    return request
...
class SortedMapServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
    ...
    async def __Insert(
        ...
        *,
        ...
        try:
            typed_state: SortedMap.State = SortedMapFromProto(state, validate=(context.state_id not in states_being_constructed))
            response = (
            ...
            SortedMapToProto(typed_state, state)
...
class SortedMapSingletonServicer(SortedMapBaseServicer):
    ...
    async def _Insert(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = SortedMapInsertRequestFromProto(request)
            return SortedMapInsertResponseToProto(await self.Insert(context, state, typed_request))
    ...
    async def _Remove(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = SortedMapRemoveRequestFromProto(request)
            return SortedMapRemoveResponseToProto(await self.Remove(context, state, typed_request))
    ...
    async def _Get(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = SortedMapGetRequestFromProto(request)
            response = (
                self.Get(
                    context,
                    state,
            ...
            return SortedMapGetResponseToProto(await response)
    ...
    async def _Range(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = SortedMapRangeRequestFromProto(request)
            response = (
                self.Range(
                    context,
                    state,
            ...
            return SortedMapRangeResponseToProto(await response)
    ...
    async def _ReverseRange(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = SortedMapReverseRangeRequestFromProto(request)
            response = (
                self.ReverseRange(
                    context,
                    state,
            ...
            return SortedMapReverseRangeResponseToProto(await response)
...
class SortedMapServicer(SortedMapBaseServicer):
    ...
    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[SortedMap.State]
    ...
    @property
    def state(self) -> SortedMap.State:
    ...
    @state.setter
    def state(self, new_state: SortedMap.State):
        state = SortedMapServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def _Insert(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = SortedMapInsertRequestFromProto(request)
                return SortedMapInsertResponseToProto(await instance.Insert(context, typed_request))
        finally:
    ...
    async def _Remove(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = SortedMapRemoveRequestFromProto(request)
                return SortedMapRemoveResponseToProto(await instance.Remove(context, typed_request))
        finally:
            SortedMapServicer._state.set(None)
    ...
    async def _Get(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = SortedMapGetRequestFromProto(request)
                return SortedMapGetResponseToProto(await instance.Get(context, typed_request))
        finally:
            SortedMapServicer._state.set(None)
    ...
    async def _Range(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = SortedMapRangeRequestFromProto(request)
                return SortedMapRangeResponseToProto(await instance.Range(context, typed_request))
        finally:
            SortedMapServicer._state.set(None)
    ...
    async def _ReverseRange(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = SortedMapReverseRangeRequestFromProto(request)
                return SortedMapReverseRangeResponseToProto(await instance.ReverseRange(context, typed_request))
        finally:
            SortedMapServicer._state.set(None)
...
class SortedMap:
    ...
    InsertRequest: IMPORT_typing.TypeAlias = rbt.std.collections.v1.sorted_map_pb2.InsertRequest
    InsertResponse: IMPORT_typing.TypeAlias = rbt.std.collections.v1.sorted_map_pb2.InsertResponse

    RemoveRequest: IMPORT_typing.TypeAlias = rbt.std.collections.v1.sorted_map_pb2.RemoveRequest
    RemoveResponse: IMPORT_typing.TypeAlias = rbt.std.collections.v1.sorted_map_pb2.RemoveResponse

    GetRequest: IMPORT_typing.TypeAlias = rbt.std.collections.v1.sorted_map_pb2.GetRequest
    GetResponse: IMPORT_typing.TypeAlias = rbt.std.collections.v1.sorted_map_pb2.GetResponse

    RangeRequest: IMPORT_typing.TypeAlias = rbt.std.collections.v1.sorted_map_pb2.RangeRequest
    RangeResponse: IMPORT_typing.TypeAlias = rbt.std.collections.v1.sorted_map_pb2.RangeResponse

    ReverseRangeRequest: IMPORT_typing.TypeAlias = rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest
    ReverseRangeResponse: IMPORT_typing.TypeAlias = rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse
    ...
    class InsertTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, SortedMap.InsertResponse]:
            ...
            async def wait_for_task() -> rbt.std.collections.v1.sorted_map_pb2.InsertResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        return SortedMapInsertResponseFromProto(response)
    ...
    class RemoveTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, SortedMap.RemoveResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.std.collections.v1.sorted_map_pb2.RemoveResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return SortedMapRemoveResponseFromProto(response)
    ...
    class GetTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, SortedMap.GetResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.std.collections.v1.sorted_map_pb2.GetResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return SortedMapGetResponseFromProto(response)
    ...
    class RangeTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, SortedMap.RangeResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.std.collections.v1.sorted_map_pb2.RangeResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return SortedMapRangeResponseFromProto(response)
    ...
    class ReverseRangeTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, SortedMap.ReverseRangeResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return SortedMapReverseRangeResponseFromProto(response)
    ...
    class WeakReference(IMPORT_typing.Generic[SortedMap_ScheduleTypeVar]):
        ...
        async def Insert(
            ...
            *,
            ...
            return SortedMapInsertResponseFromProto(
                await __this__._writer(__context__).Insert(
                    __request__,
                    idempotency=__idempotency__,
                    metadata=__metadata__,
                    bearer_token=__bearer_token__,
        ...
        async def Remove(
            ...
            *,
            ...
            return SortedMapRemoveResponseFromProto(
                await __this__._writer(__context__).Remove(
                    __request__,
                    idempotency=__idempotency__,
                    metadata=__metadata__,
                    bearer_token=__bearer_token__,
        ...
        async def Get(
            ...
            *,
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return SortedMapGetResponseFromProto(
        ...
        async def Range(
            ...
            *,
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return SortedMapRangeResponseFromProto(
        ...
        async def ReverseRange(
            ...
            *,
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return SortedMapReverseRangeResponseFromProto(
