...
def PresenceToProto(state: Presence.State, protobuf_state: rbt.std.presence.v1.presence_pb2.Presence):
    pass

def PresenceFromProto(
    state: rbt.std.presence.v1.presence_pb2.Presence,
    validate: bool = True,
) -> Presence.State:
    return state
def PresenceSubscribeResponseToProto(
    response: Presence.SubscribeResponse
) -> rbt.std.presence.v1.presence_pb2.SubscribeResponse:
    return response

def PresenceSubscribeResponseFromProto(
    response: rbt.std.presence.v1.presence_pb2.SubscribeResponse
) -> Presence.SubscribeResponse:
    return response

def PresenceSubscribeRequestToProto(
    request: Presence.SubscribeRequest
) -> rbt.std.presence.v1.presence_pb2.SubscribeRequest:
    return request

def PresenceSubscribeRequestFromProto(
    request: rbt.std.presence.v1.presence_pb2.SubscribeRequest
) -> Presence.SubscribeRequest:
    return request

def PresenceListResponseToProto(
    response: Presence.ListResponse
) -> rbt.std.presence.v1.presence_pb2.ListResponse:
    return response

def PresenceListResponseFromProto(
    response: rbt.std.presence.v1.presence_pb2.ListResponse
) -> Presence.ListResponse:
    return response

def PresenceListRequestToProto(
    request: Presence.ListRequest
) -> rbt.std.presence.v1.presence_pb2.ListRequest:
    return request

def PresenceListRequestFromProto(
    request: rbt.std.presence.v1.presence_pb2.ListRequest
) -> Presence.ListRequest:
    return request

def PresenceWatchResponseToProto(
    response: Presence.WatchResponse
) -> rbt.std.presence.v1.presence_pb2.WatchResponse:
    return response

def PresenceWatchResponseFromProto(
    response: rbt.std.presence.v1.presence_pb2.WatchResponse
) -> Presence.WatchResponse:
    return response

def PresenceWatchRequestToProto(
    request: Presence.WatchRequest
) -> rbt.std.presence.v1.presence_pb2.WatchRequest:
    return request

def PresenceWatchRequestFromProto(
    request: rbt.std.presence.v1.presence_pb2.WatchRequest
) -> Presence.WatchRequest:
    return request
...
class PresenceServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
    ...
    async def __Subscribe(
        ...
        *,
        ...
        try:
            typed_state: Presence.State = PresenceFromProto(state, validate=(context.state_id not in states_being_constructed))
            response = (
            ...
            PresenceToProto(typed_state, state)
...
class PresenceSingletonServicer(PresenceBaseServicer):
    ...
    async def _Subscribe(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = PresenceSubscribeRequestFromProto(request)
            return PresenceSubscribeResponseToProto(await self.Subscribe(context, state, typed_request))
    ...
    async def _List(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = PresenceListRequestFromProto(request)
            response = (
                self.List(
                    context,
                    state,
            ...
            return PresenceListResponseToProto(await response)
    ...
    async def _Watch(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = PresenceWatchRequestFromProto(request)
            return await self.Watch(context, typed_request)
...
class PresenceServicer(PresenceBaseServicer):
    ...
    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[Presence.State]
    ...
    @state.setter
    def state(self, new_state: Presence.State):
        state = PresenceServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def _Subscribe(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = PresenceSubscribeRequestFromProto(request)
                return PresenceSubscribeResponseToProto(await instance.Subscribe(context, typed_request))
        finally:
    ...
    async def _List(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = PresenceListRequestFromProto(request)
                return PresenceListResponseToProto(await instance.List(context, typed_request))
        finally:
            PresenceServicer._state.set(None)
    ...
    async def _Watch(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = PresenceWatchRequestFromProto(request)
                return PresenceWatchResponseToProto(await instance.Watch(context, typed_request))
        finally:
...
class Presence:
    ...
    SubscribeRequest: IMPORT_typing.TypeAlias = rbt.std.presence.v1.presence_pb2.SubscribeRequest
    SubscribeResponse: IMPORT_typing.TypeAlias = rbt.std.presence.v1.presence_pb2.SubscribeResponse

    ListRequest: IMPORT_typing.TypeAlias = rbt.std.presence.v1.presence_pb2.ListRequest
    ListResponse: IMPORT_typing.TypeAlias = rbt.std.presence.v1.presence_pb2.ListResponse

    WatchRequest: IMPORT_typing.TypeAlias = rbt.std.presence.v1.presence_pb2.WatchRequest
    WatchResponse: IMPORT_typing.TypeAlias = rbt.std.presence.v1.presence_pb2.WatchResponse
    ...
    class SubscribeTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Presence.SubscribeResponse]:
            ...
            async def wait_for_task() -> rbt.std.presence.v1.presence_pb2.SubscribeResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        return PresenceSubscribeResponseFromProto(response)
    ...
    class ListTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Presence.ListResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.std.presence.v1.presence_pb2.ListResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return PresenceListResponseFromProto(response)
    ...
    class WatchTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Presence.WatchResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.std.presence.v1.presence_pb2.WatchResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return PresenceWatchResponseFromProto(response)
    ...
    class WeakReference(IMPORT_typing.Generic[Presence_ScheduleTypeVar]):
        ...
        async def Subscribe(
            ...
            *,
            ...
            return PresenceSubscribeResponseFromProto(
        ...
        async def List(
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return PresenceListResponseFromProto(
                await __this__._reader(__context__).List(
                    __request__,
                    metadata=__metadata__,
                    bearer_token=__bearer_token__,
        ...
        async def Watch(
            ...
            *,
            ...
            return PresenceWatchResponseFromProto(
                await (
                    await __this__.spawn().Watch(
                        __context__,
                        __options__,
