    ...
    async def __Send(
        ...
        *,
        ...
        try:
            ...
            typed_state: Message.State = MessageFromProto(state, validate=(context.state_id not in states_being_constructed))
            response = (
...
class MessageSingletonServicer(MessageBaseServicer):
    ...
    async def _Send(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return MessageSendResponseToProto(await self.Send(context, state, typed_request))
    ...
    async def _SendWorkflow(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return await self.SendWorkflow(context, typed_request)
    ...
    async def _Send(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = MessageSendRequestFromProto(request)
                return MessageSendResponseToProto(await instance.Send(context, typed_request))
        finally:
    ...
    async def _SendWorkflow(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = MessageSendWorkflowRequestFromProto(request)
                return MessageSendWorkflowResponseToProto(await instance.SendWorkflow(context, typed_request))
        finally:
    ...
    class WeakReference(IMPORT_typing.Generic[Message_ScheduleTypeVar]):
        ...
        async def SendWorkflow(
            ...
            *,
            ...
            return MessageSendWorkflowResponseFromProto(
                await (
                    await __this__.spawn().SendWorkflow(
                        __context__,
                        __options__,
