...
class MousePositionServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
    ...
    async def __Update(
        ...
        *,
        ...
        try:
            typed_state: MousePosition.State = MousePositionFromProto(state, validate=(context.state_id not in states_being_constructed))
            response = (
...
class MousePositionSingletonServicer(MousePositionBaseServicer):
    ...
    async def _Update(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return MousePositionUpdateResponseToProto(await self.Update(context, state, typed_request))
    ...
    async def _Update(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = MousePositionUpdateRequestFromProto(request)
                return MousePositionUpdateResponseToProto(await instance.Update(context, typed_request))
        finally:
    ...
    async def _Position(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = MousePositionPositionRequestFromProto(request)
                return MousePositionPositionResponseToProto(await instance.Position(context, typed_request))
        finally:
            MousePositionServicer._state.set(None)
