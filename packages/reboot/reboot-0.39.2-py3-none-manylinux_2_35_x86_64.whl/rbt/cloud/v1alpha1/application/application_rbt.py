    ...
    async def __Create(
        ...
        *,
        ...
        try:
            ...
            typed_state: Application.State = ApplicationFromProto(state, validate=(context.state_id not in states_being_constructed))
            response = (
            ...
            ApplicationToProto(typed_state, state)
...
class ApplicationSingletonServicer(ApplicationBaseServicer):
    ...
    async def _Create(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = ApplicationCreateRequestFromProto(request)
            return ApplicationCreateResponseToProto(await self.Create(context, state, typed_request))
    ...
    async def _PushInfo(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = ApplicationPushInfoRequestFromProto(request)
            response = (
                self.PushInfo(
                    context,
                    state,
            ...
            return ApplicationPushInfoResponseToProto(await response)
    ...
    async def _Up(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = ApplicationUpRequestFromProto(request)
            return ApplicationUpResponseToProto(await self.Up(context, state, typed_request))
    ...
    async def _UpWorkflow(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = ApplicationUpWorkflowRequestFromProto(request)
            return await self.UpWorkflow(context, typed_request)
    ...
    async def _Down(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = ApplicationDownRequestFromProto(request)
            return ApplicationDownResponseToProto(await self.Down(context, state, typed_request))
    ...
    async def _DownWorkflow(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = ApplicationDownWorkflowRequestFromProto(request)
            return await self.DownWorkflow(context, typed_request)
    ...
    async def _RevisionStatus(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = ApplicationRevisionStatusRequestFromProto(request)
            response = (
                self.RevisionStatus(
                    context,
                    state,
            ...
            return ApplicationRevisionStatusResponseToProto(await response)
    ...
    async def _Logs(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = ApplicationLogsRequestFromProto(request)
            responses = (
                self.Logs(
                    context,
                    state,
    ...
    async def _ActiveRevisions(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = ApplicationActiveRevisionsRequestFromProto(request)
            response = (
            ...
            return ApplicationActiveRevisionsResponseToProto(await response)
    ...
    async def _Status(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = ApplicationStatusRequestFromProto(request)
            response = (
                self.Status(
                    context,
                    state,
            ...
            return ApplicationStatusResponseToProto(await response)
    ...
    async def _IsAdmin(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            typed_request = ApplicationIsAdminRequestFromProto(request)
            response = (
                self.IsAdmin(
                    context,
                    state,
            ...
            return ApplicationIsAdminResponseToProto(await response)
...
class ApplicationServicer(ApplicationBaseServicer):
    ...
    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[Application.State]
    ...
    @property
    def state(self) -> Application.State:
    ...
    @state.setter
    def state(self, new_state: Application.State):
        state = ApplicationServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def _Create(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationCreateRequestFromProto(request)
                return ApplicationCreateResponseToProto(await instance.Create(context, typed_request))
        finally:
    ...
    async def _PushInfo(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationPushInfoRequestFromProto(request)
                return ApplicationPushInfoResponseToProto(await instance.PushInfo(context, typed_request))
        finally:
            ApplicationServicer._state.set(None)
    ...
    async def _Up(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationUpRequestFromProto(request)
                return ApplicationUpResponseToProto(await instance.Up(context, typed_request))
        finally:
            ApplicationServicer._state.set(None)
    ...
    async def _UpWorkflow(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationUpWorkflowRequestFromProto(request)
                return ApplicationUpWorkflowResponseToProto(await instance.UpWorkflow(context, typed_request))
        finally:
    ...
    async def _Down(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationDownRequestFromProto(request)
                return ApplicationDownResponseToProto(await instance.Down(context, typed_request))
        finally:
            ApplicationServicer._state.set(None)
    ...
    async def _DownWorkflow(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationDownWorkflowRequestFromProto(request)
                return ApplicationDownWorkflowResponseToProto(await instance.DownWorkflow(context, typed_request))
        finally:
            ApplicationServicer._workflow.set(False)
    ...
    async def _RevisionStatus(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationRevisionStatusRequestFromProto(request)
                return ApplicationRevisionStatusResponseToProto(await instance.RevisionStatus(context, typed_request))
        finally:
            ApplicationServicer._state.set(None)
    ...
    async def _ActiveRevisions(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationActiveRevisionsRequestFromProto(request)
                return ApplicationActiveRevisionsResponseToProto(await instance.ActiveRevisions(context, typed_request))
        finally:
            ApplicationServicer._state.set(None)
    ...
    async def _Status(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationStatusRequestFromProto(request)
                return ApplicationStatusResponseToProto(await instance.Status(context, typed_request))
        finally:
            ApplicationServicer._state.set(None)
    ...
    async def _IsAdmin(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationIsAdminRequestFromProto(request)
                return ApplicationIsAdminResponseToProto(await instance.IsAdmin(context, typed_request))
        finally:
            ApplicationServicer._state.set(None)
...
class Application:
    ...
    CreateRequest: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.CreateRequest
    CreateResponse: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.CreateResponse

    PushInfoRequest: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest
    PushInfoResponse: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse

    UpRequest: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.UpRequest
    UpResponse: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.UpResponse

    UpWorkflowRequest: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest
    UpWorkflowResponse: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowResponse

    DownRequest: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.DownRequest
    DownResponse: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.DownResponse

    DownWorkflowRequest: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest
    DownWorkflowResponse: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowResponse

    RevisionStatusRequest: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest
    RevisionStatusResponse: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse

    LogsRequest: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.LogsRequest
    LogsResponse: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.LogsResponse

    ActiveRevisionsRequest: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest
    ActiveRevisionsResponse: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse

    StatusRequest: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.StatusRequest
    StatusResponse: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.StatusResponse

    IsAdminRequest: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest
    IsAdminResponse: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse
    ...
    class CreateTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Application.CreateResponse]:
            ...
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.CreateResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        return ApplicationCreateResponseFromProto(response)
    ...
    class PushInfoTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Application.PushInfoResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return ApplicationPushInfoResponseFromProto(response)
    ...
    class UpTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Application.UpResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.UpResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return ApplicationUpResponseFromProto(response)
    ...
    class UpWorkflowTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Application.UpWorkflowResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return ApplicationUpWorkflowResponseFromProto(response)
    ...
    class DownTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Application.DownResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.DownResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return ApplicationDownResponseFromProto(response)
    ...
    class DownWorkflowTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Application.DownWorkflowResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return ApplicationDownWorkflowResponseFromProto(response)
    ...
    class RevisionStatusTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Application.RevisionStatusResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return ApplicationRevisionStatusResponseFromProto(response)
    ...
    class LogsTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Application.LogsResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.LogsResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return ApplicationLogsResponseFromProto(response)
    ...
    class ActiveRevisionsTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Application.ActiveRevisionsResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return ApplicationActiveRevisionsResponseFromProto(response)
    ...
    class StatusTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Application.StatusResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.StatusResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return ApplicationStatusResponseFromProto(response)
    ...
    class IsAdminTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, Application.IsAdminResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse:
                ...
                try:
                    ...
                    if is_error:
                        ...
                        response_or_error.Unpack(response)
                        return ApplicationIsAdminResponseFromProto(response)
    ...
    class WeakReference(IMPORT_typing.Generic[Application_ScheduleTypeVar]):
        ...
        async def PushInfo(
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return ApplicationPushInfoResponseFromProto(
                await __this__._reader(__context__).PushInfo(
                    __request__,
                    metadata=__metadata__,
                    bearer_token=__bearer_token__,
        ...
        async def Up(
            ...
            *,
            ...
            return ApplicationUpResponseFromProto(
                await __this__._writer(__context__).Up(
                    __request__,
                    idempotency=__idempotency__,
                    metadata=__metadata__,
                    bearer_token=__bearer_token__,
        ...
        async def UpWorkflow(
            ...
            *,
            ...
            return ApplicationUpWorkflowResponseFromProto(
                await (
                    await __this__.spawn().UpWorkflow(
                        __context__,
                        __options__,
        ...
        async def Down(
            ...
            return ApplicationDownResponseFromProto(
                await __this__._writer(__context__).Down(
                    __request__,
                    idempotency=__idempotency__,
                    metadata=__metadata__,
                    bearer_token=__bearer_token__,
        ...
        async def DownWorkflow(
            ...
            return ApplicationDownWorkflowResponseFromProto(
                await (
                    await __this__.spawn().DownWorkflow(
                        __context__,
                        __options__,
        ...
        async def RevisionStatus(
            ...
            *,
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return ApplicationRevisionStatusResponseFromProto(
                await __this__._reader(__context__).RevisionStatus(
                    __request__,
                    metadata=__metadata__,
                    bearer_token=__bearer_token__,
                    idempotency=__options__.idempotency if __options__ is not None else None,
        ...
        async def ActiveRevisions(
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return ApplicationActiveRevisionsResponseFromProto(
                await __this__._reader(__context__).ActiveRevisions(
                    __request__,
                    metadata=__metadata__,
                    bearer_token=__bearer_token__,
                    idempotency=__options__.idempotency if __options__ is not None else None,
        ...
        async def Status(
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return ApplicationStatusResponseFromProto(
        ...
        async def IsAdmin(
            ...
            *,
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return ApplicationIsAdminResponseFromProto(
                await __this__._reader(__context__).IsAdmin(
                    __request__,
                    metadata=__metadata__,
                    bearer_token=__bearer_token__,
                    idempotency=__options__.idempotency if __options__ is not None else None,
    ...
    async def Create(
        ...
        return (
            __reference__,
            ApplicationCreateResponseFromProto(
