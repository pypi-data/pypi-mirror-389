...
class MemoizeServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
    ...
    async def __Reset(
        ...
        *,
        ...
        try:
            typed_state: Memoize.State = MemoizeFromProto(state, validate=(context.state_id not in states_being_constructed))
            response = (
...
class MemoizeSingletonServicer(MemoizeBaseServicer):
    ...
    async def _Reset(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return MemoizeResetResponseToProto(await self.Reset(context, state, typed_request))
    ...
    async def _Start(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return MemoizeStartResponseToProto(await self.Start(context, state, typed_request))
    ...
    async def _Store(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return MemoizeStoreResponseToProto(await self.Store(context, state, typed_request))
    ...
    async def _Fail(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return MemoizeFailResponseToProto(await self.Fail(context, state, typed_request))
    ...
    async def _Reset(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = MemoizeResetRequestFromProto(request)
                return MemoizeResetResponseToProto(await instance.Reset(context, typed_request))
        finally:
    ...
    async def _Start(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = MemoizeStartRequestFromProto(request)
                return MemoizeStartResponseToProto(await instance.Start(context, typed_request))
        finally:
            MemoizeServicer._state.set(None)
    ...
    async def _Store(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = MemoizeStoreRequestFromProto(request)
                return MemoizeStoreResponseToProto(await instance.Store(context, typed_request))
        finally:
            MemoizeServicer._state.set(None)
    ...
    async def _Fail(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = MemoizeFailRequestFromProto(request)
                return MemoizeFailResponseToProto(await instance.Fail(context, typed_request))
        finally:
            MemoizeServicer._state.set(None)
    ...
    async def _Status(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = MemoizeStatusRequestFromProto(request)
                return MemoizeStatusResponseToProto(await instance.Status(context, typed_request))
        finally:
            MemoizeServicer._state.set(None)
