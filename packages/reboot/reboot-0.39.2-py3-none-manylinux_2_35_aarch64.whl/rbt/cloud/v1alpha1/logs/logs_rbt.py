...
class ApplicationLogsServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
    ...
    async def __Ensure(
        ...
        *,
        ...
        try:
            typed_state: ApplicationLogs.State = ApplicationLogsFromProto(state, validate=(context.state_id not in states_being_constructed))
            response = (
...
class ApplicationLogsSingletonServicer(ApplicationLogsBaseServicer):
    ...
    async def _Ensure(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return ApplicationLogsEnsureResponseToProto(await self.Ensure(context, state, typed_request))
    ...
    async def _RegisterConsensus(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return ApplicationLogsRegisterConsensusResponseToProto(await self.RegisterConsensus(context, state, typed_request))
    ...
    async def _RegisterRevision(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return ApplicationLogsRegisterRevisionResponseToProto(await self.RegisterRevision(context, state, typed_request))
    ...
    async def _Ensure(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationLogsEnsureRequestFromProto(request)
                return ApplicationLogsEnsureResponseToProto(await instance.Ensure(context, typed_request))
        finally:
    ...
    async def _RegisterConsensus(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationLogsRegisterConsensusRequestFromProto(request)
                return ApplicationLogsRegisterConsensusResponseToProto(await instance.RegisterConsensus(context, typed_request))
        finally:
            ApplicationLogsServicer._state.set(None)
    ...
    async def _RegisterRevision(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = ApplicationLogsRegisterRevisionRequestFromProto(request)
                return ApplicationLogsRegisterRevisionResponseToProto(await instance.RegisterRevision(context, typed_request))
        finally:
            ApplicationLogsServicer._state.set(None)
