    ...
    async def __Create(
        ...
        *,
        ...
        try:
            ...
            typed_state: APIKey.State = APIKeyFromProto(state, validate=(context.state_id not in states_being_constructed))
            response = (
...
class APIKeySingletonServicer(APIKeyBaseServicer):
    ...
    async def _Create(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return APIKeyCreateResponseToProto(await self.Create(context, state, typed_request))
    ...
    async def _Revoke(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return APIKeyRevokeResponseToProto(await self.Revoke(context, state, typed_request))
    ...
    async def _Create(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = APIKeyCreateRequestFromProto(request)
                return APIKeyCreateResponseToProto(await instance.Create(context, typed_request))
        finally:
    ...
    async def _Revoke(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = APIKeyRevokeRequestFromProto(request)
                return APIKeyRevokeResponseToProto(await instance.Revoke(context, typed_request))
        finally:
            APIKeyServicer._state.set(None)
    ...
    async def _Authenticate(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = APIKeyAuthenticateRequestFromProto(request)
                return APIKeyAuthenticateResponseToProto(await instance.Authenticate(context, typed_request))
        finally:
            APIKeyServicer._state.set(None)
