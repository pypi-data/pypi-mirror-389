...
class SubscriberServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
    ...
    async def __Create(
        ...
        *,
        ...
        try:
            typed_state: Subscriber.State = SubscriberFromProto(state, validate=(context.state_id not in states_being_constructed))
            response = (
...
class SubscriberSingletonServicer(SubscriberBaseServicer):
    ...
    async def _Create(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return SubscriberCreateResponseToProto(await self.Create(context, state, typed_request))
    ...
    async def _Toggle(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return SubscriberToggleResponseToProto(await self.Toggle(context, state, typed_request))
    ...
    async def _WaitForDisconnect(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return await self.WaitForDisconnect(context, typed_request)
    ...
    async def _Create(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = SubscriberCreateRequestFromProto(request)
                return SubscriberCreateResponseToProto(await instance.Create(context, typed_request))
        finally:
    ...
    async def _Connect(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = SubscriberConnectRequestFromProto(request)
                return SubscriberConnectResponseToProto(await instance.Connect(context, typed_request))
        finally:
            SubscriberServicer._state.set(None)
    ...
    async def _Toggle(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = SubscriberToggleRequestFromProto(request)
                return SubscriberToggleResponseToProto(await instance.Toggle(context, typed_request))
        finally:
            SubscriberServicer._state.set(None)
    ...
    async def _WaitForDisconnect(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = SubscriberWaitForDisconnectRequestFromProto(request)
                return SubscriberWaitForDisconnectResponseToProto(await instance.WaitForDisconnect(context, typed_request))
        finally:
    ...
    async def _Status(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = SubscriberStatusRequestFromProto(request)
                return SubscriberStatusResponseToProto(await instance.Status(context, typed_request))
        finally:
            SubscriberServicer._state.set(None)
    ...
    class WeakReference(IMPORT_typing.Generic[Subscriber_ScheduleTypeVar]):
        ...
        async def WaitForDisconnect(
            ...
            *,
            ...
            return SubscriberWaitForDisconnectResponseFromProto(
                await (
                    await __this__.spawn().WaitForDisconnect(
                        __context__,
                        __options__,
