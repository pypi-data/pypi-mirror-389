...
class Software(ConfigPart):
    def __init__(self, drt_go_chain: "SoftwareChainGo", drt_go_chain_proxy: "SoftwareChainProxyGo"):
        self.drt_go_chain = drt_go_chain
        self.drt_go_chain_proxy = drt_go_chain_proxy

    def get_name(self) -> str:
        return "software"

    def _do_override(self, other: Dict[str, Any]):
        self.drt_go_chain.override(other.get("drt_go_chain", {}))
        self.drt_go_chain_proxy.override(other.get("drt_go_chain_proxy", {}))

    def to_dictionary(self) -> Dict[str, Any]:
        return {
            "drt_go_chain": self.drt_go_chain.to_dictionary(),
            "drt_go_chain_proxy": self.drt_go_chain_proxy.to_dictionary(),
        }
