...
class Networking(ConfigPart):
    def __init__(
        ...
        self.port_seednode_rest_api: int = port_seednode_rest_api
    ...
    def _do_override(self, other: Dict[str, Any]):
        ...
        self.port_seednode_rest_api = other.get("port_seednode_rest_api", self.port_seednode_rest_api)
        ...
        self.port_first_validator_rest_api = other.get(
            "port_first_validator_rest_api", self.port_first_validator_rest_api
        )
