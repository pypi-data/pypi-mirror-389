...
def _add_arguments_arg(sub: Any):
    sub.add_argument(
        ...
        "boolean] or hex-encoded. E.g. --arguments 42 0x64 1000 0xabba str:TOK-a1c2ef true addr:drt1[..]",
    )
    sub.add_argument(
        "--arguments-file",
        type=str,
...
After installing, use the `sc-meta all build` command. To lear more about `sc-meta`, check out this page: https://docs.dharitri.org/developers/meta/sc-meta-cli/#calling-build."""
