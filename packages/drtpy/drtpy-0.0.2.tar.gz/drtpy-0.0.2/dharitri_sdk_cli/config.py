...
from dharitri_py_sdk import NetworkProviderConfig
...
def get_defaults() -> dict[str, Any]:
    return {
        ...
        "dependencies.vmtools.urlTemplate.linux": "https://github.com/TerraDharitri/drt-go-chain-vm/archive/{TAG}.tar.gz",
        "dependencies.vmtools.urlTemplate.osx": "https://github.com/TerraDharitri/drt-go-chain-vm/archive/{TAG}.tar.gz",
        "dependencies.vmtools.urlTemplate.windows": "https://github.com/TerraDharitri/drt-go-chain-vm/archive/{TAG}.tar.gz",
        ...
        "dependencies.testwallets.urlTemplate.linux": "https://github.com/TerraDharitri/drt-sdk-testwallets/archive/{TAG}.tar.gz",
        "dependencies.testwallets.urlTemplate.osx": "https://github.com/TerraDharitri/drt-sdk-testwallets/archive/{TAG}.tar.gz",
        "dependencies.testwallets.urlTemplate.windows": "https://github.com/TerraDharitri/drt-sdk-testwallets/archive/{TAG}.tar.gz",
...
def add_config_args(argv: list[str]) -> list[str]:
    ...
    print(f"Found extra arguments in drtpy.json. Final arguments: {final_args}")
    return final_args
...
def determine_final_args(argv: list[str], config_args: dict[str, Any]) -> list[str]:
    ...
    # eg. drtpy --verbose contract deploy
