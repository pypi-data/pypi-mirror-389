...
fn main() -> Result<(), Error> {
    let test_files = vec![
        ("test_datasets/pdfs/newspapers/IA_0001-cdc-2015-american-tour.pdf", 11),
        ("test_datasets/pdfs/newspapers/IA_0001-cdc-2018-american-tour.pdf", 10),
        ("test_datasets/pdfs/newspapers/IA_0001-chambers-museum.pdf", 31),
    ];
                    ...
                    Ok(obj) => {
                        ...
                        match &obj {
                            ...
                            match obj.decode_stream_data() {
                                Ok(decoded) => {
                                    println!("✅ Decompression succeeded: {} bytes", decoded.len());
