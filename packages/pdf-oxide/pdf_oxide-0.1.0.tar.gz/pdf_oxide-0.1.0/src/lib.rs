...
//! - **Format Conversion**: Convert to Markdown, HTML, plain text
//! - **Image Extraction**: Extract embedded images (JPEG, PNG)
//! - **ML Integration** (optional): Advanced layout analysis with ONNX models
//! - **Table Detection** (optional): ML-based table extraction
//! - **OCR** (optional): Text extraction from scanned PDFs
