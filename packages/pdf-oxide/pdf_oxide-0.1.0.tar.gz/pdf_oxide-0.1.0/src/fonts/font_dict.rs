...
impl FontInfo {
    ...
    pub fn from_dict(dict: &Object, doc: &mut PdfDocument) -> Result<Self> {
        ...
        if subtype == "Type3" {
            log::warn!("Font '{}' is Type 3 - may require special glyph name mapping (Phase 7C)", base_font);
        }
...
mod tests {
    ...
    #[test]
    fn test_glyph_name_to_unicode_uniXXXX() {
    ...
    #[test]
    fn test_glyph_name_to_unicode_uXXXX() {
