...
class AlgorithmResultApi:
    ...
    @validate_arguments
    def get_algorithm_result(self, algorithm_result_id: Any, **kwargs) -> ResultResponseAlgorithmResultSchema:  # noqa: E501
        ...
        :type algorithm_result_id: AlgorithmResultId
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
    ...
    @validate_arguments
    def get_algorithm_result_with_http_info(self, algorithm_result_id: Any, **kwargs) -> ApiResponse:  # noqa: E501
        """Get algorithm result  # noqa: E501
    ...
    def list_algorithm_results(
        self, algorithm_version_id: Optional[Any] = None, cohort_id: Optional[Any] = None, **kwargs
        ...
        :type algorithm_version_id: AlgorithmVersionId
        :param cohort_id:
        :type cohort_id: CohortId
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
