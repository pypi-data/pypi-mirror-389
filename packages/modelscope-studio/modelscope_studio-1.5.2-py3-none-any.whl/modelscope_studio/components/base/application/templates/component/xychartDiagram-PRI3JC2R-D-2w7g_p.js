import { _ as a, s as gi, g as xi, q as Xt, p as di, a as fi, b as pi, l as Nt, H as mi, e as yi, y as bi, E as St, D as Yt, F as Ai, K as wi, i as Ci, aD as Si, R as Wt } from "./mermaid.core-DqXbFyRH.js";
import { i as _i } from "./init-DjUOC4st.js";
import { o as ki } from "./ordinal-CDDIbzuo.js";
import { l as zt } from "./linear-Isii5Ny_.js";
function Ri(e, t, i) {
...
var bt = function() {
  var e = /* @__PURE__ */ a(function(F, h, u, x) {
    ...
    table: [e(t, i, {
      ...
      49: _,
      50: c
    }), e(L, [2, 38]), e(L, [2, 39]), e(S, [2, 40]), e(S, [2, 42]), e(S, [2, 43]), e(S, [2, 44]), e(S, [2, 45]), e(S, [2, 46]), e(S, [2, 47]), e(S, [2, 48]), e(S, [2, 49]), e(S, [2, 50]), e(S, [2, 51]), e(l, [2, 10]), e(l, [2, 22], {
      30: 41,
      29: 56,
      24: W,
      27: z
      ...
      17: 65,
      24: X
    }, e(l, [2, 16]), e(l, [2, 17]), e(S, [2, 41]), e(l, [2, 23]), {
      27: [1, 66]
    }, {
      26: [1, 67]
    }, {
    ...
    parse: /* @__PURE__ */ a(function(h) {
      var u = this, x = [0], d = [], w = [null], r = [], at = this.table, f = "", lt = 0, It = 0, hi = 2, Mt = 1, li = r.slice.call(arguments, 1), T = Object.create(this.lexer), Y = {
        yy: {}
      };
...
Expecting ` + ut.join(", ") + ", got '" + (this.terminals_[M] || M) + "'" : mt = "Parse error on line " + (lt + 1) + ": Unexpected " + (M == Mt ? "end of input" : "'" + (this.terminals_[M] || M) + "'"), this.parseError(mt, {
        ...
        switch (B[0]) {
          ...
          case 2:
            ...
            }, ci && (q._$.range = [r[r.length - (O || 1)].range[0], r[r.length - 1].range[1]]), pt = this.performAction.apply(q, [f, It, lt, Y.yy, B[1], w, r].concat(li)), typeof pt < "u")
              return pt;
...
var st, Mi = (st = class {
  ...
  calculateVerticalSpace() {
    let t = this.chartConfig.width, i = this.chartConfig.height, s = 0, n = 0, o = Math.floor(t * this.chartConfig.plotReservedSpacePercent / 100), g = Math.floor(i * this.chartConfig.plotReservedSpacePercent / 100), m = this.componentStore.plot.calculateSpace({
      width: o,
      height: g
    });
  ...
  calculateHorizontalSpace() {
    let t = this.chartConfig.width, i = this.chartConfig.height, s = 0, n = 0, o = 0, g = Math.floor(t * this.chartConfig.plotReservedSpacePercent / 100), m = Math.floor(i * this.chartConfig.plotReservedSpacePercent / 100), p = this.componentStore.plot.calculateSpace({
      width: g,
      height: m
    });
    t -= p.width, i -= p.height, p = this.componentStore.title.calculateSpace({
      ...
      x: n,
      y: s
    }), this.componentStore.xAxis.setRange([o, o + m]), this.componentStore.xAxis.setBoundingBoxXY({
      x: 0,
      y: o
...
function Tt() {
  const e = St();
  return Yt(Ai.xyChart, e.xyChart);
}
          ...
          if (g.chartOrientation === "horizontal") {
            ...
            let c = function(l, L, S) {
              const {
                data: R,
                label: $
              } = l, N = L * $.length * 0.7, F = R.x + R.width / 2, h = F - N / 2, u = F + N / 2, x = h >= R.x && u <= R.x + R.width, d = R.y + S + L <= R.y + R.height;
              return x && d;
            };
            a(c, "fitsInBar");
