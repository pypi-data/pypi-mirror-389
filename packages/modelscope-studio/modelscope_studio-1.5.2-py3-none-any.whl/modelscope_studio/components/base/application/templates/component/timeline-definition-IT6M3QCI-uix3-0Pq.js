import { _ as s, c as xt, l as E, d as q, V as kt, W as vt, X as _t, Y as bt, B as wt, $ as St, y as Et } from "./mermaid.core-DqXbFyRH.js";
import { d as nt } from "./arc-CmZvMxdd.js";
var X = function() {
  var n = /* @__PURE__ */ s(function(f, r, a, h) {
    ...
    parse: /* @__PURE__ */ s(function(r) {
      var a = this, h = [0], u = [], y = [null], o = [], S = this.table, k = "", $ = 0, C = 0, B = 2, J = 1, O = o.slice.call(arguments, 1), v = Object.create(this.lexer), N = {
        yy: {}
      };
...
Expecting ` + G.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : Q = "Parse error on line " + ($ + 1) + ": Unexpected " + (w == J ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(Q, {
        ...
        switch (I[0]) {
          ...
          case 2:
            ...
            }, M && (V._$.range = [o[o.length - (P || 1)].range[0], o[o.length - 1].range[1]]), K = this.performAction.apply(V, [k, C, $, N.yy, I[1], y, o].concat(O)), typeof K < "u")
              return K;
...
var W = "", lt = 0, Y = [], U = [], z = [], ot = /* @__PURE__ */ s(() => St, "getCommonDb"), ct = /* @__PURE__ */ s(function() {
  ...
  i.x = t.x, i.y = t.y, i.fill = t.fill, i.width = e.width, i.height = e.height, i.class = "journey-section section-type-" + t.num, i.rx = 3, i.ry = 3, Z(l, i), mt(e)(t.text, l, i.x, i.y, i.width, i.height, {
  ...
  const c = D();
  c.x = t.x, c.y = t.y, c.fill = t.fill, c.width = e.width, c.height = e.height, c.class = "task task-type-" + t.num, c.rx = 3, c.ry = 3, Z(i, c), mt(e)(t.task, i, c.x, c.y, c.width, c.height, {
    class: "task"
  }, e, t.colour);
...
var Ft = /* @__PURE__ */ s(function(n, t, e, l) {
  ...
  E.debug("maxSectionHeight before draw", r), E.debug("maxTaskHeight before draw", a), f && f.length > 0 ? f.forEach((L) => {
    ...
    E.debug("sectionNode output", A), R.attr("transform", `translate(${y}, ${u})`), o += r + 50, b.length > 0 && st(p, b, S, y, o, a, i, $, C, r, !1), y += 200 * Math.max(b.length, 1), o = u, S++;
  }) : (k = !1, st(p, x, S, y, o, a, i, $, C, r, !0));
  const B = p.node().getBBox();
  E.debug("bounds", B), _ && p.append("text").text(_).attr("x", B.width / 2 - d).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), h = k ? r + a + 150 : a + 100, p.append("g").attr("class", "lineWrapper").append("line").attr("x1", d).attr("y1", h).attr("x2", B.width + 3 * d).attr("y2", h).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), kt(void 0, p, ((v = i.timeline) == null ? void 0 : v.padding) ?? 50, ((N = i.timeline) == null ? void 0 : N.useMaxWidth) ?? !1);
