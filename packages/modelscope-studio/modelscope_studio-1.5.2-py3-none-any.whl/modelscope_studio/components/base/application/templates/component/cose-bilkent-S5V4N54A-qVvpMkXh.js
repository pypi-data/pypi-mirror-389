import { _ as V, l as k, d as lt } from "./mermaid.core-DqXbFyRH.js";
import { c as J } from "./cytoscape.esm-D-tHOlud.js";
import { e as $, g as gt } from "./Index-C_OWUvsZ.js";
var tt = {
  exports: {}
}, Z = {
  exports: {}
        ...
        function(I, T, o) {
          ...
          a.prototype.run = function() {
            ...
            var M = function(w, x) {
              ...
              for (var w = function() {
                E.fit && E.cy.fit(E.eles, E.padding), D || (D = !0, O.cy.one("layoutready", E.ready), O.cy.trigger({
                  type: "layoutready",
                  layout: O
                }));
              ...
              if (F) {
                y.checkLayoutSuccess() && !y.isSubLayout && y.doPostLayout(), y.tilingPostLayout && y.tilingPostLayout(), y.isLayoutFinished = !0, O.options.eles.nodes().positions(M), w(), O.cy.one("layoutstop", O.options.stop), O.cy.trigger({
                  type: "layoutstop",
                  layout: O
                }), u && cancelAnimationFrame(u), D = !1;
                return;
              }
...
var dt = /* @__PURE__ */ V(async (G, b, {
  ...
  t.debug("Inserting nodes into DOM for dimension calculation"), await Promise.all(G.nodes.map(async (u) => {
    if (u.isGroup) {
      const E = {
        ...u
      };
  ...
  t.debug("Positioning nodes based on layout results"), D.nodes.forEach((u) => {
    const E = g[u.id];
    E != null && E.domId && (E.domId.attr("transform", `translate(${u.x}, ${u.y})`), E.x = u.x, E.y = u.y, t.debug(`Positioned node ${E.id} at center (${u.x}, ${u.y})`));
  }), D.edges.forEach((u) => {
  ...
  }), t.debug("Inserting and positioning edges"), await Promise.all(G.edges.map(async (u) => {
    await T(a, u);
