import { a as gt, g as lt, f as mt, d as xt } from "./chunk-TZMSLE5B-BFxvdy11.js";
import { g as kt } from "./chunk-FMBD7UC4-C3_C7-U9.js";
import { _ as n, g as _t, s as vt, a as bt, b as wt, q as Tt, p as St, c as R, d as G, e as $t, y as Mt } from "./mermaid.core-DqXbFyRH.js";
import { d as et } from "./arc-CmZvMxdd.js";
var U = function() {
  var t = /* @__PURE__ */ n(function(h, i, a, l) {
    ...
    parse: /* @__PURE__ */ n(function(i) {
      var a = this, l = [0], d = [], p = [null], o = [], b = this.table, k = "", C = 0, K = 0, dt = 2, Q = 1, yt = o.slice.call(arguments, 1), _ = Object.create(this.lexer), I = {
        yy: {}
      };
...
Expecting ` + z.join(", ") + ", got '" + (this.terminals_[v] || v) + "'" : X = "Parse error on line " + (C + 1) + ": Unexpected " + (v == Q ? "end of input" : "'" + (this.terminals_[v] || v) + "'"), this.parseError(X, {
        ...
        switch (T[0]) {
          ...
          case 2:
            ...
            }, ft && (F._$.range = [o[o.length - (M || 1)].range[0], o[o.length - 1].range[1]]), q = this.performAction.apply(F, [k, K, C, I.yy, T[1], p, o].concat(yt)), typeof q < "u")
              return q;
...
`, "getStyles"), jt = Bt, J = /* @__PURE__ */ n(function(t, e) {
  ...
  s.diagramMarginX * (e.taskCount - 1), r.height = s.height, r.class = "journey-section section-type-" + e.num, r.rx = 3, r.ry = 3, J(c, r), ht(s)(e.text, c, r.x, r.y, r.width, r.height, {
  ...
  e.people.forEach((g) => {
    ...
    ot(r, x), y += 10;
  }), ht(s)(e.task, r, u.x, u.y, u.width, u.height, {
    class: "task"
  }, s, e.colour);
