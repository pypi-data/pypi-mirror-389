...
function Ds(e, t, n) {
  ...
  const f = Ya(() => import("./conversations-C0bwcGQh.js"));
  let {
    gradio: _
  } = t, {
    props: l = {}
  ...
  return pe(e, Me, (h) => n(1, s = h)), e.$$set = (h) => {
    t = me(me({}, t), Ts(h)), n(19, i = ct(t, r)), "gradio" in h && n(7, _ = h.gradio), "props" in h && n(8, l = h.props), "_internal" in h && n(9, d = h._internal), "as_item" in h && n(10, b = h.as_item), "visible" in h && n(11, g = h.visible), "elem_id" in h && n(12, v = h.elem_id), "elem_classes" in h && n(13, T = h.elem_classes), "elem_style" in h && n(14, w = h.elem_style), "$$scope" in h && n(17, c = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && p.update((h) => ({
      ...h,
  ...
  }, [a, s, f, p, M, Qt, Me, _, l, d, b, g, v, T, w, o, u, c];
}
class Us extends _s {
  constructor(t) {
