...
var be = K(x, "DataView"), he = K(x, "Promise"), ye = K(x, "Set"), Ze = "[object Map]", Fi = "[object Object]", Ye = "[object Promise]", We = "[object Set]", Qe = "[object WeakMap]", Ve = "[object DataView]", Ri = N(be), Li = N(J), Di = N(he), Ni = N(ye), Ki = N(de), $ = D;
(be && $(new be(new ArrayBuffer(1))) != Ve || J && $(new J()) != Ze || he && $(he.resolve()) != Ye || ye && $(new ye()) != We || de && $(new de()) != Qe) && ($ = function(e) {
...
function Fs(e, t, n) {
  ...
  const c = Za(() => import("./bubble.list-PeV4oGaS.js"));
  let {
    gradio: _
  } = t, {
    props: l = {}
  ...
  return pe(e, Me, (b) => n(1, s = b)), e.$$set = (b) => {
    t = me(me({}, t), ys(b)), n(18, i = ft(t, r)), "gradio" in b && n(6, _ = b.gradio), "props" in b && n(7, l = b.props), "_internal" in b && n(8, d = b._internal), "as_item" in b && n(9, h = b.as_item), "visible" in b && n(10, g = b.visible), "elem_id" in b && n(11, v = b.elem_id), "elem_classes" in b && n(12, T = b.elem_classes), "elem_style" in b && n(13, O = b.elem_style), "$$scope" in b && n(16, f = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && p.update((b) => ({
      ...b,
  ...
  }, [a, s, c, p, I, Me, _, l, d, h, g, v, T, O, o, u, f];
}
class Ds extends ps {
  constructor(t) {
