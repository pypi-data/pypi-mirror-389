import { Z as m, g as G } from "./Index-CN-asEdT.js";
...
function pe(r) {
  ...
  return {
    ...
    p(s, [i]) {
      ...
      16 && g(e, 1)) : (e = E(s), e.c(), g(e, 1), e.m(n.parentNode, n)) : e && (le(), w(e, 1, 1, () => {
        e = null;
      }), ee());
    },
    i(s) {
...
const {
  ...
  ItemHandler: we
} = H("antdx-suggestion-chain-items"), Se = ve((r) => /* @__PURE__ */ X.jsx(we, {
  ...r,
