...
var Ot = Object.prototype, Jn = Ot.hasOwnProperty, qn = Ot.propertyIsEnumerable, Ae = Ge(/* @__PURE__ */ function() {
  return arguments;
}()) ? Ge : function(e) {
...
var At = typeof exports == "object" && exports && !exports.nodeType && exports, H = At && typeof module == "object" && module && !module.nodeType && module, wr = H && H.exports === At, ge = wr && gt.process, G = function() {
  try {
    var e = H && H.require && H.require("util").types;
    return e || ge && ge.binding && ge.binding("util");
  } catch {
  }
}(), Xe = G && G.isTypedArray, $t = Xe ? $e(Xe) : Tr, Or = Object.prototype, Pr = Or.hasOwnProperty;
function St(e, t) {
...
var he = K(E, "DataView"), ye = K(E, "Promise"), me = K(E, "Set"), Qe = "[object Map]", Di = "[object Object]", Ve = "[object Promise]", ke = "[object Set]", et = "[object WeakMap]", tt = "[object DataView]", Ni = N(he), Ki = N(J), Ui = N(ye), Bi = N(me), Gi = N(_e), $ = D;
...
var it = G && G.isMap, vo = it ? $e(it) : mo, To = "[object Set]";
function wo(e) {
  return I(e) && $(e) == To;
}
var ot = G && G.isSet, Oo = ot ? $e(ot) : wo, Lt = "[object Arguments]", Po = "[object Array]", Ao = "[object Boolean]", $o = "[object Date]", So = "[object Error]", Dt = "[object Function]", xo = "[object GeneratorFunction]", Co = "[object Map]", jo = "[object Number]", Nt = "[object Object]", Eo = "[object RegExp]", Io = "[object Set]", Mo = "[object String]", Fo = "[object Symbol]", Ro = "[object WeakMap]", Lo = "[object ArrayBuffer]", Do = "[object DataView]", No = "[object Float32Array]", Ko = "[object Float64Array]", Uo = "[object Int8Array]", Bo = "[object Int16Array]", Go = "[object Int32Array]", zo = "[object Uint8Array]", Ho = "[object Uint8ClampedArray]", Xo = "[object Uint16Array]", Jo = "[object Uint32Array]", h = {};
h[Lt] = h[Po] = h[Lo] = h[Do] = h[Ao] = h[$o] = h[No] = h[Ko] = h[Uo] = h[Bo] = h[Go] = h[Co] = h[jo] = h[Nt] = h[Eo] = h[Io] = h[Mo] = h[Fo] = h[zo] = h[Ho] = h[Xo] = h[Jo] = !0;
h[So] = h[Dt] = h[Ro] = !1;
...
function Kt(e, t, n, r, i, o) {
  ...
  if (l && c)
    return l == t && c == e;
  var b = -1, f = !0, p = n & ko ? new ae() : void 0;
...
var na = 1, ra = 2, ia = "[object Boolean]", oa = "[object Date]", aa = "[object Error]", sa = "[object Map]", ua = "[object Number]", la = "[object RegExp]", ca = "[object Set]", fa = "[object String]", pa = "[object Symbol]", ga = "[object ArrayBuffer]", da = "[object DataView]", at = P ? P.prototype : void 0, de = at ? at.valueOf : void 0;
...
function ma(e, t, n, r, i, o) {
  var a = n & ba, s = We(e), u = s.length, l = We(t), c = l.length;
  if (u != c && !a)
    return !1;
  for (var b = u; b--; ) {
    var f = s[b];
...
function wa(e, t, n, r, i, o) {
  ...
  if (!(n & va)) {
    var p = c && lt.call(e, "__wrapped__"), _ = b && lt.call(t, "__wrapped__");
    if (p || _) {
...
function Aa(e, t, n, r) {
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var c = new j(), b;
      if (!(b === void 0 ? Me(l, u, Oa | Pa, r, c) : b))
        return !1;
    }
  }
  return !0;
...
var Ea = 1, Ia = 2;
function Ma(e, t) {
  return xe(e) && Ut(t) ? Bt(Y(e), t) : function(n) {
    var r = gi(n, e);
...
function Ha(e, t) {
  return t = ce(t, e), e = Ga(e, t), e == null || delete e[Y(Ba(t))];
}
function Xa(e) {
  return be(e) ? void 0 : e;
}
var Ja = 1, qa = 2, Za = 4, Gt = hi(function(e, t) {
  var n = {};
  if (e == null)
    return n;
  var r = !1;
...
function ka(e, t = {}, n = !1) {
  return za(Gt(e, n ? [] : zt), (r, i) => t[i] || Ya(i));
}
function es(e, t) {
  const {
    gradio: n,
...
function Ls(e) {
  ...
  return {
    ...
    p(i, o) {
      ...
      1 && B(r, 1)) : (r = pt(i), r.c(), B(r, 1), r.m(t.parentNode, t)) : r && (Ss(), q(r, 1, 1, () => {
        r = null;
      }), hs());
    },
    i(i) {
...
function Ks(e, t, n) {
  ...
  const f = Qa(() => import("./table.row-selection.selection-DxdvFv39.js"));
  let {
    gradio: p
  } = t, {
    props: _ = {}
  ...
  return ee(e, Le, (d) => n(18, a = d)), e.$$set = (d) => {
    t = ve(ve({}, t), ws(d)), n(23, o = ft(t, i)), "gradio" in d && n(8, p = d.gradio), "props" in d && n(9, _ = d.props), "_internal" in d && n(10, g = d._internal), "as_item" in d && n(11, v = d.as_item), "text" in d && n(12, T = d.text), "built_in_selection" in d && n(13, O = d.built_in_selection), "visible" in d && n(14, x = d.visible), "elem_id" in d && n(15, A = d.elem_id), "elem_classes" in d && n(16, Q = d.elem_classes), "elem_style" in d && n(17, V = d.elem_style), "$$scope" in d && n(21, b = d.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    512 && y.update((d) => ({
      ...d,
    ...
    262145 && n(1, r = {
      props: {
        style: s.elem_style,
        className: _s(s.elem_classes, "ms-gr-antd-table-selection"),
        id: s.elem_id,
        text: s.text,
        ...s.restProps,
        ...s.props,
  ...
  }, [s, r, l, f, y, Fe, Re, Le, p, _, g, v, T, O, x, A, Q, V, a, u, c, b];
}
class Gs extends bs {
  constructor(t) {
