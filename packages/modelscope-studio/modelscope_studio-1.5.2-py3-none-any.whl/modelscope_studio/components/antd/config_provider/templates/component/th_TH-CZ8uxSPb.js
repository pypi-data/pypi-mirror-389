import { c as h } from "./Index-Blu19QVf.js";
import { i as o, o as b, c as g } from "./config-provider-CVk98Wd5.js";
function T(s, f) {
  for (var p = 0; p < f.length; p++) {
    ...
    if (typeof t != "string" && !Array.isArray(t)) {
      for (const l in t)
        if (l !== "default" && !(l in s)) {
          const m = Object.getOwnPropertyDescriptor(t, l);
