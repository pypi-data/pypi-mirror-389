import { Z as p, g as B } from "./Index-FjnwbbJn.js";
...
function me(r) {
  ...
  return {
    ...
    p(o, [a]) {
      ...
      16 && g(e, 1)) : (e = C(o), e.c(), g(e, 1), e.m(n.parentNode, n)) : e && (le(), b(e, 1, 1, () => {
        e = null;
      }), ee());
    },
    i(o) {
...
const {
  ...
  useItems: xe,
  ItemHandler: be
} = H("antd-radio-group-options"), ke = we((r) => /* @__PURE__ */ X.jsx(be, {
  ...r
}));
export {
