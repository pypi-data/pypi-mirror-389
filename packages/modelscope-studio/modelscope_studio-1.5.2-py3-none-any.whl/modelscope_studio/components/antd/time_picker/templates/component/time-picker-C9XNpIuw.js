import { i as we, a as H, r as be, Z as A, g as Ie, b as Ee } from "./Index-DxxJhIik.js";
  ...
  return ye(() => {
    ...
    if (v && window.MutationObserver) {
      let f = function() {
        ...
        c = x, u(w), c.style.display = "contents", y && clearTimeout(y), y = setTimeout(() => {
          g();
