...
}(), Be = B && B.isTypedArray, $t = Be ? $e(Be) : br, vr = Object.prototype, Tr = vr.hasOwnProperty;
function At(e, t) {
...
var xt = St(Object.getPrototypeOf, Object), _i = "[object Object]", hi = Function.prototype, yi = Object.prototype, Ct = hi.toString, bi = yi.hasOwnProperty, mi = Ct.call(Object);
function _e(e) {
  if (!C(e) || D(e) != _i)
    return !1;
  var t = xt(e);
...
var he = K(x, "DataView"), ye = K(x, "Promise"), be = K(x, "Set"), Ze = "[object Map]", Fi = "[object Object]", Ye = "[object Promise]", We = "[object Set]", Qe = "[object WeakMap]", Ve = "[object DataView]", Ri = N(he), Li = N(J), Di = N(ye), Ni = N(be), Ki = N(de), $ = D;
(he && $(new he(new ArrayBuffer(1))) != Ve || J && $(new J()) != Ze || ye && $(ye.resolve()) != Ye || be && $(new be()) != We || de && $(new de()) != Qe) && ($ = function(e) {
...
var tt = B && B.isMap, yo = tt ? $e(tt) : ho, bo = "[object Set]";
function mo(e) {
  return C(e) && $(e) == bo;
}
...
b[Rt] = b[To] = b[Mo] = b[Fo] = b[wo] = b[Oo] = b[Ro] = b[Lo] = b[Do] = b[No] = b[Ko] = b[Ao] = b[So] = b[Dt] = b[xo] = b[Co] = b[jo] = b[Eo] = b[Uo] = b[Go] = b[Bo] = b[zo] = !0;
b[Po] = b[Lt] = b[Io] = !1;
...
var ya = 1, it = "[object Arguments]", ot = "[object Array]", Q = "[object Object]", ba = Object.prototype, at = ba.hasOwnProperty;
...
function Fs(e, t, n) {
  ...
  const c = Za(() => import("./layout.sider-y0-b0QJb.js"));
  let {
    gradio: _
  } = t, {
    props: l = {}
  ...
  }, [a, s, c, p, I, Me, _, l, d, y, g, v, T, O, o, u, f];
}
class Ds extends ps {
  constructor(t) {
