import { Z as m, g as G } from "./Index-Cc7kXf78.js";
...
function ge(r, t, l) {
  ...
  return r.$$set = (i) => {
    l(17, t = y(y({}, t), S(i))), "svelteInit" in i && l(5, c = i.svelteInit), "$$scope" in i && l(6, s = i.$$scope);
...
const {
  ...
  useItems: ke,
  ItemHandler: be
} = H("antd-color-picker-presets"), xe = we((r) => /* @__PURE__ */ X.jsx(be, {
  ...r
}));
export {
