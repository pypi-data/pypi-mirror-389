import { i as ie, a as W, r as le, Z as R, g as ae } from "./Index-AqtukblP.js";
...
function we(e, t, o) {
  ...
  t = z(t) || 0, W(o) && (h = !!o.leading, a = "maxWait" in o, n = a ? Ee(z(o.maxWait) || 0, t) : n, g = "trailing" in o ? !!o.trailing : g);
  function m(u) {
    var y = i, T = s;
  ...
  return {
    ...
    l(r) {
      t = $(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), Q(t).forEach(I), o = Le(r), n && n.l(r), i = K(), this.h();
    },
    h() {
      te(t, "class", "svelte-1rt0kpf");
    },
