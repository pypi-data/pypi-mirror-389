...
var be = K(C, "DataView"), he = K(C, "Promise"), ye = K(C, "Set"), Ze = "[object Map]", Ri = "[object Object]", Ye = "[object Promise]", We = "[object Set]", Qe = "[object WeakMap]", Ve = "[object DataView]", Li = N(be), Di = N(J), Ni = N(he), Ki = N(ye), Ui = N(de), A = D;
(be && A(new be(new ArrayBuffer(1))) != Ve || J && A(new J()) != Ze || he && A(he.resolve()) != Ye || ye && A(new ye()) != We || de && A(new de()) != Qe) && (A = function(e) {
...
var tt = B && B.isMap, yo = tt ? Ae(tt) : ho, mo = "[object Set]";
function vo(e) {
  return I(e) && A(e) == mo;
}
...
function va(e, t, n, r, i, o) {
  ...
  return l ? (o || (o = new x()), ha(e, t, n, r, i, o)) : !1;
}
...
function Ra(e) {
  return typeof e == "function" ? e : e == null ? bt : typeof e == "object" ? $(e) ? Ea(e[0], e[1]) : Aa(e) : Fa(e);
}
function La(e) {
...
function Rs(e, t, n) {
  ...
  const c = Ya(() => import("./badge.ribbon-DtrfoHeC.js"));
  let {
    gradio: _
  } = t, {
    props: l = {}
  ...
  return pe(e, Me, (b) => n(1, s = b)), e.$$set = (b) => {
    t = me(me({}, t), ms(b)), n(19, i = ft(t, r)), "gradio" in b && n(6, _ = b.gradio), "props" in b && n(7, l = b.props), "_internal" in b && n(8, d = b._internal), "text" in b && n(9, h = b.text), "as_item" in b && n(10, g = b.as_item), "visible" in b && n(11, v = b.visible), "elem_id" in b && n(12, T = b.elem_id), "elem_classes" in b && n(13, P = b.elem_classes), "elem_style" in b && n(14, S = b.elem_style), "$$scope" in b && n(17, f = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && p.update((b) => ({
      ...b,
  ...
  }, [a, s, c, p, j, Me, _, l, d, h, g, v, T, P, S, o, u, f];
}
class Ns extends gs {
  constructor(t) {
