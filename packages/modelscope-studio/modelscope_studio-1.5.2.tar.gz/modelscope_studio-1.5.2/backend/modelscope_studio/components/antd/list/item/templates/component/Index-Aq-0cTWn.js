...
function Ds(e, t, n) {
  ...
  const c = Za(() => import("./list.item-BgpakfuT.js"));
  let {
    gradio: _
  } = t, {
    _internal: l = {}
  ...
  return pe(e, Me, (b) => n(1, s = b)), e.$$set = (b) => {
    t = me(me({}, t), Ts(b)), n(18, i = ft(t, r)), "gradio" in b && n(6, _ = b.gradio), "_internal" in b && n(7, l = b._internal), "as_item" in b && n(8, p = b.as_item), "props" in b && n(9, d = b.props), "elem_id" in b && n(10, g = b.elem_id), "elem_classes" in b && n(11, v = b.elem_classes), "elem_style" in b && n(12, T = b.elem_style), "visible" in b && n(13, O = b.visible), "$$scope" in b && n(16, f = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    512 && h.update((b) => ({
      ...b,
  ...
  }, [a, s, c, h, M, Me, _, l, p, d, g, v, T, O, o, u, f];
}
class Gs extends _s {
  constructor(t) {
