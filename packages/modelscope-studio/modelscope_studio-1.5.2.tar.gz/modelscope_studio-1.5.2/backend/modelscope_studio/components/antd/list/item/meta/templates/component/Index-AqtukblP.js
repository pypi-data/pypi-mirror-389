...
function Fs(e, t, n) {
  ...
  const c = Za(() => import("./list.item.meta-CdWCMpvN.js"));
  let {
    gradio: _
  } = t, {
    _internal: l = {}
  ...
  return pe(e, Me, (h) => n(1, s = h)), e.$$set = (h) => {
    t = me(me({}, t), ys(h)), n(18, i = ft(t, r)), "gradio" in h && n(6, _ = h.gradio), "_internal" in h && n(7, l = h._internal), "as_item" in h && n(8, p = h.as_item), "props" in h && n(9, d = h.props), "elem_id" in h && n(10, g = h.elem_id), "elem_classes" in h && n(11, v = h.elem_classes), "elem_style" in h && n(12, T = h.elem_style), "visible" in h && n(13, O = h.visible), "$$scope" in h && n(16, f = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    512 && y.update((h) => ({
      ...h,
  ...
  }, [a, s, c, y, I, Me, _, l, p, d, g, v, T, O, o, u, f];
}
class Ds extends ps {
  constructor(t) {
