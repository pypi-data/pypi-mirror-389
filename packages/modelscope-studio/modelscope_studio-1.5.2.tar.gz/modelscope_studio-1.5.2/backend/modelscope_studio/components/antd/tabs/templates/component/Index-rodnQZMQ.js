...
var be = K(x, "DataView"), he = K(x, "Promise"), ye = K(x, "Set"), Ze = "[object Map]", Ri = "[object Object]", Ye = "[object Promise]", We = "[object Set]", Qe = "[object WeakMap]", Ve = "[object DataView]", Li = N(be), Di = N(q), Ni = N(he), Ki = N(ye), Ui = N(de), $ = D;
(be && $(new be(new ArrayBuffer(1))) != Ve || q && $(new q()) != Ze || he && $(he.resolve()) != Ye || ye && $(new ye()) != We || de && $(new de()) != Qe) && ($ = function(e) {
...
function wa(e, t, n, r) {
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var f = new S(), _;
      if (!(_ === void 0 ? Ie(c, u, Ta | Pa, r, f) : _))
        return !1;
    }
  }
  return !0;
...
function Ds(e, t, n) {
  ...
  const f = Ya(() => import("./tabs-CFFkqYgs.js"));
  let {
    gradio: _
  } = t, {
    props: l = {}
  ...
  return pe(e, Me, (b) => n(1, s = b)), e.$$set = (b) => {
    t = me(me({}, t), Ts(b)), n(19, i = ct(t, r)), "gradio" in b && n(7, _ = b.gradio), "props" in b && n(8, l = b.props), "_internal" in b && n(9, d = b._internal), "as_item" in b && n(10, h = b.as_item), "visible" in b && n(11, g = b.visible), "elem_id" in b && n(12, v = b.elem_id), "elem_classes" in b && n(13, T = b.elem_classes), "elem_style" in b && n(14, w = b.elem_style), "$$scope" in b && n(17, c = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && p.update((b) => ({
      ...b,
  ...
  }, [a, s, f, p, M, Qt, Me, _, l, d, h, g, v, T, w, o, u, c];
}
class Us extends _s {
  constructor(t) {
