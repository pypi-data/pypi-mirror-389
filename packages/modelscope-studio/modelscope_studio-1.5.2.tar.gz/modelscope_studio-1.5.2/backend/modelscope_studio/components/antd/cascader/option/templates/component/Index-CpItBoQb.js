...
function vt(e, t, n) {
  var r = e[t];
  (!(Kn.call(e, t) && Pe(r, n)) || n === void 0 && !(t in e)) && Oe(e, t, n);
}
function Un(e, t, n, r) {
  var i = !n;
  n || (n = {});
...
var Pt = Object.prototype, Jn = Pt.hasOwnProperty, qn = Pt.propertyIsEnumerable, Ae = Be(/* @__PURE__ */ function() {
  return arguments;
}()) ? Be : function(e) {
...
}(), Xe = B && B.isTypedArray, $t = Xe ? $e(Xe) : Tr, Pr = Object.prototype, wr = Pr.hasOwnProperty;
function St(e, t) {
...
function Aa(e, t, n, r) {
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var c = new j(), h;
      if (!(h === void 0 ? Me(l, u, Pa | wa, r, c) : h))
        return !1;
    }
  }
  return !0;
...
function Ks(e, t, n) {
  ...
  const f = Qa(() => import("./cascader.option-C2t7VMPv.js"));
  let {
    gradio: p
  } = t, {
    props: _ = {}
  ...
  return ee(e, Le, (d) => n(18, a = d)), e.$$set = (d) => {
    t = ve(ve({}, t), Os(d)), n(23, o = ft(t, i)), "gradio" in d && n(8, p = d.gradio), "props" in d && n(9, _ = d.props), "_internal" in d && n(10, g = d._internal), "value" in d && n(11, v = d.value), "label" in d && n(12, T = d.label), "as_item" in d && n(13, P = d.as_item), "visible" in d && n(14, x = d.visible), "elem_id" in d && n(15, A = d.elem_id), "elem_classes" in d && n(16, Q = d.elem_classes), "elem_style" in d && n(17, V = d.elem_style), "$$scope" in d && n(21, h = d.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    512 && y.update((d) => ({
      ...d,
    ...
    262145 && n(1, r = {
      props: {
        style: s.elem_style,
        className: _s(s.elem_classes, "ms-gr-antd-cascader-option"),
        id: s.elem_id,
        label: s.label,
        value: s.value,
        ...s.restProps,
  ...
  }, [s, r, l, f, y, Fe, Re, Le, p, _, g, v, T, P, x, A, Q, V, a, u, c, h];
}
class Bs extends hs {
  constructor(t) {
