import { g as de } from "./chunk-FMBD7UC4-C3_C7-U9.js";
import { _ as d, E as st, d as R, e as ge, l as m, y as ue, A as pe, c as z, ai as fe, R as xe, S as ye, O as be, aj as Z, ak as Ht, al as we, u as et, k as me, am as Le, an as yt, i as bt, ao as Se } from "./mermaid.core-DqXbFyRH.js";
import { c as ve } from "./clone-DJ2ltZ-A.js";
import { G as Ee } from "./graph-DHADSxh5.js";
import { c as _e } from "./channel-vdxEt9ck.js";
var wt = function() {
  var e = /* @__PURE__ */ d(function(N, x, g, p) {
    ...
    performAction: /* @__PURE__ */ d(function(x, g, p, w, S, c, _) {
      ...
      switch (S) {
        ...
        case 13:
          ...
          break;
        case 14:
          w.getLogger().debug("Rule: link: ", c[f], x), this.$ = {
            edgeTypeStr: c[f],
            label: ""
          };
          break;
        case 15:
          w.getLogger().debug("Rule: LABEL link: ", c[f - 3], c[f - 1], c[f]), this.$ = {
            edgeTypeStr: c[f],
            label: c[f - 1]
          };
          break;
        ...
        case 23:
          ...
          break;
        case 24:
          w.getLogger().debug("Rule: nodeStatement (abc88 node size) ", c[f - 1], c[f]), this.$ = {
            id: c[f - 1].id,
            label: c[f - 1].label,
          ...
          break;
        case 25:
          w.getLogger().debug("Rule: nodeStatement (node) ", c[f]), this.$ = {
            id: c[f].id,
            label: c[f].label,
            type: w.typeStr2Type(c[f].typeStr),
            directions: c[f].directions,
          ...
          break;
        case 26:
          w.getLogger().debug("APA123", this ? this : "na"), w.getLogger().debug("COLUMNS: ", c[f]), this.$ = {
            type: "column-setting",
            columns: c[f] === "auto" ? -1 : parseInt(c[f])
          };
          break;
        case 27:
          w.getLogger().debug("Rule: id-block statement : ", c[f - 2], c[f - 1]), w.generateId(), this.$ = {
            ...c[f - 2],
            type: "composite",
            children: c[f - 1]
          };
        ...
        case 28:
          ...
          break;
        case 29:
          w.getLogger().debug("Rule: node (NODE_ID separator): ", c[f]), this.$ = {
            id: c[f]
          };
          break;
        case 30:
          w.getLogger().debug("Rule: node (NODE_ID nodeShapeNLabel separator): ", c[f - 1], c[f]), this.$ = {
            id: c[f - 1],
            label: c[f].label,
            typeStr: c[f].typeStr,
            directions: c[f].directions
        ...
        case 32:
          ...
          break;
        case 33:
          w.getLogger().debug("Rule: nodeShapeNLabel: ", c[f - 2], c[f - 1], c[f]), this.$ = {
            typeStr: c[f - 2] + c[f],
            label: c[f - 1]
          };
          break;
        case 34:
          w.getLogger().debug("Rule: BLOCK_ARROW nodeShapeNLabel: ", c[f - 3], c[f - 2], " #3:", c[f - 1], c[f]), this.$ = {
            typeStr: c[f - 3] + c[f],
            label: c[f - 2],
            directions: c[f - 1]
          };
    ...
    table: [{
      ...
      15: y,
      16: b
    }), e(h, [2, 17]), e(h, [2, 18]), e(h, [2, 19]), e(h, [2, 20]), e(h, [2, 21]), e(h, [2, 22]), e(L, [2, 25], {
      27: [1, 25]
    }), e(h, [2, 26]), {
      19: 26,
      26: 12,
    ...
    parse: /* @__PURE__ */ d(function(x) {
      var g = this, p = [0], w = [], S = [null], c = [], _ = this.table, f = "", A = 0, O = 0, X = 2, P = 1, J = c.slice.call(arguments, 1), M = Object.create(this.lexer), Q = {
        yy: {}
      };
...
Expecting ` + nt.join(", ") + ", got '" + (this.terminals_[Y] || Y) + "'" : xt = "Parse error on line " + (A + 1) + ": Unexpected " + (Y == P ? "end of input" : "'" + (this.terminals_[Y] || Y) + "'"), this.parseError(xt, {
        ...
        switch (U[0]) {
          ...
          case 2:
            ...
            }, oe && (tt._$.range = [c[c.length - (q || 1)].range[0], c[c.length - 1].range[1]]), ft = this.performAction.apply(tt, [f, O, A, Q.yy, U[1], S, c].concat(J)), typeof ft < "u")
              return ft;
...
var ke = wt, V = /* @__PURE__ */ new Map(), Et = [], mt = /* @__PURE__ */ new Map(), It = "color", Bt = "fill", De = "bgFill", Kt = ",", Ne = z(), ot = /* @__PURE__ */ new Map(), Te = /* @__PURE__ */ d((e) => me.sanitizeText(e, Ne), "sanitizeText"), Ce = /* @__PURE__ */ d(function(e, t = "") {
  ...
  a || (a = {
    ...
    styles: [],
    textStyles: []
  }, ot.set(e, a)), t != null && t.split(Kt).forEach((i) => {
  ...
  for (const r of a) {
    if (typeof s == "number" && s > 0 && r.type !== "column-setting" && typeof r.widthInColumns == "number" && r.widthInColumns > s && m.warn(`Block ${r.id} width ${r.widthInColumns} exceeds configured column width ${s}`), r.label && (r.label = Te(r.label)), r.type === "classDef") {
      Ce(r.id, r.css);
      continue;
    }
  ...
  m.debug("Clear called"), ue(), at = {
    id: "root",
    type: "composite",
    children: [],
    columns: -1
  }, V = /* @__PURE__ */ new Map([["root", at]]), _t = [], ot = /* @__PURE__ */ new Map(), Et = [], mt = /* @__PURE__ */ new Map();
}, "clear");
function Ut(e) {
...
var nr = /* @__PURE__ */ d((e) => {
  ...
  for (const i of e.children) {
    ...
    m.debug("getMaxChildSize abc95 child:", i.id, "width:", l, "height:", s, "x:", r, "y:", n, i.type), i.type !== "space" && (l > t && (t = l / (e.widthInColumns ?? 1)), s > a && (a = s));
  }
  return {
    width: t,
    height: a
...
function ht(e, t, a = 0, i = 0) {
  ...
  m.debug("setBlockSizes abc95 (start)", e.id, (r = e == null ? void 0 : e.size) == null ? void 0 : r.x, "block width =", e == null ? void 0 : e.size, "siblingWidth", a), (n = e == null ? void 0 : e.size) != null && n.width || (e.size = {
    width: a,
    height: i,
    x: 0,
    y: 0
  ...
  if (((o = e.children) == null ? void 0 : o.length) > 0) {
    ...
    for (const S of e.children)
      S.size && (m.debug(`abc95 Setting size of children of ${e.id} id=${S.id} ${l} ${s} ${JSON.stringify(S.size)}`), S.size.width = l * (S.widthInColumns ?? 1) + B * ((S.widthInColumns ?? 1) - 1), S.size.height = s, S.size.x = 0, S.size.y = 0, m.debug(`abc95 updating size of ${e.id} children child:${S.id} maxWidth:${l} maxHeight:${s}`));
    for (const S of e.children)
      ht(S, t, l, s);
    const k = e.columns ?? -1;
    let N = 0;
    ...
    if (p < a) {
      m.debug(`Detected to small sibling: abc95 ${e.id} siblingWidth ${a} siblingHeight ${i} width ${p}`), p = a, w = i;
    ...
    if (m.debug(`abc95 (finale calc) ${e.id} xSize ${x} ySize ${g} columns ${k}${e.children.length} width=${Math.max(p, ((u = e.size) == null ? void 0 : u.width) || 0)}`), p < (((h = e == null ? void 0 : e.size) == null ? void 0 : h.width) || 0)) {
  ...
  m.debug("setBlockSizes abc94 (done)", e.id, (L = e == null ? void 0 : e.size) == null ? void 0 : L.x, (E = e == null ? void 0 : e.size) == null ? void 0 : E.width, (D = e == null ? void 0 : e.size) == null ? void 0 : D.y, (v = e == null ? void 0 : e.size) == null ? void 0 : v.height);
}
d(ht, "setBlockSizes");
function kt(e, t) {
  var i, l, s, r, n, o, u, h, y, b, L, E, D, v, T, k, N;
  m.debug(`abc85 layout blocks (=>layoutBlocks) ${e.id} x: ${(i = e == null ? void 0 : e.size) == null ? void 0 : i.x} y: ${(l = e == null ? void 0 : e.size) == null ? void 0 : l.y} width: ${(s = e == null ? void 0 : e.size) == null ? void 0 : s.width}`);
  const a = e.columns ?? -1;
  ...
  m.debug(`layout blocks (<==layoutBlocks) ${e.id} x: ${(T = e == null ? void 0 : e.size) == null ? void 0 : T.x} y: ${(k = e == null ? void 0 : e.size) == null ? void 0 : k.y} width: ${(N = e == null ? void 0 : e.size) == null ? void 0 : N.width}`);
}
d(kt, "layoutBlocks");
function Dt(e, {
  minX: t,
...
var lr = /* @__PURE__ */ d(async (e, t, a, i) => {
  ...
  const a = z(), i = Z(a.flowchart.htmlLabels), l = t.labelType === "markdown" ? Ht(e, t.label, {
    style: t.labelStyle,
    useHtmlLabels: i,
    addSvgBackground: !0
  }, a) : await j(t.label, t.labelStyle), s = e.insert("g").attr("class", "edgeLabel"), r = s.insert("g").attr("class", "label");
...
var dr = /* @__PURE__ */ d((e, t) => {
  ...
  if (e.label) {
    ...
    if (a) {
      ...
      m.debug("Moving label " + e.label + " from (", r, ",", n, ") to (", o.x, ",", o.y, ") abc88"), t.updatedPath && (r = o.x, n = o.y);
    }
  ...
  if (Math.abs(l - t.y) * r > Math.abs(i - t.x) * o) {
    ...
    return m.debug(`sides calc abc89, Q ${u}, q ${y}, R ${h}, r ${n}`, {
      _x: b,
      _y: L
    }), n === 0 && (b = t.x, L = t.y), h === 0 && (b = t.x), u === 0 && (L = t.y), {
      x: b,
      y: L
    };
  }
...
function ee(e, t, a, i) {
  ...
  if (l = t.y - e.y, r = e.x - t.x, o = t.x * e.y - e.x * t.y, b = l * a.x + r * a.y + o, L = l * i.x + r * i.y + o, !(b !== 0 && L !== 0 && vt(b, L)) && (s = i.y - a.y, n = a.x - i.x, u = i.x * a.y - a.x * i.y, h = s * e.x + n * e.y + u, y = s * t.x + n * t.y + u, !(h !== 0 && y !== 0 && vt(h, y)) && (E = l * n - s * r, E !== 0)))
    return D = Math.abs(E / 2), v = r * u - n * o, T = v < 0 ? (v - D) / E : (v + D) / E, v = s * o - l * u, k = v < 0 ? (v - D) / E : (v + D) / E, {
      x: T,
      y: k
    };
}
...
function re(e, t, a) {
  ...
  for (var o = i - e.width / 2 - r, u = l - e.height / 2 - n, h = 0; h < t.length; h++) {
    var y = t[h], b = t[h < t.length - 1 ? h + 1 : 0], L = wr(e, a, {
      x: o + y.x,
      y: u + y.y
    }, {
      x: o + b.x,
...
var Lr = /* @__PURE__ */ d((e, t) => {
  ...
  const h = o.node();
  let y;
  t.labelType === "markdown" ? y = Ht(o, bt(yt(u), l), {
    useHtmlLabels: r,
    width: t.width || l.flowchart.wrappingWidth,
    classes: "markdown-node-label"
  }, l) : y = h.appendChild(await j(bt(yt(u), l), t.labelStyle, !1, i));
  let b = y.getBBox();
  const L = t.padding / 2;
  ...
  return r ? o.attr("transform", "translate(" + -b.width / 2 + ", " + -b.height / 2 + ")") : o.attr("transform", "translate(0, " + -b.height / 2 + ")"), t.centerLabel && o.attr("transform", "translate(" + -b.width / 2 + ", " + -b.height / 2 + ")"), o.insert("rect", ":first-child"), {
    shapeSvg: n,
    bbox: b,
    halfPadding: L,
    label: o
...
var vr = /* @__PURE__ */ d(async (e, t) => {
...
}, "note"), Er = vr, At = /* @__PURE__ */ d((e) => e ? " " + e : "", "formatClass"), K = /* @__PURE__ */ d((e, t) => `${t || "node default"}${At(e.classes)} ${At(e.class)}`, "getClassesFromNode"), Mt = /* @__PURE__ */ d(async (e, t) => {
  const {
    shapeSvg: a,
    bbox: i
  } = await F(e, t, K(t, void 0), !0), l = i.width + t.padding, s = i.height + t.padding, r = l + s, n = [{
    x: r / 2,
    y: 0
  }, {
    x: r,
  ...
  const {
    shapeSvg: a,
    bbox: i
  } = await F(e, t, K(t, void 0), !0), l = 4, s = i.height + t.padding, r = s / l, n = i.width + 2 * r + t.padding, o = [{
    x: r,
    y: 0
  }, {
    x: n - r,
  ...
  const {
    shapeSvg: a,
    bbox: i
  } = await F(e, t, void 0, !0), l = 2, s = i.height + 2 * t.padding, r = s / l, n = i.width + 2 * r + t.padding, o = xr(t.directions, i, t), u = G(a, n, s, o);
  return u.attr("style", t.style), I(t, u), t.intersect = function(h) {
    return C.polygon(t, o, h);
  }, a;
  ...
  const {
    shapeSvg: a,
    bbox: i
  } = await F(e, t, K(t, void 0), !0), l = i.width + t.padding, s = i.height + t.padding, r = [{
    x: -s / 2,
    y: 0
  }, {
    x: l,
  ...
  const {
    shapeSvg: a,
    bbox: i
  } = await F(e, t, K(t), !0), l = i.width + t.padding, s = i.height + t.padding, r = [{
    x: -2 * s / 6,
    y: 0
  }, {
    x: l - s / 6,
  ...
  const {
    shapeSvg: a,
    bbox: i
  } = await F(e, t, K(t, void 0), !0), l = i.width + t.padding, s = l / 2, r = s / (2.5 + l / 50), n = i.height + r + t.padding, o = "M 0," + r + " a " + s + "," + r + " 0,0,0 " + l + " 0 a " + s + "," + r + " 0,0,0 " + -l + " 0 l 0," + n + " a " + s + "," + r + " 0,0,0 " + l + " 0 l 0," + -n, u = a.attr("label-offset-y", r).insert("path", ":first-child").attr("style", t.style).attr("d", o).attr("transform", "translate(" + -l / 2 + "," + -(n / 2 + r) + ")");
  ...
  const {
    ...
    bbox: i,
    halfPadding: l
  } = await F(e, t, "node " + t.classes + " " + t.class, !0), s = a.insert("rect", ":first-child"), r = t.positioned ? t.width : i.width + t.padding, n = t.positioned ? t.height : i.height + t.padding, o = t.positioned ? -r / 2 : -i.width / 2 - l, u = t.positioned ? -n / 2 : -i.height / 2 - l;
  ...
  const {
    ...
    bbox: i,
    halfPadding: l
  } = await F(e, t, "node " + t.classes, !0), s = a.insert("rect", ":first-child"), r = t.positioned ? t.width : i.width + t.padding, n = t.positioned ? t.height : i.height + t.padding, o = t.positioned ? -r / 2 : -i.width / 2 - l, u = t.positioned ? -n / 2 : -i.height / 2 - l;
...
var Fr = /* @__PURE__ */ d(async (e, t) => {
  ...
  const E = t.padding / 2;
  return R(L).attr("transform", "translate( " + // (titleBox.width - bbox.width) / 2 +
  (h.width > b.width ? 0 : (b.width - h.width) / 2) + ", " + (b.height + E + 5) + ")"), R(u).attr("transform", "translate( " + // (titleBox.width - bbox.width) / 2 +
  (h.width < b.width ? 0 : -(b.width - h.width) / 2) + ", 0)"), h = r.node().getBBox(), r.attr("transform", "translate(" + -h.width / 2 + ", " + (-h.height / 2 - E + 3) + ")"), l.attr("class", "outer title-state").attr("x", -h.width / 2 - E).attr("y", -h.height / 2 - E).attr("width", h.width + t.padding).attr("height", h.height + t.padding), s.attr("class", "divider").attr("x1", -h.width / 2 - E).attr("x2", h.width / 2 + E).attr("y1", -h.height / 2 - E + b.height + E).attr("y2", -h.height / 2 - E + b.height + E), I(t, l), t.intersect = function(D) {
    return C.rect(t, D);
  }, i;
  ...
  const {
    shapeSvg: a,
    bbox: i
  } = await F(e, t, K(t, void 0), !0), l = i.height + t.padding, s = i.width + l / 4 + t.padding, r = a.insert("rect", ":first-child").attr("style", t.style).attr("rx", l / 2).attr("ry", l / 2).attr("x", -s / 2).attr("y", -l / 2).attr("width", s).attr("height", l);
  ...
  const {
    ...
    bbox: i,
    halfPadding: l
  } = await F(e, t, K(t, void 0), !0), s = a.insert("circle", ":first-child");
  ...
  const {
    ...
    bbox: i,
    halfPadding: l
  } = await F(e, t, K(t, void 0), !0), s = 5, r = a.insert("g", ":first-child"), n = r.insert("circle"), o = r.insert("circle");
  ...
  let w = (h - x.width) / 2;
  return R(N).attr("transform", "translate( " + (-1 * h / 2 + w) + ", " + (-1 * y / 2 + L) + ")"), L += x.height + i, o.attr("class", "divider").attr("x1", -h / 2 - a).attr("x2", h / 2 + a).attr("y1", -y / 2 - a + l + L).attr("y2", -y / 2 - a + l + L), L += l, g.forEach((c) => {
...
function Nt(e, t, a = !1) {
  ...
  const o = Se((i == null ? void 0 : i.styles) ?? []), u = i.label, h = i.size ?? {
    width: 0,
    height: 0,
    x: 0,
    y: 0
...
async function se(e, t, a) {
  ...
  if (i.type === "group")
    return;
  const l = st(), s = await ae(e, i, {
    config: l
  }), r = s.node().getBBox(), n = a.getBlock(i.id);
  n.size = {
    width: r.width,
    height: r.height,
    x: 0,
...
async function ie(e, t, a) {
  ...
  if (a.getBlock(i.id).type !== "space") {
    ...
    await ae(e, i, {
      config: s
    }), t.intersect = i == null ? void 0 : i.intersect, jr(i);
  }
}
  ...
  for (const r of t)
    if (r.start && r.end) {
      ...
      if (n != null && n.size && (o != null && o.size)) {
        ...
        }, void 0, "block", s, l), r.label && (await hr(e, {
          ...r,
          label: r.label,
...
var Vr = /* @__PURE__ */ d(function(e, t) {
  ...
  if (await le(E, y, r), await ce(E, L, b, r, t), D) {
    ...
    ge(u, k, N, !!x), m.debug("Here Bounds", D, v), u.attr("viewBox", `${v.x - 5} ${v.y - 5} ${v.width + 10} ${v.height + 10}`);
  }
}, "draw"), Zr = {
  draw: Gr,
  getClasses: Vr
