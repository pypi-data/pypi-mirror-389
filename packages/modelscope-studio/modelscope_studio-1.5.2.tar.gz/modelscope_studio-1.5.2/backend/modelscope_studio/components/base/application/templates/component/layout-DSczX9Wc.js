import { G as g } from "./graph-DHADSxh5.js";
import { e as ce, a as f, f as C, v as x, r as I } from "./_baseUniq-BE9lmiHy.js";
import { b as le, a as Me, c as Te, d as Ie, t as F, m as w, e as N, h as he, f as z, g as je } from "./_basePickBy-C7C44-Tz.js";
import { aJ as $, aA as Se, aY as q } from "./mermaid.core-DqXbFyRH.js";
import { b as Fe, K as Ve, j as Ae, x as ve, n as X, L as Be, r as pe, f as ee, o as V, p as we, w as Ge, M as Ye, N as De, O as $e, a as qe, P as We, v as ze, Q as _, c as Xe, i as m, R as M } from "./Index-C_OWUvsZ.js";
var Ue = 1, He = 4;
function Je(e) {
  return Fe(e, Ue | He);
}
...
function j(e, n) {
  var r = {};
  return n = X(n), ve(e, function(t, a, i) {
    Be(r, a, n(t, a, i));
  }), r;
}
function y(e) {
  return e && e.length ? le(e, pe, Ze) : void 0;
}
function U(e, n) {
  return e && e.length ? le(e, X(n), Me) : void 0;
}
function en(e, n) {
  var r = e.length;
  for (e.sort(n); r--; )
...
function sn(e) {
  return function(n, r, t) {
    return t && typeof t != "number" && $(n, r, t) && (r = t = void 0), n = F(n), r === void 0 ? (r = n, n = 0) : r = F(r), t = t === void 0 ? n < r ? 1 : -1 : F(t), dn(n, r, t);
  };
}
var E = sn(), R = Se(function(e, n) {
  if (e == null)
    return [];
  var r = n.length;
...
function _n(e) {
  var n = e.graph().rankdir.toLowerCase();
  (n === "bt" || n === "rl") && Rn(e), (n === "lr" || n === "rl") && (Mn(e), ge(e));
}
function ge(e) {
...
function ye(e) {
  ...
  n.setNode(r, {});
  for (var a, i; Sn(n, e) < t; )
    a = Fn(n, e), i = n.hasNode(a.v) ? P(e, a) : -P(e, a), Vn(n, e, i);
  return n;
}
function Sn(e, n) {
  function r(t) {
...
function Pe(e, n, r, t) {
  var a = r.v, i = r.w;
  e.removeEdge(a, i), e.setEdge(t.v, t.w, {}), Q(e), K(e, n), Dn(e, n);
}
function Dn(e, n) {
...
function Xn(e) {
  var n = O(e, "root", {}, "_root"), r = Un(e), t = y(x(r)) - 1, a = 2 * t + 1;
...
function Nr(e) {
  var n = S(e), r = q(wr(e, n), br(e, n)), t = {}, a;
  f(["u", "d"], function(o) {
...
function _r(e) {
  e = be(e), Rr(e), Qe(Nr(e), function(n, r) {
    e.node(r).x = n;
  });
}
function Rr(e) {
...
function it(e, n) {
  ...
  r("layout", () => {
    ...
    r("  runLayout", () => Mr(t, r)), r("  updateInputGraph", () => Tr(e, t));
  });
}
function Mr(e, n) {
  n("    makeSpaceForEdgeLabels", () => Dr(e)), n("    removeSelfEdges", () => Kr(e)), n("    acyclic", () => gn(e)), n("    nestingGraph.run", () => Xn(e)), n("    rank", () => qn(be(e))), n("    injectEdgeLabelProxies", () => $r(e)), n("    removeEmptyRanks", () => On(e)), n("    nestingGraph.cleanup", () => Jn(e)), n("    normalizeRanks", () => En(e)), n("    assignRankMinMax", () => qr(e)), n("    removeEdgeLabelProxies", () => Wr(e)), n("    normalize.run", () => Tn(e)), n("    parentDummyChains", () => hr(e)), n("    addBorderSegments", () => Pn(e)), n("    order", () => cr(e)), n("    insertSelfEdges", () => Qr(e)), n("    adjustCoordinateSystem", () => Cn(e)), n("    position", () => _r(e)), n("    positionSelfEdges", () => Zr(e)), n("    removeBorderNodes", () => Jr(e)), n("    normalize.undo", () => jn(e)), n("    fixupEdgeLabelCoords", () => Ur(e)), n("    undoCoordinateSystem", () => _n(e)), n("    translateGraph", () => zr(e)), n("    assignNodeIntersects", () => Xr(e)), n("    reversePoints", () => Hr(e)), n("    acyclic.undo", () => kn(e));
}
function Tr(e, n) {
  f(e.nodes(), function(r) {
...
var Ir = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"], jr = {
  ranksep: 50,
  edgesep: 20,
  nodesep: 50,
  rankdir: "tb"
}, Sr = ["acyclicer", "ranker", "rankdir", "align"], Fr = ["width", "height"], Vr = {
  width: 0,
  height: 0
...
function Yr(e) {
  ...
  return n.setGraph(q({}, jr, Y(r, Ir), T(r, Sr))), f(e.nodes(), function(t) {
    var a = D(e.node(t));
    n.setNode(t, je(Y(a, Fr), Vr)), n.setParent(t, e.parent(t));
  }), f(e.edges(), function(t) {
    var a = D(e.edge(t));
    n.setEdge(t, q({}, Br, Y(a, Ar), T(a, Gr)));
  }), n;
}
function Dr(e) {
  var n = e.graph();
...
function Jr(e) {
  f(e.nodes(), function(n) {
    if (e.children(n).length) {
      var r = e.node(n), t = e.node(r.borderTop), a = e.node(r.borderBottom), i = e.node(M(r.borderLeft)), o = e.node(M(r.borderRight));
