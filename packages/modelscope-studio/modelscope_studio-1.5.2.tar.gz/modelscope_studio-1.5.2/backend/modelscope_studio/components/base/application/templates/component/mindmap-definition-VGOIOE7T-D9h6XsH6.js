...
import { s as he } from "./chunk-QN33PNHL-BVOxQlDm.js";
import { _ as l, l as C, o as de, r as ge, F as j, c as X, i as B, aF as ue, W as pe, X as fe, Y as ye } from "./mermaid.core-DqXbFyRH.js";
const E = [];
for (let t = 0; t < 256; ++t)
...
const be = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), ne = {
  randomUUID: be
};
function Se(t, e, n) {
  var u;
...
var q = function() {
  var t = /* @__PURE__ */ l(function(v, s, i, a) {
    ...
    performAction: /* @__PURE__ */ l(function(s, i, a, o, g, r, U) {
      ...
      switch (g) {
        ...
        case 15:
          ...
          break;
        case 16:
          o.getLogger().trace("Icon: ", r[d]), o.decorateNode({
            icon: r[d]
          });
          break;
        case 17:
        ...
        case 20:
          ...
          break;
        case 25:
          o.getLogger().trace("node found ..", r[d - 2]), this.$ = {
            id: r[d - 1],
            descr: r[d - 1],
            type: o.getType(r[d - 2], r[d])
          };
          break;
        case 26:
          this.$ = {
            id: r[d],
            descr: r[d],
            type: o.nodeType.DEFAULT
          };
          break;
        case 27:
          o.getLogger().trace("node found ..", r[d - 3]), this.$ = {
            id: r[d - 3],
            descr: r[d - 1],
            type: o.getType(r[d - 2], r[d])
          };
    ...
    table: [{
      ...
      19: p,
      22: y
    }), t(D, [2, 18]), t(D, [2, 19]), t(D, [2, 20]), t(D, [2, 21]), t(D, [2, 23]), t(D, [2, 24]), t(D, [2, 26], {
      19: [1, 30]
    }), {
      20: [1, 31]
    }, {
      ...
      7: K,
      11: Q
    }), t(A, [2, 8]), t(A, [2, 9]), t(A, [2, 10]), t(D, [2, 15]), t(D, [2, 16]), t(D, [2, 17]), {
      20: [1, 35]
    }, {
      21: [1, 36]
    }, t(J, [2, 13], {
    ...
    parse: /* @__PURE__ */ l(function(s) {
      var i = this, a = [0], o = [], g = [null], r = [], U = this.table, d = "", M = 0, Z = 0, re = 2, ee = 1, ae = r.slice.call(arguments, 1), f = Object.create(this.lexer), T = {
        yy: {}
      };
...
Expecting ` + F.join(", ") + ", got '" + (this.terminals_[S] || S) + "'" : z = "Parse error on line " + (M + 1) + ": Unexpected " + (S == ee ? "end of input" : "'" + (this.terminals_[S] || S) + "'"), this.parseError(z, {
        ...
        switch (k[0]) {
          ...
          case 2:
            ...
            }, oe && (I._$.range = [r[r.length - (L || 1)].range[0], r[r.length - 1].range[1]]), W = this.performAction.apply(I, [d, Z, M, T.yy, k[1], g, r].concat(ae)), typeof W < "u")
              return W;
...
var De = q, x = {
  ...
  addNode(e, n, c, u) {
    ...
    if (b)
      ...
      throw new Error(`There can be only one root. No parent could be found for ("${_.descr}")`);
  }
  getType(e, n) {
  ...
  getData() {
    ...
    const p = [], y = [];
    this.flattenNodes(e, p), this.generateEdges(e, y), C.debug(`getData: processed ${p.length} nodes and ${y.length} edges`);
...
` + t);
  ...
  }), await ge(h, p), he(p, ((_ = h.config.mindmap) == null ? void 0 : _.padding) ?? j.mindmap.padding, "mindmapDiagram", ((b = h.config.mindmap) == null ? void 0 : b.useMaxWidth) ?? j.mindmap.useMaxWidth));
}, "draw"), Le = {
  draw: ke
}, xe = /* @__PURE__ */ l((t) => {
  let e = "";
