import { _ as b, D as m, H as B, e as C, l as w, b as S, a as D, p as T, q as E, g as F, s as P, E as z, F as A, y as W } from "./mermaid.core-DqXbFyRH.js";
import { p as _ } from "./chunk-4BX2VUAB-C4zYEg_Z.js";
import { p as N } from "./treemap-KMMF4GRG-CSQK1e7L.js";
var L = A.packet, u, v = (u = class {
  ...
  for (let {
    ...
    if (a ?? (a = s + 1), a !== s + 1)
      throw new Error(`Packet block ${a} - ${i ?? a} is not contiguous. It should start from ${s + 1}.`);
    if (d === 0)
  ...
  const n = r.db, l = n.getConfig(), {
    rowHeight: a,
    paddingY: i,
    bitWidth: d,
    bitsPerRow: c
  } = l, p = n.getPacket(), o = n.getDiagramTitle(), h = a + i, g = h * (p.length + 1) - (o ? 0 : a), k = d * c + 2, f = B(t);
