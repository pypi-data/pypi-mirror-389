import { _ as X, ar as F, as as Y, at as _, au as H, l as i, c as V, av as z, aw as U, ag as $, al as q, ah as P, af as K, ax as Q, ay as W, az as Z } from "./mermaid.core-DqXbFyRH.js";
import { G as B } from "./graph-DHADSxh5.js";
import { l as I } from "./layout-DSczX9Wc.js";
import { i as x } from "./Index-C_OWUvsZ.js";
import { c as L } from "./clone-DJ2ltZ-A.js";
import { m as A } from "./_basePickBy-C7C44-Tz.js";
function p(e) {
  var t = {
    options: {
  ...
  e !== o && c.push(e), i.warn("Copying (nodes) clusterId", e, "nodes", c), c.forEach((a) => {
    if (t.children(a).length > 0)
      ...
      i.debug("Copying Edges", u), u.forEach((l) => {
        ...
        try {
          se(l, o) ? (i.info("Copying as ", l.v, l.w, v, l.name), n.setEdge(l.v, l.w, v, l.name), i.info("newGraph edges ", n.edges(), n.edge(n.edges()[0]))) : i.info("Skipping copy of edge ", l.v, "-->", l.w, " rootId: ", o, " clusterId:", e);
        } catch (C) {
          i.error(C);
        }
      });
