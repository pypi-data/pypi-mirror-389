import { g as te } from "./chunk-55IACEB6-BUuPNEZY.js";
import { s as ee } from "./chunk-QN33PNHL-BVOxQlDm.js";
import { _ as f, l as D, c as F, r as se, u as ie, a as re, b as ae, g as ne, s as oe, p as le, q as ce, T as he, k as W, y as ue } from "./mermaid.core-DqXbFyRH.js";
var vt = function() {
  var e = /* @__PURE__ */ f(function(V, o, h, n) {
    ...
    performAction: /* @__PURE__ */ f(function(o, h, n, g, E, r, Z) {
      ...
      switch (E) {
        ...
        case 37:
          ...
          break;
        case 38:
          g.setDirection("TB"), this.$ = {
            stmt: "dir",
            value: "TB"
          };
          break;
        case 39:
          g.setDirection("BT"), this.$ = {
            stmt: "dir",
            value: "BT"
          };
          break;
        case 40:
          g.setDirection("RL"), this.$ = {
            stmt: "dir",
            value: "RL"
          };
          break;
        case 41:
          g.setDirection("LR"), this.$ = {
            stmt: "dir",
            value: "LR"
          };
          break;
    ...
    table: [{
      ...
      58: [1, 57]
    }), e(y, [2, 38]), e(y, [2, 39]), e(y, [2, 40]), e(y, [2, 41]), e(y, [2, 6]), e(y, [2, 13]), {
      13: 58,
      24: m,
      57: K
    }, e(y, [2, 17]), e(xt, i, {
      ...
      39: [1, 77]
    }, e(y, [2, 34]), e(y, [2, 35]), e(y, [2, 36]), e(y, [2, 37]), e(ct, [2, 46]), e(ct, [2, 47]), e(y, [2, 15]), e(y, [2, 19]), e(xt, i, {
      7: 78
    }), e(y, [2, 26]), e(y, [2, 27]), {
      5: [1, 79]
    }, {
    ...
    parse: /* @__PURE__ */ f(function(o) {
      var h = this, n = [0], g = [], E = [null], r = [], Z = this.table, c = "", U = 0, X = 0, ut = 2, tt = 1, Tt = r.slice.call(arguments, 1), b = Object.create(this.lexer), j = {
        yy: {}
      };
...
Expecting ` + ft.join(", ") + ", got '" + (this.terminals_[C] || C) + "'" : Dt = "Parse error on line " + (U + 1) + ": Unexpected " + (C == tt ? "end of input" : "'" + (this.terminals_[C] || C) + "'"), this.parseError(Dt, {
        ...
        switch (w[0]) {
          ...
          case 2:
            ...
            }, Qt && (J._$.range = [r[r.length - (Y || 1)].range[0], r[r.length - 1].range[1]]), mt = this.performAction.apply(J, [c, X, U, j.yy, w[1], E, r].concat(Tt)), typeof mt < "u")
              return mt;
...
var Be = vt, de = "TB", Yt = "TB", Rt = "dir", Q = "state", q = "root", Ct = "relation", fe = "classDef", pe = "style", Se = "applyClass", it = "default", Gt = "divider", Bt = "fill:none", Vt = "fill: #333", Mt = "c", Ut = "text", jt = "normal", bt = "rect", kt = "rectWithTitle", ye = "stateStart", ge = "stateEnd", It = "divider", Nt = "roundedWithTitle", Te = "note", Ee = "noteGroup", rt = "statediagram", _e = "state", me = `${rt}-${_e}`, Ht = "transition", De = "note", be = "note-edge", ke = `${Ht} ${be}`, ve = `${rt}-${De}`, Ce = "cluster", Ae = `${rt}-${Ce}`, xe = "cluster-alt", Le = `${rt}-${xe}`, Wt = "parent", zt = "note", Oe = "state", At = "----", Re = `${At}${zt}`, wt = `${At}${Wt}`, Kt = /* @__PURE__ */ f((e, t = Yt) => {
  ...
  ie.insertTitle(p, "statediagramTitleText", (l == null ? void 0 : l.titleTopMargin) ?? 25, a.db.getDiagramTitle()), ee(p, T, rt, (l == null ? void 0 : l.useMaxWidth) ?? !0);
}, "draw"), Ve = {
  getClasses: Ie,
  draw: Ne,
  getDir: Kt
...
var st = /* @__PURE__ */ f((e, t, s, a, i, l, d, S) => {
  ...
  clear(t) {
    this.nodes = [], this.edges = [], this.documents = {
      root: Ft()
    }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = Pt(), t || (this.links = /* @__PURE__ */ new Map(), ue());
  }
  getState(t) {
  ...
  addRelationObjs(t, s, a = "") {
    ...
    this.addState(i, l, t.doc, t.description, t.note, t.classes, t.styles, t.textStyles), this.addState(d, S, s.doc, s.description, s.note, s.classes, s.styles, s.textStyles), this.currentDocument.relations.push({
      id1: i,
      id2: d,
