...
function Ds(e, t, n) {
  ...
  const c = Ya(() => import("./bubble-bEZ0HlZN.js"));
  let {
    gradio: _
  } = t, {
    props: l = {}
  ...
  return pe(e, Me, (b) => n(1, s = b)), e.$$set = (b) => {
    t = me(me({}, t), Ts(b)), n(19, i = ft(t, r)), "gradio" in b && n(7, _ = b.gradio), "props" in b && n(8, l = b.props), "_internal" in b && n(9, d = b._internal), "as_item" in b && n(10, h = b.as_item), "visible" in b && n(11, g = b.visible), "elem_id" in b && n(12, v = b.elem_id), "elem_classes" in b && n(13, T = b.elem_classes), "elem_style" in b && n(14, w = b.elem_style), "$$scope" in b && n(17, f = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && p.update((b) => ({
      ...b,
  ...
  }, [a, s, c, p, M, Qt, Me, _, l, d, h, g, v, T, w, o, u, f];
}
class Us extends _s {
  constructor(t) {
