import { a as L, c as g } from "./XProvider-EyhlI9la.js";
  ...
  (function(s, t) {
    ...
    function o(_, e, c) {
      ...
      return c === "m" ? e ? "хвіліна" : "хвіліну" : c === "h" ? e ? "гадзіна" : "гадзіну" : _ + " " + (n = +_, m = {
        ...
        yy: "год_гады_гадоў"
      }[c].split("_"), n % 10 == 1 && n % 100 != 11 ? m[0] : n % 10 >= 2 && n % 10 <= 4 && (n % 100 < 10 || n % 100 >= 20) ? m[1] : m[2]);
    }
    var f = function(_, e) {
      return y.test(e) ? a[_.month()] : d[_.month()];
    };
    f.s = d, f.f = a;
    var l = function(_, e) {
