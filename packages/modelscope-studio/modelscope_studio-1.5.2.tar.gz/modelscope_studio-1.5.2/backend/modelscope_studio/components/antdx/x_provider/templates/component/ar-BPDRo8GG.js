import { a as Y, c as y } from "./XProvider-EyhlI9la.js";
...
(function(a, s) {
  (function(o, t) {
    ...
    var r = t(o), n = "يناير_فبراير_مارس_أبريل_مايو_يونيو_يوليو_أغسطس_سبتمبر_أكتوبر_نوفمبر_ديسمبر".split("_"), f = {
      ...
      "٩": "9",
      "٠": "0"
    }, d = /[١٢٣٤٥٦٧٨٩٠]/g, m = /،/g, p = /\d/g, M = /,/g, u = {
      name: "ar",
      ...
      preparse: function(e) {
        return e.replace(d, function(_) {
          return l[_];
        }).replace(m, ",");
      },
      postformat: function(e) {
        return e.replace(p, function(_) {
          return f[_];
        }).replace(M, "،");
      },
      ordinal: function(e) {
...
var c = i.exports;
const b = /* @__PURE__ */ Y(c), j = /* @__PURE__ */ L({
  __proto__: null,
  default: b
}, [c]);
export {
