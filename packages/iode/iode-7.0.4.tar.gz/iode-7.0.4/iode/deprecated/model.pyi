...
def model_simulate(sample_from: str, sample_to: str, eqs_list: Incomplete | None = None, endo_exo_list: Incomplete | None = None, eps: float = 0.0001, relax: float = 1.0, maxit: int = 100, init_values: int = ..., sort_algo: int = ..., nb_passes: int = 5, debug: bool = False, newton_eps: float = 1e-06, newton_maxit: int = 50, newton_debug: bool = False): ...
def model_calc_scc(nb_passes: int = 1, pre_listname: str = '_PRE', inter_listname: str = '_INTER', post_listname: str = '_POST', eqs_list: Incomplete | None = None): ...
