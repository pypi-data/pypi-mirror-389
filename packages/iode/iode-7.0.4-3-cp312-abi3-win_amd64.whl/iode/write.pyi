from iode.iode_cython import WriteFileExt as WriteFileExt, cython_write as cython_write, cython_write_close as cython_write_close, cython_write_code_block as cython_write_code_block, cython_write_destination as cython_write_destination, cython_write_enum as cython_write_enum, cython_write_flush as cython_write_flush, cython_write_page_footer as cython_write_page_footer, cython_write_page_header as cython_write_page_header, cython_write_paragraph as cython_write_paragraph, cython_write_title as cython_write_title
from pathlib import Path

def write_destination(filename: str | Path, file_type: WriteFileExt | str = ...):
    '''
