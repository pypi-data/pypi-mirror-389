...
from iode.iode_cython import TableCellAlign as TableCellAlign, TableGraphAxis as TableGraphAxis, TableGraphGrid as TableGraphGrid, TableGraphType as TableGraphType, TableLineType as TableLineType, TableTextAlign as TableTextAlign
...
class Table:
    ...
    *Tables* can very well be used in a project that does not include an econometric model: 
    ...
    def graph_alignment(self, value: TableTextAlign | str): ...
    @property
    def box(self) -> bool:
        """
        Whether the graph should be boxed. 
