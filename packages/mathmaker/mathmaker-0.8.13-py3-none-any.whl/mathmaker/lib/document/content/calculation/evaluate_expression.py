...
EXPRESSIONS = {
    ...
    '104': r'A+\dfrac{x}{B}', '105': r'A-\dfrac{x}{B}',
    '106': r'\dfrac{x}{B}+A',
    '107': r'\dfrac{x}{B}-A',
    '108': r'A+\dfrac{B}{x}', '109': r'A-\dfrac{B}{x}',
    '110': r'\dfrac{B}{x}+A',
    '111': r'\dfrac{B}{x}-A',
    '112': 'A(x+B)', '113': 'A(x-B)', '114': r'\dfrac{A}{x+B}',
    '115': r'\dfrac{A}{x-B}',
    '116': 'A(B+x)', '117': 'A(B-x)', '118': r'\dfrac{A}{B+x}',
    '119': r'\dfrac{A}{B-x}',
    '120': r'\dfrac{x+B}{A}', '121': r'\dfrac{x-B}{A}',
    '122': r'\dfrac{B+x}{A}',
    '123': r'\dfrac{B-x}{A}',
    '124': 'x^{2}+A', '125': 'A+x^{2}', '126': 'x^{2}-A', '127': 'A-x^{2}',
    '128': 'x^{2}', '129': 'Ax^{2}', '130': r'\dfrac{x^{2}}{A}',
    '131': r'\dfrac{A}{x^{2}}',
