...
DIGITSPLACES_HOW_MANY = {BILLIONS: 'How many billions are there in '
                         '{decimal_number}?',
                         HUNDREDS_OF_MILLIONS: 'How many hundreds of millions '
                         'are there in {decimal_number}?',
                         TENS_OF_MILLIONS: 'How many tens of millions are '
                         'there in {decimal_number}?',
                         MILLIONS: 'How many millions are there in '
                         '{decimal_number}?',
                         HUNDREDS_OF_THOUSANDS: 'How many hundreds of '
                         'thousands are there in {decimal_number}?',
                         TENS_OF_THOUSANDS: 'How many tens of thousands are '
                         'there in {decimal_number}?',
                         THOUSANDS: 'How many thousands are there in'
                         ' {decimal_number}?',
                         HUNDREDS: 'How many hundreds are there in'
                         ' {decimal_number}?',
                         TENS: 'How many tens are there in {decimal_number}?',
                         UNITS: 'How many units are there in'
                         ' {decimal_number}?',
                         TENTHS: 'How many tenths are there in'
                         ' {decimal_number}?',
                         HUNDREDTHS: 'How many hundredths are there in'
                         ' {decimal_number}?',
                         THOUSANDTHS: 'How many thousandths are there in'
                         ' {decimal_number}?'}
