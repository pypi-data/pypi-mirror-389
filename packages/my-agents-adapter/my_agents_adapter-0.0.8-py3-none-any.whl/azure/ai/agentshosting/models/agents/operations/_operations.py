...
def build_conversations_create_conversation_items_request(  # pylint: disable=name-too-long
    conversation_id: str, *, include: Optional[list[str]] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_conversations_list_conversation_items_request(  # pylint: disable=name-too-long
    ...
    *,
    ...
    after: Optional[str] = None,
    before: Optional[str] = None,
    item_type: Optional[Union[str, _openai_models5.ItemType]] = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_responses_get_response_request(
    response_id: str,
    *,
    includables: Optional[list[Union[str, _openai_models5.Includable]]] = None,
...
def build_agents_create_or_update_agent_event_handler_request(  # pylint: disable=name-too-long
    agent_name: str, event_handler_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/agents/{agent_name}/event_handlers/{event_handler_name}"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
        "event_handler_name": _SERIALIZER.url("event_handler_name", event_handler_name, "str"),
    }
...
def build_agents_get_agent_event_handler_request(  # pylint: disable=name-too-long
    agent_name: str, event_handler_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_agents_list_agent_event_handlers_request(  # pylint: disable=name-too-long
    agent_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/agents/{agent_name}/event_handlers"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
    }
...
def build_agents_delete_agent_event_handler_request(  # pylint: disable=name-too-long
    agent_name: str, event_handler_name: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_agents_start_agent_container_request(  # pylint: disable=name-too-long
    agent_name: str, agent_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/agents/{agent_name}/versions/{agent_version}/containers/default:start"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
        "agent_version": _SERIALIZER.url("agent_version", agent_version, "str"),
    }
...
def build_agents_update_agent_container_request(  # pylint: disable=name-too-long
    agent_name: str, agent_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/agents/{agent_name}/versions/{agent_version}/containers/default:update"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
        "agent_version": _SERIALIZER.url("agent_version", agent_version, "str"),
    }
...
def build_agents_stop_agent_container_request(  # pylint: disable=name-too-long
    agent_name: str, agent_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/agents/{agent_name}/versions/{agent_version}/containers/default:stop"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
        "agent_version": _SERIALIZER.url("agent_version", agent_version, "str"),
    }
...
def build_agents_delete_agent_container_request(  # pylint: disable=name-too-long
    agent_name: str, agent_version: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/agents/{agent_name}/versions/{agent_version}/containers/default:delete"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
        "agent_version": _SERIALIZER.url("agent_version", agent_version, "str"),
    }
...
def build_agents_get_agent_container_request(agent_name: str, agent_version: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/agents/{agent_name}/versions/{agent_version}/containers/default"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
        "agent_version": _SERIALIZER.url("agent_version", agent_version, "str"),
    }
...
def build_agents_get_agent_container_operation_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/agents/{agent_name}/operations/{operation_id}"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
...
def build_agents_list_agent_container_operations_request(  # pylint: disable=name-too-long
    agent_name: str,
    *,
    limit: Optional[int] = None,
    order: Optional[Literal["asc", "desc"]] = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/agents/{agent_name}/operations"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
    }
...
def build_agents_list_agent_version_container_operations_request(  # pylint: disable=name-too-long
    agent_name: str,
    agent_version: str,
    *,
    limit: Optional[int] = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/agents/{agent_name}/versions/{agent_version}/containers/default/operations"
    path_format_arguments = {
        "agent_name": _SERIALIZER.url("agent_name", agent_name, "str"),
        "agent_version": _SERIALIZER.url("agent_version", agent_version, "str"),
    }
...
class ConversationsOperations:
    ...
    def create_conversation(
        ...
        *,
        ...
        items: Optional[list[_openai_models5.ItemParam]] = None,
        **kwargs: Any
    ) -> _openai_models5.ConversationResource:
    ...
    def create_conversation(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_openai_models5.ConversationResource] = kwargs.pop("cls", None)
        ...
        if response.status_code not in [200]:
            ...
            error = _failsafe_deserialize(_models1.ApiError, response)
            raise HttpResponseError(response=response, model=error)

        if _stream:
            deserialized = response.iter_bytes()
        else:
            deserialized = _deserialize(_openai_models5.ConversationResource, response.json())
    ...
    def update_conversation(
        self,
        conversation_id: str,
        body: _openai_models5.UpdateConversationRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _openai_models5.ConversationResource:
    ...
    def update_conversation(
        self,
        conversation_id: str,
        body: Union[_openai_models5.UpdateConversationRequest, JSON, IO[bytes]],
        **kwargs: Any
    ) -> _openai_models5.ConversationResource:
        """Update a conversation.
    ...
    @distributed_trace
    def get_conversation(self, conversation_id: str, **kwargs: Any) -> _openai_models5.ConversationResource:
    ...
    @distributed_trace
    def delete_conversation(self, conversation_id: str, **kwargs: Any) -> _openai_models5.DeletedConversationResource:
        ...
        cls: ClsType[_openai_models5.DeletedConversationResource] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_openai_models5.DeletedConversationResource, response.json())
    ...
    def list_conversations(
        ...
        *,
        ...
        agent_id: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_openai_models5.ConversationResource"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~openai.models.ConversationResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[list[_openai_models5.ConversationResource]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            ...
            list_of_elem = _deserialize(list[_openai_models5.ConversationResource], deserialized.get("data", []))
            if cls:
    ...
    def create_conversation_items(
        ...
        conversation_id: str,
        *,
        items: list[_openai_models5.ItemParam],
        include: Optional[list[str]] = None,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models1.AgentsPagedResultItemResource:
    ...
    def create_conversation_items(
        ...
        body: Union[JSON, IO[bytes]] = _Unset,
        *,
        items: list[_openai_models5.ItemParam] = _Unset,
        include: Optional[list[str]] = None,
        **kwargs: Any
    ) -> _models1.AgentsPagedResultItemResource:
        """Create items in a conversation with the given ID.
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models1.AgentsPagedResultItemResource] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.AgentsPagedResultItemResource, response.json())
    ...
    @distributed_trace
    def get_conversation_item(self, conversation_id: str, item_id: str, **kwargs: Any) -> _openai_models5.ItemResource:
        ...
        cls: ClsType[_openai_models5.ItemResource] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_openai_models5.ItemResource, response.json())
    ...
    def list_conversation_items(
        ...
        *,
        ...
        item_type: Optional[Union[str, _openai_models5.ItemType]] = None,
        **kwargs: Any
    ) -> ItemPaged["_openai_models5.ItemResource"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~openai.models.ItemResource]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[list[_openai_models5.ItemResource]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(list[_openai_models5.ItemResource], deserialized.get("data", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return None, iter(list_of_elem)
...
class ResponsesOperations:
    ...
    def create_response(
        ...
        *,
        ...
        service_tier: Optional[Union[str, _openai_models5.ServiceTier]] = None,
        ...
        text: Optional[_openai_models5.CreateResponseRequestText] = None,
        tools: Optional[list[_openai_models5.Tool]] = None,
        tool_choice: Optional[Union[str, _openai_models5.ToolChoiceOptions, _openai_models5.ToolChoiceObject]] = None,
        prompt: Optional[_openai_models5.Prompt] = None,
        truncation: Optional[Literal["auto", "disabled"]] = None,
        input: Optional[Union[str, list[Union[_openai_models5.ImplicitUserMessage, _openai_models5.ItemParam]]]] = None,
        include: Optional[list[Union[str, _openai_models5.Includable]]] = None,
        parallel_tool_calls: Optional[bool] = None,
        store: Optional[bool] = None,
        instructions: Optional[str] = None,
        stream_parameter: Optional[bool] = None,
        conversation: Optional[Union[str, _openai_models5.CreateResponseRequestConversation1]] = None,
        agent: Optional[_models1.AgentReference] = None,
        **kwargs: Any
    ) -> _openai_models5.Response:
    ...
    def create_response(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_openai_models5.Response] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_openai_models5.Response, response.json())
    ...
    def create_response_stream(
        self, request: _openai_models5.CreateResponse, *, content_type: str = "application/json", **kwargs: Any
    ) -> _openai_models5.ResponseStreamEvent:
    ...
    @distributed_trace
    def create_response_stream(
        self, request: Union[_openai_models5.CreateResponse, JSON, IO[bytes]], **kwargs: Any
    ) -> _openai_models5.ResponseStreamEvent:
        """Creates a model response (streaming response).
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_openai_models5.ResponseStreamEvent] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_openai_models5.ResponseStreamEvent, response.text())
    ...
    @distributed_trace
    def delete_response(self, response_id: str, **kwargs: Any) -> _models1.DeleteResponseResult:
        ...
        cls: ClsType[_models1.DeleteResponseResult] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.DeleteResponseResult, response.json())
    ...
    @distributed_trace
    def cancel_response(self, response_id: str, **kwargs: Any) -> _openai_models5.Response:
    ...
    def list_responses(
        ...
        *,
        ...
        conversation_id: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_openai_models5.Response"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~openai.models.Response]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[list[_openai_models5.Response]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(list[_openai_models5.Response], deserialized.get("data", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return None, iter(list_of_elem)
...
class _AgentsClientOperationsMixin(
    ...
    def list_agents(
        ...
        *,
        ...
        before: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models1.AgentObject"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.agents.models.AgentObject]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[list[_models1.AgentObject]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(list[_models1.AgentObject], deserialized.get("data", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return None, iter(list_of_elem)
    ...
    def create_agent_version(
        self,
        agent_name: str,
        body: _models1.CreateAgentVersionRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    @distributed_trace
    def create_agent_version(
        self, agent_name: str, body: Union[_models1.CreateAgentVersionRequest, JSON, IO[bytes]], **kwargs: Any
    ) -> _models1.AgentVersionObject:
        """Create a new agent version.
    ...
    def list_agent_versions(
        ...
        *,
        ...
        before: Optional[str] = None,
        **kwargs: Any
    ) -> ItemPaged["_models1.AgentVersionObject"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.agents.models.AgentVersionObject]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[list[_models1.AgentVersionObject]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(list[_models1.AgentVersionObject], deserialized.get("data", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return None, iter(list_of_elem)
    ...
    @overload
    def create_or_update_agent_event_handler(
        self,
        agent_name: str,
        event_handler_name: str,
        body: _models1.AgentEventHandlerRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models1.AgentEventHandlerObject:
    ...
    def create_or_update_agent_event_handler(
        ...
        agent_name: str,
        event_handler_name: str,
        body: Union[_models1.AgentEventHandlerRequest, JSON, IO[bytes]],
        **kwargs: Any
    ) -> _models1.AgentEventHandlerObject:
        """Create or update an event handler for an agent.
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models1.AgentEventHandlerObject] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.AgentEventHandlerObject, response.json())
    ...
    def list_agent_event_handlers(
    ...
    ) -> ItemPaged["_models1.AgentEventHandlerObject"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.ai.agents.models.AgentEventHandlerObject]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[list[_models1.AgentEventHandlerObject]] = kwargs.pop("cls", None)
        ...
        def extract_data(pipeline_response):
            deserialized = pipeline_response.http_response.json()
            list_of_elem = _deserialize(list[_models1.AgentEventHandlerObject], deserialized.get("data", []))
            if cls:
                list_of_elem = cls(list_of_elem)  # type: ignore
            return None, iter(list_of_elem)
    ...
    @distributed_trace
    def delete_agent_event_handler(
        self, agent_name: str, event_handler_name: str, **kwargs: Any
    ) -> _models1.DeleteAgentEventHandlerResponse:
        ...
        cls: ClsType[_models1.DeleteAgentEventHandlerResponse] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.DeleteAgentEventHandlerResponse, response.json())
    ...
    def start_agent_container(
        ...
        **kwargs: Any
    ) -> _models1.AgentContainerOperationObject:
    ...
    def start_agent_container(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models1.AgentContainerOperationObject] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.AgentContainerOperationObject, response.json())
    ...
    @distributed_trace
    def get_agent_container(self, agent_name: str, agent_version: str, **kwargs: Any) -> _models1.AgentContainerObject:
        ...
        cls: ClsType[_models1.AgentContainerObject] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.AgentContainerObject, response.json())
    ...
    @distributed_trace
    def get_agent_container_operation(
    ...
    @distributed_trace
    def list_agent_container_operations(
        self,
        agent_name: str,
        *,
        limit: Optional[int] = None,
        ...
        before: Optional[str] = None,
        **kwargs: Any
    ) -> _models1.AgentsPagedResultAgentContainerOperationObject:
        ...
        cls: ClsType[_models1.AgentsPagedResultAgentContainerOperationObject] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models1.AgentsPagedResultAgentContainerOperationObject, response.json())
    ...
    @distributed_trace
    def list_agent_version_container_operations(
        self,
        agent_name: str,
        agent_version: str,
        *,
