...
from .operations import ConversationsOperations, ResponsesOperations, _AgentsClientOperationsMixin

if TYPE_CHECKING:
    from azure.core.credentials_async import AsyncTokenCredential


class AgentsClient(_AgentsClientOperationsMixin):
    """AgentsClient.

    :ivar conversations: ConversationsOperations operations
    :vartype conversations: azure.ai.agents.aio.operations.ConversationsOperations
    :ivar responses: ResponsesOperations operations
    :vartype responses: azure.ai.agents.aio.operations.ResponsesOperations
