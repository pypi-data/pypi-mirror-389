...
class GetProjectInfoFieldsResult(APIModel):
    fields: Annotated[List[FieldModel], Field(description="A list of project info fields.")]
...
class CreateColumnsParameters(APIModel):
    columnsData: Annotated[List[ColumnsDatum], Field(description="Array of data to create Columns.")]


class CreateSlabsParameters(APIModel):
    slabsData: Annotated[List[SlabsDatum], Field(description="Array of data to create Slabs.")]


class CreatePolylinesParameters(APIModel):
    polylinesData: Annotated[List[PolylinesDatum], Field(description="Array of data to create Polylines.")]


class CreateObjectsParameters(APIModel):
    objectsData: Annotated[List[ObjectsDatum], Field(description="Array of data to create Objects.")]


class CreateMeshesParameters(APIModel):
    meshesData: Annotated[List[MeshesDatum], Field(description="Array of data to create Meshes.")]
...
class CreateZonesParameters(APIModel):
    zonesData: Annotated[List[ZonesDatum], Field(description="Array of data to create Zones.")]
