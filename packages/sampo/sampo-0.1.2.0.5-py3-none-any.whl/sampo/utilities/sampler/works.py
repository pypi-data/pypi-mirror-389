...
def get_work_unit(rand: random.Random,
    ...
    return WorkUnit(work_id, model_name, worker_reqs=reqs, volume=volume, group=group)
...
def get_similar_work_unit(rand: random.Random,
    ...
    work_id = work_id or uuid_str(rand)
    model_name = model_name or exemplar.model_name
    return WorkUnit(work_id, model_name, worker_reqs=reqs, group=exemplar.group,
