...
def enhance_account_with_tags(
    ...
    try:
        ...
        tier_order = [
            ...
            'WBS', 'CostGroup', 'TechnicalLead', 'AccountOwner',
            # TIER 2 - Governance Metadata
            'BusinessUnit', 'FunctionalArea', 'ManagedBy', 'ProductOwner',
            # TIER 3 - Operational Metadata
            'Purpose', 'Environment', 'ComplianceScope', 'DataClassification',
            # TIER 4 - Extended Metadata (optional)
            'ProjectName', 'BudgetCode', 'SupportTier', 'CreatedDate', 'ExpiryDate'
        ]
