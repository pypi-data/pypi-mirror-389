...
DEFAULT_PROFILES = {
    ...
    "AWS_CENTRALISED_OPS_PROFILE": "ams-centralised-ops-ReadOnlyAccess-335083429030",
}
...
def get_profile_for_service(service_name: str, override_profile: Optional[str] = None) -> str:
    ...
    Examples:
        ...
        'ams-admin-ReadOnlyAccess-909135376185'  # from AWS_MANAGEMENT_PROFILE

        >>> get_profile_for_service("cost-explorer")
        'ams-admin-Billing-ReadOnlyAccess-909135376185'  # from AWS_BILLING_PROFILE

        >>> get_profile_for_service("cloudwatch")
        'ams-centralised-ops-ReadOnlyAccess-335083429030'  # from AWS_CENTRALISED_OPS_PROFILE
