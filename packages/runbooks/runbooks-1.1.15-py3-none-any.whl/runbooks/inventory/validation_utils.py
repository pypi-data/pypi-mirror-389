...
def validate_organizations_enabled(profile: str, region: str = "ap-southeast-2") -> Tuple[bool, str, Dict]:
    """
...
def validate_iam_role_exists(profile: str, role_name: str, region: str = "ap-southeast-2") -> Tuple[bool, str, Dict]:
    """
...
def validate_cloudtrail_enabled(profile: str, region: str = "ap-southeast-2") -> Tuple[bool, str, Dict]:
    """
...
def validate_config_enabled(profile: str, region: str = "ap-southeast-2") -> Tuple[bool, str, Dict]:
    """
