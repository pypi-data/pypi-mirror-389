...
class FirewallRemediationPlanner:
    ...
    def generate_remediation_plan(
        ...
        vpcs_needing_remediation = [
            vpc for vpc in vpcs
            if vpc.inspection_status == InspectionStatus.NONE
        ]
...
aws logs delete-log-group \\
  ...
  --region {vpc.region}"""
    ...
    def validate_remediation_safety_for_tgw(
        self,
        vpc: VPCInspectionRecord
    ) -> List[str]:
        """
    ...
    def validate_remediation_safety_for_routes(
        self,
        vpc: VPCInspectionRecord
    ) -> List[str]:
        """
    ...
    def _create_priority_sheet(self, wb: Workbook, priority: VPCRemediationPriority) -> None:
        ...
        # Headers
        headers = [
            "VPC ID", "Account", "Region", "Action Type", "Description",
            "AWS CLI Command", "Cost Impact", "Risk Level"
        ]
...
if __name__ == "__main__":
    ...
    planner = FirewallRemediationPlanner(
        central_tgw_id=tgw_id,
        firewall_vpc_id=firewall_vpc_id
    )
