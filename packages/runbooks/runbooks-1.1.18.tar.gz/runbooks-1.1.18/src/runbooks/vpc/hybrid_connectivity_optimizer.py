...
class HybridConnectivityOptimizer:
    ...
    def __init__(self, region: str = "ap-southeast-2", profile: Optional[str] = None, console: Optional[Console] = None):
        """
...
if __name__ == "__main__":
    ...
    vpn_savings = optimizer.calculate_vpn_savings(current_vpn_count=len(vpn_analysis), target_vpn_count=len(vpn_analysis) - len(consolidation_candidates))
