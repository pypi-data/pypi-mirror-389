...
class ResourceExplorerCollector(CloudFoundationsBase):
    ...
    RESOURCE_TYPE_MAP = {
        # Compute
        'ec2': {'type': 'ec2:instance', 'category': 'compute', 'service': 'Amazon EC2', 'description': 'Virtual servers for compute workloads'},
        'ec2-instance': {'type': 'ec2:instance', 'category': 'compute', 'service': 'Amazon EC2', 'description': 'Virtual servers for compute workloads'},
        'instance': {'type': 'ec2:instance', 'category': 'compute', 'service': 'Amazon EC2', 'description': 'Virtual servers for compute workloads'},
        'lambda': {'type': 'lambda:function', 'category': 'compute', 'service': 'AWS Lambda', 'description': 'Serverless compute for event-driven code execution'},
        'lambda-function': {'type': 'lambda:function', 'category': 'compute', 'service': 'AWS Lambda', 'description': 'Serverless compute for event-driven code execution'},
        'workspaces': {'type': 'workspaces:workspace', 'category': 'compute', 'service': 'Amazon WorkSpaces', 'description': 'Cloud-based virtual desktop infrastructure (VDI)'},
        'workspace': {'type': 'workspaces:workspace', 'category': 'compute', 'service': 'Amazon WorkSpaces', 'description': 'Cloud-based virtual desktop infrastructure (VDI)'},
        'ecs': {'type': 'ecs:cluster', 'category': 'compute', 'service': 'Amazon ECS', 'description': 'Container orchestration for Docker workloads'},
        'ecs-cluster': {'type': 'ecs:cluster', 'category': 'compute', 'service': 'Amazon ECS', 'description': 'Container orchestration for Docker workloads'},
        'ecs-service': {'type': 'ecs:service', 'category': 'compute', 'service': 'Amazon ECS', 'description': 'Managed container service deployment units'},

        # Storage
        's3': {'type': 's3:bucket', 'category': 'storage', 'service': 'Amazon S3', 'description': 'Object storage for data backup and archival'},
        's3-bucket': {'type': 's3:bucket', 'category': 'storage', 'service': 'Amazon S3', 'description': 'Object storage for data backup and archival'},
        'bucket': {'type': 's3:bucket', 'category': 'storage', 'service': 'Amazon S3', 'description': 'Object storage for data backup and archival'},
        'ec2-volume': {'type': 'ec2:volume', 'category': 'storage', 'service': 'Amazon EBS', 'description': 'Block storage volumes for EC2 instances'},
        'volume': {'type': 'ec2:volume', 'category': 'storage', 'service': 'Amazon EBS', 'description': 'Block storage volumes for EC2 instances'},
        'volumes': {'type': 'ec2:volume', 'category': 'storage', 'service': 'Amazon EBS', 'description': 'Block storage volumes for EC2 instances'},
        'ebs': {'type': 'ec2:volume', 'category': 'storage', 'service': 'Amazon EBS', 'description': 'Block storage volumes for EC2 instances'},
        'ec2-snapshot': {'type': 'ec2:snapshot', 'category': 'storage', 'service': 'Amazon EBS', 'description': 'Point-in-time backups of EBS volumes'},
        'snapshot': {'type': 'ec2:snapshot', 'category': 'storage', 'service': 'Amazon EBS', 'description': 'Point-in-time backups of EBS volumes'},
        'snapshots': {'type': 'ec2:snapshot', 'category': 'storage', 'service': 'Amazon EBS', 'description': 'Point-in-time backups of EBS volumes'},
        'ec2-ami': {'type': 'ec2:image', 'category': 'storage', 'service': 'Amazon EC2', 'description': 'Machine images for EC2 instance templates'},
        'ami': {'type': 'ec2:image', 'category': 'storage', 'service': 'Amazon EC2', 'description': 'Machine images for EC2 instance templates'},
        'image': {'type': 'ec2:image', 'category': 'storage', 'service': 'Amazon EC2', 'description': 'Machine images for EC2 instance templates'},
        'efs': {'type': 'elasticfilesystem:file-system', 'category': 'storage', 'service': 'Amazon EFS', 'description': 'Scalable file storage for EC2 instances'},
        'efs-filesystem': {'type': 'elasticfilesystem:file-system', 'category': 'storage', 'service': 'Amazon EFS', 'description': 'Scalable file storage for EC2 instances'},

        # Databases
        'rds': {'type': 'rds:db', 'category': 'databases', 'service': 'Amazon RDS', 'description': 'Managed relational database instances'},
        'rds-instance': {'type': 'rds:db', 'category': 'databases', 'service': 'Amazon RDS', 'description': 'Managed relational database instances'},
        'rds-db': {'type': 'rds:db', 'category': 'databases', 'service': 'Amazon RDS', 'description': 'Managed relational database instances'},
        'rds-cluster': {'type': 'rds:cluster', 'category': 'databases', 'service': 'Amazon RDS', 'description': 'Aurora database cluster deployments'},
        'dynamodb': {'type': 'dynamodb:table', 'category': 'databases', 'service': 'Amazon DynamoDB', 'description': 'NoSQL database tables for key-value storage'},
        'dynamodb-table': {'type': 'dynamodb:table', 'category': 'databases', 'service': 'Amazon DynamoDB', 'description': 'NoSQL database tables for key-value storage'},

        # Networking
        'vpc': {'type': 'ec2:vpc', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Virtual private cloud network isolation'},
        'vpcs': {'type': 'ec2:vpc', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Virtual private cloud network isolation'},
        'subnet': {'type': 'ec2:subnet', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Network segments within VPC for resource placement'},
        'subnets': {'type': 'ec2:subnet', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Network segments within VPC for resource placement'},
        'vpc-endpoint': {'type': 'ec2:vpc-endpoint', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Private connections to AWS services without internet'},
        'vpce': {'type': 'ec2:vpc-endpoint', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Private connections to AWS services without internet'},
        'vpc-endpoints': {'type': 'ec2:vpc-endpoint', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Private connections to AWS services without internet'},
        'nat-gateway': {'type': 'ec2:natgateway', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Network address translation for private subnet internet'},
        'nat': {'type': 'ec2:natgateway', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Network address translation for private subnet internet'},
        'natgateway': {'type': 'ec2:natgateway', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Network address translation for private subnet internet'},
        'internet-gateway': {'type': 'ec2:internet-gateway', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Public internet connectivity for VPC resources'},
        'igw': {'type': 'ec2:internet-gateway', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Public internet connectivity for VPC resources'},
        'eni': {'type': 'ec2:network-interface', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Virtual network interface cards for EC2 instances'},
        'network-interface': {'type': 'ec2:network-interface', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Virtual network interface cards for EC2 instances'},
        'elastic-ip': {'type': 'ec2:elastic-ip', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Static public IPv4 addresses'},
        'eip': {'type': 'ec2:elastic-ip', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Static public IPv4 addresses'},
        'security-group': {'type': 'ec2:security-group', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Virtual firewall rules for resource access control'},
        'sg': {'type': 'ec2:security-group', 'category': 'networking', 'service': 'Amazon VPC', 'description': 'Virtual firewall rules for resource access control'},
        'elb': {'type': 'elasticloadbalancing:loadbalancer', 'category': 'networking', 'service': 'Elastic Load Balancing', 'description': 'Traffic distribution across multiple targets'},
        'load-balancer': {'type': 'elasticloadbalancing:loadbalancer', 'category': 'networking', 'service': 'Elastic Load Balancing', 'description': 'Traffic distribution across multiple targets'},
        'loadbalancer': {'type': 'elasticloadbalancing:loadbalancer', 'category': 'networking', 'service': 'Elastic Load Balancing', 'description': 'Traffic distribution across multiple targets'},
        'alb': {'type': 'elasticloadbalancing:loadbalancer/app', 'category': 'networking', 'service': 'Elastic Load Balancing', 'description': 'Application-layer HTTP/HTTPS load balancer'},
        'nlb': {'type': 'elasticloadbalancing:loadbalancer/net', 'category': 'networking', 'service': 'Elastic Load Balancing', 'description': 'Network-layer TCP/UDP load balancer'},
        'api-gateway': {'type': 'apigateway:restapi', 'category': 'networking', 'service': 'Amazon API Gateway', 'description': 'RESTful API endpoints for serverless applications'},
        'apigateway': {'type': 'apigateway:restapi', 'category': 'networking', 'service': 'Amazon API Gateway', 'description': 'RESTful API endpoints for serverless applications'},
        'apigw': {'type': 'apigateway:restapi', 'category': 'networking', 'service': 'Amazon API Gateway', 'description': 'RESTful API endpoints for serverless applications'},

        # Security & Compliance
        'iam': {'type': 'iam:role', 'category': 'security', 'service': 'AWS IAM', 'description': 'Identity and access management roles'},
        'iam-role': {'type': 'iam:role', 'category': 'security', 'service': 'AWS IAM', 'description': 'Identity and access management roles'},
        'role': {'type': 'iam:role', 'category': 'security', 'service': 'AWS IAM', 'description': 'Identity and access management roles'},
        'iam-user': {'type': 'iam:user', 'category': 'security', 'service': 'AWS IAM', 'description': 'Individual user accounts for AWS console access'},
        'user': {'type': 'iam:user', 'category': 'security', 'service': 'AWS IAM', 'description': 'Individual user accounts for AWS console access'},
        'secrets-manager': {'type': 'secretsmanager:secret', 'category': 'security', 'service': 'AWS Secrets Manager', 'description': 'Encrypted storage for database credentials and API keys'},
        'secret': {'type': 'secretsmanager:secret', 'category': 'security', 'service': 'AWS Secrets Manager', 'description': 'Encrypted storage for database credentials and API keys'},
        'kms': {'type': 'kms:key', 'category': 'security', 'service': 'AWS KMS', 'description': 'Encryption keys for data security'},
        'kms-key': {'type': 'kms:key', 'category': 'security', 'service': 'AWS KMS', 'description': 'Encryption keys for data security'},

        # Management & Governance
        'cloudwatch': {'type': 'cloudwatch:alarm', 'category': 'management', 'service': 'Amazon CloudWatch', 'description': 'Monitoring alarms for resource metrics and thresholds'},
        'cloudwatch-alarm': {'type': 'cloudwatch:alarm', 'category': 'management', 'service': 'Amazon CloudWatch', 'description': 'Monitoring alarms for resource metrics and thresholds'},
        'cloudwatch-logs': {'type': 'logs:log-group', 'category': 'management', 'service': 'Amazon CloudWatch Logs', 'description': 'Centralized log aggregation and analysis'},
        'log-group': {'type': 'logs:log-group', 'category': 'management', 'service': 'Amazon CloudWatch Logs', 'description': 'Centralized log aggregation and analysis'},
        'logs': {'type': 'logs:log-group', 'category': 'management', 'service': 'Amazon CloudWatch Logs', 'description': 'Centralized log aggregation and analysis'},
        'cloudformation': {'type': 'cloudformation:stack', 'category': 'management', 'service': 'AWS CloudFormation', 'description': 'Infrastructure as code deployment stacks'},
        'cfn': {'type': 'cloudformation:stack', 'category': 'management', 'service': 'AWS CloudFormation', 'description': 'Infrastructure as code deployment stacks'},
        'cfn-stack': {'type': 'cloudformation:stack', 'category': 'management', 'service': 'AWS CloudFormation', 'description': 'Infrastructure as code deployment stacks'},
        'stack': {'type': 'cloudformation:stack', 'category': 'management', 'service': 'AWS CloudFormation', 'description': 'Infrastructure as code deployment stacks'},

        # Analytics
        'glue': {'type': 'glue:database', 'category': 'analytics', 'service': 'AWS Glue', 'description': 'Serverless ETL and data catalog service'},
        'glue-database': {'type': 'glue:database', 'category': 'analytics', 'service': 'AWS Glue', 'description': 'Serverless ETL and data catalog service'},
        'glue-table': {'type': 'glue:table', 'category': 'analytics', 'service': 'AWS Glue', 'description': 'Data catalog table definitions'},
        'glue-job': {'type': 'glue:job', 'category': 'analytics', 'service': 'AWS Glue', 'description': 'ETL job execution units'},

        # Development Tools
        'sqs': {'type': 'sqs:queue', 'category': 'developer_tools', 'service': 'Amazon SQS', 'description': 'Message queues for asynchronous processing'},
        'sqs-queue': {'type': 'sqs:queue', 'category': 'developer_tools', 'service': 'Amazon SQS', 'description': 'Message queues for asynchronous processing'},
        'queue': {'type': 'sqs:queue', 'category': 'developer_tools', 'service': 'Amazon SQS', 'description': 'Message queues for asynchronous processing'},

        # ML & AI
        'sagemaker': {'type': 'sagemaker:notebook-instance', 'category': 'ml_ai', 'service': 'Amazon SageMaker', 'description': 'Machine learning notebook environments'},
        'sagemaker-notebook': {'type': 'sagemaker:notebook-instance', 'category': 'ml_ai', 'service': 'Amazon SageMaker', 'description': 'Machine learning notebook environments'},
        'sagemaker-endpoint': {'type': 'sagemaker:endpoint', 'category': 'ml_ai', 'service': 'Amazon SageMaker', 'description': 'ML model deployment endpoints'},

        # Migration & Transfer
        'transfer-family': {'type': 'transfer:server', 'category': 'migration', 'service': 'AWS Transfer Family', 'description': 'Managed SFTP/FTPS/FTP file transfer service'},
        'transfer-server': {'type': 'transfer:server', 'category': 'migration', 'service': 'AWS Transfer Family', 'description': 'Managed SFTP/FTPS/FTP file transfer service'},
        'transfer': {'type': 'transfer:server', 'category': 'migration', 'service': 'AWS Transfer Family', 'description': 'Managed SFTP/FTPS/FTP file transfer service'},
    }
    ...
    RESOURCE_CATEGORIES = {
        'compute': [
            'ec2:instance', 'lambda:function', 'workspaces:workspace',
            'ecs:cluster', 'ecs:service'
        ],
        'storage': [
            's3:bucket', 'ec2:volume', 'ec2:snapshot', 'ec2:image',
            'elasticfilesystem:file-system'
        ],
        'databases': [
            'rds:db', 'rds:cluster', 'dynamodb:table'
        ],
        'networking': [
            'ec2:vpc', 'ec2:subnet', 'ec2:vpc-endpoint', 'ec2:natgateway',
            'ec2:internet-gateway', 'ec2:network-interface', 'ec2:elastic-ip',
            'ec2:security-group', 'elasticloadbalancing:loadbalancer',
            'elasticloadbalancing:loadbalancer/app', 'elasticloadbalancing:loadbalancer/net',
            'apigateway:restapi'
        ],
        'security': [
            'iam:role', 'iam:user', 'secretsmanager:secret', 'kms:key'
        ],
        'management': [
            'cloudwatch:alarm', 'logs:log-group', 'cloudformation:stack'
        ],
        'analytics': [
            'glue:database', 'glue:table', 'glue:job'
        ],
        'developer_tools': [
            'sqs:queue'
        ],
        'ml_ai': [
            'sagemaker:notebook-instance', 'sagemaker:endpoint'
        ],
        'migration': [
            'transfer:server'
        ],
    ...
    def __init__(
        ...
        if billing_profile and self.legacy_mode:
            try:
                ...
                # Issue 1B: Silent mode to avoid duplicate profile logging
                resolved_billing = get_profile_for_operation("billing", billing_profile, silent=True)
    ...
    def discover_resources(
        ...
        try:
            ...
            # Step 6: LEGACY MODE: Cost enrichment (deprecated)
            if enrich_costs:
            ...
            if error_code in ['AccessDenied', 'UnauthorizedOperation']:
                ...
                raise ResourceExplorerPermissionError(
                    f"Missing IAM permissions: {error_code} - {error_message}"
                ) from e

            elif error_code == 'ResourceNotFoundException':
                print_error(
                    "❌ Resource Explorer aggregator not configured",
                    f"Region: {self.region}"
                )
                print_info(
                    f"Solution: aws resource-explorer-2 create-index --type AGGREGATOR --region {self.region}"
                )
                raise ResourceExplorerConfigError(
                    f"Resource Explorer aggregator not found in {self.region}"
                ) from e

            elif error_code in ['Throttling', 'RequestLimitExceeded', 'TooManyRequestsException']:
                print_warning(
                    "⚠️  AWS API rate limit exceeded",
                    f"Retry after 60 seconds or reduce query scope"
                )
                ...
                print_error(
                    "❌ AWS API error during resource discovery",
                    f"Error Code: {error_code}"
                )
                print_info(f"Message: {error_message}")
                raise ResourceExplorerConnectionError(
            ...
            if hasattr(e, 'errno') and e.errno == 28:  # ENOSPC - Disk full
                print_error(
                    "❌ Disk full - cannot save output file",
                    f"Free up disk space or specify alternative path"
                )
                print_info(f"Attempted path: {output_file if output_file else 'N/A'}")
            elif isinstance(e, PermissionError):
                print_error(
                    "❌ Permission denied - cannot write output file",
                    f"Check file permissions or use alternative path"
                )
                print_info(f"Attempted path: {output_file if output_file else 'N/A'}")
            else:
            ...
            print_error(
                "❌ Unexpected error during resource discovery",
            ...
            while True:
                try:
                    ...
                    for resource in response.get('Resources', []):
                        ...
                        application = tags.get('application') or tags.get('Application') or tags.get('APPLICATION') or ''
    ...
    def _save_output(self, df: pd.DataFrame, output_file: str) -> None:
        ...
        try:
            ...
            print_warning(
                f"⚠️  Permission denied writing to {output_file}",
                f"Attempting fallback to {fallback_path}"
            )
            ...
            try:
                ...
                raise OSError(
                    f"Failed to save output (primary and fallback): {str(fallback_error)}"
                ) from e
