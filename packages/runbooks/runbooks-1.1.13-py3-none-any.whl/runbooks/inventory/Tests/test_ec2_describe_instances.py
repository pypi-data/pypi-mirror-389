...
class TestScriptFunctions(unittest.TestCase):
    def setUp(self):
        ...
        self.account_mapping = [
            {"AccountNumber": "111122223333", "Region": "ap-southeast-2", "mock_instances_returned": "mock_instances_1"},
            {"AccountNumber": "444455556666", "Region": "us-east-2", "mock_instances_returned": "mock_instances_2"},
            {"AccountNumber": "555566667777", "Region": "ap-southeast-6", "mock_instances_returned": "mock_instances_3"},
        ...
        self.mock_args = ["-p", "mock_profile", "-rs", "ap-southeast-2", "-s", "running", "--time", "-vvv"]
        self.mock_profile_list = ["mock_profile_1", "mock_profile_2"]
        self.mock_region_list = ["ap-southeast-2", "us-east-2"]
	...
	def test_get_credentials(self, mock_get_credentials_for_accounts_in_org, mock_get_profiles, mock_get_regions3):
		...
		self.assertEqual(credentials[0]['Region'], 'ap-southeast-2')
    ...
    def test_find_all_instances(self, mock_find_account_instances2):
        ...
        self.assertEqual(instances[0]["PublicDNSName"], "ec2-1-2-3-4.ap-southeast-2.compute.amazonaws.com")
        ...
        self.assertEqual(instances[0]["Region"], "ap-southeast-2")
