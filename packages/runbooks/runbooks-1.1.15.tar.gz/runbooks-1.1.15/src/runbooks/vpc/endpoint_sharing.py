...
class EndpointSharingService:
    ...
    def create_shared_endpoints(
        self, services: Optional[List[str]] = None, subnet_ids: Optional[List[str]] = None, security_group_id: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
    ...
    def share_with_accounts(self, target_account_ids: List[str], endpoint_arns: Optional[List[str]] = None) -> Dict[str, Any]:
        """
    ...
    def calculate_endpoint_savings(
        self, current_endpoint_count: int, target_endpoint_count: int
    ) -> Dict[str, float]:
        """
...
if __name__ == "__main__":
    ...
    savings = sharer.calculate_endpoint_savings(current_endpoint_count=current_count, target_endpoint_count=target_count)
