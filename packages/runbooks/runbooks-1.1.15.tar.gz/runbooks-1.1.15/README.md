...
# - CENTRALISED_OPS: Single-account resources ✅, Limited multi-account ⚠️
# - TEST_SRE: Workload-specific ✅, NO Organizations access ❌
```

#### Multi-Account Discovery (PROVEN PATTERN)
```bash
