...
def discover_ec2_via_cli(
    ...
    billing_profile: str,
    output_file: str = '/tmp/ec2-mcp-discovered.json'
) -> pd.DataFrame:
    """
    ...
    command = [
        ...
        '--resource-type', 'ec2',
        '--centralised-ops-profile', centralised_ops_profile,
        '--enrich-costs',
...
def discover_workspaces_via_cli(
    centralised_ops_profile: str,
    billing_profile: str,
    output_file: str = '/tmp/workspaces-mcp-discovered.json'
) -> pd.DataFrame:
    """
...
def discover_snapshots_via_cli(
    ...
    output_file: str = '/tmp/snapshots-mcp-discovered.json'
) -> pd.DataFrame:
    """
...
def generate_evidence_package(
    ...
    try:
        ...
        evidence = {
            ...
            'validation_results': {
                'per_account_validation': validation_results.to_dict('records') if validation_results is not None else None,
