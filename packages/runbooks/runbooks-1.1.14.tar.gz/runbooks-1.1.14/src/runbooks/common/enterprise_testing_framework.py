...
class EnterpriseTestingFramework:
    ...
    def two_ways_validate(
        ...
        Example:
            ...
            ...     aws_profile="ams-centralised-ops-ReadOnlyAccess-335083429030"
            ... )
    ...
    def _execute_mode_1_cli(self, cli_command: str) -> Dict[str, Any]:
        ...
        try:
            result = subprocess.run(
                cli_command.split(), capture_output=True, text=True, timeout=120, check=False
            )
...
def three_modes_test(
    module_name: str, cli_command: str, notebook_path: Optional[Path] = None
) -> ThreeModesResult:
    """
    Execute 3-Modes Testing: CLI + Papermill + JupyterLab.
...
if __name__ == "__main__":
    ...
    three_modes_result = three_modes_test(
        module_name="vpc", cli_command="runbooks vpc --help"  # Simple help command for demo
    )
