...
class ResourceExplorerCollector(CloudFoundationsBase):
    ...
    # Resource type mapping for Resource Explorer API
    ...
    def _build_query_string(
        ...
        query_parts = [f"resourcetype:{self.RESOURCE_TYPE_MAPPING[resource_type]}"]
        ...
        with create_progress_bar("Discovering resources") as progress:
            ...
            while True:
                try:
                    ...
                    # Call Resource Explorer API
                    response = self.re_client.search(**query_params)
