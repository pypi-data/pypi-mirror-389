...
class TestScriptFunctions(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_regions = ["ap-southeast-2", "us-west-1"]
    ...
    def test_setup_auth_accounts_and_regions(self, mock_get_regions3, mock_aws_acct):
        ...
        mock_get_regions3.return_value = ["ap-southeast-2", "us-west-1"]
    ...
    def test_collect_cfnstacks(self, mock_find_stacks2):
        ...
        mock_credential_list = [
            {"AccountId": "123456789012", "Region": "ap-southeast-2", "Success": True},
    ...
    def test_display_stacks(self, mock_print, mock_display_results):
        ...
        RegionList = ["ap-southeast-2", "ap-southeast-6"]
        all_stacks = [
            {
                ...
                "StackName": "stack1",
                "StackArn": "arn:aws:cloudformation:ap-southeast-2:111111111111:stack/stack1/abcd1234",
            },
            {
                ...
                "StackName": "stack2",
                "StackArn": "arn:aws:cloudformation:ap-southeast-6:222222222222:stack/stack2/efgh5678",
            },
        ]
    ...
    def test_modify_stacks(self, mock_delete_stack2, mock_input):
        ...
        mock_delete_stack2.assert_any_call(stack_found1, "ap-southeast-2", "stack1")
