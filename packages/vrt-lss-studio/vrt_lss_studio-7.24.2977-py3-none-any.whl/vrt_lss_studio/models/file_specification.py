...
class FileSpecification(BaseModel):
    ...
    File specification.
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="File name.")
    comment: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=10000)]] = Field(description="File comment.")
    folder_key: UUID = Field(description="Key, unique identifier.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileSpecification from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileSpecification from a dict"""
        if obj is None:
            return None
