...
class TableFactMetrics(BaseModel):
    ...
    """ # noqa: E501
    fields_sum: Optional[TableFactFields] = Field(default=None, description="Total values for fields of types int, double, duration. ")
    fields_avg: Optional[TableFactFields] = Field(default=None, description="Average values for fields of types int, double, duration. Only fields that have a value are taken into account to calculate the average. ")
