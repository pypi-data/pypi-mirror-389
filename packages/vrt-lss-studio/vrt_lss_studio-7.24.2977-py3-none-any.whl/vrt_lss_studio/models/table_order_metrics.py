...
class TableOrderMetrics(BaseModel):
    ...
    """ # noqa: E501
    fields_sum: Optional[TableOrderFields] = Field(default=None, description="Total values for fields of types int, double, duration. ")
    fields_avg: Optional[TableOrderFields] = Field(default=None, description="Average values for fields of types int, double, duration. Only fields that have a value are taken into account to calculate the average. ")
