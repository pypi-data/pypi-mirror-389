...
class FileNamePath(BaseModel):
    """
    The path from the root of the virtual file system to the file in the form of folder and file names. 
    """ # noqa: E501
    folder_names: Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=100)]], Field(min_length=0, max_length=10)] = Field(description="List of folder names from the root of the virtual filesystem.")
    file_name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="File name.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["folder_names", "file_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileNamePath from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileNamePath from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "folder_names": obj.get("folder_names"),
