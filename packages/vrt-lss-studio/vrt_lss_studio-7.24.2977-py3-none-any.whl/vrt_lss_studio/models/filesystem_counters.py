...
class FilesystemCounters(BaseModel):
    ...
    """ # noqa: E501
    current: FolderCounters = Field(description="Current number of available folders/files.")
    max: FolderCounters = Field(description="Max number of available folders/files.")
