...
class TableLocationMetrics(BaseModel):
    ...
    """ # noqa: E501
    fields_sum: Optional[TableLocationFields] = Field(default=None, description="Total values for fields of types int, double, duration. ")
    fields_avg: Optional[TableLocationFields] = Field(default=None, description="Average values for fields of types int, double, duration. Only fields that have a value are taken into account to calculate the average. ")
