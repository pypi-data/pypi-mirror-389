...
#define NEURON_DATA_DIR "/tmp/tmpl28yphq3/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpl28yphq3/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-xvmettss/bin/python)"};
