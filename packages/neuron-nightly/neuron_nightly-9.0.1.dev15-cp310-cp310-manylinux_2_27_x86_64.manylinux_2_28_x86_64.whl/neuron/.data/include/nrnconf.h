...
#define NEURON_DATA_DIR "/tmp/tmp3exdba9e/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp3exdba9e/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-7g8legno/bin/python)"};
