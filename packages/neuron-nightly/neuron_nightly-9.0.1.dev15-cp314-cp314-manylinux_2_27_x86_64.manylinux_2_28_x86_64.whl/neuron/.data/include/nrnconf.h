...
#define NEURON_DATA_DIR "/tmp/tmpajkzbfdd/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpajkzbfdd/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-xtavv4do/bin/python)"};
