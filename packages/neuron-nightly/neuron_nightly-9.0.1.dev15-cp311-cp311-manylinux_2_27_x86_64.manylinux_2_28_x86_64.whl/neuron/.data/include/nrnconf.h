...
#define NEURON_DATA_DIR "/tmp/tmpj9kq4rjv/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpj9kq4rjv/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-uwdri7nh/bin/python)"};
