...
#define NEURON_DATA_DIR "/tmp/tmpqc4z7375/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpqc4z7375/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-f1kvmt6w/bin/python)"};
