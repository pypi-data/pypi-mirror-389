...
#define NEURON_DATA_DIR "/tmp/tmpcmbhpxyi/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpcmbhpxyi/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-y6u2bpxi/bin/python)"};
