...
#define NEURON_DATA_DIR "/tmp/tmpskxkgu3s/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpskxkgu3s/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-zsgr_t0c/bin/python)"};
