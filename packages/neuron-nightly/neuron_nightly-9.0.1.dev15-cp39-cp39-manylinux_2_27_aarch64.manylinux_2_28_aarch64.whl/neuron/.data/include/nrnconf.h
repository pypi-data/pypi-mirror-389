...
#define NEURON_DATA_DIR "/tmp/tmp79ndcmlq/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp79ndcmlq/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-wrkomh14/bin/python)"};
