...
#define NEURON_DATA_DIR "/tmp/tmpxhqx_qcb/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpxhqx_qcb/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-epd4zxv8/bin/python)"};
