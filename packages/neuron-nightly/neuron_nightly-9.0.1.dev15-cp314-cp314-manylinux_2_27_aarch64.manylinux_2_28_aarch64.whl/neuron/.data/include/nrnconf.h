...
#define NEURON_DATA_DIR "/tmp/tmpedyivorx/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpedyivorx/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-vo5bg_gi/bin/python)"};
