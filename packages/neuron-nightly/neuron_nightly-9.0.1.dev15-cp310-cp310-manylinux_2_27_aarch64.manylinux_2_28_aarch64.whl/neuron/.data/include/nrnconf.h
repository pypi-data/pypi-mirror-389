...
#define NEURON_DATA_DIR "/tmp/tmpjkrc7ma1/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpjkrc7ma1/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-_aov9j5_/bin/python)"};
