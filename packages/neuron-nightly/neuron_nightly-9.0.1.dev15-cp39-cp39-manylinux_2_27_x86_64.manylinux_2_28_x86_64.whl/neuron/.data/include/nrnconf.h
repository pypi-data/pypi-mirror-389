...
#define NEURON_DATA_DIR "/tmp/tmpb4g4ox_w/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpb4g4ox_w/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/tmp/build-env-7fn26eft/bin/python)"};
