...
class QueryV1alpha1Spec(BaseModel):
    ...
    selector: Optional[QueryV1alpha1SpecSelector] = None
    ...
    __properties: ClassVar[List[str]] = ["cancel", "input", "memory", "parameters", "selector", "serviceAccount", "sessionId", "targets", "timeout", "ttl", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selector": QueryV1alpha1SpecSelector.from_dict(obj["selector"]) if obj.get("selector") is not None else None,
