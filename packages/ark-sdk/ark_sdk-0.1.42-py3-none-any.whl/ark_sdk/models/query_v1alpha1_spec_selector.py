...
class QueryV1alpha1SpecSelector(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryV1alpha1SpecSelector from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryV1alpha1SpecSelector from a dict"""
        if obj is None:
            return None
