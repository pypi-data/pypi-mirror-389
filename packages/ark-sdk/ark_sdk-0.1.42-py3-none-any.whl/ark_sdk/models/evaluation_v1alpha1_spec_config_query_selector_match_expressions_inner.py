...
class EvaluationV1alpha1SpecConfigQuerySelectorMatchExpressionsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EvaluationV1alpha1SpecConfigQuerySelectorMatchExpressionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EvaluationV1alpha1SpecConfigQuerySelectorMatchExpressionsInner from a dict"""
        if obj is None:
            return None
