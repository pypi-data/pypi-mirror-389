...
class EvaluationV1alpha1SpecConfigQuerySelector(BaseModel):
    """
    Query selector for dynamic evaluation creation (requires template)
    """ # noqa: E501
    match_expressions: Optional[List[EvaluationV1alpha1SpecConfigQuerySelectorMatchExpressionsInner]] = Field(default=None, description="Field selector expressions", alias="matchExpressions")
    match_labels: Optional[Dict[str, Any]] = Field(default=None, description="Label selector", alias="matchLabels")
