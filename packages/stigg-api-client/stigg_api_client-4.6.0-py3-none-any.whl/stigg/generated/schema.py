...
class SubscriptionQueryFilter(sgqlc.types.Input):
    __schema__ = schema
    __field_names__ = ('and_', 'billing_id', 'cancellation_date', 'created_at', 'customer', 'customer_id', 'end_date', 'environment_id', 'or_', 'payment_collection', 'pricing_type', 'product_id', 'resource_id', 'salesforce_id', 'start_date', 'status', 'subscription_id')
