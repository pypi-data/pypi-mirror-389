...
from nectargraphenebase.base58 import (
    Base58,
    base58CheckDecode,
    base58CheckEncode,
    base58decode,
...
class Testcases(unittest.TestCase):
    def test_base58decode(self):
        self.assertEqual(
            [
                base58decode("5HueCGU8rMjxEXxiPuD5BDku4MkFqeZyd4dZ1jvhTVqvbTLvyTJ"),
    ...
    def test_base58CheckEncodeDecopde(self):
        self.assertEqual(
            ...
            [
                ...
                base58CheckDecode(
                    base58CheckEncode(
                        0x80, "021c7359cd885c0e319924d97e3980206ad64387aff54908241125b3a88b55ca16"
                    )
                ),
                base58CheckDecode(
                    base58CheckEncode(
                ...
                base58CheckDecode(
                    base58CheckEncode(
                        0x80, "03e7595c3e6b58f907bee951dc29796f3757307e700ecf3d09307a0cc4a564eba3"
                    )
                ),
            ],
        )
