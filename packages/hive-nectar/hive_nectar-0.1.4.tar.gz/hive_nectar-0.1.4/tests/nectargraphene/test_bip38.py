...
from nectargraphenebase.bip38 import decrypt, encrypt
    ...
    def test_encrypt(self):
        self.assertEqual(
            [
                ...
                format(
                    encrypt(
                        PrivateKey("5HtasZ6ofTHP6HCwTqTkLDuLQisYPah7aUnSKfC7h4hMUVw2gi5"), "Satoshi"
                    ),
                    "encwif",
                ),
            ],
    ...
    def test_deencrypt(self):
        self.assertEqual(
            [
                ...
                format(
                    decrypt(
                        "6PRNFFkZc2NZ6dJqFfhRoFNMR9Lnyj7dYGrzdgXXVMXcxoKTePPX1dWByq", "Satoshi"
                    ),
                    "wif",
                ),
            ],
