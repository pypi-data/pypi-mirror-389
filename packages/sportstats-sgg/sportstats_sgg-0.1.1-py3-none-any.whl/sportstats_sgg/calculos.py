...
def filtrar_tiempos_rapidos(tiempos, limite):
    """
    Filtra una lista de tiempos por debajo de un límite usando list comprehension.
    """
    return [t for t in tiempos if t < limite]