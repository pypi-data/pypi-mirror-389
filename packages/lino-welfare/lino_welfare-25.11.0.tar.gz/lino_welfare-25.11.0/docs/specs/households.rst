...
>>> html = check(uri, 'humanlinks.LinksByHuman1')
...
javascript:Lino.contacts.Persons.detail.run(null,{ "base_params": { "mk": 141,
"mt": 8 }, "record_id": 139 })
...
Create relationship as `Father <…>`__/`Son <…>`__ `Adoptive father <…>`__/`Adopted son <…>`__ `Foster father <…>`__/`Foster son <…>`__ `Husband <…>`__ `Partner <…>`__ `Stepfather <…>`__/`Stepson <…>`__ `Brother <…>`__ `Cousin <…>`__ `Uncle <…>`__/`Nephew <…>`__ `Relative <…>`__ `Other <…>`__
...
>>> cli = pcsw.Client.objects.get(pk=82)
>>> cli
Client #82 ('JEANÉMART Jérôme (82)')
...
>>> print(d['data']['households.MembersByPerson2'])
... #doctest: +ELLIPSIS +NORMALIZE_WHITESPACE
<div class="htmlText">JEANÉMART Jérôme (82) ist<ul><li>...einen neuen erstellen</a>.</div>


<div>JEAN&#201;MART J&#233;r&#244;me (82) ist<ul><li><a ...href="javascript:Lino.households.Members.set_primary(...)...</div>
...
>>> soup = BeautifulSoup(d['data']['households.MembersByPerson2'], 'lxml')

>>> print(soup.get_text(' ', strip=True))
... #doctest: +NORMALIZE_WHITESPACE +REPORT_CDIFF
JEANÉMART Jérôme (82) ist
...
"base_params": { "mk": 82, "mt": 59 }, "param_values": { "aged_from": null,
"aged_to": null, "end_date": null, "gender": null, "genderHidden": null,
"start_date": null }, "record_id": 138 })
...
>>> soup = get_json_soup('rolf', url, 'households.MembersByPerson2',
...
VANDENMEULENBOS Marie-Louise (75) : 2 Erwachsene
LAHM Lisa (77) : 2 Erwachsene
DUBOIS Robin (80) : 2 Erwachsene
DENON Denis (81*) : 1 Erwachsener und 1 Kind
JEANÉMART Jérôme (82) : 2 Erwachsene
KASENNOVA Tatjana (114) : 1 Erwachsener und 1 Kind
FRISCH Paul (141) : 2 Erwachsene und 3 Kinder
BRAUN Bruno (160) : BRAUN Bruno (160) ist in mehreren Haushalten zugleich
...
>>> person = contacts.Person.objects.get(pk=160)
