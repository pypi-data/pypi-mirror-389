...
- **Person** (general):
  ...
  - (general_2) [visible for 100 110 120 130 200 210 220 300 400 410 420 430 500 510 800 admin 910]:
    ...
    - **Termin machen mit** (reception.AgentsByClient1)
- **Beziehungen** (contact):
  - (contact_1): **Ähnliche Klienten** (dupable_clients.SimilarClients1) [visible for 100 110 120 130 200 210 220 300 400 410 420 430 500 510 800 admin 910], **Beziehungen** (humanlinks.LinksByHuman2) [visible for 100 110 120 130 200 210 300 400 410 420 430 500 510 800 admin 910], **ZDSS** (cbss_relations)
  - (contact_2) [visible for 100 110 120 130 200 210 300 400 410 420 430 500 510 800 admin 910]:
    - **Mitgliedschaft in Haushalten** (households.MembersByPerson2)
...
- **Arbeitssuche** (work_tab_1):
  ...
  - (papers):
    ...
    - **Upload-Dateien** (uploads.UploadsByProject1) [visible for 100 110 120 130 200 210 300 400 410 420 430 500 510 800 admin 910]
...
- **Sprachen** (languages) [visible for 100 110 120 130 200 300 400 410 420 430 admin 910]:
  - **Sprachkenntnisse** (cv.LanguageKnowledgesByPerson1) [visible for 100 110 120 130 420 admin 910]
...
- **Historie** (history) [visible for 100 110 120 130 200 210 300 400 410 420 430 500 510 800 admin 910]: **Ereignisse/Notizen** (notes.NotesByProject1), **Bestehende Auszüge** (excerpts.ExcerptsByProject1)
...
- **Bewegungen** (accounting.MovementsByProject1) [visible for 500 510 admin 910]
- **Sonstiges** (misc) [visible for 110 120 130 210 410 420 430 800 admin 910]:
  ...
  - (misc_5) [visible for 100 110 120 130 200 210 220 300 400 410 420 430 500 510 800 admin 910]: **Datenproblemmeldungen** (checkdata.MessagesByOwner1) [visible for 100 110 120 130 200 300 400 410 420 430 admin 910], **Kontaktperson für** (contacts.RolesByPerson2)
