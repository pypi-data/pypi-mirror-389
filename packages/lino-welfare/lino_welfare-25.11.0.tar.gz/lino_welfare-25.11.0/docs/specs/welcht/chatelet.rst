...
+=========================+=====================================+=====================================+==================================+
| Romain Raffault         | `Permis de séjour                   | Upload entry uploads/2014/05/reside | uploads.UploadChecker            |
|                         | residence_permit.pdf <…>`__         | nce_permit.pdf has no file          |                                  |
+-------------------------+-------------------------------------+-------------------------------------+----------------------------------+
| Romain Raffault         | `Ascension (29.05.2014) <…>`__      | Event conflicts with 4 other        | cal.ConflictingEventsChecker     |
|                         |                                     | events.                             |                                  |
+-------------------------+-------------------------------------+-------------------------------------+----------------------------------+
| Romain Raffault         | `Pentecôte (09.06.2014) <…>`__      | Event conflicts with 3 other        | cal.ConflictingEventsChecker     |
|                         |                                     | events.                             |                                  |
+-------------------------+-------------------------------------+-------------------------------------+----------------------------------+
| Romain Raffault         | `Internal meetings with client      | Event conflicts with Pentecôte      | cal.ConflictingEventsChecker     |
|                         | (09.06.2014 09:00) <…>`__           | (09.06.2014).                       |                                  |
+-------------------------+-------------------------------------+-------------------------------------+----------------------------------+
| Alicia Allmanns         | `Consultation (29.05.2014 08:30)    | Event conflicts with Ascension      | cal.ConflictingEventsChecker     |
|                         | avec JANSEN Jérémy (37) <…>`__      | (29.05.2014).                       |                                  |
+-------------------------+-------------------------------------+-------------------------------------+----------------------------------+
| Alicia Allmanns         | `Petit-déjeuner (09.06.2014 09:40)  | Event conflicts with Pentecôte      | cal.ConflictingEventsChecker     |
|                         | avec LAMBERTZ Guido (43) <…>`__     | (09.06.2014).                       |                                  |
+-------------------------+-------------------------------------+-------------------------------------+----------------------------------+
| Hubert Huppertz         | `Réunion (09.06.2014 10:20) avec    | Event conflicts with Pentecôte      | cal.ConflictingEventsChecker     |
|                         | LASCHET Laura (44) <…>`__           | (09.06.2014).                       |                                  |
+-------------------------+-------------------------------------+-------------------------------------+----------------------------------+
| Patrick Paraneau        | `Absent for private reasons         | Event conflicts with Ascension      | cal.ConflictingEventsChecker     |
|                         | (29.05.2014) <…>`__                 | (29.05.2014).                       |                                  |
+-------------------------+-------------------------------------+-------------------------------------+----------------------------------+
| Caroline Carnol         | `FAYMONVILLE Luc (31*) <…>`__       | Both coached and obsolete.          | coachings.ClientCoachingsChecker |
+-------------------------+-------------------------------------+-------------------------------------+----------------------------------+
| Caroline Carnol         | `DENON Denis (81*) <…>`__           | Both coached and obsolete.          | coachings.ClientCoachingsChecker |
+-------------------------+-------------------------------------+-------------------------------------+----------------------------------+
<BLANKLINE>
...
63 plugins: lino, printing, system, about, jinja, extjs, help, office, xl, countries, contacts, appypod, humanize, users, contenttypes, gfks, memo, linod, notify, changes, checkdata, addresses, excerpts, uploads, outbox, extensible, cal, reception, calview, badges, boards, clients, coachings, pcsw, welfare, languages, cv, integ, isip, jobs, art60, art61, immersion, active_job_search, courses, newcomers, cbss, households, humanlinks, debts, notes, aids, polls, summaries, weasyprint, esf, beid, dashboard, export_excel, tinymce, lino_welcht, staticfiles, sessions.
140 models:
============================== =============================== ========= =======
...
------------------------------ ------------------------------- --------- -------
 ...
 checkdata.Message              checkdata.Messages              6         10
 ...
 languages.Language             languages.Languages             6         6
 ...
 polls.AnswerChoice             polls.AnswerChoices             5         88
 polls.AnswerRemark             polls.AnswerRemarks             4         0
 polls.Choice                   polls.Choices                   7         39
 polls.ChoiceSet                polls.ChoiceSets                6         9
 ...
 uploads.Upload                 uploads.Uploads                 20        9
...
- art60.Contracts.detail : id, client, user, user_asd, language, type, printed, applies_from, duration, applies_until, exam_policy, remark, date_decided, date_issued, date_ended, ending, art60.ConventionsByContract1
- art60.Contracts.insert : client, type, user_asd
- art60.Conventions.detail : id, contract, job, company, contact_person, contact_role, start_date, reference_person, regime, schedule, monthly_refund, responsibilities, uploads.UploadsByController1
...
- contacts.Companies.detail : overview, prefix, name, type, vat_id, url, client_contact_type, job_provider, email, phone, gsm, fax, contacts.RolesByCompany1, remarks, notes.NotesByCompany1, id, language, activity, is_obsolete, created, modified
...
- contacts.Persons.detail : overview, title, first_name, middle_name, last_name, gender, birth_date, age, id, language, email, phone, gsm, fax, contacts.RolesByPerson1, households.MembersByPerson1, humanlinks.LinksByHuman1, remarks, activity, url, client_contact_type, is_obsolete, created, modified
...
- isip.Contracts.detail : id, client, type, user, user_asd, study_type, applies_from, applies_until, exam_policy, language, date_decided, date_issued, printed, date_ended, ending, uploads.UploadsByController1
...
- jobs.Employers.detail : overview, prefix, name, type, vat_id, client_contact_type, is_social, url, email, phone, gsm, fax, contacts.RolesByCompany2, uploads.UploadsByController1, notes.NotesByCompany2
- jobs.Employers.merge_row : merge_to, addresses_Address, reason
- jobs.JobProviders.detail : overview, prefix, name, type, vat_id, client_contact_type, is_social, url, email, phone, gsm, fax, contacts.RolesByCompany2, jobs.WorkplacesByProvider1, uploads.UploadsByController1, notes.NotesByCompany2
...
- pcsw.Clients.detail : overview, gender, id, nationality, last_name, first_name, middle_name, birth_date, age, language, email, phone, fax, gsm, image, national_id, civil_state, birth_country, birth_place, declared_name, needs_residence_permit, needs_work_permit, in_belgium_since, residence_type, residence_until, group, aid_type, reception.AgentsByClient1, workflow_buttons, id_document, faculty, households.MembersByPerson2, child_custody, humanlinks.LinksByHuman2, skills, obstacles, is_seeking, unemployed_since, seeking_since, activity, client_state, noble_condition, unavailable_until, unavailable_why, is_obsolete, has_esf, created, modified, remarks, checkdata.MessagesByOwner1, contacts.RolesByPerson2
...
- polls.ChoiceSets.detail : name, name_nl, name_de, name_en, choice_type
...
- polls.Responses.detail : poll, partner, date, workflow_buttons, polls.AnswersByResponseEditor1, user, state, remark, polls.AnswersByResponsePrint1
- polls.Responses.insert : user, date, poll
- polls.Responses.set_answer : choice_id, remark, question, choice_type
...
- uploads.UploadTypes.detail : id, upload_area, shortcut, name, name_nl, name_de, name_en, warn_expiry_unit, warn_expiry_value, wanted, max_number, uploads.UploadsByType1
...
- polls.Responses.set_answer : visible for 100 110 120 130 200 300 400 410 420 430 admin 910
...
- polls.Responses.set_answer : Set answer
  (main) [visible for all]:
  - **choice id** (choice_id)
  - **Remarque** (remark)
  - (main_3): **Question** (question), **Type de contenu** (choice_type)
...
- Bureau --> Mes Fichiers téléchargés : 3
- Bureau --> Mon courrier sortant : 1
- Bureau --> Mes Observations : 11
- Bureau --> Mes messages de problème de données : 4
...
- Configuration --> Parcours --> Langues : 7
...
- Explorateur --> Système --> Tests de données : 16
- Explorateur --> Système --> Messages de problème : 10
- Explorateur --> Bureau --> Extraits : 93
- Explorateur --> Bureau --> Fichiers téléchargés : 10
