...
- **Personne** (general):
  ...
  - (general_4) [visible for 100 110 120 130 200 210 220 300 400 410 420 430 500 510 800 admin 910]:
    ...
    - **Créer rendez-vous avec** (reception.AgentsByClient1)
...
- **Situation familiale** (family) [visible for 100 110 120 130 200 210 300 400 410 420 430 500 510 800 admin 910]:
  - (family_1) [visible for all]:
    - (family_left): **Appartenance aux ménages** (households.MembersByPerson2) [visible for 100 110 120 130 200 210 300 400 410 420 430 500 510 800 admin 910], **Garde d'enfant** (child_custody)
  ...
  - **Liens de parenté** (humanlinks.LinksByHuman2)
...
- **Divers** (misc) [visible for 110 120 410 420 admin 910]:
  ...
  - (misc_4) [visible for 100 110 120 130 200 210 220 300 400 410 420 430 500 510 800 admin 910]: **Messages de problème** (checkdata.MessagesByOwner1) [visible for 100 110 120 130 200 300 400 410 420 430 admin 910], **contact pour** (contacts.RolesByPerson2)
...
>>> obj = pcsw.Client.objects.get(pk=67)
