...
==== ===================== ===================== ===================== ================
 ID   Désignation           Désignation (de)      Désignation (en)      Database model
---- --------------------- --------------------- --------------------- ----------------
 1    Yes/No                Yes/No                Yes/No                Choix
 2    Oui/Peut-être/Non     Oui/Peut-être/Non     Yes/Maybe/No          Choix
 3    That's it!...Never!   That's it!...Never!   That's it!...Never!   Choix
 4    -1..+1                -1..+1                -1..+1                Choix
 5    Acquis                Acquis                Acquired              Choix
 6    1...5                 1...5                 1...5                 Choix
 7    1...10                1...10                1...10                Choix
 8    Agree-Disagree        Agree-Disagree        Agree-Disagree        Choix
 9    Temps de travail                                                  Choix
==== ===================== ===================== ===================== ================
<BLANKLINE>
...
`ⓘ <…>`__ `⏏ <…>`__ | Question `03/03/2014 <…>`__ 02/04/2014 `02/05/2014 <…>`__
<BLANKLINE>
1) Cherchez-vous du travail actuellement? Oui
 `**[Oui]** <…>`__ `Peut-être <…>`__ `Non <…>`__ `(Remarque) <…>`__
 Oui
<BLANKLINE>
...
Temps de travail acceptés 3/4
 `temps-plein <…>`__ `**[3/4]** <…>`__ `1/2 <…>`__ `quelques heures par semaine <…>`__ `(Remarque) <…>`__
 3/4
...
=========================================================== ==========================================================================================================
 Question                                                    Ma réponse
----------------------------------------------------------- ----------------------------------------------------------------------------------------------------------
 1) Cherchez-vous du travail actuellement?                   `**[Oui]** <…>`__ `Peut-être <…>`__ `Non <…>`__ `(Remarque) <…>`__
 2) Avez-vous un CV à jour?                                  `Oui <…>`__ `**[Peut-être]** <…>`__ `Non <…>`__ `(Remarque) <…>`__
 3) Est-ce que vous vous présentez régulièrement au FOREM?   `Oui <…>`__ `Peut-être <…>`__ `**[Non]** <…>`__ `(Remarque) <…>`__
 4) Est-ce que vous consultez les petites annonces?          `**[Oui]** <…>`__ `Peut-être <…>`__ `Non <…>`__ `(Remarque) <…>`__
 5) Demande à l’entourage?                                   `Oui <…>`__ `**[Peut-être]** <…>`__ `Non <…>`__ `(Remarque) <…>`__
 6) Candidature spontanée?                                   `Oui <…>`__ `Peut-être <…>`__ `**[Non]** <…>`__ `(Remarque) <…>`__
 7) Antécédents judiciaires?                                 `**[Oui]** <…>`__ `Peut-être <…>`__ `Non <…>`__ `(Remarque) <…>`__
 Temps de travail acceptés                                   `temps-plein <…>`__ `**[3/4]** <…>`__ `1/2 <…>`__ `quelques heures par semaine <…>`__ `(Remarque) <…>`__
=========================================================== ==========================================================================================================
<BLANKLINE>
