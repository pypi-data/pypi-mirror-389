...
...     print(tostring(msg))
... #doctest: +ELLIPSIS +NORMALIZE_WHITESPACE -REPORT_UDIFF
Your email address (demo@example.com) is not verified, please check your mailbox and <a href="…" title="Ask for the verification code you have received by email and mark your email address as verified.">verify now</a> or <a href="…">re-send our welcome email</a>.
<span>Du bist beschäftigt in <a href="…">Beschwerde (22.05.2014) mit COLLARD Charlotte (19)</a> (<a href="…" title="Stattgefunden">☑</a>). </span>
...
----------------------- ------------------------- ----------- -------------- ---------- ------- ------------------------------
 DA VINCI David (66)     Ausländerbeihilfe                     10.08.14                          [Bestätigen] **Unbestätigt**
 DA VINCI David (66)     Eingliederungseinkommen               10.07.14                          [Bestätigen] **Unbestätigt**
 EMONTS-GAST Erna (53)   Heizkosten                            30.05.14       31.05.14           [Bestätigen] **Unbestätigt**
 DUBOIS Robin (80)       Ausländerbeihilfe                     06.03.14                          [Bestätigen] **Unbestätigt**
 DUBOIS Robin (80)       Eingliederungseinkommen               27.04.13                          [Bestätigen] **Unbestätigt**
 DA VINCI David (66)     Ausländerbeihilfe                     16.03.13                          [Bestätigen] **Unbestätigt**
======================= ========================= =========== ============== ========== ======= ==============================
<BLANKLINE>
...
---- --------------------------- ---------------- ------------ ------------- -----
 4    DOBBELSTEIN Dorothée (25)   Zusammenlebend   456,00       13.10.12
                                                   **456,00**
==== =========================== ================ ============ ============= =====
<BLANKLINE>
...
=================================== ===== ============================================================================================
 Name                                ID    Ansicht als
----------------------------------- ----- --------------------------------------------------------------------------------------------
 Apotheke Schunck                    102   `Organisation <…>`__ [`❌ <…>`__], **Partner**, Person [`➕ <…>`__], Haushalt [`➕ <…>`__]
 Bosten-Bocken A                     104   `Organisation <…>`__ [`❌ <…>`__], **Partner**, Person [`➕ <…>`__], Haushalt [`➕ <…>`__]
 Pharmacies Populaires de Verviers   103   `Organisation <…>`__ [`❌ <…>`__], **Partner**, Person [`➕ <…>`__], Haushalt [`➕ <…>`__]
=================================== ===== ============================================================================================
<BLANKLINE>
...
------------------------- ------------------- -------------- ---------- ----
 `AMK/27.05.14/40 <…>`__   JONAS Josef (40)    27.05.14       26.06.14   45
 `AMK/27.05.14/42 <…>`__   KAIVERS Karl (42)   27.05.14       27.05.14   46
========================= =================== ============== ========== ====
<BLANKLINE>
...
---- ----------------- --------------------- ------------------------------------------------- ------------- ----------
 12   DMH/28.05.14/45   LAZARUS Line (45)     Dringende Medizinische Hilfe                      28.05.14      28.05.15
 11   DMH/28.05.14/45   LAZARUS Line (45)     Dringende Medizinische Hilfe                      28.05.14      28.05.15
 10   DMH/28.05.14/45   LAZARUS Line (45)     Dringende Medizinische Hilfe                      28.05.14      28.05.15
 9    DMH/28.05.14/43   LAMBERTZ Guido (43)   Dringende Medizinische Hilfe                      28.05.14
 8    DMH/28.05.14/43   LAMBERTZ Guido (43)   Dringende Medizinische Hilfe                      28.05.14
 7    DMH/28.05.14/43   LAMBERTZ Guido (43)   Dringende Medizinische Hilfe                      28.05.14
 6    AMK/27.05.14/42   KAIVERS Karl (42)     Übernahme von Arzt- und/oder Medikamentenkosten   27.05.14      27.05.14
 5    AMK/27.05.14/42   KAIVERS Karl (42)     Übernahme von Arzt- und/oder Medikamentenkosten   27.05.14      27.05.14
 4    AMK/27.05.14/42   KAIVERS Karl (42)     Übernahme von Arzt- und/oder Medikamentenkosten   27.05.14      27.05.14
 3    AMK/27.05.14/40   JONAS Josef (40)      Übernahme von Arzt- und/oder Medikamentenkosten   27.05.14      26.06.14
 2    AMK/27.05.14/40   JONAS Josef (40)      Übernahme von Arzt- und/oder Medikamentenkosten   27.05.14      26.06.14
 1    AMK/27.05.14/40   JONAS Josef (40)      Übernahme von Arzt- und/oder Medikamentenkosten   27.05.14      26.06.14
==== ================= ===================== ================================================= ============= ==========
<BLANKLINE>


>>> cn = "id client start_date end_date"
>>> pv = dict(client=pcsw.Client.objects.get(pk=45))
>>> rt.show(aids.RefundConfirmations, column_names=cn, param_values=pv)
==== =================== ============= ==========
 ID   Klient              Periode vom   bis
---- ------------------- ------------- ----------
 12   LAZARUS Line (45)   28.05.14      28.05.15
 11   LAZARUS Line (45)   28.05.14      28.05.15
 10   LAZARUS Line (45)   28.05.14      28.05.15
==== =================== ============= ==========
<BLANKLINE>
...
---- --------------------- ------------- ----------
 ...
 11   LAZARUS Line (45)     28.05.14      28.05.15
 10   LAZARUS Line (45)     28.05.14      28.05.15
 9    LAMBERTZ Guido (43)   28.05.14
 8    LAMBERTZ Guido (43)   28.05.14
 7    LAMBERTZ Guido (43)   28.05.14
==== ===================== ============= ==========
<BLANKLINE>
...
>>> pv = dict(client=pcsw.Client.objects.get(pk=82))
>>> rt.show(aids.IncomeConfirmations, column_names=cn, param_values=pv)
==== ======================= ============= ===== ============ ========
 ID   Klient                  Periode vom   bis   Erwachsene   Kinder
---- ----------------------- ------------- ----- ------------ --------
 51   JEANÉMART Jérôme (82)   20.03.14            2            0
 50   JEANÉMART Jérôme (82)   20.03.14            2            0
 49   JEANÉMART Jérôme (82)   11.05.13            2            0
                                                  **6**        **0**
==== ======================= ============= ===== ============ ========
<BLANKLINE>
...
..
    >>> contenttypes.ContentType.objects.get_for_model(aids.Granting).pk #doctest: +NORMALIZE_WHITESPACE +ELLIPSIS
    137
...
---------------------------- ---------------- ---------------- -------------
 `EiEi/13.10.12/25/4 <…>`__   Judith Jousten   Mélanie Mélard
============================ ================ ================ =============
<BLANKLINE>
...
>>> show_choices('rolf', '/choices/aids/GrantingsByClient/board?decision_date=&mk=21')
<br/>
Sozialhilferat (SHR)
...
Open the detail window (tab panel "Aids") on Client 17.  We know that
...
>>> obj = pcsw.Client.objects.get(id=17)
>>> obj
Client #17 ('AUSDEMWALD Alfons (17)')
>>> rt.login('robin').show(aids.GrantingsByClient, obj, language="en")
========================================= ============== ======= ================= ======================== =================== =============================
 Aid granting                              Applies from   until   Signer            Workflow                 Board               Actions
----------------------------------------- -------------- ------- ----------------- ------------------------ ------------------- -----------------------------
 `EiEi/22/05/2014/17 <…>`__                22/05/2014             Caroline Carnol   [Sign] **Unconfirmed**   Social Board (SB)   `Create confirmation <…>`__
 `Ausländerbeihilfe/08/08/2013/17 <…>`__   08/08/2013             Caroline Carnol   [Sign] **Unconfirmed**                       `Create confirmation <…>`__
 `EiEi/29/09/2012/17 <…>`__                29/09/2012             Caroline Carnol   [Sign] **Unconfirmed**                       `Create confirmation <…>`__
========================================= ============== ======= ================= ======================== =================== =============================
<BLANKLINE>
...
>>> sign = aids.Grantings.get_action_by_name('sign')
>>> revoke = aids.Grantings.get_action_by_name('revoke')
>>> with translation.override('de'):
...     print(sign.help_text)
Sign this granting or confirmation, making most fields read-only.

>>> with translation.override('de'):
...     print(revoke.help_text)
Revoke your signature of this granting or confirmation.
