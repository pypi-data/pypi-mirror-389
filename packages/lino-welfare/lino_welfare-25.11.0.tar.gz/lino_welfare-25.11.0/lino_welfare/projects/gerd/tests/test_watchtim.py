...
class TestCase(TestCase):
    ...
    def test00(self):
        ...
        ar = rt.models.changes.ChangesByMaster.create_request(georges)
        ...
        ar = rt.models.changes.ChangesByMaster.create_request(obj)
        self.assertEqual(ar.get_total_count(), 0)
...
----------- ------------- ------------------------------------------ ----------------------------------------------------------------------------- ------------- -----------
 watch_tim   Create        `alicia / Voldemort-Potter H <…>`__        Coaching(id=2,start_date=1985-07-23,user=2,client=4260,type=2,primary=True)   Coaching      2
 watch_tim   Add child     `Eheleute Harald VOLDEMORT-POTTER <…>`__   pcsw.Client                                                                   Person        4260
 watch_tim   Add child     `Voldemort-Potter Harald <…>`__            contacts.Person                                                               Partner       4260
=========== ============= ========================================== ============================================================================= ============= ===========
...
| Author    | Change Type | Object                           | Changes                                                | Object type  | object id |
+===========+=============+==================================+========================================================+==============+===========+
| watch_tim | Update      | `S.A. Air Liquide Belgium <…>`__ | - activity_id : None --> 19                            | Organization | 5         |
...
=========== ============== ======================= ================== ============= ===========
 Author      Change Type    Object                  Changes            Object type   object id
----------- -------------- ----------------------- ------------------ ------------- -----------
 watch_tim   Add child      `Andenne, CPAS <…>`__   contacts.Company   Partner       9932
