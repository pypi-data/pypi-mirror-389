...
from .mixins import (ContractTypeBase, ContractPartnerBase, ContractBase,
                     ContractBaseTable)
...
class ContractType(ContractTypeBase):
    ...
    needs_study_type = models.BooleanField(_("needs Study type"),
                                           default=False)
...
class ContractEnding(dd.Model):
    ...
    needs_date_ended = models.BooleanField(_("Require date ended"),
                                           default=False)
...
class Contract(ContractBase):
    ...
    type = dd.ForeignKey("isip.ContractType",
    ...
    stages = dd.RichTextField(_("stages"),
                              ...
                              null=True,
                              format='html')
    goals = dd.RichTextField(_("goals"), blank=True, null=True, format='html')
    ...
    duties_dsbe = dd.RichTextField(_("duties DSBE"),
                                   ...
                                   null=True,
                                   format='html')
    duties_pcsw = dd.RichTextField(_("duties PCSW"),
                                   blank=True,
                                   null=True,
                                   format='html')
...
class Contracts(ContractBaseTable):
    ...
    parameters = dict(type=dd.ForeignKey(ContractType, blank=True),
...
class DelegatedTasksByContract(dd.Table):
    ...
    def override_column_headers(self, ar, **headers):
        headers.update(summary=str(_("Proceedings")))
        return headers
...
class EntriesByContract(dd.Table):
    ...
    @classmethod
    def override_column_headers(self, ar, **headers):
        headers.update(start_date=_("Date"))
        return headers
