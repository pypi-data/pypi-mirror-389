...
# TableLayout is potentially useful for similar situations. If needed, move it
# to lino.core choicelists
...
class TableLayout(dd.Choice):
    ...
    def __init__(self, value, verbose_name, columns_spec):
        ...
        super().__init__(value, verbose_name, None)
...
class EntriesLayouts(TableLayouts):
    verbose_name = _("Budget entries layout")
    verbose_name_plural = _("Budget entries layouts")


AMOUNT_WIDTH = ":15"

add = EntriesLayouts.add_item
add(
