...
def album1(driver):
    ...
    app.stabilize()
    app.screenshot(
        'login1.png', "Avant l'identification", """
    ...
    app.screenshot(
        'login2.png', "S'identifier", f"""

    Pour ce tour nous nous connectons avec le nom de "romain" et mot
    de passe "{dd.plugins.users.demo_password}".
    ...
    app.screenshot(
        'menu_contacts.png', "Le menu :menuselection:`Contacts`", """
    ...
    app.screenshot(
        'pcsw.Clients.grid.png', "La liste des bénéficiaires", """
    ...
    app.stabilize()
    app.screenshot(
        'pcsw.Clients.grid.params.png', "Le panneau à paramètres", """
    ...
    app.screenshot(
        'pcsw.Clients.detail.png', "Le détail d'un bénéficiaire", """
    ...
    app.screenshot(
        'pcsw.Clients.detail2.png', "Intervenants d'un bénéficiaire", """
