...
def objects():
    ...
    EntriesLayouts = rt.models.debts.EntriesLayouts
    group = Instantiator('debts.Group').build
    g = group(ref="10",
              account_type=AccountTypes.incomes,
              entries_layout=EntriesLayouts.get_by_value('11'),
    ...
    g = group(ref="20",
              account_type=AccountTypes.incomes,
              entries_layout=EntriesLayouts.get_by_value('30'),
              **dd.babel_values('name',
    ...
    g = group(ref="11",
              ...
              entries_layout=EntriesLayouts.get_by_value('10'),
              **dd.babel_values('name',
    ...
    g = group(ref="70",
              ...
              entries_layout=EntriesLayouts.get_by_value('20'),
              **dd.babel_values('name',
    ...
    g = group(ref="71",
              account_type=AccountTypes.liabilities,
              entries_layout=EntriesLayouts.get_by_value('40'),
              **dd.babel_values('name',
