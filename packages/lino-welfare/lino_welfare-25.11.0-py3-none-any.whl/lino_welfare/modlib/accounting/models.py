...
"""
Database models for :mod:`lino_welfare.modlib.accounting`.
"""
...
add('4450', _("Disbursement orders to execute"), "disbursement_orders", True)
...
from lino_xl.lib.accounting.models import Account
...
from lino_xl.lib.accounting.models import Movement
