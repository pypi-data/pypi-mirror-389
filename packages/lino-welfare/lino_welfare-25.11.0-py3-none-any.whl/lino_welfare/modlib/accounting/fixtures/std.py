...
Also loads :mod:`lino_xl.lib.accounting.fixtures.std`
and :mod:`lino_welfare.modlib.accounting.fixtures.std_journals`
...
def objects():
    ...
    from lino_xl.lib.accounting.fixtures import std
    yield std.objects()
    ...
    from lino_welfare.modlib.accounting.fixtures import std_journals
