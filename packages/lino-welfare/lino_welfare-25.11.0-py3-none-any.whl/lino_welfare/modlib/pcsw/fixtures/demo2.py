...
from lino_xl.lib.contacts.utils import PARTNER_NUMBERS_START_AT
...
def objects():
    ...
    newcomer = Client.objects.get(id=21 + PARTNER_NUMBERS_START_AT)
    coached = Client.objects.get(id=24 + PARTNER_NUMBERS_START_AT)
