...
loader.save(
    create_contacts_companytype(1, [
        'Aktiengesellschaft', 'Soci\xe9t\xe9 Anonyme', 'Public Limited Company'
    ], ['AG', 'SA', '']))
loader.save(
...
loader.save(
    create_contacts_companytype(6, [
        'Gesellschaft \xf6ffentlichen Rechts', 'Soci\xe9t\xe9 de Droit Commun',
        'Non-stock Corporation'
    ], ['', '', '']))
loader.save(
    create_contacts_companytype(7, [
...
loader.save(
    create_contacts_companytype(8, [
        'Genossenschaft', 'Soci\xe9t\xe9 Coop\xe9rative', 'Cooperative Company'
    ], ['', 'SC', '']))
loader.save(
    create_contacts_companytype(9, ['Firma', 'Soci\xe9t\xe9', 'Company'],
                                ['', '', '']))
loader.save(
    create_contacts_companytype(
        10, ['\xd6ffentlicher Dienst', 'Service Public', 'Public service'],
        ['', '', '']))
loader.save(
    create_contacts_companytype(11,
                                ['Ministerium', 'Minist\xe8re', 'Ministry'],
                                ['', '', '']))
loader.save(
    create_contacts_companytype(12, ['Schule', '\xe9cole', 'School'],
                                ['', '', '']))
loader.save(
    create_contacts_companytype(
        13, ['Freier Mitarbeiter', 'Travailleur libre', 'Freelancer'],
        ['', '', '']))
loader.save(
    create_contacts_companytype(14, [
        'Einzelunternehmen', 'Entreprise individuelle', 'Sole proprietorship'
    ], ['', '', '']))
