...
- reduce problems with headless systems and keyrings.
  If the Database credentials are set via environment variables and the keyring doesn'T work, the system will still work and just not store the credentials.
- fix cursor already closed error
