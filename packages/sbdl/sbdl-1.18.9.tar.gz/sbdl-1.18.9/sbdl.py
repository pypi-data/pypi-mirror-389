#!/usr/bin/python3
_Cb='SteeringFirmware::correctCourse'
_Ca='rocket_in_motion'
_CZ='rocket_ready'
_CY='correct_course'
_CX='fire_booster'
_CW='steering_requirement_1'
_CV='booster_requirement_1'
_CU='steering_firmware'
_CT='test/macro.py'
_CS='--custom-mode'
_CR='--custom-directive'
_CQ='template-fill'
_CP='openfmea-csv'
_CO='skinparam linetype ortho\n'
_CN='{} .{}.{} {}{}\n'
_CM='\n{}{} "{}" as {} {}{}'
_CL='Not a file: {}'
_CK='Reading: {}'
...
_CE='customtype'
_CD='arguments'
_CC='skinparam NoteBackgroundColor LightSteelBlue\nskinparam ParticipantBackgroundColor LightGrey\nskinparam backgroundColor transparent'
_CB='multipartite'
_CA='sbdl_unique_identifier_gen_alphabet'
_C9='sbdl_unique_identifier_gen_length'
_C8='profile_output'
_C7='fmea_cause_extension'
_C6='openfmea_bidirectional_import_relations'
_C5='openfmea_include_in_template'
_C4='openfmea_fmeadev_url'
_C3='openfmea_content_based_keys'
_C2='openfmea_include_cme_unlinked'
_C1='openfmea_include_cme_orphans'
_C0='openfmea_expand_compoundfields'
_B_='remote_procedure_call_api_endpoint'
_Bz='remote_procedure_call_api_key'
_By='remote_procedure_call_enable'
_Bx='remote_resouce_fetch_enable'
_Bw='sbdl_disable_pretty_print'
_Bv='sbdl_disable_pretty_print_environ'
_Bu='manual_command'
_Bt='add_description_bsci_property'
_Bs='elision_placeholder'
_Br='reference_maximum_length'
_Bq='usecase_diagram_style'
_Bp='state_diagram_descriptions'
_Bo='state_diagram_style'
_Bn='uml_text_block_wrap_element'
_Bm='process_diagram_descriptions'
_Bl='function_diagram_aspect'
_Bk='function_diagram_descriptions'
_Bj='aspect_diagram_descriptions'
_Bi='aspect_diagram_element'
_Bh='aspect_diagram_aspect'
_Bg='requirement_diagram_legend'
_Bf='requirement_diagram_style'
_Be='requirement_diagram_title_node_always'
_Bd='requirement_diagram_toplevel_depth'
_Bc='requirement_diagram_aspect_groups'
_Bb='network_diagram_hide_types'
_Ba='network_diagram_dpi'
_BZ='network_diagram_layout'
_BY='network_diagram_labels'
_BX='network_diagram_descriptions'
_BW='network_diagram_height'
_BV='network_diagram_width'
_BU='parser_allow_load_config'
_BT='parser_allow_custom_directive_import'
_BS='parser_custom_attributes'
_BR='parser_allow_preparse_directives'
_BQ='plantuml_generate_footer'
_BP='plantuml_output_type'
_BO='plantuml_limit_size'
_BN='plantuml_command'
_BM='wsl_auto_correct_paths'
_BL='sbdl_caching_suffix'
_BK='sbdl_import_allows_recurse'
_BJ='sbdl_warn_new_config'
_BI='sbdl_update_package'
_BH='sbdl_hash_check'
_BG='sbdl_hash_length'
_BF='sbdl_ast_pre_hooks'
_BE='sbdl_attribute_passthrough'
_BD='sbdl_file_extension'
_BC='sbdl_output_reference'
_BB='sbdl_element_color_map'
_BA='sbdl_grammar_write_statement_separator'
_B9='sbdl_grammar_write_attribute_separator'
_B8='sbdl_grammar_custom_comment'
_B7='sbdl_grammar_custom_noop'
_B6='sbdl_grammar_custom_end'
_B5='sbdl_grammar_custom_begin'
_B4='sbdl_grammar_custom_suffix'
_B3='sbdl_grammar_custom_prefix'
_B2='rocket_launch'
_B1='launch_protocol'
_B0='system_requirement_1'
_A_='rocket_steering'
_Az='rocket_system'
_Ay='test/function_test.sbdl'
_Ax='from:yaml-tree'
_Aw='usecase-diagram'
_Av='state-diagram'
_Au='function-process-diagram'
_At='function-diagram'
_As='network-diagram'
_Ar='requirement-diagram'
_Aq='element-diagram'
_Ap='aspect-diagram'
_Ao='from:openfmea'
_An='openfmea-portfolio'
_Am='yaml-tree'
_Al='compile'
_Ak='format'
_Aj='<<{}>>'
...
_Aa='function'
_AZ='ignore'
_AY='**LOCKED_CONFIG_KEYS'
_AX='linux'
_AW='openfmea_compoundfield_separator'
_AV='usecase_diagram_descriptions'
_AU='function_diagram_style'
_AT='aspect_diagram_style'
_AS='network_diagram_node_size'
_AR='parser_allow_global_directive_definition'
_AQ='parser_allow_directive_definition'
_AP='plantuml_ortho_line_routing'
_AO='plantuml_layout_tweaks'
_AN='plantuml_raw_output'
_AM='prolog_trace_file'
_AL='sbdl_caching_dependent_files'
_AK='sbdl_caching_enabled'
_AJ='sbdl_show_stack_trace'
_AI='test/example.cpp'
_AH='test/example.sbdl'
_AG='from:csv-matrix'
_AF='from:json-tree'
_AE='json-tree'
_AD='csv-matrix'
...
_A7='system'
_A6='occurrence_post'
_A5='detectability_post'
_A4='interface'
_A3='parser_allow_directives'
_A2='prolog_result_output'
_A1='sbdl_sort_output_by_identifier'
_A0='sbdl_sort_output_by_type'
_z='action'
_y='@startuml\n{style}\n\n{header}\n{content}\n@enduml\n'
_x='title "{}"\n'
_w='fmea'
...
__LOGO=''
__HELP_TEXT=''
_CONFIG_DATA={_B3:'_sbdl\\s?\\(',_B4:'\\)$',_B5:'_sbdl_block_begin',_B6:'_sbdl_block_end',_B7:'^\\.\\.\\.$',_B8:_B,_B9:_A,_BA:_C,_o:_A,_BB:{},_V:_C,_BC:_A,_BD:'.sbdl',_BE:_O,_BF:[],_j:[],_BG:5,_BH:_A,_BI:'sbdl-package.tar.gz',_AJ:_C,_A0:_C,_A1:_C,_BJ:_A,_BK:_A,_AK:_C,_BL:'.sbdlc',_AL:{},_BM:_A,_k:_A,_A2:_C,_AM:_B,_AN:_C,_BN:'plantuml',_BO:65536,_BP:'png',_BQ:_A,_AO:_C,_AP:_C,_A3:_A,_BR:_A,_AQ:_A,_AR:_A,_T:{},_BS:_A,_BT:_A,_BU:_A,_BV:38,_BW:22,_BX:_C,_BY:_A,_AS:20000,_BZ:_CB,_Ba:200,_Bb:'',_Bc:_C,_Bd:2,_Be:_C,_W:"!pragma layout newlayouter\nskinparam dpi 200\nskinparam backgroundColor transparent\n'skinparam monochrome reverse\n\n",_Bf:'\n<style>\n  node {\n      HorizontalAlignment center\n      MaximumWidth 150\n  }\n  wbsDiagram {\n    Linecolor black\n    arrow {\n      LineColor black\n    }\n    .toplevel {\n    }\n    .source {\n      LineStyle 2\n      RoundCorner 10\n    }\n    .aspect {\n      LineStyle 8.0;3.0\n      LineColor lightgray\n      BackgroundColor lightgray\n      LineThickness 1.0\n      RoundCorner 0\n      Shadowing 0.0\n    }\n  }\n</style>',_Bg:_B,_AT:'hide circle',_Bh:'frame',_Bi:'class',_Bj:_C,_AU:_CC,_Bk:_C,_Bl:'participant','process_diagram_style':_CC,_Bm:_C,_p:_C,_b:15,_Bn:40,_Bo:'',_Bp:_C,_Bq:'',_AV:_C,_Br:0,_Bs:'[...]',_Bt:_C,_Bu:'less -R'if os.name=='posix'else'',_Bv:'SBDL_NO_PRETTY',_Bw:_C,_Bx:_A,_By:_C,_Bz:'1879da28-0fc2-4f1d-8ff1-407f4c070c44',_B_:'{base}/{endp}'.format(base=__URL,endp='rest.api'),_AW:'; ',_C0:'',_C1:_A,_C2:_A,_C3:_C,_C4:'https://fmea.dev',_C5:_A,_C6:_C,_C7:_U,_C8:_B,_C9:8,_CA:'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'}
...
def allow_pretty_print():return not get_config_value(_Bv)in os.environ and not get_config_value(_Bw,number=_A)
...
def current_os():
	...
	elif sys.platform.startswith(_AX):return _AX
...
def get_config_value(key,raise_on_missing=_A,default=_B,number=_B):
	...
	return result
def config_key_locked(key):lock_key=_AY;return key in get_config_value(lock_key,raise_on_missing=_C,default={})
...
def set_config_value(key,data,warn_on_new=_A):
	if not config_key_locked(key):
		if not key in _CONFIG_DATA and get_config_value(_BJ,number=_A)and warn_on_new:f_print('WARNING: adding new key ({}) to config registry'.format(key),warning=_A)
...
def use_config_data(new_config_data,skip_keys=_B):
	global _CONFIG_DATA;lock_key=_AY;skip_keys_l=list(get_config_value(lock_key,raise_on_missing=_C,default={}).keys())
...
def safe_stdout_endcode(in_string):
	result=in_string
	if isinstance(result,str):result=result.encode(sys.stdout.encoding,errors=_AZ).decode(sys.stdout.encoding)
	return result
...
def fix_wsl_path(path):
	result=path
	if get_config_value(_BM,number=_A):
...
def rest_api_call(function_name,arguments_dict,print_l=print_null):
	D='result';C='api_version';B='errors';A='api_name';API_END_POINT=get_config_value(_B_);result_data={}
	def create_rest_object(command,arguments_dict):return{A:name(),C:version_rest_api(),'api_key':get_config_value(_Bz),_Aa:command,_CD:{**arguments_dict}}
	...
	if get_config_value(_By,number=_A):
...
class SBDL_Parser:
	class Statements:declaration='declaration';using='using';scope='scope';operator='operator';customtype=_CE
	class Types:aspect=_c;requirement=_Y;mode='fmea:mode';effect='fmea:effect';cause='fmea:cause';current_control='fmea:control';current_detection='fmea:detection';action_control='fmea:action-control';action_detection='fmea:action-detection';test='test';definition='definition';realisation='realisation';function=_Aa;event='event';state='state';transition='transition';usecase='usecase';interface=_A4;trace='trace';group='group'
	class Tokens:declaration='is';declaration_group_delimeters=['{','}'];declaration_attribute_assign=' {} '.format(declaration);declaration_attribute_delimeter='"';general_separator=';';raw_content_delimiters=['[[[',']]]'];declaration_attribute_separator=general_separator;statement_separator=general_separator;hashbang='#!sbdl';prefix='@sbdl\\s';prefix_block_start='@sbdl\\-begin';prefix_block_end='@sbdl\\-end';comment='#';using='using';scope='scope';customtype=_CE;line_continuation=_X;replacement_string_default='';replacement_map={_S:'，',';':'；'};declaration_token_rule='\\s+{}\\s+'.format(declaration);declaration_rule='^.+?{}\\S+\\s*{}.*?{}\\s*$'.format(declaration_token_rule,declaration_group_delimeters[0],declaration_group_delimeters[1]);using_rule=_CF.format(using,declaration_group_delimeters[0],declaration_group_delimeters[1]);scope_rule=_CF.format(scope,declaration_group_delimeters[0],declaration_group_delimeters[1]);customtype_rule='^\\s*{}\\s+{}'.format(customtype,declaration_rule.replace('^',''));macro_delimeters=['[',']'];macro_variable='@';macro_defer='%';macro_rule='\\{}{}(?:[^\\]\\\\]|\\\\.)*\\{}'.format(macro_delimeters[0],macro_variable,macro_delimeters[1]);macro_index_separator=':';whitespace_list=list(string.whitespace);escape=_X;stereotype_separator='^';link_operator='||';source_link_operator='~|';operator_rule='\\s*({}|{})\\s*'.format(_X+_X.join(link_operator),_X+_X.join(source_link_operator));inherit='inherit';compose='compose';hash_separator='~';scope_prefix=_l;stdio_name='-'
	class Attributes:description=_P;detectability=_r;detectability_post=_A5;severity=_s;occurrence=_t;occurrence_post=_A6;separator=_S;parent='parent';child='child';related='related';pragma='pragma';remark='remark';reference=_CG;identifier=_CH;type=_K;types=_Z;stereotype='stereotype';actor=_Ab;tag='tag';description_bsci='description_bsci';precondition='precondition';postcondition='postcondition';invariant='invariant';output='output';input='input';custom_prefix='custom:';condition='condition';condition_alternative='alternative';custom_required_attr='required_property';custom_optional_attr='optional_property';custom_link_types='relation_type';color='color';control_only='control_only';return_control='return_control';raw_content='raw_content';loop_name='loop';parallel_name='parallel';port_name='port'
	...
	class Parser_Element:
		...
		def shorten_reference(self,reference):
			reference_result=reference;max_length=get_config_value(_Br,number=_A)
			if max_length!=_B and max_length>0:reference_result=(reference_result[::-1][:max_length]+(reference_result[::-1][max_length:]and get_config_value(_Bs)[::-1]))[::-1]
	...
	def builtin_directive_dict(self):
		...
		def extend_deeper_cause(macros,*inp):
			...
			if SBDL_Parser.Macros.cross_reference_available in macros:
				extend_symbol=get_config_value(_C7)
		...
		def prolog_startup(_,*inp):
			...
			if not get_config_value(_k,number=_A):f_print('PROLOG environment requested but Prolog support is disabled!',warning=_A,opts=['REVERSE']);return result_val
			def prolog_element_to_fact(element):
				...
				def pstr(str_i):
					result=str_i;pl_exclude=[_O,'-',':'];pl_repl=''
					if str_i!=_B:
				...
				attr_list.append(prolog_attr(_u,'['+prolog_separator.join(inter_prop)+']',quote=_C))
				...
				handle_link_list(links,_Ac);handle_link_list(parents,'parents');handle_link_list(children,'children');handle_link_list(related,'related');return prolog_attr(etype,prolog_separator.join(attr_list),quote=_C)
			...
			def prolog_assert(fact_string,print_method):
				...
				elif get_config_value(_k,number=_A):print_method(D,error=_A,opts=['RED'])
				return result
			...
			def execute_prolog_asserts(_,print_method):
				...
				if B in globals():
					for prolog_assert in SBDL_PROLOG_ASSERTS:
						...
						print_method('PrologAssert::{}: {}'.format(prolog_assert[0],'PASS'if error_count==0 else'FAIL'),debug=not get_config_value(_A2,number=_A),error=get_config_value(_A2,number=_A))
				return error_count
			...
			def prolog_teardown(_,__):
				...
				return 0
			add_to_config_value(_j,prolog_ast_to_facts_assert);add_to_config_value(_j,execute_prolog_asserts);add_to_config_value(_j,execute_prolog_commands);add_to_config_value(_j,prolog_teardown)
			if not A in globals():
				...
				trace_file_path=get_config_value(_AM)
		...
		def prolog_assert(macros,*inp,posneg):
			...
			if not A in globals()and get_config_value(_k,number=_A):f_print('Prolog assert specified but Prolog environment not started!',error=_A);result_val=D
		...
		def prolog_cmd(macros,*inp):
			...
			if not A in globals()and get_config_value(_k,number=_A):f_print('Prolog command specified but Prolog environment not started!',error=_A);result_val=D
		...
		def prolog_result_output(_,*__):set_config_value(_A2,_A);return''
		def prolog_trace_file(_,*inp):
			...
			set_config_value(_AM,inp[0]);return''
	...
	def sanitize(self,unclean_string):
		...
		return result.encode(_CI).decode(_Ad).replace('\\\\',_X)
	@classmethod
	def sanitize_escaped(self,unclean_string,reverse=_C):
		...
		return result
	@classmethod
	def remove_escape_chars(self,escaped_string):return escaped_string.encode(_q).decode(_CI)
	@classmethod
	def attribute_string(self,statement_object):
		...
		for attr in sorted(statement_object.data()):
			...
			if len(content)>0:
				...
				attributes+='{indent}{attrname}{assign}{delimiter}{attrcontent}{delimiter}{separator}{newline}{spacing}'.format(attrname=attr,assign=SBDL_Parser.Tokens.declaration_attribute_assign,delimiter=delim,attrcontent=content,separator=SBDL_Parser.Tokens.declaration_attribute_separator if get_config_value(_B9,number=_A)else'',indent=indent_str,newline=newline_str,spacing=spacing_str)
		return attributes
	@classmethod
	...
	def parse_statements(self,parser_element):
		...
		for statement in statements:
			...
			else:result.append(SBDL_Statement(new_parser_elem(statement,statement_pos_p),_v,{},_A,'Statement does not match any recognised rule'))
		if len(result)+blanks<len(statements):result.append(SBDL_Statement(parser_element,_v,{},_A,'Unknown error (not all statements parsed)'))
		return result
	@classmethod
...
class SBDL_Semantics:
	...
	def get_language_information_struct(self):
		lang_info_struct={_d:{}};lang_info_struct[_Z]=self.type_information;lang_type_struct=lang_info_struct[_Z];categories=lang_info_struct[_d];skip_properties=[SBDL_Parser.Attributes.pragma,SBDL_Parser.Attributes.reference]
		for type_name in lang_type_struct:
			lang_type_struct[type_name][_Ac]=self.get_valid_link_type_for_type_name(type_name);valid_properties=list(self.global_properties.keys())
			if type_name in self.type_properties:valid_properties.extend(list(self.type_properties[type_name]))
			lang_type_struct[type_name][_u]=[p for p in valid_properties if not p in skip_properties];category=lang_type_struct[type_name]['category']
			if not category in categories:categories[category]={_P:self.category_descriptions[category],_Z:{}}
			categories[category][_Z][type_name]=_A
		lang_info_struct[_u]=self.property_descriptions;lang_info_struct[_Ai]=dict.fromkeys([x for x in vars(SBDL_Parser.Macros).values()if isinstance(x,str)and x!=_i and x!='__main__'],'No Description')
		for directive_description in self.directive_descriptons:lang_info_struct[_Ai][directive_description]=self.directive_descriptons[directive_description]
		lang_info_struct['CLI']=help_text();return lang_info_struct
	@classmethod
	def type_color(self,type_name):
		E='#FFFF00';D='#FF6347';C='#FF69B4';B='#9370DB';A='#1E90FF';color_list=['#FFC0CB','#FFA07A','#FFD700','#32CD32','#00FFFF',A,B,C,D,E,'#008000','#00FF7F','#00CED1','#00BFFF',A,B,C,D,'#FF4500',E,'#9ACD32','#ADFF2F','#7FFFD4','#AFEEEE','#ADD8E6','#87CEEB','#8A2BE2','#FF00FF','#FF1493'];color_index_map=get_config_value(_BB)
	...
	@classmethod
	def get_identifier_from_string_eng_standard(self,input_string,aggressive_length=20,min_word_len=3,separator='',right_to_left=_A):stop_words={'the','and','of','to','in','a','on','for','with','at','by','an',_A7,'shall','should','must','will','can','may','might','could','be','have','use','perform','execute','define','configure','manage','then'};stop_chars={'a','e','i','o','u'};abbreviations={'acceleration':'accel','actuator':'act','aerodynamics':'aero','analysis':'anal','approximate':'approx','architecture':'arch','assembly':'assy','auxiliary':'aux','battery':'batt','calculation':'calc','center of gravity':'cg','center of mass':'cm','coefficient':'coeff','configuration':'config',_n:'ctrl','controller':'cntrlr','coordinate':'coord','correction':'corr','current':'curr','data acquisition':'daq','decibel':'db','degrees of freedom':'dof','design':'des','development':'dev','diameter':'dia','dimension':'dim','dynamic':'dyn','efficiency':'eff','electrical':'elec','electromagnetic':'em','error':'err','estimate':'est','evaluation':'eval','failure mode and effects analysis':_w,'fatigue':'fat','feature':'feat','feedback':'fb','frequency':'freq',_Aa:'func','gradient':'grad','hardware':'hw','heat transfer':'ht','high voltage':'hv',_CH:'id','identification':'id','implementation':'impl','input':'in','inspection':'insp','instrumentation':'instr','integration':'intg',_A4:'intf','iteration':'iter','load':'ld','logic':'log','maintenance':'maint','management':'mgmt','manufacturing':'mfg','material':'matl','maximum':'max','measurement':'meas','mechanism':'mech','minimum':'min','model':'mdl','momentum':'mom','nominal':'nom','operating system':'os','optimization':'opt','output':'out','parameter':'param','performance':'perf','physics':'phys','position':'pos','power':'pwr','pressure':'pres','process':'proc','proportional-integral-derivative':'pid','quality assurance':'qa','radiation':'rad','redundancy':'redund',_CG:'ref','reliability':'rel',_Y:'req','resolution':'res','resistance':'resist','safety':'sfty','sensor':'sens','simulation':'sim','software':'sw','specification':'spec','stability':'stab','static':'stat','structure':'struc','subsystem':'subsys',_A7:'sys','temperature':'temp','tension':'tens','testing':'test','thermal':'therm','torque':'torq','transient':'trans','uncertainty':'uncert','validation':'val','verification':'verif','voltage':'volt','weight':'wt','target':'targ'};return self.get_identifier_from_string(re.sub('[^a-zA-Z0-9.:_ ]+|(?<=.)\\.$','',input_string),aggressive_length,min_word_len,separator,stop_words=stop_words,stop_chars=stop_chars,abbreviations=abbreviations,right_to_left=right_to_left)
	@classmethod
	...
	def get_unique_id_from_string(self,input_string):
		digest=hashlib.sha256(input_string.encode('utf‑8')).digest();alphabet=get_config_value(_CA);length=get_config_value(_C9,number=_A);num=int.from_bytes(digest,'big');base=len(alphabet);smart_key=[]
...
class SBDL_Parsed_Object:
	def throw_error(self,err=_v):raise Exception('Abstract parser object called: "{}" on {}'.format(err,self))
...
class SBDL_Element:
	...
	class Element_Link:
		...
		def is_a(self,target):
			...
			if not result:
				if isinstance(target,type)and hasattr(target,_CJ):
	...
	def __check_raise_attrs(self):
		...
		if len(unrec_attrs)>0:raise Exception('Unrecognised attributes: {}'.format(_G.join(unrec_attrs)))
	...
	def hash(self):return hashlib.sha256(re.sub('\\s+',_I,self.definition().parser_element().content().strip()).encode()).hexdigest()[:get_config_value(_BG,number=_A)]
	@classmethod
...
class SBDL_AST:
	...
	def elements(self,print_l=print_null,prune_missing_references=_C):
				...
				if isinstance(parsed_object,SBDL_Using_Statement):print_l('USING+=: {}'.format(parsed_object.data()),debug=_A);handle_using(parsed_object.data(),inherit_data)
					...
					try:
						...
						if not statement_element.identifier()in sbdl_elements:
							if get_config_value(_Bt,number=_A)and statement_element.description():statement_element.set_property(SBDL_Parser.Attributes.description_bsci,SBDL_Semantics.calc_bsci(statement_element.description(),'english'))
		...
		if get_config_value(_A3,number=_A):
			...
			if get_config_value(_AQ,number=_A)and get_config_value(_AR,number=_A):crossref_dict.update(get_config_value(_T))
...
def make_remote_file_local(file_reference):
	...
	if parsed_file_reference.scheme in['http','https','ftp','file://']and get_config_value(_Bx,number=_A):
...
def open_output_file(file_reference,is_text=_A,append=_C):return open(file_reference,('a'if append else'w')+('t'if is_text else'b'),encoding=_q if is_text else _B)if file_reference!=SBDL_Parser.Tokens.stdio_name else stdio_clone()
...
def get_parser_elements_from_filepath(filepath,elements_list,print_l=print_null,file_opener=open_input_file,read_input_set=_B):
	...
	errors=0;line_count=0;line_buffer='';line_buffer_markers=[];add_to_config_value(_AL,{filepath:_A})
	...
	local_directives={}
	if get_config_value(_AR,number=_A):local_directives=get_config_value(_T)
	...
	file_name=os.path.basename(filepath);file_ext=os.path.splitext(filepath)[1:][0];dir_name=filepath.replace(file_name,'');abs_path=os.path.abspath(filepath);native_sbdl_file=_A if get_config_value(_BD)==file_ext else _C;update_per_file_directives()
	...
	def import_directive(_,*inp):
		...
		try:
			print_l('Import: {}'.format(import_path));read_elements,import_errors=aggregate_all_parser_elements_from_files([import_path],do_recurse=get_config_value(_BK,number=_A),do_hidden=_C,print_l=print_l,file_opener=file_opener,read_input_set=read_input_set);elements_list.extend(read_elements);errors+=import_errors
	...
	def strip_comments(line):
		result=line;comment_markers=[SBDL_Parser.Tokens.comment,get_config_value(_B8)]
	...
	def detect_block_start_end(line):
		...
		if re.search(SBDL_Parser.Tokens.prefix_block_start,line)or re.search(get_config_value(_B5),line):native_sbdl_file=_A;result=_A
		elif re.search(SBDL_Parser.Tokens.prefix_block_end,line)or re.search(get_config_value(_B6),line):native_sbdl_file=_C;result=_A
		return result
	def extract_sbdl_line_non_native(line):
		nonlocal non_sbdl_line_prefix;result='';custom_prefix=get_config_value(_B3);custom_suffix=get_config_value(_B4);custom_noop=get_config_value(_B7)
...
def aggregate_all_parser_elements_from_files(input_list,do_recurse,do_hidden,print_l=print_null,file_opener=open_input_file,read_input_set=_B):
	...
	for afile in input_list:
		...
		else:errors+=1;print_l(_CL.format(afile),error=_A)
...
def plantuml_writer(file_opener,output_file,content,_):
	...
	if not get_config_value(_AN,number=_A):
		try:
			plantuml_env=os.environ.copy();plantuml_env.pop('LD_LIBRARY_PATH',_B);plantuml_env['PLANTUML_LIMIT_SIZE']=str(get_config_value(_BO));plantuml_command=get_config_value(_BN)
			if isinstance(plantuml_command,str):plantuml_command=shlex.split(plantuml_command)
			plantuml_command_full=plantuml_command+['-t',get_config_value(_BP),'-p'];debug_out('EXECUTE_PLANTUML: '+str(plantuml_command_full));exec_result=subprocess.run(plantuml_command_full,input=content.encode(),stdout=subprocess.PIPE,stderr=subprocess.STDOUT,env=plantuml_env,check=_C);content_to_output=exec_result.stdout
		except:raise Exception('Error while executing PlantUML')
	with file_opener(output_file,is_text=get_config_value(_AN,number=_A))as plantuml_file:plantuml_file.write(content_to_output)
def plantuml_footer_generator():
	footer_content=''
	if get_config_value(_BQ,number=_A):footer_content+='footer \\nGenerated by {generator} on {date}\\n\\n\n'.format(generator='{} version {}'.format(__NAME,__VERSION),date=get_date_string())
	return footer_content
def plantuml_identifier(in_string):
	result=in_string.strip(_I).replace('/',_U).replace(_N,_U).replace('-',_U).replace(_l,_U)
	if result=='':result=_U
	return result
def write_requirement_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	if len(top_level_requirements)==1 and not get_config_value(_Be):root_requirement=requirements[top_level_requirements[0][A]]
	else:
	...
	def plantuml_requirement_diagram_wrap(content):
		header=plantuml_footer_generator();legend_text='';legend=get_config_value(_Bg)
		if legend!=_B:legend_text='legend\n{legend_content}\nendlegend\n'.format(legend_content=legend)
		plant_uml_prepost='@startwbs\n{style}\n\n{header}\n{content}\n{legend}@endwbs\n';return plant_uml_prepost.format(style=get_config_value(_W)+get_config_value(_Bf),header=header,content=content,legend=legend_text)
...
def write_decomposition_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	def plantuml_decomposition_diagram():
		header=plantuml_footer_generator();title=_x.format(arguments.title)if arguments.title!=''else'';plant_uml_prepost=_y;content='';notes='';note_count=0;interface_count=0;relations='';descriptions=get_config_value(_Bj,number=_A);interface_mem={};handled_elems=[];indentation_prefix=_M
		def puml_id(elem_id):return plantuml_identifier(elem_id)
		def note_rel_pos(posindex):positions={0:'top',1:'bottom',2:_A8,3:_A9};return positions[posindex%4]
		def interface_rel_pos(posindex):positions={0:'up',1:'down',2:_A8,3:_A9};return positions[posindex%4]if get_config_value(_AO,number=_A)else''
		def handle_elem(elem_id,pref='',parent_id=_B):
			...
			def add_interface_line(interface,type_name,pref_l=''):
				nonlocal content
				if not interface.identifier()in interface_mem:interface_mem[interface.identifier()]=[x for x in elements[interface.identifier()].links()if x.is_a(SBDL_Interface)];content+='\n{}{} "{}{}" as {}'.format(pref+pref_l,type_name,puml_id(interface.identifier()),_H+_H.join(textwrap.wrap(elements[interface.identifier()].description(),get_config_value(_b,number=_A)))if descriptions else'',puml_id(interface.identifier()))
			if not elem_id in handled_elems and elements[elem_id].is_a(SBDL_Aspect):
				...
				for relation in related:
					if parent_id!=relation.identifier():
						...
						relations+=_CN.format(puml_id(elem_id),interface_rel_pos(interface_count),relation_end,puml_id(relation.identifier()),link_text);interface_count+=1
			else:0
		...
		return plant_uml_prepost.format(style=(_CO if get_config_value(_AP,number=_A)else'')+get_config_value(_W)+get_config_value(_AT),header=header+title,content=content+_D+relations+_D+(_D+notes if descriptions or arguments.source else''))
...
def write_element_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A)
	def plantuml_decomposition_diagram():
		header=plantuml_footer_generator();title=_x.format(arguments.title)if arguments.title!=''else'';plant_uml_prepost=_y;content='';relations='';interface_mem={};handled_elems=[]
		def puml_id(elem_id):return plantuml_identifier(elem_id).replace('(','').replace(')','').replace('[]','').replace(']','').replace(':',_U).encode(_Ad,_AZ).decode(_Ad)
		def interface_rel_pos(posindex):positions={0:'up',1:'down',2:_A8,3:_A9};return positions[posindex%4]if get_config_value(_AO,number=_A)else''
		def detailed_content(elem_id):
			props=[];links={};result='\t{}: **{}**\n'.format(SBDL_Parser.Attributes.type,elements[elem_id].type());elem=elements[elem_id]
			for prop in elem.properties():props.append('\t{}:\n\t  {}'.format(prop,textwrap.shorten(elem.get_property(prop),width=get_config_value(_Bn,number=_A),placeholder='...')))
		...
		def handle_elem(elem_id,pref='',_=_B):
			...
			if not elem_id in handled_elems:
				...
				for interface in interfaces:
					if not interface.identifier()in interface_mem:interface_mem[interface.identifier()]=_A;content+='\n{}{} "**{}**\\n{}" as {}'.format(pref,_A4,interface.identifier(),'',puml_id(interface.identifier()))
					relations+='{} -{}- {}\n'.format(puml_id(elem_id),interface_rel_pos(interface_count),puml_id(interface.identifier()));interface_count+=1
				aspect_stereotype=elements[elem_id].stereotype()
				if not aspect_stereotype:aspect_stereotype=elements[elem_id].type()
				else:aspect_stereotype=elements[elem_id].type()+_l+aspect_stereotype
				aspect_stereotype=_Aj.format(aspect_stereotype);content+=_CM.format(pref,get_config_value(_Bi),elem_id,puml_id(elem_id),aspect_stereotype,''if not SBDL_Parser.Attributes.color in elements[elem_id].properties()else' #'+elements[elem_id].get_property(SBDL_Parser.Attributes.color));content+='{{\n{}\n}}\n'.format(detailed_content(elem_id));related=elements[elem_id].related();related.extend([link for link in elements[elem_id].links()])
				for relation in related:
					relation_type=relation.stereotype();relation_type=relation_type if relation_type else'';link_text=': '+relation_type if relation_type else'';relation_end='>'
					if relation_type.startswith(SBDL_Parser.Tokens.inherit):relation_end='|>'
					elif elements[relation.identifier()].is_a(SBDL_Parser.Types.interface):relation_end='('
					elif relation_type.startswith(SBDL_Parser.Tokens.compose):relation_end=_O
					relations+=_CN.format(puml_id(elem_id),interface_rel_pos(interface_count),relation_end,puml_id(relation.identifier()),link_text)
			else:0
		elements_ordered=list(elements.keys())
		for elem in elements_ordered:handle_elem(elem)
		return plant_uml_prepost.format(style=(_CO if get_config_value(_AP,number=_A)else'')+get_config_value(_W)+get_config_value(_AT),header=header+title,content=content+_D+relations+_D+(_D+''))
	plantuml_writer(file_opener,output_file,plantuml_decomposition_diagram(),print_l);return errors
def write_function_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A);show_descriptions=get_config_value(_Bk,number=_A);event_count=0;entities={}
	def puml_id(elem_id):return plantuml_identifier(elem_id)
	def plantuml_function_diagram():
		header=plantuml_footer_generator();title=_x.format(arguments.title)if arguments.title!=''else'';plant_uml_prepost=_y;content='';empty_aspect_replace=_v
		...
		def handle_func(func_id,depth=1):
			A='end\n';nonlocal content;func_element=elements[func_id];children=SBDL_AST.get_all_children_for_element(func_element,elements);func_links=SBDL_AST.get_all_links_for_element(func_element,elements);func_aspect=_G.join([x.identifier()for x in func_links if x.is_a(SBDL_Aspect)])
			...
			def define_aspect(aspect_name):
				...
				if not aspect_name in entities:
					...
					else:aspect_stereotype=elements[aspect_name].type()+_l+aspect_stereotype
					aspect_stereotype=_Aj.format(aspect_stereotype);aspect_color=''
					...
					content+='{}{} "{}{}" as {} {}{}\n'.format(_M*depth,get_config_value(_Bl),aspect_name,_H+elements[aspect_name].reference()if arguments.source else'',puml_id(aspect_name),aspect_stereotype,aspect_color)
		...
		return plant_uml_prepost.format(style=get_config_value(_W)+get_config_value(_AU),header=header+title,content=content)
...
def write_process_graph_output(sbdl_ast,output_file,file_opener,_,print_l):
	errors=0;elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A);show_descriptions=get_config_value(_Bm,number=_A);first_event=_A;g_process_elem=_B;note_stagger=_C
	def elem_colour_prefix(elem):
		colour=''
		if SBDL_Parser.Attributes.color in elem.properties():colour=f"#{elem.get_property(SBDL_Parser.Attributes.color)} "
		return colour
	def recurse_event_contents(event_elem,current_aspect=_B,indent=2):
		...
		def emit_note():
			...
			if show_descriptions and event_elem.description():event_cont+=f"{indent_str}note {_A8 if note_stagger else _A9}\n{indent_str}{event_elem.description()}\n{indent_str}end note\n";note_stagger=not note_stagger
	...
	def plantuml_process_diagram():
		process_dia_cont='';process_dia_cont+='@startuml\n';process_dia_cont+=get_config_value(_W)+get_config_value(_AU)+_e
...
def write_state_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A);show_descriptions=get_config_value(_Bp,number=_A)
	def plantuml_state_diagram():
		header=plantuml_footer_generator();title=_x.format(arguments.title)if arguments.title!=''else'';plant_uml_prepost=_y;statedefs='';statedefs_dict={};transitions_visited={};content='';relations=''
		def handle_elem(elem_id,depth=0):
			if elem_id in elements:
				element=elements[elem_id];nonlocal statedefs_dict,content,relations;elem_children=SBDL_AST.get_all_children_for_element(element,elements);elem_aspect=_G.join([x.identifier()for x in sbdl_ast.get_all_links_for_element(element,elements)if x.is_a(SBDL_Aspect)])
		...
		return plant_uml_prepost.format(style=get_config_value(_W)+get_config_value(_Bo),header=header+title,content=statedefs+content+_D+relations)
...
def write_usecase_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	def plantuml_usecase_diagram():
		header=plantuml_footer_generator();title=_x.format(arguments.title)if arguments.title!=''else'';plant_uml_prepost=_y;aspects={};content=''
		for usecase in[elements[elem]for elem in elements if elements[elem].is_a(SBDL_UseCase)]:
			actor=usecase.get_property(_Ab)if _Ab in usecase.properties()else'User';content+='actor "{}" as {}\n'.format(actor,puml_id(actor))
			for function in[elements[link.identifier()]for link in sbdl_ast.get_all_links_for_element(usecase,elements)if link.identifier()in elements and elements[link.identifier()].is_a(SBDL_Function)]:
				aspect=_G.join([link.identifier()for link in sbdl_ast.get_all_links_for_element(function,elements)if link.is_a(SBDL_Aspect)])
		...
		for aspect in aspects:
			...
			for usecase_tuple in aspects[aspect]:content+='  usecase "{}" as {}\n'.format('**{}**\\n{}{}'.format(usecase_tuple[3],_H.join(textwrap.wrap(usecase_tuple[4],get_config_value(_b,number=_A))),_H+usecase_tuple[6]if arguments.source else'')if get_config_value(_AV,number=_A)else usecase_tuple[3],puml_id(usecase_tuple[3]));relations+='\n{} --> {}: {}{}\n'.format(puml_id(usecase_tuple[0]),puml_id(usecase_tuple[3]),'**{}**\\n{}'.format(usecase_tuple[1],_H.join(textwrap.wrap(usecase_tuple[2],get_config_value(_b,number=_A))))if get_config_value(_AV,number=_A)else usecase_tuple[1],_H+usecase_tuple[5]if arguments.source else'')
			content+='}\n'
		content+=relations;return plant_uml_prepost.format(style=get_config_value(_W)+get_config_value(_Bq),header=header+title,content=content)
...
def write_network_graph_output(sbdl_ast,output_file,_,arguments,print_l):
	...
	elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A);sbdl_graph=nx.MultiDiGraph();skip_types={x for x in get_config_value(_Bb,number=_C).split(_S)};node_name_sep=_l;node_text_wrap_width=25
	def node_name(elem_id):
		...
		if get_config_value(_BX,number=_A):node_text+=_e+_D.join(textwrap.wrap(elements[elem_id].description(),width=node_text_wrap_width))
		if arguments.source:node_text+=_e+_D.join(textwrap.wrap(elements[elem_id].reference(),width=node_text_wrap_width))
		return node_text
	...
	layouts={_CB:mpl,'graphviz':dot,'spring':spring,'spiral':nx.spiral_layout,'random':nx.random_layout,'planar':nx.planar_layout};options={'font_size':10,'node_size':get_config_value(_AS,number=_A),'edgecolors':'gray','edge_color':'darkgray','linewidths':1,'with_labels':get_config_value(_BY,number=_A),'width':2,'node_color':colour_list,'node_shape':'s','pos':layouts[get_config_value(_BZ,number=_C)](sbdl_graph)};plt.figure(figsize=(get_config_value(_BV,number=_A),get_config_value(_BW,number=_A)));nx.draw_networkx(sbdl_graph,**options,alpha=1.);ax=plt.gca();ax.margins(.0);plt.axis('off');plt.tight_layout();plt.plot();plt.savefig(output_file,dpi=get_config_value(_Ba,number=_A));return errors
class OpenFMEA:
	@classmethod
	def generate_sbdl_table_from_ast(self,sbdl_ast,id_in_body=_C,source_in_body=_C,print_l=print_null,multi_field_separator=_B):
		...
		id_counter=0;sbdl_row={A:_B,_c:_B,_Y:_B,_L:_B,_a:_B,_R:_B,_n:_B,_f:_B,_s:_B,_t:_B,_A6:_B,_r:_B,_A5:_B,_z:_B,_g:_B}
		...
		def generate_table(element,row=_B,path=_B,add_single=_C):
			...
			def add_row():
				...
				rows_to_add=[row];expand_attrs=get_config_value(_C0)
			...
			def get_compounded_linked_events():
				...
				return'({})'.format(_G.join(result))if len(result)>0 else''
			if not element.identifier()in path:
				path[element.identifier()]=_A;custom_prop_prefix=SBDL_Parser.Attributes.custom_prefix+get_config_value(_BE)
				...
				if element.identifier()==start_node.identifier():recurse_links(SBDL_Failure_Cause)
					...
					if not is_fully_meta()and(get_config_value(_C2,number=_A)or not is_partly_meta()):add_row()
				elif element.is_a(SBDL_Failure_Cause):
					events=get_compounded_linked_events();assign_column(_R,_I+events if len(events)>0 else'');assign_column_value(_t,element.rating());assign_column_value(_A6,element.rating(post=_A))
					...
					assign_column(_L);assign_column_value(_r,element.rating());assign_column_value(_A5,element.rating(post=_A))
				...
				elif element.is_a(SBDL_Failure_Effect):assign_column(_a);assign_column_value(_s,element.rating());recurse_links(end_node.type())
				...
				elif element.is_a(SBDL_Failure_Current_Detection)or element.is_a(SBDL_Test_Definition):element.visited=_A;assign_column(_f)
				elif element.is_a(SBDL_Failure_Action_Control):element.visited=_A;assign_column(_z)
				elif element.is_a(SBDL_Failure_Action_Detection):element.visited=_A;assign_column(_g)
	...
	def struct_from_table(self,title,sbdl_table,open_fmea_type=_Q):
		result_struct={_Ak:_AA,'version':'1.0',_K:open_fmea_type,_h:{'title':title,'application':name(),'application_version':version(),'cmd_line':str(sys.argv),'date':get_date_string()},_w:sbdl_table,'layout':{}};result_struct[_h]['user']=get_user_string()
		try:result_struct[_h][_A7]=platform.uname()
		except Exception as _:result_struct[_h][_A7]='UNKNOWN'
	...
	def read_struct_from_file(self,open_sbdl_file):
		...
		if not(_Ak in open_sbdl_content and open_sbdl_content[_Ak]==_AA):raise Exception('Not an OpenFMEA file')
		...
		for row in range(len(table_data)):
			for column in table_data[row]:
				if table_data[row][column]==from_value:
					...
					if column in{_s,_t,_r}:target_value=number_value
	...
	def write_opensbdl_portfolio_output(self,sbdl_ast,output_file,file_opener,arguments,print_l):
		...
		def get_entry_path(entry):
			def trace_aspect_path(aspect,path=_B):
				...
				return path
			aspect_name=self.get_id_from_string(entry[_c]);entry_path=trace_aspect_path(aspect_name)
	...
	def elements_from_table(self,sbdl_table,_):
		multi_field_separator=get_config_value(_AW);elems_to_consider={_c:SBDL_Parser.Types.aspect,_Y:SBDL_Parser.Types.requirement,_L:SBDL_Parser.Types.mode,_a:SBDL_Parser.Types.effect,_R:SBDL_Parser.Types.cause,_n:SBDL_Parser.Types.current_control,_f:SBDL_Parser.Types.current_detection,_z:SBDL_Parser.Types.action_control,_g:SBDL_Parser.Types.action_detection};elem_rating={_a:_s,_R:_t,_L:_r};elem_rating_post={_R:_A6,_L:_A5};elem_link={_R:[_L,_n,_z,_f,_g],_L:[_c,_a,_f,_Y,_g,_R],_Y:[_c,_L],_a:[_L],_n:[_R],_f:[_L],_z:[_R],_g:[_L]};elem_present_every_row={_f,_g};replace_str=SBDL_Parser.Tokens.replacement_string_default;elements={};id_lookup={}
		if not get_config_value(_C6,number=_A):elem_link[_L].remove(_R);elem_link[_a].remove(_L)
		...
		for general_element in general_entries:
			...
			if'id'in gen_elem_obj and _P in gen_elem_obj and _K in gen_elem_obj:
				if gen_elem_obj[_K]in supported_general_types:
					if supported_general_types[gen_elem_obj[_K]][B]==0:supported_general_types[gen_elem_obj[_K]][B]+=1;new_customtype_statement=SBDL_Parser.parse_customtype(SBDL_Parser.Parser_Element(supported_general_types[gen_elem_obj[_K]][C],_AA,0));new_customtype_def=SBDL_CustomType(new_customtype_statement);general_elements.append(new_customtype_def)
	...
	def statements_from_openfmea(self,openfmea_data,source_name):
		A='general';elements=[]
		if _w in openfmea_data:elements.extend(self.elements_from_table(openfmea_data[_w],source_name))
		else:debug_out(f"No FMEA data in {source_name}")
		if _h in openfmea_data and A in openfmea_data[_h]:elements.extend(self.elements_from_general(openfmea_data[_h][A],elements,source_name))
		else:debug_out(f"No general elements in {source_name}")
		return[SBDL_Parser.Parser_Element(x.definition().string(),source_name,_AA)for x in elements]
	@classmethod
	def aggregate_all_parser_elements_from_files(self,source_files,recurse,hidden,print_l):
		...
		for input_file in source_files:
			...
			else:errors+=1;print_l(_CL.format(input_file),error=_A)
		set_config_value(_A0,_A);set_config_value(_A1,_A);return aggregated_elements,errors
	@classmethod
...
def write_aggregated_output(sbdl_ast,output_file,file_opener,__,print_l):
	print_l('Writing aggregate output: {}'.format(output_file),debug=_A);new_line_str=_e if get_config_value(_V,number=_A)else _D
	with file_opener(output_file)as fmfile:
		sbdl_element_set,errors=sbdl_ast.elements(print_l=print_l);sbdl_elements=[sbdl_element_set[x]for x in sbdl_element_set];sort_by_type=get_config_value(_A0,number=_A);sort_by_iden=get_config_value(_A1,number=_A)
		...
		for element in sbdl_elements:
			if not get_config_value(_BC,number=_A):element.delete_property(SBDL_Parser.Attributes.reference)
			print_l('Writing element: {}'.format(element.identifier()),debug=_A);fmfile.write('{}{} {}'.format(element.definition().string(),SBDL_Parser.Tokens.statement_separator if get_config_value(_BA,number=_A)else'',new_line_str))
	return errors
def write_rpc_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	if arguments.rpc==_B:errors+=1;print_l('RPC parameter required',error=_A)
		...
		rpc_result=rest_api_call(arguments.rpc,{_CD:str(sys.argv),A:sbdl_statement_strings},print_l)
...
def apply_template_to_officex_files(officex_dir,sbdl_ast,print_l):
	...
	return 0
def template_docx_file(template_dict,infile,outfile):warnings.filterwarnings(_AZ,category=UserWarning,module='docxcompose');docxtpl=lazy_import('docxtpl');word_template=docxtpl.DocxTemplate(infile);word_template.render(template_dict);word_template.save(outfile)
def write_template_fill(sbdl_ast,output_file,file_opener,arguments,print_l):
	elements,errors=sbdl_ast.elements();full_dict,errors_dict=sbdl_ast.get_full_ast_as_dict(elements);errors+=errors_dict;template_context={_i:full_dict}
	if get_config_value(_C5,number=_A):openfmea,errors_fmea=OpenFMEA.generate_sbdl_table_from_ast(sbdl_ast,id_in_body=arguments.identifier,source_in_body=arguments.source,print_l=print_l);errors+=errors_fmea;template_context[_AC]=openfmea
...
def write_type_information(_,output_file,file_opener,____,_____):
	all_types=[x for x in vars(SBDL_Parser.Types).values()if isinstance(x,str)]+list(SBDL_Semantics.custom_types.keys());skip_types=[_i]
	with file_opener(output_file)as output_file:
		output_file.write('Types');output_file.write(_D);output_file.write('=====');output_file.write(_e)
		for type_name in all_types:
			if not type_name in skip_types:
				...
				output_file.write(_D);output_file.write('     Relations: ');output_file.write(_G.join(SBDL_Semantics.get_valid_link_type_for_type_name(type_name)));output_file.write(_D);output_file.write('    Properties: ');output_file.write(_G.join(SBDL_Semantics.global_properties.keys()))
				if type_name in SBDL_Semantics.type_properties:output_file.write(_G);output_file.write(_G.join(SBDL_Semantics.type_properties[type_name]))
...
def affinity_graph():
	...
	for category in lang_info_struct[_d]:
		graph_output+='frame "{}" {{\n'.format(category)
		for e_type in lang_info_struct[_d][category][_Z]:
...
def update_self(print_l,force=_C):
	print_l(f"Updating {__NAME}...");ret,stdout,stderr=exec_external([sys.executable,_F,'pip','install',*(['--trusted-host',f"{urllib.parse.urlparse(__URL).netloc}"]if force else[]),'--upgrade',urllib.parse.urljoin(url(),get_config_value(_BI)),*(['--break-system-packages']if force else[])]);print_l(stdout)
...
def initialise_dependencies(print_l):
	...
	if current_os()==_AX:errors+=install_package('PlantUML',urllib.parse.urljoin(__URL,'deps/plantuml-headless-jre-linux-x64.tar.bz2'),install_target,print_l)
...
def get_cache_file_path(input_file):
	cache_file_path=_B
	if input_file!=SBDL_Parser.Tokens.stdio_name:cache_file_path=f"{input_file}{get_config_value(_BL)}"
	...
	if do_caching:
		if len(source_files)==1:
			...
			if cache_file is not _B:
				...
				for dep_file in get_config_value(_AL):
...
def load_ast_cache(parser_elements,do_caching,source_files,print_l):
	...
	if do_caching:
		if valid_cache:
			print_l(f"Loading cache for: {_G.join(source_files)}");sbdl_ast_object=SBDL_AST([])
			try:
...
def main(arguments):
	...
	operations={_Al:write_aggregated_output,'aggregate':write_aggregated_output,'query':query_output,_AD:write_matrixcsv_output,'matrixcsv':write_matrixcsv_output,_AE:write_matrixjson_output,'matrixjson':write_matrixjson_output,_Am:write_yaml_tree_output,_CP:write_csv_output,'fmeacsv':write_csv_output,_AC:OpenFMEA.write_opensbdl_output,'openfmea-quickshare':OpenFMEA.write_quickshare_output,_An:OpenFMEA.write_opensbdl_portfolio_output,A:write_aggregated_output,_Ao:write_aggregated_output,B:write_aggregated_output,C:write_aggregated_output,_Ap:write_decomposition_graph_output,_Aq:write_element_graph_output,_Ar:write_requirement_graph_output,_As:write_network_graph_output,_At:write_function_graph_output,_Au:write_process_graph_output,_Av:write_state_graph_output,_Aw:write_usecase_graph_output,_CQ:write_template_fill,'rpc':write_rpc_output,_AF:write_aggregated_output,_Ax:write_aggregated_output,_AG:write_aggregated_output,'type-info':write_type_information};macro_errors=0
	...
	if arguments.already_processed:print_l('Input should be treated as already-processed');arguments.skip_validation=_A;set_config_value(_A3,_C)
	...
	aggregate_methods={_Ao:OpenFMEA.aggregate_all_parser_elements_from_files,A:OpenFMEA.aggregate_all_parser_elements_from_quickshare,C:OpenFMEA.aggregate_all_parser_elements_from_files,B:OpenFMEA.aggregate_all_parser_elements_from_quickshare,_AF:aggregate_all_parser_elements_from_json,_Ax:aggregate_all_parser_elements_from_yaml,_AG:aggregate_all_parser_elements_from_csv};aggregation_method=aggregate_all_parser_elements_from_files if not arguments.mode in aggregate_methods else aggregate_methods[arguments.mode];parser_elements,read_errors=aggregation_method([fix_wsl_path(x)for x in arguments.source_files],arguments.recurse,arguments.hidden,print_l);check_step('File reading',read_errors);sbdl_ast=load_ast_cache(parser_elements,get_config_value(_AK,number=_A),arguments.source_files,print_l);check_step('Parsing',sbdl_ast.check_parsing(print_l))
	for pre_hook in get_config_value(_BF):check_step('Pre Hook: {}'.format(pre_hook.__name__),pre_hook(sbdl_ast,print_l))
...
def show_manual(_):
	...
	sbdl_info_struct=SBDL_Semantics.get_language_information_struct();sbdl_properties=sbdl_info_struct[_u];sbdl_types=sbdl_info_struct[_Z];sbdl_directives=sbdl_info_struct[_Ai]
	for category in sbdl_info_struct[_d]:
		add_manual_header(category,headchar='=');add_manual(sbdl_info_struct[_d][category][_P])
		for elem_type in sbdl_info_struct[_d][category][_Z]:
			add_manual_header(_AB.format(elem_type,category));add_manual('Description:\n  {}'.format(sbdl_types[elem_type][_P]));add_manual();add_manual('Relations:\n  {}'.format(_S.join(sbdl_types[elem_type][_Ac])));add_manual();add_manual('Properties :')
			for elem_prop in sbdl_types[elem_type][_u]:
	...
	try:
		manual_command=get_config_value(_Bu)
...
class LanguageLevelTests(unittest.TestCase):
	...
	def testFunction(self):main(handle_arguments([_Ay,_E,self.TEST_OUTPUT_FILE]))
	...
	def testLanguageExample(self):main(handle_arguments([_AH,_AI,_E,self.TEST_OUTPUT_FILE]))
	...
	def testGeneralProcessDiagram(self):main(handle_arguments([_Ay,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_Au]))
	def testGeneralStateDiagram(self):main(handle_arguments([_J,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_Av]))
	def testGeneralRequirementDiagram(self):main(handle_arguments([_J,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_Ar]))
	def testGeneralUsercaseDiagram(self):main(handle_arguments([_J,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_Aw]))
	def testGeneralNetworkDiagram(self):main(handle_arguments([_J,_E,self.TEST_DIAGRAM_OUTPUT_FILE,_F,_As]))
	def testGeneralJSON(self):main(handle_arguments([_J,_E,self.TEST_OUTPUT_FILE,_F,_AE]))
	def testGeneralYAML(self):main(handle_arguments([_J,_E,self.TEST_OUTPUT_FILE,_F,_Am]))
	def testGeneralCSV(self):main(handle_arguments([_J,_E,self.TEST_OUTPUT_FILE,_F,_AD]))
	def testGeneralOpenFMEA(self):main(handle_arguments([_J,_E,self.TEST_OUTPUT_FILE,_F,_AC]))
	def testGeneralOpenFMEAPortfolio(self):main(handle_arguments([_J,_E,self.TEST_OUTPUT_FILE,_F,_An]))
	def testGeneralFMEACSV(self):main(handle_arguments([_J,_E,self.TEST_OUTPUT_FILE,_F,'fmeacsv']))
	def testFromJSON(self):main(handle_arguments([_AH,_AI,_E,self.TEST_OUTPUT_FILE,_F,_AE]));reset();main(handle_arguments([self.TEST_OUTPUT_FILE,_E,self.TEST_OUTPUT_FILE2,_F,_AF]))
	def testFromCSV(self):main(handle_arguments([_AH,_AI,_E,self.TEST_OUTPUT_FILE,_F,_AD]));reset();main(handle_arguments([self.TEST_OUTPUT_FILE,_E,self.TEST_OUTPUT_FILE2,_F,_AG]))
...
class LanguageSemanticTests(unittest.TestCase):
	def setUp(self):self.parser_elements,errors=aggregate_all_parser_elements_from_files([_AH,_AI],_C,_C,print_null,open_input_file);self.ast=SBDL_AST(self.parser_elements);self.sbdl_elements,statement_errors=self.ast.elements(print_null)
	...
	def test_existence_type_semantic_check(self):
		expected_elem_type={_Az:SBDL_Aspect,'rocket_booster':SBDL_Aspect,_A_:SBDL_Aspect,_CU:SBDL_Aspect,_B0:SBDL_Requirement,_CV:SBDL_Requirement,_CW:SBDL_Requirement,_B1:SBDL_Function,_CX:SBDL_Event,_CY:SBDL_Event,_CZ:SBDL_State,_Ca:SBDL_State,_B2:SBDL_Transition,_Cb:SBDL_Event}
		for elem in expected_elem_type:0
	def test_existence_semantic_relation(self):
		relations_between={_CU:_A_,_B0:_Az,_CV:_B0,_CW:_A_,_B1:_Az,_CX:_B1,_CY:_Cb,_CZ:_B2,_Ca:_B2}
...
def handle_pre_exec_args(ARGS):
	...
	if ARGS.debug:set_config_value(_AJ,_A);ARGS.verbose=_A
...
def whoopsie_handler(whoopsie):
	...
	except Exception as _:w_print(_v)
	if isinstance(whoopsie,Exception)and get_config_value(_AJ,number=_A):
...
def init_profiling():
	global main,main_original;profile_output=get_config_value(_C8)
	def wrap_main(ARGS):
