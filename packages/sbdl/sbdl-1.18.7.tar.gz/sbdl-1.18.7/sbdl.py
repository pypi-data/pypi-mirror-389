...
def main(arguments):
	...
	if get_config_value(_AL,number=_A):_,cache_path=check_ast_cache(_A,[arguments.output],print_l);store_ast_cache(sbdl_ast.ast(),cache_path,print_l)
