...
class FacebookProfileCollector:
    def __init__(self, cookie, api_key):
        """
    ...
    def collect_user_info(self, username):
        """
        Get profile information using Selenium and GraphQL handler
        :param profile_url: Facebook profile URL
        :return: Dictionary containing profile information
        """
        profile_info = UserInfoHandler(self.api_key).get_user_info(username)
        if profile_info:
            return profile_info
...
if __name__ == '__main__':
    # Example usage
    cookie = "sb=O7BCZ76WW9WsEOdAYM6yzAAv; ps_l=1; ps_n=1; datr=4045aJ-fPaeH6aGaf6gIKB-x; c_user=100011101573199; xs=34%3Af_KtIyeG8BJyDg%3A2%3A1762267771%3A-1%3A-1%3A%3AAcw8909ivRbzkFah9kmNuQ_feRDwdHSSWOuHmJ78PQ; presence=C%7B%22t3%22%3A%5B%5D%2C%22utc3%22%3A1762332043667%2C%22v%22%3A1%7D; wd=874x966; fr=1xXDLbttBbuolxt9H.AWcKHpBUNmzz_kYZ0aRonx4RBqia0xzIupYmqovug63B-AENGXE.BpCw2F..AAA.0.0.BpCw4r.AWegplNBxKGMraNWyENUv-SisoI"
    collector = FacebookProfileCollector(cookie, api_key="1784198495144876|949e7fb42e7bc13a4dd3cf4d8f138afa")
    usernames = ["mrdiyPH"]
    for i in usernames:
        profile_info = collector.collect_user_info(i)
