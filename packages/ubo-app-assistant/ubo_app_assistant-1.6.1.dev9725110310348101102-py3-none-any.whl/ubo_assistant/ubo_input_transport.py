...
class UboInputTransport(BaseInputTransport):
    ...
    def _on_listening_state_changed(self, *, is_listening: bool) -> None:
        ...
        elif not self._zero_frame_task or self._zero_frame_task.done():
    ...
    async def start(self, frame: StartFrame) -> None:
        ...
        # Monitor listening state to control zero frame generation
        self.client.autorun(['state.audio.is_listening'])(
