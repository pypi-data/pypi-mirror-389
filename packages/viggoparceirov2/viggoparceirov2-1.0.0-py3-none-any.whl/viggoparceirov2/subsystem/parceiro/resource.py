...
class Parceiro(entity.Entity, schema_model.DynamicModel):
...
class ParceiroEndereco(endereco.resource.Endereco, schema_model.DynamicModel):
...
class ParceiroContato(entity.Entity, schema_model.DynamicModel):
