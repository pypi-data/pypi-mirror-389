...
def open_file_read(filepath: Path) -> Generator[IO[str]]:
    ...
    if is_gz_file(filepath):
        # XXX Cannot use bgzip.BGZipReader because of bug https://github.com/DataBiosphere/bgzip/issues/88
        # with (
        #     filepath.open("rb") as f_in,
        #     bgzip.BGZipReader(f_in) as g_in,
        # ):
        #     text_in = io.TextIOWrapper(g_in, encoding="utf-8")  # noqa: ERA001
        #     yield text_in
        #     text_in.close()  # noqa: ERA001
