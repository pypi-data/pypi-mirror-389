...
class Command(BaseCommand):
    ...
    def _inspect_action(self, action, admin):
        ...
        if hasattr(action, 'get_form_class'):
            try:
            ...
            for action_type in action_types:
                ...
                if action_list:
                    ...
                    for action in action_list:
                        ...
                        if 'form_class' in action:
                            lines.append(f"      Form: {action['form_class']}")
                        if 'layout' in action:
                            lines.append(f"      Layout: {action['layout']}")
