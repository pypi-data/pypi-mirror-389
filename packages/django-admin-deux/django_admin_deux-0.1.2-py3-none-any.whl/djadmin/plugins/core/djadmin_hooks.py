...
def djadmin_get_default_general_actions():
    ...
    return [ListViewAction, AddAction]
...
def djadmin_get_default_record_actions():
    ...
    from .actions import DeleteRecordAction, EditRecordAction, ViewRecordAction

    return [ViewRecordAction, EditRecordAction, DeleteRecordAction]
...
def djadmin_get_action_view_attribute_bindings(action):
    ...
    return {
        BaseAction: ['get_template_name', 'get_template_names'],  # All actions provide templates
        ...
        CreateViewActionMixin: ['get_form_class', 'get_fields', 'get_success_url'],  # Create actions
        UpdateViewActionMixin: ['get_form_class', 'get_fields', 'get_success_url'],  # Update actions
...
def djadmin_get_action_view_attributes(action):
    ...
    return {
        ...
        UpdateViewActionMixin: copy_model_admin_attrs(action, ['layout', 'update_layout']),
        CreateViewActionMixin: copy_model_admin_attrs(action, ['layout', 'create_layout']),
    }
...
def djadmin_get_sidebar_widgets(action):
    ...
    if not isinstance(action, ListViewAction):
        return {}
    ...
    return {ListViewAction: [search_widget]}
