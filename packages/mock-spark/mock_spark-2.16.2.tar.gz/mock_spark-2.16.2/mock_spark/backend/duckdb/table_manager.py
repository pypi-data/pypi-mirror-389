            ...
            for result in results:
                ...
                for i, column in enumerate(table_obj.columns):
                    ...
                    if is_array_column and value is not None:
                        ...
                        if value is None:
                            # For coalesce operations with numeric literals, None should be converted to 0.0
                            # Check if column name contains "coalesce" as a heuristic
                            if "coalesce" in column.name.lower():
                            ...
                            try:
                                # Ensure we convert to float, including 0 -> 0.0
