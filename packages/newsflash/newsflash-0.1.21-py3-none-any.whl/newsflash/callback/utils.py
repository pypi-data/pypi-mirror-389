...
from newsflash.widgets.base import Widget, ChartWidget, ControlWidget, TextWidget
...
def process_callback_arg(
    ...
    try:
        ...
        assert (
            issubclass(widget_type, ControlWidget)
            or issubclass(widget_type, ChartWidget)
            or issubclass(widget_type, TextWidget)
        )
