...
Never use the web search, only use links found IN the guide OR links found by looking inside of links inside of the guide. Always use curl to fetch content from URLs.
