...
def main(
    ...
    ######### Data processing #########
    # Read data
    data_file = "./data/benchmark_data/test_11_monthly_data.csv"
    ...
    if param_optimization:
        ...
        with open("saved_params/benchmark_11.pkl", "wb") as f:
            pickle.dump(skf_optim_dict, f)
    else:
        # # Load saved skf model
        with open("saved_params/benchmark_11.pkl", "rb") as f:
