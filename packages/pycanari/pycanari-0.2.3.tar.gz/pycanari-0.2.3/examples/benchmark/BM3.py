...
def main(
    ...
    def model_with_parameters(param, train_data, validation_data):
        ...
        model.auto_initialize_baseline_states(train_data["y"][3 : 52 * 4 + 3])
    ...
    if param_optimization:
        ...
        with open("saved_params/benchmark_3.pkl", "wb") as f:
            pickle.dump(skf_optim_dict, f)
    else:
        # # Load saved skf model
        with open("saved_params/benchmark_3.pkl", "rb") as f:
    ...
    plt.savefig("./saved_results/BM3.png")
    plt.show()
