...
class TaskStatistics(BaseModel):
    ...
    """ # noqa: E501
    planning_horizon: TimeWindow = Field(description="Planning horizon is a time window where:   * `from` - the left border of the time windows of all entities from the input data   * `to` - the right border of the time windows of all entities from the input data ")
