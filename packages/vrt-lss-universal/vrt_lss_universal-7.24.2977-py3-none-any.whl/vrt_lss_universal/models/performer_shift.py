...
"""
    ...
    The version of the OpenAPI document: 7.24.2977
...
class PerformerShift(BaseModel):
    ...
    availability_time: TimeWindow = Field(description="Time shift window when the performer can perform work at locations and drive between locations.")
    working_time: TimeWindow = Field(description="Working time window, when the performer can perform work at locations, must be inside the time window.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_locations": obj.get("max_locations") if obj.get("max_locations") is not None else None,
            "max_stops": obj.get("max_stops") if obj.get("max_stops") is not None else None,
