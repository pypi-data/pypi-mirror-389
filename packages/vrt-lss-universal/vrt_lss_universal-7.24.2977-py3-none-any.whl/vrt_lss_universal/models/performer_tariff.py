...
class PerformerTariff(BaseModel):
    ...
    constraints: Optional[Annotated[List[PerformerTariffConstraint], Field(min_length=0, max_length=100)]] = Field(default=None, description="List of components of the tariff.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_penalty_cost": obj.get("max_penalty_cost") if obj.get("max_penalty_cost") is not None else None
        })
