...
class TimeWindowViolations(BaseModel):
    ...
    """ # noqa: E501
    before: TimeWindowViolationDetail = Field(description="Count and order's keys, what planned before permitted time window.")
    after: TimeWindowViolationDetail = Field(description="Count and order's keys, what planned after permitted time window.")
