...
class LocationStatistics(BaseModel):
    ...
    total_cargos_statistics: LocationCargosLimit = Field(description="For location - The amount of measures of cargos moved and the amount of fines for violating restrictions on the movement of cargos.")
    total_transports_statistics: LocationTransportsLimit = Field(description="For location - the number of transports serviced on average during a specified time window and the amount of fines for violating transport service restrictions.")
