...
from arcade_gmail.enums import GmailAction, GmailContentType, GmailReplyToWhom
...
async def send_email(
    ...
    dict, "A dictionary containing the sent email details with date in descriptive UTC format"
]:
    """
...
async def write_draft_email(
    ...
    draft = {
        "message": build_email_message(
            recipient, subject, body, cc, bcc, action=GmailAction.DRAFT, content_type=content_type
        )
    }
...
async def trash_email(
    ...
    dict, "A dictionary containing the trashed email details with date in descriptive UTC format"
]:
    """
...
async def list_emails_by_header(
    ...
    dict, "A dictionary containing a list of email details with dates in descriptive UTC format"
]:
    """
    ...
    if not any([sender, recipient, subject, body, label, date_range]):
        raise RetryableToolError(
            ...
            additional_prompt_content=(
                "Please provide at least one search parameter: sender, recipient, subject, body, "
                "label, or date_range to search for emails."
            ),
        )
...
async def get_thread(
    ...
    dict, "A dictionary containing the thread details with dates in descriptive UTC format"
]:
    """
