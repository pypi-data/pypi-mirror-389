...
By delegating to :mod:`security_dependency_pinning.behaviors` the transport stays
...
targets register the console script defined in :mod:`security_dependency_pinning.__init__conf__`.
