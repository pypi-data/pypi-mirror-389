...
* src/security_dependency_pinning/behaviors.py
* src/security_dependency_pinning/cli.py
* src/security_dependency_pinning/__main__.py
* src/security_dependency_pinning/__init__.py
* src/security_dependency_pinning/__init__conf__.py
* tests/test_cli.py
...
* **Location:** src/security_dependency_pinning/behaviors.py
...
* **Location:** src/security_dependency_pinning/cli.py
...
* **Location:** src/security_dependency_pinning/__main__.py
...
* **Location:** src/security_dependency_pinning/__init__conf__.py
...
1. ``security_dependency_pinning`` → prints CLI help (no default action).
2. ``security_dependency_pinning hello`` → prints greeting.
3. ``security_dependency_pinning fail`` → prints truncated traceback.
4. ``security_dependency_pinning --traceback fail`` → prints full rich traceback.
5. ``python -m security_dependency_pinning --traceback fail`` → matches console output.
...
* Behaviour module contains placeholder logic
