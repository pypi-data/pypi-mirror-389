Hier ist dein Konzept – **unverändert in Struktur & Inhalt**, aber mit dem Bibliotheksnamen **`security_dependency_pinning`** durchgängig aktualisiert.
...
* **Dump-API:** `security_dependency_pinning.dump(format="text"|"json"|"html", path=None)`
...
**Modulname:** `security_dependency_pinning`

```python
import security_dependency_pinning as log
...
>
> * Minimal: `pip install security_dependency_pinning`
> * Mit Rich: `pip install security_dependency_pinning[rich]`
> * Mit Graylog: `pip install security_dependency_pinning[gelf]`
> * Komplett: `pip install security_dependency_pinning[rich,gelf,journald,eventlog]`
...
Wenn du willst, liefere ich dir als Nächstes ein kleines **Starter-Skeleton** für `security_dependency_pinning` (Package-Layout, Handler-Stubs, Rich-Theme, HTML-Dump) – ready to run.
