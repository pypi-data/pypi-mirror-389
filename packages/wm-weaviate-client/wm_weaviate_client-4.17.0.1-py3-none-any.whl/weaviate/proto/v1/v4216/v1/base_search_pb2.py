...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _VECTORFORTARGET.fields_by_name['vector_bytes']._options = None
  _VECTORFORTARGET.fields_by_name['vector_bytes']._serialized_options = b'\030\001'
  _HYBRID.fields_by_name['vector']._options = None
  _HYBRID.fields_by_name['vector']._serialized_options = b'\030\001'
  _HYBRID.fields_by_name['vector_bytes']._options = None
  ...
  _NEARVECTOR.fields_by_name['vector_bytes']._serialized_options = b'\030\001'
  _NEARVECTOR.fields_by_name['target_vectors']._options = None
  _NEARVECTOR.fields_by_name['target_vectors']._serialized_options = b'\030\001'
  _NEARVECTOR.fields_by_name['vector_per_target']._options = None
  _NEARVECTOR.fields_by_name['vector_per_target']._serialized_options = b'\030\001'
  _NEAROBJECT.fields_by_name['target_vectors']._options = None
  _NEAROBJECT.fields_by_name['target_vectors']._serialized_options = b'\030\001'
  _NEARTEXTSEARCH.fields_by_name['target_vectors']._options = None
  _NEARTEXTSEARCH.fields_by_name['target_vectors']._serialized_options = b'\030\001'
  _NEARIMAGESEARCH.fields_by_name['target_vectors']._options = None
  _NEARIMAGESEARCH.fields_by_name['target_vectors']._serialized_options = b'\030\001'
  _NEARAUDIOSEARCH.fields_by_name['target_vectors']._options = None
  _NEARAUDIOSEARCH.fields_by_name['target_vectors']._serialized_options = b'\030\001'
  _NEARVIDEOSEARCH.fields_by_name['target_vectors']._options = None
  _NEARVIDEOSEARCH.fields_by_name['target_vectors']._serialized_options = b'\030\001'
  _NEARDEPTHSEARCH.fields_by_name['target_vectors']._options = None
  _NEARDEPTHSEARCH.fields_by_name['target_vectors']._serialized_options = b'\030\001'
  _NEARTHERMALSEARCH.fields_by_name['target_vectors']._options = None
  _NEARTHERMALSEARCH.fields_by_name['target_vectors']._serialized_options = b'\030\001'
  _NEARIMUSEARCH.fields_by_name['target_vectors']._options = None
  _NEARIMUSEARCH.fields_by_name['target_vectors']._serialized_options = b'\030\001'
  _globals['_COMBINATIONMETHOD']._serialized_start=3337
  _globals['_COMBINATIONMETHOD']._serialized_end=3575
  ...
  _globals['_TARGETS']._serialized_end=257
  _globals['_VECTORFORTARGET']._serialized_start=259
  _globals['_VECTORFORTARGET']._serialized_end=355
  _globals['_SEARCHOPERATOROPTIONS']._serialized_start=358
  _globals['_SEARCHOPERATOROPTIONS']._serialized_end=583
  _globals['_SEARCHOPERATOROPTIONS_OPERATOR']._serialized_start=484
  _globals['_SEARCHOPERATOROPTIONS_OPERATOR']._serialized_end=555
  _globals['_HYBRID']._serialized_start=586
  _globals['_HYBRID']._serialized_end=1178
  _globals['_HYBRID_FUSIONTYPE']._serialized_start=1043
  _globals['_HYBRID_FUSIONTYPE']._serialized_end=1140
  _globals['_NEARVECTOR']._serialized_start=1181
  _globals['_NEARVECTOR']._serialized_end=1610
  _globals['_NEARVECTOR_VECTORPERTARGETENTRY']._serialized_start=1529
  _globals['_NEARVECTOR_VECTORPERTARGETENTRY']._serialized_end=1583
  _globals['_NEAROBJECT']._serialized_start=1613
  _globals['_NEAROBJECT']._serialized_end=1778
  _globals['_NEARTEXTSEARCH']._serialized_start=1781
  _globals['_NEARTEXTSEARCH']._serialized_end=2149
  _globals['_NEARTEXTSEARCH_MOVE']._serialized_start=2042
  _globals['_NEARTEXTSEARCH_MOVE']._serialized_end=2096
  _globals['_NEARIMAGESEARCH']._serialized_start=2152
  _globals['_NEARIMAGESEARCH']._serialized_end=2325
  _globals['_NEARAUDIOSEARCH']._serialized_start=2328
  _globals['_NEARAUDIOSEARCH']._serialized_end=2501
  _globals['_NEARVIDEOSEARCH']._serialized_start=2504
  _globals['_NEARVIDEOSEARCH']._serialized_end=2677
  _globals['_NEARDEPTHSEARCH']._serialized_start=2680
  _globals['_NEARDEPTHSEARCH']._serialized_end=2853
  _globals['_NEARTHERMALSEARCH']._serialized_start=2856
  _globals['_NEARTHERMALSEARCH']._serialized_end=3033
  _globals['_NEARIMUSEARCH']._serialized_start=3036
  _globals['_NEARIMUSEARCH']._serialized_end=3205
  _globals['_BM25']._serialized_start=3207
  _globals['_BM25']._serialized_end=3334
