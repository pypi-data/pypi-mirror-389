...
@pass_tgclient
def publish(client, textgrid_uri, really_publish, ignore_warnings):
...
@click.option('--resume', '-r', help='resume import', is_flag=True)
@click.option(
    '--linkrewriter-cli',
...
@click.option('--xpath', help='xpath to extract uri from TEI. For example: ".//tei:idno[@type=\'textgrid\']"')
@pass_tgclient
