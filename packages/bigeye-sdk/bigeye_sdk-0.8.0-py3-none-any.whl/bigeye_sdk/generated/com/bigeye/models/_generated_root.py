...
class ScanJob(betterproto.Message):
    ...
    latest_scan_run: "ScanRun" = betterproto.message_field(11)
...
class ScanRun(betterproto.Message):
    ...
    started_at: int = betterproto.int64_field(6)
    completed_at: int = betterproto.int64_field(7)
    bytes_scanned: int = betterproto.int64_field(8)
...
class GetScanFindingsRequest(betterproto.Message):
    ...
    workspace_id: int = betterproto.int32_field(4)
    scan_job_ids: List[int] = betterproto.int64_field(5)
    scan_run_ids: List[int] = betterproto.int64_field(6)
    source_ids: List[int] = betterproto.int32_field(7)
    schema_ids: List[int] = betterproto.int32_field(8)
    table_ids: List[int] = betterproto.int32_field(9)
    column_ids: List[int] = betterproto.int32_field(10)
    positive_or_negative_findings: "ThreeLeggedBoolean" = betterproto.enum_field(11)
    classifier_ids: List[int] = betterproto.int64_field(12)
    data_class_ids: List[int] = betterproto.int64_field(13)
    sensitivities: List["DataSensitivity"] = betterproto.enum_field(14)
    is_current: "ThreeLeggedBoolean" = betterproto.enum_field(15)
...
class ScanFinding(betterproto.Message):
    ...
    scan_run_id: int = betterproto.int64_field(2)
    source: "IdAndDisplayName" = betterproto.message_field(3)
    schema: "IdAndDisplayName" = betterproto.message_field(4)
    table: "IdAndDisplayName" = betterproto.message_field(5)
    column: "IdAndDisplayName" = betterproto.message_field(6)
    classifier: "IdAndDisplayName" = betterproto.message_field(7)
    data_class: "DataClass" = betterproto.message_field(8)
    is_positive: bool = betterproto.bool_field(9)
    some_chunks_failed: bool = betterproto.bool_field(10)
    rows_scanned: int = betterproto.int64_field(11)
    rows_matched: int = betterproto.int64_field(12)
...
@dataclass
class RunScanJobRequest(betterproto.Message):
...
@dataclass
class RunScanJobResponse(betterproto.Message):
...
class ScanTableRequest(betterproto.Message):
    ...
    columns: List["IdAndDisplayName"] = betterproto.message_field(5)
...
@dataclass
class ScanRowsRequest(betterproto.Message):
    scan_run_id: int = betterproto.int64_field(1)
...
@dataclass
class ScanRowsResponse(betterproto.Message):
