...
class CombinedTechnology(Component):
    ...
    def __init__(
        ...
        emission_factor: Optional[
            Union[float, Dict[str, float], Dict[str, Dict[int, float]], pl.DataFrame]
        ] = 0.0,
        ...
        """Initialize a combined technology component.

        Args:
            name: Name of the combined technology
            factor: Conversion factors between energy carriers by mode, resource, and year
            ...
            emission_factor: Emission factors by mode and year
            ...
            variable_cost: Variable operation and maintenance costs by mode and year
            ...
            must_run: Minimum power output as fraction of capacity by mode and year
            ramp_down: Maximum ramp down rate as fraction of capacity by mode and year
            ramp_up: Maximum ramp up rate as fraction of capacity by mode and year
        """
        super().__init__(name)
