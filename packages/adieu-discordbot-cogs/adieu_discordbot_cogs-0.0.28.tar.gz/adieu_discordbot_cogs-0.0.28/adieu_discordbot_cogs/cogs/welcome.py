...
# Black Rose Discordbot Cogs
from adieu_discordbot_cogs.helper import unload_cog
from adieu_discordbot_cogs.models.setting import Setting

logger = logging.getLogger(__name__)

# Discord Bot Settings
# Channel
WELCOME_CHANNEL_AUTHENTICATED = settings.RECRUIT_CHANNEL_ID
WELCOME_CHANNEL_UNAUTHENTICATED = settings.RECRUIT_CHANNEL_ID
