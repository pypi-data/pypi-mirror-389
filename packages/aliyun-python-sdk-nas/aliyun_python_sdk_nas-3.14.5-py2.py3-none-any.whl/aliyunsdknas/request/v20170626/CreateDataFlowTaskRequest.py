...
class CreateDataFlowTaskRequest(RpcRequest):
	...
	def get_TransferFileListPath(self): # String
		return self.get_query_params().get('TransferFileListPath')

	def set_TransferFileListPath(self, TransferFileListPath):  # String
		self.add_query_param('TransferFileListPath', TransferFileListPath)
