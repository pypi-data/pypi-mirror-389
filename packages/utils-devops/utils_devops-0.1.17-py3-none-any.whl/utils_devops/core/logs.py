...
debug, info, warn, error, exception, task, task_start, task_pass, task_fail,
run_command, run_and_log, script_start, script_end: Direct callable shortcuts.
Critical Notes

Use .warn(), this module exposes warn() as the public convenience alias.
...
if not hasattr(DevopsLogger, "warning"):
    DevopsLogger.warning = DevopsLogger.warn
