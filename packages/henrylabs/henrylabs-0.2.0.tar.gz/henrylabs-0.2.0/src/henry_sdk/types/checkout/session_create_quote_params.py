...
__all__ = ["SessionCreateQuoteParams", "ShippingDetails"]


class SessionCreateQuoteParams(TypedDict, total=False):
    shipping_details: Required[Annotated[ShippingDetails, PropertyInfo(alias="shippingDetails")]]
