...
#   timestamp: 2025-10-27T02:43:13+00:00
...
class PositionLiquidationDto(BaseModel):
    ...
    funding_charge_usd: Optional[str] = Field(
        None,
...
class V1ProductMarketPriceGetParametersQuery(BaseModel):
    product_ids: List[UUID] = Field(
        ..., alias="productIds", max_length=10, min_length=1
    )
...
class V1SubaccountBalanceGetParametersQuery(BaseModel):
    ...
    cursor: Optional[str] = None
    subaccount_id: UUID = Field(..., alias="subaccountId")
    order_by: Optional[OrderBy9] = Field(None, alias="orderBy", examples=["tokenName"])
...
class ArchiveV1SubaccountBalanceGetParametersQuery(BaseModel):
    ...
    end_time: Optional[float] = Field("2025-10-26T21:39:37.496Z", alias="endTime")
    resolution: Resolution = Field(..., examples=["hour2"])
    order_by: Optional[OrderBy14] = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: UUID = Field(..., alias="subaccountId")
...
class ArchiveV1SubaccountFundingGetParametersQuery(BaseModel):
    ...
    cursor: Optional[str] = None
    start_time: float = Field(..., alias="startTime")
    end_time: Optional[float] = Field("2025-10-26T21:39:36.787Z", alias="endTime")
    order_by: Optional[OrderBy14] = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: UUID = Field(
...
class ArchiveV1SubaccountUnrealizedPnlGetParametersQuery(BaseModel):
    ...
    cursor: Optional[str] = None
    start_time: float = Field(..., alias="startTime")
    end_time: Optional[float] = Field("2025-10-26T21:39:37.507Z", alias="endTime")
    resolution: Resolution = Field(..., examples=["hour2"])
    order_by: Optional[OrderBy14] = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: UUID = Field(..., alias="subaccountId")
    product_ids: Optional[List[UUID]] = Field(None, alias="productIds", min_length=1)
...
class ArchiveV1SubaccountVolumeGetParametersQuery(BaseModel):
    ...
    cursor: Optional[str] = None
    start_time: float = Field(..., alias="startTime")
    end_time: Optional[float] = Field("2025-10-26T21:39:37.510Z", alias="endTime")
    resolution: Resolution = Field(..., examples=["hour2"])
    order_by: Optional[OrderBy14] = Field(None, alias="orderBy", examples=["time"])
    subaccount_id: UUID = Field(..., alias="subaccountId")
