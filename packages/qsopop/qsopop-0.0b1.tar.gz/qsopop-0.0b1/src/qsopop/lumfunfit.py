...
import qsopop.lumfun as lumfun
...
def log_prior(theta, parameters):
    ...
    :type parameters: dict(qsopop.lumfun.Parameter)
...
def log_probability(theta, lumfun=None, lum_range=None,
    ...
    :type lumfun: qsopop.lumfun.LuminosityFunction (or children classes)
    ...
    :type surveys: list(qsopop.survey.Survey)
