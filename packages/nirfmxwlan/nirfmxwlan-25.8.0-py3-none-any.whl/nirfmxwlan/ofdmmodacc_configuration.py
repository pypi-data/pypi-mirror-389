...
class OfdmModAccConfiguration(object):
    ...
    def auto_level(self, selector_string, timeout):
        ...
        level corresponding to the lowest :py:attr:`~nirfmxwlan.attributes.AttributeID.CHAIN_RMS_EVM_MEAN` result on each
        device.

        This method only measures at the reference levels that do not result in an ADC or OSP overflow when you set the
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AUTO_LEVEL_ALLOW_OVERFLOW` attribute to **False**. If you set the
        OFDMModAcc Auto Level Allow Overflow attribute to **True**, this method measures at a few reference levels beyond the
        overflow.
        ...
        **True** with a step size of 0.5 dB.
        ...
        When you use this method with the :py:attr:`~nirfmxwlan.attributes.AttributeID.NOISE_COMPENSATION_ENABLED`
