    ...
    def configure_maximum_measurement_interval(self, selector_string, maximum_measurement_interval):
        ...
        Args:
            ...
            maximum_measurement_interval (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.BURST_DETECTION_ENABLED` attribute to **True**, the measurement interval
                used is equal to the smaller of the duration of the WLAN packet under analysis or the value you set for this parameter.
