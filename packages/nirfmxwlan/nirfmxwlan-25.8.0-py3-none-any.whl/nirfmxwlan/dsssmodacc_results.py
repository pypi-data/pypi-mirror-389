...
class DsssModAccResults(object):
    ...
    def fetch_average_powers(self, selector_string, timeout):
        ...
        Returns:
            ...
            preamble_average_power_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this result returns the mean of
                the average preamble field power computed for each averaging count. This value is expressed in dBm.
    ...
    def fetch_evm_per_chip_mean_trace(self, selector_string, timeout, evm_per_chip_mean):
        ...
        the EVM per chip computed for each averaging count.
        ...
        Args:
            ...
            evm_per_chip_mean (numpy.float32):
                ...
                as a percentage. When you set the DSSSModAcc EVM Unit attribute to **dB**, the measurement returns this result in dB.
    ...
    def fetch_evm(self, selector_string, timeout):
        ...
        Returns:
            ...
            rms_evm_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this result returns the mean of
                the RMS EVM computed for each averaging count. When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.EVM_UNIT`
                attribute to **Percentage**, the measurement returns this result as a percentage. When you set the DSSSModAcc EVM Unit
                attribute to **dB**, the measurement returns this result in dB.

            peak_evm_80211_2016_maximum (float):
                This parameter returns the peak EVM results of the burst. When you set the
                :py:attr:`~nirfmxwlan.attributes.AttributeID.EVM_UNIT` attribute to **Percentage**, the measurement returns this result
                as a percentage. When you set the DSSSModAcc EVM Unit attribute to **dB**, the measurement returns this result in dB.
                This measurement is performed in accordance with section 16.3.7.9 of *IEEE Standard 802.11-2016*. When you set the
                DSSSModAcc Averaging Enabled attribute to **True**, this result returns the maximum of the peak EVM computed for each
                averaging count.
            ...
            peak_evm_80211_2007_maximum (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.EVM_UNIT` attribute to **Percentage**, the measurement returns this result
                as a percentage. When you set the DSSSModAcc EVM Unit attribute to **dB**, the measurement returns this result in dB.
                This measurement is performed in accordance with section 18.4.7.8 of *IEEE Standard 802.11-2007*. When you set the
                DSSSModAcc Averaging Enabled attribute to **True**, this result returns the maximum of the peak EVM computed for each
                averaging count.
            ...
            peak_evm_80211_1999_maximum (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.EVM_UNIT` attribute to **Percentage**, the measurement returns this result
                as a percentage. When you set the DSSSModAcc EVM Unit attribute to **dB**, the measurement returns this result in dB.
                This measurement is performed in accordance with section 18.4.7.8 of *IEEE Standard 802.11b-1999*. When you set the
                DSSSModAcc Averaging Enabled attribute to **True**, this result returns the maximum of the peak EVM computed for each
                averaging count.
            ...
            frequency_error_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this result returns the mean of
                the carrier frequency error results computed for each averaging count.
    ...
    def fetch_iq_impairments(self, selector_string, timeout):
        ...
        Returns:
            ...
            iq_origin_offset_mean (float):
                ...
                of the I/Q origin offset results computed for each averaging count.
    ...
    def fetch_peak_powers(self, selector_string, timeout):
        ...
        Returns:
            ...
            preamble_peak_power_maximum (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this result returns the maximum
                of the peak preamble field power results computed for each averaging count. This value is expressed in dBm.
            ...
            data_peak_power_maximum (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this result returns the maximum
                of the peak data field power results computed for each averaging count. This value is expressed in dBm.
            ...
            ppdu_peak_power_maximum (float):
                ...
                maximum of the peak PPDU power results computed for each averaging count. This value is expressed in dBm.
