...
class SemConfiguration(object):
    ...
    def configure_offset_frequency_array(
        ...
        on both the sides of the carrier when you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.MASK_TYPE` attribute to
        **Custom**.
    ...
    def configure_offset_relative_limit_array(
        ...
        the :py:attr:`~nirfmxwlan.attributes.AttributeID.MASK_TYPE` attribute to **Custom**. The relative  limits are relative
        to the peak power of the carrier.
    ...
    def configure_span(self, selector_string, span_auto, span):
        ...
        Args:
            ...
            span_auto (enums.SemSpanAuto, int):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.MASK_TYPE` attribute to **Standard**. The default value is **True**.
            ...
            span (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.MASK_TYPE` attribute to **Standard**. The default value is 66 MHz.
