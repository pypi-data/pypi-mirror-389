    ...
    def fetch_upper_offset_margin(self, selector_string, timeout):
        ...
        Returns:
            ...
            margin_relative_power (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.UPPER_OFFSET_MARGIN` result. The power level is returned relative to the
                peak power of the carrier channel. This value is expressed in dB.
