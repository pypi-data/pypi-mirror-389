...
class Standard(Enum):
    ...
    r"""Corresponds to the OFDM based PPDU formats as defined in *IEEE Standard P802.11bn/D1.0*."""
...
class DsssModAccAcquisitionLengthMode(Enum):
    ...
    MANUAL = 0
    r"""Uses the acquisition length specified by the :py:attr:`~nirfmxwlan.attributes.AttributeID.ACQUISITION_LENGTH`
    attribute."""

    AUTO = 1
    r"""Computes the acquisition length based on the :py:attr:`~nirfmxwlan.attributes.AttributeID.MEASUREMENT_OFFSET` attribute
    and the :py:attr:`~nirfmxwlan.attributes.AttributeID.MAXIMUM_MEASUREMENT_LENGTH` attribute."""
...
class DsssModAccAveragingEnabled(Enum):
    ...
    TRUE = 1
    r"""Measurement uses the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_COUNT` attribute for the number of
    acquisitions using which the results are averaged."""
...
class OfdmModAccAveragingEnabled(Enum):
    ...
    TRUE = 1
    r"""The measurement uses the value of the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_COUNT` attribute as the
    number of acquisitions over which the results are computed according to the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_TYPE` attribute."""
...
class OfdmModAccAveragingType(Enum):
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.VECTOR_AVERAGING_TIME_ALIGNMENT_ENABLED` and
    :py:attr:`~nirfmxwlan.attributes.AttributeID.VECTOR_AVERAGING_PHASE_ALIGNMENT_ENABLED` properties, respectively. The
    averaged I/Q data is used for the measurement. Refer to the `OFDMModAcc Vector Averaging
...
class OfdmModAccAcquisitionLengthMode(Enum):
    ...
    MANUAL = 0
    r"""Uses the acquisition length specified by the :py:attr:`~nirfmxwlan.attributes.AttributeID.ACQUISITION_LENGTH_MODE`
    attribute."""

    AUTO = 1
    r"""Computes the acquisition length based on the :py:attr:`~nirfmxwlan.attributes.AttributeID.MEASUREMENT_OFFSET` and the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.MAXIMUM_MEASUREMENT_LENGTH` attributes."""
...
class SemSweepTimeAuto(Enum):
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.SWEEP_TIME_INTERVAL` attribute."""
...
class SemAveragingEnabled(Enum):
    ...
    TRUE = 1
    r"""The SEM measurement uses the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_COUNT` attribute as the number of
...
class TxpAveragingEnabled(Enum):
    ...
    TRUE = 1
    r"""The TXP measurement uses the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_COUNT` attribute as the number of
...
class PowerRampAveragingEnabled(Enum):
    ...
    TRUE = 1
    r"""The measurement uses the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_COUNT` attribute as the number of
    acquisitions using which the results are averaged."""
