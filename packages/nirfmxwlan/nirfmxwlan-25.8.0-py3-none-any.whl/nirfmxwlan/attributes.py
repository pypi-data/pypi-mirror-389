...
class AttributeID(Enum):
    ...
    *IEEE Standard 802.11n - 2009* and *IEEE Standard P802.11be/D7.0*.
    ...
    |              | OFDM EHT-SIG Compression Enabled                                                                                         |
    |              | OFDM Num EHT-SIG Symbols                                                                                                 |
    +--------------+--------------------------------------------------------------------------------------------------------------------------+
    ...
    r"""Specifies whether to enable SIG compression. This attribute is applicable only for 802.11be MU PPDU signals.
    ...
    802.11ax Extended Range SU, MU, and 802.11be MU PPDUs, you must configure this attribute if the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.OFDM_HEADER_DECODING_ENABLED` attribute is set to **False**.
    ...
    *IEEE P802.11be/D7.0*. If a dRU is configured, the RU Offset represents dRU Index as defined in the Table 38-4
    to Table 38-6 and the Equation 38-1 of *IEEE P802.11bn/D1.0*.
    ...
    802.11ax MU PPDU and 802.11be MU PPDU, you must configure this attribute if
    ...
    r"""Specifies the number of SIG symbols. This attribute is applicable only for 802.11be MU PPDU signals.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.ACQUISITION_LENGTH_MODE` attribute to **Manual**. This value is expressed
    in seconds.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.EQUALIZATION_ENABLED` attribute to **True**.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.PULSE_SHAPING_FILTER_TYPE` attribute to **Raised Cosine** or **Root Raised
    Cosine**. This attribute is ignored if you set the Pulse Shaping Filter Type attribute to **Rectangular**.
    
    This attribute is ignored when you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.EQUALIZATION_ENABLED`
    attribute to **True**.
    ...
    **False**. If you are unable to reliably trigger at the start of a burst, set this attribute to **True**.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.POWER_NUMBER_OF_CUSTOM_GATES`, the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.POWER_CUSTOM_GATE_START_TIME` and the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.POWER_CUSTOM_GATE_STOP_TIME` attributes.
    ...
    .. note::
       Set the :py:attr:`~nirfmxwlan.attributes.AttributeID.MAXIMUM_MEASUREMENT_LENGTH` attribute to -1 to decode all chips.
       Data decoding is not supported if the data rate is 33 Mbps.
    ...
    result returns the mean of the RMS EVM computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the mean of the peak EVM computed for each averaging count.
    ...
    This measurement is performed in accordance with section 16.3.7.9 of *IEEE Standard 802.11-2016*.
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the maximum value of the peak EVM computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute is set to **True**,
    this result returns the mean of the peak EVM computed for each averaging count.
    ...
    This measurement is performed in accordance with section 18.4.7.8 of *IEEE Standard 802.11b-1999*.
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the maximum of the peak EVM computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the mean of the carrier frequency error computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the mean of the chip clock error computed for each averaging count.
    ...
    quadrature-phase (Q) signal. When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute
    to **True**, this result returns the mean of the I/Q gain imbalance computed for each averaging count.
    ...
    signals. When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the mean of the I/Q quadrature error computed for each averaging count.
    ...
    this :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this result returns the
    mean of the I/Q origin offset computed for each averaging count.
    ...
    When you set this :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the mean of the RMS magnitude error computed for each averaging count.
    ...
    When you set this :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the mean of the RMS phase error computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the mean of the average preamble field power computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the maximum of the peak preamble field power computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the mean of the average header field power computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the maximum value of the peak header field power computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the mean of the average data field power computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the maximum value of the peak data field power computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the mean of the average PPDU power computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the maximum value of the peak PPDU power computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the mean value of the average custom gate power computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    result returns the maximum value of the peak custom gate power computed for each averaging count.
    ...
    *IEEE Standard 802.11 2016*.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True** and when you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_COUNT` attribute is to a value greater than 1.
    ...
    This attribute is considered only when you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, when you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_COUNT` attribute to a value greater than 1, and when you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_TYPE` attribute to **Vector**. You can set this attribute to
    **False** when there is no time offset between the acquired I/Q data of all averaging counts. Refer to the `OFDMModAcc
    Vector Averaging <www.ni.com/docs/en-US/bundle/rfmx-wlan/page/ofdmmodacc-vector-averaging.html>`_ concept topic for
    more information.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_COUNT` attribute to a value greater than 1, and when you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_TYPE` attribute to **Vector**. You can set this attribute to
    **False** when there is no phase offset between the acquired I/Q data of all averaging counts. Refer to the `OFDMModAcc
    Vector Averaging <www.ni.com/docs/en-US/bundle/rfmx-wlan/page/ofdmmodacc-vector-averaging.html>`_ concept topic for
    more information.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.CHANNEL_ESTIMATION_INTERPOLATION_TYPE`
    ...
    This attribute is used only when you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.CHANNEL_ESTIMATION_INTERPOLATION_TYPE` attribute to **Wiener Filter**.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.POWER_NUMBER_OF_CUSTOM_GATES`,
    :py:attr:`~nirfmxwlan.attributes.AttributeID.POWER_CUSTOM_GATE_START_TIME` and
    :py:attr:`~nirfmxwlan.attributes.AttributeID.POWER_CUSTOM_GATE_STOP_TIME` attributes.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.POWER_CUSTOM_GATE_START_TIME` attribute. This value is expressed in
    seconds.
    ...
    .. note::
       Set the :py:attr:`~nirfmxwlan.attributes.AttributeID.MAXIMUM_MEASUREMENT_LENGTH` attribute to -1 to decode all symbols.
    ...
    **Supported devices: **PXIe-5830/5831/5832/5646/5840/5841/5842/5860.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.NOISE_COMPENSATION_ENABLED` attribute to **True**
    and the :py:attr:`~nirfmxwlan.attributes.AttributeID.MEASUREMENT_MODE` attribute to **Measure**, the measurement
    attempts to read the noise floor calibration data corresponding to the configured reference level. If the noise floor
    calibration data corresponding to the configured reference level in the calibration database is not found, then the
    measurement attempts to read noise floor calibration data from the calibration database for any reference level in the
    range of the configured reference level plus or minus the coercion limit you set for this attribute.
    ...
    configuring the :py:attr:`~nirfmxwlan.attributes.AttributeID.OPTIMIZE_DYNAMIC_RANGE_FOR_EVM_MARGIN` attribute.
    ...
    **Supported devices: **PXIe-5646/5840/5841/5842/5860.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.OPTIMIZE_DYNAMIC_RANGE_FOR_EVM_ENABLED` attribute to **True**. This value
    is expressed in dB.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of RMS EVM results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of data RMS EVM results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute is set to **True**,
    this attribute returns the mean of pilot RMS EVM results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of stream RMS EVM results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of data stream RMS EVM results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of pilot stream RMS EVM results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of chain RMS EVM results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of data chain RMS EVM results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of pilot chain RMS EVM results computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of RMS EVM results for the specified user that is computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of data RMS EVM results for the specified user that is computed for each averaging count.
    ...
    This result is applicable for MU PPDU. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of pilot RMS EVM results for the specified user that is computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the L-STF or STF average power results computed for each averaging count.
    ...
    This result is not applicable for 802.11n Greenfield PPDU signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the L-STF or STF peak power results computed for each averaging count.
    ...
    This result is not applicable for 802.11n Greenfield PPDU signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the L-LTF or LTF average power results computed for each averaging count.
    ...
    This result is not applicable for 802.11n Greenfield PPDU signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the L-LTF or LTF peak power results computed for each averaging count.
    ...
    This result is not applicable for 802.11n Greenfield PPDU signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the L-SIG or SIGNAL field average power results computed for each averaging count.
    ...
    This result is not applicable for 802.11n Greenfield PPDU signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the L-SIG or SIGNAL field peak power results computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the RL-SIG field average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ax and 802.11be signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the RL-SIG field peak power results computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the HT-SIG field average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11n signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the HT-SIG field peak power results computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the VHT-SIG-A field average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ac signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the VHT-SIG-A field peak power results computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the HE-SIG-A field average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ax signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the HE-SIG-A field peak power results computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the U-SIG field average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11be signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the U-SIG field peak power results computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the ELR-MARK field average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11bn signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the ELR-MARK field peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ac signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the VHT-SIG-B field average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ac signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the VHT-SIG-B field peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ax signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the HE-SIG-B field average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ax signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the HE-SIG-B field peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11be signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the EHT-SIG field average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11be signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the EHT-SIG field peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11bn signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the UHR-SIG field average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11bn signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the UHR-SIG field peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11bn signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the ELR-SIG field average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11bn signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the ELR-SIG field peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11n signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the HT-STF average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11n signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the HT-STF peak power results computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the HT-GF-STF average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11n greenfield PPDU signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the HT-GF-STF peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ac signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the VHT-STF average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ac signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the VHT-STF peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ax signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the HE-STF average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ax signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the HE-STF peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11be signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the EHT-STF average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11be signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the EHT-STF peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11bn signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the UHR-STF average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11bn signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the UHR-STF peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11n signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the HT-DLTF average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11n signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the HT-DLTF peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11n signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the HT-ELTF average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11n signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the HT-ELTF peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ac signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the VHT-LTF average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ac signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the VHT-LTF peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ax signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the HE-LTF average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ax signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the HE-LTF peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11be signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the EHT-LTF average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11be signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the EHT-LTF peak power results computed for each averaging count.
    ...
    This result is applicable only to 802.11bn signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the UHR-LTF average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11bn signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the UHR-LTF peak power results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the data field average power results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the maximum of the data field peak power results computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the packet extension field average power results computed for each averaging count.
    ...
    This result is applicable only to 802.11ax and 802.11be signals. When you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    maximum of the PE  field peak power results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the PPDU average power results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the maximum of the PPDU peak power results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the custom gate average power results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the maximum of the custom gate peak power results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the cross power results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the user power results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of stream power results computed for each averaging count.
    ...
    lower mask across subcarriers. When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED`
    attribute to **True**, the spectral flatness is computed using the mean of the channel frequency response magnitude
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.SPECTRAL_FLATNESS_MARGIN` result.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, the measurement computes the
    mean of the unused tone error over each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.UNUSED_TONE_ERROR_MARGIN`  result.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the burst start time computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the carrier frequency error results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, the
    CCDF is computed over each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the symbol clock error results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the relative I/Q origin offset computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the absolute I/Q origin offset computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the I/Q gain imbalance results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the I/Q quadrature error results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the I/Q timing skew computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
    of the RMS common phase error computed for each averaging count.
    ...
    the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
    mean of the RMS common pilot error computed for each averaging count.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.MASK_TYPE` attribute to **Custom**.
    ...
    This attribute is applicable when you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.MASK_TYPE`
    ...
    This attribute is applicable only when you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.SPAN_AUTO`
    attribute to **False** and the :py:attr:`~nirfmxwlan.attributes.AttributeID.MASK_TYPE` attribute to **Standard**.
    ...
    This attribute is ignored when you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.SWEEP_TIME_AUTO`
    attribute to **True**.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.CARRIER_INTEGRATION_BANDWIDTH` attribute. This value is expressed in dBm.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.CARRIER_INTEGRATION_BANDWIDTH` attribute. This value is expressed in dBm.
    SEM mask level is determined by this result.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.LOWER_OFFSET_MARGIN` attribute. This value is expressed in dBm.
    ...
    r"""Returns the power level of the spectrum corresponding to the result of the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.LOWER_OFFSET_MARGIN` attribute. This value is expressed in dB.
    ...
    :py:attr:`~nirfmxwlan.attributes.AttributeID.LOWER_OFFSET_MARGIN` attribute. This value is expressed in Hz.
    ...
    r"""Returns the power level of the spectrum corresponding to the result of the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.UPPER_OFFSET_MARGIN` attribute. This value is expressed in dBm.
    ...
    r"""Returns the power level of the spectrum corresponding to the result of the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.UPPER_OFFSET_MARGIN` attribute. This value is expressed in dB.
    ...
    r"""Returns the frequency of the spectrum corresponding to the result of the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.UPPER_OFFSET_MARGIN` attribute. This value is expressed in Hz.
    ...
    r"""Specifies the number of acquisitions used for averaging when you set the
    :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED`
    attribute to **True**.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the rise time results computed for each averaging count.
    ...
    When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this
    attribute returns the mean of the fall time results computed for each averaging count.
