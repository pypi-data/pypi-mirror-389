...
class DriverNotInstalledError(Error):
    ...
    def __init__(self):
        """An error due to using this module without the driver runtime installed."""
        super(DriverNotInstalledError, self).__init__("The NI-RFmxWLAN runtime could not be loaded. Make sure it is installed and its bitness matches that of your Python interpreter. Please visit http://www.ni.com/downloads/drivers/ to download and install it.")  # type: ignore
...
class DriverTooOldError(Error):
    ...
    def __init__(self):
        """An error due to using this module with an older version of the NI-RFmxWLAN driver runtime."""
        super(DriverTooOldError, self).__init__("A function was not found in the NI-RFmxWLAN runtime. Please visit http://www.ni.com/downloads/drivers/ to download a newer version and install it.")  # type: ignore
...
class DriverTooNewError(Error):
    ...
    def __init__(self):
        """An error due to the NI-RFmxWLAN driver runtime being too new for this module."""
        super(DriverTooNewError, self).__init__("The NI-RFmxWLAN runtime returned an unexpected value. This can occur if it is too new for the nirfmxwlan Python module. Upgrade the nirfmxwlan Python module.")  # type: ignore
