...
class _WlanBase(SignalConfiguration):
    ...
    def get_ofdm_sig_compression_enabled(self, selector_string):
        r"""Gets whether to enable SIG compression. This attribute is applicable only for 802.11be MU PPDU signals.
        ...
        Returns:
            ...
            attr_val (enums.OfdmSigCompressionEnabled):
                Specifies whether to enable SIG compression. This attribute is applicable only for 802.11be MU PPDU signals.
    ...
    def set_ofdm_sig_compression_enabled(self, selector_string, value):
        r"""Sets whether to enable SIG compression. This attribute is applicable only for 802.11be MU PPDU signals.
    ...
    def get_ofdm_number_of_sig_symbols(self, selector_string):
        r"""Gets the number of SIG symbols. This attribute is applicable only for 802.11be MU PPDU signals.
        ...
        Returns:
            ...
            attr_val (int):
                Specifies the number of SIG symbols. This attribute is applicable only for 802.11be MU PPDU signals.
    ...
    def set_ofdm_number_of_sig_symbols(self, selector_string, value):
        r"""Sets the number of SIG symbols. This attribute is applicable only for 802.11be MU PPDU signals.
