...
class OfdmModAccResults(object):
    ...
    def fetch_chain_data_rms_evm_per_symbol_mean_trace(
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the chain data RMS EVM per symbol computed for each averaging count.
        ...
        Args:
            ...
            chain_data_rms_evm_per_symbol_mean (numpy.float32):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.EVM_UNIT` attribute to **Percentage**, the measurement returns this result
                as a percentage. When you set the OFDMModAcc EVM Unit attribute to **dB**, the measurement returns this result in dB.
        ...
        Returns:
            ...
            x0 (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.MEASUREMENT_OFFSET` attribute.
    ...
    def fetch_chain_pilot_rms_evm_per_symbol_mean_trace(
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the chain pilot RMS EVM per symbol computed for each averaging count.
    ...
    def fetch_chain_rms_evm_per_subcarrier_mean_trace(
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the chain RMS EVM per subcarrier computed for each averaging count.
    ...
    def fetch_chain_rms_evm_per_symbol_mean_trace(
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the chain RMS EVM per symbol computed for each averaging count.
    ...
    def fetch_chain_rms_evm(self, selector_string, timeout):
        ...
        Returns:
            ...
            chain_rms_evm_mean (float):
                ...
                of chain RMS EVM results computed for each averaging count. This value is expressed as a percentage or in dB.
    ...
    def fetch_channel_frequency_response_mean_trace(
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the channel frequency response trace computed for each averaging count.
    ...
    def fetch_group_delay_mean_trace(self, selector_string, timeout, group_delay_mean):
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the group delay trace computed for each averaging count.
    ...
    def fetch_composite_rms_evm(self, selector_string, timeout):
        ...
        Returns:
            ...
            composite_rms_evm_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.EVM_UNIT` attribute to **Percentage**, the measurement returns this result
                as a percentage. When you set the OFDMModAcc EVM Unit attribute to **dB**, the measurement returns this result in dB.
                When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter
                returns the mean of the composite RMS EVM results computed for each averaging count.
            ...
            composite_data_rms_evm_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.EVM_UNIT` attribute to **Percentage**, the measurement returns this result
                as a percentage. When you set the OFDMModAcc EVM Unit attribute to **dB**, the measurement returns this result in dB.
                When you set the OFDMModAcc Averaging Enabled attribute to **True**, this parameter returns the mean of the composite
                data RMS EVM results computed for each averaging count.
            ...
            composite_pilot_rms_evm_mean (float):
                ...
                as a percentage. When you set the OFDMModAcc EVM Unit attribute to **dB**, the measurement returns this result in dB.
                When you set the OFDMModAcc Averaging Enabled attribute to **True**, this parameter returns the mean of the composite
                pilot RMS EVM results computed for each averaging count.
    ...
    def fetch_cross_power(self, selector_string, timeout):
        ...
        Returns:
            ...
            cross_power_mean (float):
                ...
                stream *x* in the chain. When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to
                **True**, this parameter returns the mean of the cross power results computed for each averaging count. This value is
                expressed in dB.
    ...
    def fetch_custom_gate_powers_array(self, selector_string, timeout):
        ...
        Returns:
            ...
            average_power_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns an array
                of the mean of the average custom gate power results computed for each averaging count.
    ...
    def fetch_data_average_power(self, selector_string, timeout):
        ...
        Returns:
            ...
            data_average_power_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns the mean
                of the data average power results computed for each averaging count.
    ...
    def fetch_data_peak_power(self, selector_string, timeout):
        ...
        Returns:
            ...
            data_peak_power_maximum (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns an array
                of the maximum of the data peak power results computed for each averaging count.
    ...
    def fetch_frequency_error_ccdf_10_percent(self, selector_string, timeout):
        ...
        Returns:
            ...
            frequency_error_ccdf_10_percent (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, the CCDF is computed over each
    ...
    def fetch_frequency_error_mean(self, selector_string, timeout):
        ...
        Returns:
            ...
            frequency_error_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the mean
                of the carrier frequency error results computed for each averaging count.
    ...
    def fetch_iq_gain_imbalance_per_subcarrier_mean_trace(
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the I/Q gain imbalance computed for each averaging count.
    ...
    def fetch_iq_impairments(self, selector_string, timeout):
        ...
        Returns:
            ...
            relative_iq_origin_offset_mean (float):
                ...
                total power of all the subcarriers. When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED`
                attribute to **True**, this attribute returns the mean of the relative I/Q origin offset computed for each averaging
                count. This value is expressed in dB.
    ...
    def fetch_iq_quadrature_error_per_subcarrier_mean_trace(
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the I/Q quadrature error computed for each averaging count.
    ...
    def fetch_pe_average_power(self, selector_string, timeout):
        ...
        Returns:
            ...
            pe_average_power_mean (float):
                ...
                parameter returns the mean of the packet extension field average power results computed for each averaging count. This
    ...
    def fetch_pe_peak_power(self, selector_string, timeout):
        ...
        Returns:
            ...
            pe_peak_power_maximum (float):
                ...
                When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter
                returns the maximum of the PE field peak power results computed for each averaging count. This value is expressed in
                dBm.
    ...
    def fetch_ppdu_average_power(self, selector_string, timeout):
        ...
        Returns:
            ...
            ppdu_average_power_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns the mean
                of the PPDU average power results computed for each averaging count. This value is expressed in dBm.
    ...
    def fetch_ppdu_peak_power(self, selector_string, timeout):
        ...
        Returns:
            ...
            ppdu_peak_power_maximum (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns the
                maximum of the PPDU peak power results computed for each averaging count. This value is expressed in dBm.
    ...
    def fetch_preamble_average_powers_802_11ac(self, selector_string, timeout):
        ...
        Returns:
            ...
            vht_sig_a_average_power_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns the mean
                of the VHT-SIG-A field average power results computed for each averaging count. This value is expressed in dBm.
    ...
    def fetch_preamble_average_powers_802_11ax(self, selector_string, timeout):
        ...
        Returns:
            ...
            rl_sig_average_power_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns the mean
                of the RL-SIG field average power results computed for each averaging count. This value is expressed in dBm.
    ...
    def fetch_preamble_average_powers_common(self, selector_string, timeout):
        ...
        Returns:
            ...
            l_stf_average_power_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns the mean
                of the L-STF or STF average power results computed for each averaging count. This value is expressed in dBm.
    ...
    def fetch_preamble_peak_powers_802_11ac(self, selector_string, timeout):
        ...
        Returns:
            ...
            vht_sig_a_peak_power_maximum (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this attribute returns the
                maximum of the VHT-SIG-A field peak power results computed for each averaging count. This value is expressed in dBm.
    ...
    def fetch_preamble_peak_powers_802_11ax(self, selector_string, timeout):
        ...
        Returns:
            ...
            rl_sig_peak_power_maximum (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns the
                maximum of the RL-SIG field peak power results computed for each averaging count. This value is expressed in dBm.
    ...
    def fetch_preamble_peak_powers_802_11n(self, selector_string, timeout):
        ...
        Returns:
            ...
            ht_sig_peak_power_maximum (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns the
                maximum of the HT-SIG field peak power results computed for each averaging count. This value is expressed in dBm.
    ...
    def fetch_preamble_peak_powers_common(self, selector_string, timeout):
        ...
        Returns:
            ...
            l_stf_peak_power_maximum (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns the
                maximum of the L-STF or STF peak power results computed for each averaging count. This value is expressed in dBm.
    ...
    def fetch_spectral_flatness_mean_trace(
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the spectral
        flatness trace computed on the mean of the channel estimates computed for each averaging count.
    ...
    def fetch_stream_rms_evm(self, selector_string, timeout):
        ...
        Returns:
            ...
            stream_rms_evm_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns the mean
                of stream RMS EVM results computed for each averaging count. This value is expressed as a percentage or in dB.
    ...
    def fetch_symbol_clock_error_mean(self, selector_string, timeout):
        ...
        Returns:
            ...
            symbol_clock_error_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter returns the mean
                of the symbol clock error results computed for each averaging count. This value is expressed in parts per million
                (ppm).
    ...
    def fetch_unused_tone_error_mean_trace(
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the unused tone error computed for each averaging count.
    ...
    def fetch_user_power(self, selector_string, timeout):
        ...
        Returns:
            ...
            user_power_mean (float):
                ...
                given user. When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**,
                this parameter returns the mean of the user power results computed for each averaging count. This value is expressed in
                dBm.
    ...
    def fetch_user_stream_data_rms_evm_per_symbol_mean_trace(
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the user stream data RMS EVM per symbol computed for each averaging count.
    ...
    def fetch_user_stream_rms_evm_per_subcarrier_mean_trace(
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the user stream RMS EVM per subcarrier computed for each averaging count.
    ...
    def fetch_user_stream_rms_evm_per_symbol_mean_trace(
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the user stream RMS EVM per symbol computed for each averaging count.
    ...
    def fetch_user_stream_rms_evm(self, selector_string, timeout):
        ...
        Returns:
            ...
            user_stream_rms_evm_mean (float):
                ...
                as a percentage. When you set the OFDMModAcc EVM Unit attribute to **dB**, the measurement returns this result in dB.
                When you set the :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this parameter
                returns the mean of the user stream RMS EVM computed for each averaging count.
            ...
            user_stream_data_rms_evm_mean (float):
                ...
                :py:attr:`~nirfmxwlan.attributes.AttributeID.EVM_UNIT` attribute to **Percentage**, the measurement returns this result
                as a percentage. When you set the OFDMModAcc EVM Unit attribute to **dB**, the measurement returns this result in dB.
                When you set the OFDMModAcc Averaging Enabled attribute to **True**, this parameter returns the mean of the user stream
                data RMS EVM computed for each averaging count.
            ...
            user_stream_pilot_rms_evm_mean (float):
                ...
                as a percentage. When you set the OFDMModAcc EVM Unit attribute to **dB**, the measurement returns this result in dB.
                When you set the OFDMModAcc Averaging Enabled attribute to **True**, this parameter returns the mean of the user stream
                pilot RMS EVM computed for each averaging count.
    ...
    def fetch_phase_noise_psd_mean_trace(self, selector_string, timeout, phase_noise_psd_mean):
        ...
        :py:attr:`~nirfmxwlan.attributes.AttributeID.AVERAGING_ENABLED` attribute to **True**, this method returns the mean of
        the phase noise PSD computed for each averaging count.
