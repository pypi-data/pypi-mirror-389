...
from nirfmxwlan.attributes import *  # noqa: F403
from nirfmxwlan.enums import *  # noqa: F403
from nirfmxwlan.wlan import Wlan, _WlanSignalConfiguration
...
def get_diagnostic_information():
    ...
    if platform.system() == "Windows":
        ...
        os_name = "Windows"
        try:
            driver_version_key = winreg.OpenKey(winreg.HKEY_LOCAL_MACHINE, r"SOFTWARE\National Instruments\RFmx\WLAN\C Runtime Support")  # type: ignore
    ...
    info["driver"]["name"] = "NI-RFmxWLAN"
    info["driver"]["version"] = driver_version
    info["module"]["name"] = "nirfmxwlan"
