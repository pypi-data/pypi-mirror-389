...
from module_qc_analysis_tools.analysis import (
    ob_loaded_module_cell_metrology,
    quad_pcb_metrology,
)
...
def main(
    ...
    """
    Performs analysis of METROLOGY for either Quad PCB or OB loaded module cell.
    """
    ...
    log.info("")
    log.info(" ===============================================")
    log.info(" \tPerforming METROLOGY analysis")
    log.info(" ===============================================")
    log.info("")
    ...
    for filename in sorted(allinputs):
        ...
        analyze = quad_pcb_metrology.analyze
        serial_number = input_jsons[0][0].get("serialNumber")
        component_code = itksn.parse(serial_number.encode("utf-8")).component_code
        if "OB_Loaded_Module_Cell" in component_code:
            analyze = ob_loaded_module_cell_metrology.analyze
