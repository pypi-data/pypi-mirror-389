...
class AuthProvider:
    def __init__(self, 
                 ...
                 client_id: str = "dbac0065-4e89-4d12-b9e6-e9319a970fff", 
                 tenant_id: str = "0bb5c534-5234-4f04-aae4-828e00611352",
                 api_scopes: str = "api://3272018a-91f0-47bc-8751-aa745e6bb4ca/access_as_user"):
