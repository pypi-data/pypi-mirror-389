...
def report_spec_list(*, show_family: bool = False, sort_by_family: bool = False) -> list[str]:
    """
    Return a list of available report spec (format set) names, with optional family display and sorting.

    Parameters
    - show_family: when True, include the family tag alongside each name (e.g., "Collections [Catalog]")
    ...
    Returns
    - list[str]: list of names (or name + family decorations if show_family=True)
