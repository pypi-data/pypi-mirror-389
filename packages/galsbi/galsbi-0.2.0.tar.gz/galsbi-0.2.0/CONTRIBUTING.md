...
> available [Documentation](https://cosmo-docs.phys.ethz.ch/galsbi/).

Before you ask a question, it is best to search for existing
[Issues](https://gitlab.com/cosmology-ethz/galsbi/issues) that might
...
- Open an [Issue](https://gitlab.com/cosmology-ethz/galsbi/issues/new).
...
- Determine if your bug is really a bug and not an error on your side
  ...
  you have read the
  [documentation](https://cosmo-docs.phys.ethz.ch/galsbi/). If you are
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://gitlab.com/cosmology-ethz/galsbi/issues?q=label%3Abug).
...
- Open an
  [Issue](https://gitlab.com/cosmology-ethz/galsbi/issues/new). (Since
...
- Make sure that you are using the latest version.
- Read the [documentation](https://cosmo-docs.phys.ethz.ch/galsbi/)
  carefully and find out if the functionality is already covered, maybe by
  an individual configuration.
- Perform a
  [search](https://gitlab.com/cosmology-ethz/galsbi/issues) to see if
...
[Gitlab issues](https://gitlab.com/cosmology-ethz/galsbi/issues).
