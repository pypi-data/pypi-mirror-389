...
deb http://repo.jethome.ru bookworm jethome-tools
deb http://repo.jethome.ru bookworm jethome-armbian
```

**Структура:**
- Base URL: `http://repo.jethome.ru`
...
**Структура:**
- Base URL: `http://repo.jethome.ru/bookworm` (с codename в пути)
...
```bash
# Release файл
curl -I http://repo.jethome.ru/dists/bookworm/jethome-bookworm/Release

# Packages
curl -I http://repo.jethome.ru/dists/bookworm/jethome-bookworm/main/binary-amd64/Packages
...
```bash
# Release файл
curl -I http://repo.jethome.ru/bookworm/jethome-bookworm/dists/jethome-bookworm/Release

# Packages
curl -I http://repo.jethome.ru/bookworm/jethome-bookworm/dists/jethome-bookworm/main/binary-amd64/Packages
...
```bash
# Старый формат
echo "deb http://repo.jethome.ru bookworm jethome-tools" | \
    sudo tee /etc/apt/sources.list.d/test-old.list
sudo apt update

# Новый формат
echo "deb http://repo.jethome.ru/bookworm jethome-tools main" | \
