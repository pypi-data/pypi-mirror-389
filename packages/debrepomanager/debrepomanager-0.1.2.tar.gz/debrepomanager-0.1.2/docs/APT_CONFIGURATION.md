...
```bash
# JetHome Tools
deb http://repo.jethome.ru/trixie jethome-tools main

# JetHome Armbian
deb http://repo.jethome.ru/trixie jethome-armbian main

# JetHome BSP для Trixie
deb http://repo.jethome.ru/trixie jethome-trixie main
```
...
```bash
# JetHome Tools
deb http://repo.jethome.ru/jammy jethome-tools main

# JetHome Armbian
deb http://repo.jethome.ru/jammy jethome-armbian main

# JetHome BSP для Jammy
deb http://repo.jethome.ru/jammy jethome-noble main
```
...
deb http://repo.jethome.ru/$CODENAME jethome-tools main
deb http://repo.jethome.ru/$CODENAME jethome-armbian main
EOF
```
...
deb http://repo.jethome.ru/$CODENAME jethome-tools main
deb http://repo.jethome.ru/$CODENAME jethome-armbian main
deb http://repo.jethome.ru/$CODENAME jethome-$CODENAME main
EOF
...
grep -r "repo.jethome.ru" /etc/apt/sources.list /etc/apt/sources.list.d/
...
curl -I http://repo.jethome.ru/$(lsb_release -sc)/jethome-tools/dists/jethome-tools/Release
...
```bash
# Test connectivity
ping -c 3 repo.jethome.ru

# Try with curl
curl -v http://repo.jethome.ru/
```
...
deb https://repo.jethome.ru/bookworm jethome-tools main
```
...
# Import GPG key
RUN wget -qO - http://repo.jethome.ru/pubkey.gpg | \
    gpg --dearmor -o /etc/apt/trusted.gpg.d/jethome.gpg

# Add repository
RUN echo "deb http://repo.jethome.ru/bookworm jethome-tools main" > \
