...
- [ ] Старый формат: `deb http://repo.site.com bookworm component` работает
- [ ] Новый формат: `deb http://repo.site.com/bookworm component main` работает
...
### Dual Format Support
- [ ] Старый формат работает: `deb http://repo.site.com codename component`
- [ ] Новый формат работает: `deb http://repo.site.com/codename component main`
