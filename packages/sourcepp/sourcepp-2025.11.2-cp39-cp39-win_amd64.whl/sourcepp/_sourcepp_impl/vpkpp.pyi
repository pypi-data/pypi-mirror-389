...
class PackFile:
    ...
    @staticmethod
    def open(path: str, callback: Optional[Callable[[str, Entry], None]] = None, request_callback: Optional[Callable[[PackFile, PackFile.OpenProperty], Sequence["std::byte"]]] = None) -> PackFile: ...
    ...
    def find_entry(self, path: str, include_unbaked: bool = True) -> Optional[Entry]: ...

    def read_entry(self, path: str) -> Optional[bytes]: ...

    def __getitem__(self, path: str) -> Optional[bytes]: ...

    def read_entry_text(self, path: str) -> Optional[str]: ...
    ...
    def bake(self, output_dir: str = '', bake_options: BakeOptions = ..., callback: Optional[Callable[[str, Entry], None]] = None) -> bool: ...
...
class VPK(PackFile):
    ...
    @staticmethod
    def open(path: str, callback: Optional[Callable[[str, Entry], None]] = None) -> PackFile: ...
...
class OL(PackFileReadOnly):
    ...
    def get_entry_notes(self, path: str) -> Optional[str]: ...
