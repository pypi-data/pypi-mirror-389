...
class PPL:
    ...
    def get_image_raw(self, lod: int) -> Optional[PPL.Image]: ...

    def get_image_as(self, new_format: ImageFormat, lod: int) -> Optional[PPL.Image]: ...

    def get_image_as_rgb888(self, lod: int) -> Optional[PPL.Image]: ...
...
class VTF:
    ...
    @property
    def width_without_padding(self) -> int: ...

    def width_without_padding_for_mip(self, mip: int = 0) -> int: ...
    ...
    @property
    def height_without_padding(self) -> int: ...

    def height_without_padding_for_mip(self, mip: int = 0) -> int: ...
    ...
    @property
    def depth(self, arg: int, /) -> int: ...

    @depth.setter
    def depth(self, arg: int, /) -> bool: ...
