# Generate a JSON schema of the Sh handler configuration.
...
from mkdocstrings_handlers.sh._internal.config import ShInputConfig, ShInputOptions
...
def on_post_build(config: MkDocsConfig, **kwargs: Any) -> None:  # noqa: ARG001
    ...
    @dataclass
    class ShHandlerSchema:
        sh: ShInputConfig

    adapter = TypeAdapter(ShHandlerSchema)
