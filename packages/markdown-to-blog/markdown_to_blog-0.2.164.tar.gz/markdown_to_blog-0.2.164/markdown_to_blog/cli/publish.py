...
def run_easy_publish(
    title, filename, is_draft, after, after_hour, blogid, thumbnail
):
    ...
    click.echo("Gemini API를 사용하여 키워드와 요약을 생성 중...")
    try:
        result = extract_keywords_and_summary(markdown_content)
