...
class TriggerJobRequestTypedDict(TypedDict):
    project_name: str
...
TriggerJobNotFoundCode = Literal["not-found",]
r"""The requested resource was not found
https://docs.intunedhq.com/docs/support/errors#not-found - Find more info here
"""


TriggerJobNotFoundCategory = Literal["user",]
r"""Errors caused by user actions or input
https://docs.intunedhq.com/docs/support/errors#user - Find more info here
"""


TriggerJobUnauthorizedCode = Literal["unauthorized",]
r"""The request requires user authentication
https://docs.intunedhq.com/docs/support/errors#unauthorized - Find more info here
"""


TriggerJobUnauthorizedCategory = Literal["user",]
r"""Errors caused by user actions or input
https://docs.intunedhq.com/docs/support/errors#user - Find more info here
"""


TriggerJobBadRequestCode = Literal["bad-request",]
r"""The request is invalid or malformed
https://docs.intunedhq.com/docs/support/errors#bad-request - Find more info here
"""


TriggerJobBadRequestCategory = Literal["user",]
r"""Errors caused by user actions or input
https://docs.intunedhq.com/docs/support/errors#user - Find more info here
"""


class TriggerJobResponseTypedDict(TypedDict):
    r"""Job triggered successfully."""

    job_run_id: str
    r"""The ID of the triggered job run."""
    message: str
    r"""A message indicating the result of the trigger action."""


class TriggerJobResponse(BaseModel):
    r"""Job triggered successfully."""

    job_run_id: Annotated[str, pydantic.Field(alias="jobRunId")]
    r"""The ID of the triggered job run."""
