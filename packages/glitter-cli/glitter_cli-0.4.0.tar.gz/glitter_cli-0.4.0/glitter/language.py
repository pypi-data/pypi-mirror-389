   ...
   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@   
     @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@     
       @@@@@@@@@@@@@@@@@@@@@@@@@@       
        ...
        "cli_send_target_help": "Target IP or IP:port / [IPv6]:port",
        ...
        "settings_header": "Settings — language: {language_name} ({language_code}), device: {device}, port: {port}, encryption: {encryption}, auto-accept: {auto_accept}",
        "settings_options": "[1] Change language  [2] Change device name  [3] Change transfer port  [4] Change download directory  [5] Clear history  [6] Transfer encryption  [7] Auto-accept trusted transfers  [8] Clear trusted fingerprints  [9] Back",
        ...
        "settings_auto_accept_prompt": "Auto-accept trusted transfers when idle? (current: {state}) [y/N]: ",
        "settings_auto_accept_updated": "Auto-accept trusted transfers is now {state}.",
   ...
   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@   
     @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@     
       @@@@@@@@@@@@@@@@@@@@@@@@@@       
        ...
        "cli_send_target_help": "目标 IP（支持 IPv4/IPv6，可选端口，如 192.168.1.5:45846 或 [fe80::1]:45846）",
        ...
        "settings_header": "设置 — 当前语言：{language_name} ({language_code})，设备名称：{device}，传输端口：{port}，传输加密：{encryption}，自动接收：{auto_accept}",
        "settings_options": "[1] 更改语言  [2] 更改设备名称  [3] 更改传输端口  [4] 更改默认接收目录  [5] 清空传输记录  [6] 传输加密  [7] 空闲时自动接收已信任设备  [8] 清空信任指纹  [9] 返回",
        ...
        "settings_auto_accept_prompt": "是否在空闲时自动接收已信任的设备？当前状态：{state}（输入 Y/N）：",
        "settings_auto_accept_updated": "自动接收功能已{state}。",
