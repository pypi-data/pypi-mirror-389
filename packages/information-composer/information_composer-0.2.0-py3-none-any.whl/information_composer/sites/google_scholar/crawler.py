...
class GoogleScholarCrawler(BaseSiteCollector):
    ...
    async def search_batch(
        ...
        delay_between_queries: Optional[float] = None,
        **kwargs: Any,
    ...
    def get_paper_by_id(self, google_scholar_id: str) -> Optional[GoogleScholarPaper]:
        """
    ...
    async def export_results(
        self,
        results: Union[SearchResult, List[GoogleScholarPaper]],
        output_file: str,
        format: str = "json",
    ) -> None:
        """
    ...
    def _validate_export_format(self, output_file: str, format: Optional[str]) -> str:
        """
