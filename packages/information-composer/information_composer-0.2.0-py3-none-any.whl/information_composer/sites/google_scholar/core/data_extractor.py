...
class DataExtractor:
    ...
    def extract_papers(
        self, elements: List[Union[Tag, BeautifulSoup, dict]], query: str = ""
    ...
    def _parse_authors_and_venue(
        self, element: Tag
    ) -> Tuple[List[str], Optional[Dict], Optional[int], Dict]:
    ...
    def _parse_venue_string(self, venue_text: str) -> Dict[str, Optional[str]]:
    ...
    def _extract_pdf_url(self, element: Tag) -> Optional[str]:
    ...
    def _extract_doi(self, element: Tag, title: str, venue_info: Dict) -> Optional[str]:
