...
class DOIDownloader:
    ...
    def download_by_doi(
        self, doi: str, output_dir: Union[str, Path] = "downloads"
    ) -> Optional[str]:
        """
        Download PDF by DOI.
    ...
    def download_single(
        self, doi: str, output_dir: Union[str, Path], file_name: Optional[str] = None
    ) -> DownloadResult:
        """
    ...
    def download_batch(
        self, dois: List[str], output_dir: Union[str, Path], delay: int = 2
    ) -> List[DownloadResult]:
        """
        ...
        print("\nDownload Results:")
        print("-" * 50)
        for result, (_doi, status_msg) in zip(download_results, status_messages):
