...
.. list-table::
   ...
   * - `1.0.0 <https://pypi.org/project/qblox-instruments/1.0.0/>`__
     - `0.13.0 <https://gitlab.com/qblox/releases/cluster_releases/-/releases/v0.13.0>`__
   * - `1.0.0 <https://pypi.org/project/qblox-instruments/1.0.0/>`__
     - `0.12.x <https://gitlab.com/qblox/releases/cluster_releases/-/releases/v0.12.1>`__
