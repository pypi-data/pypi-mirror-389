...
class DB(sumo.JSON.Container):
        ...
        for build_tag in self.iter_builds():
            ...
            for modulespec in modulespecs:
                ...
                if v is None:
                    ...
                    spec_st= sumo.ModuleSpec.Spec(modulename, v,
                                                     "eq").to_string()
    ...
    def iter_builds(self):
        ...
        """
        yield from sorted(self.datadict().keys())
    ...
    def module_specs(self, build_tag):
        ...
        for modulename in sorted(build_dict.keys()):
            ...
            m= sumo.ModuleSpec.Spec(modulename, versionname, "eq")
...
class DB_overlay(DB):
    ...
    def overlay(self, filename, use_lock= True):
        ...
        if ignored_keys:
            ...
            sumo.utils.errmessage(" ".join(sorted(ignored_keys)))
            # list of builds:
