...
def query_appStats_parse(query_subparsers):
    query_appStats_parser = query_subparsers.add_parser('appStats', 
            ...
            usage=get_help("query_appStats"), formatter_class=CustomSubparserHelpFormatter)
    ...
    query_appStats_parser.add_argument('-n', '--stream-events', dest='stream_events', help='Send events over network to host:port TCP')
