        ...
        try:
            ...
            if audio_size > 50 * 1024 * 1024:  # 50MB
                ...
                if os.path.exists(compressed_audio):
                    ...
                    print(f"[DEBUG] 压缩后音频: {audio_path}, 大小: {os.path.getsize(audio_path)/1024:.2f}KB")
            ...
            # 更详细的错误处理
            print(f"[DEBUG] API返回状态: {result.status_code}")
            print(f"[DEBUG] API返回消息: {getattr(result, 'message', 'N/A')}")
