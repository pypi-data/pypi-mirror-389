...
class ServerRegistry:
    ...
    def __init__(self, store: KeyValueStore, max_history: int = 3600):
        """
    ...
    async def heartbeat(self, port: int, data: Optional[Dict] = None):
        ...
        try:
            ...
            if info_bytes:
                ...
                await self.register_server(port, self._metadata)
        except Exception:
