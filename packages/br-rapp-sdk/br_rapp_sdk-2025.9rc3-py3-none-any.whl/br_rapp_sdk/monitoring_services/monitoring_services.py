...
class MonitoringServices:
    ...
    def _fetch_data_from_sql(
        ...
        Args:
            endpoint (DeliveryEndpoint): _description_
            query (str): _description_
            db (str, optional): _description_. Defaults to "testdb".
            usr (str, optional): _description_. Defaults to "oai".
            pwd (str, optional): _description_. Defaults to "linux".
    ...
    def fetch_data_from_endpoint(
        ...
        Args:
            ...
            db (str, optional): The database name. Defaults to "testdb".
            usr (str, optional): The database user. Defaults to "oai".
            pwd (str, optional): The database password. Defaults to "linux".
