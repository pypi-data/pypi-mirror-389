...
**26. maadstml.viperpreprocessproducetotopicstream(VIPERTOKEN,host,port,topic,producerid,offset,maxrows=0,enabletls=0,delay=100,
				...
				preprocessconditions='',identifier='',preprocesstopic='',jsoncriteria='',array=0,saveasarray=0,rawdataoutput=0)**
...
- Enter the jsconcriteria to extract data from a JSON.  You can preprocess raw json.
...
- Maximum number of sliding time windows to go back.
