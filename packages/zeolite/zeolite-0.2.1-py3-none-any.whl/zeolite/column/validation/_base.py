...
class BaseCheck:
    ...
    def get_validation_node(
        self, source_column: "ColumnRef", is_temporary: bool = True
    ) -> "ColumnNode":
        """Create a validation node for this check

        Args:
            source_column: The column reference to validate
            is_temporary: Whether this validation column should be temporary (default True).
                         Will be set to False if an alias is provided on the check.
        """
