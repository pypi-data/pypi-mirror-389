                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (StreamWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.mcp.v1.stream_pb2.PutRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=IMPORT_reboot_aio_idempotency.Idempotency(
                                alias=f'Task {IMPORT_uuid.UUID(bytes=task.task_id.task_uuid)}',
                            ),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (StreamWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.mcp.v1.stream_pb2.ReplayRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
...
class StreamSingletonServicer(StreamBaseServicer):
    ...
    async def _Create(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return StreamCreateResponseToProto(await self.Create(context, state, typed_request))
    ...
    async def _Put(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return StreamPutResponseToProto(await self.Put(context, state, typed_request))
    ...
    async def _Create(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = StreamCreateRequestFromProto(request)
                return StreamCreateResponseToProto(await instance.Create(context, typed_request))
        finally:
    ...
    async def _Put(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = StreamPutRequestFromProto(request)
                return StreamPutResponseToProto(await instance.Put(context, typed_request))
        finally:
            StreamServicer._state.set(None)
    ...
    async def _Replay(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = StreamReplayRequestFromProto(request)
                return StreamReplayResponseToProto(await instance.Replay(context, typed_request))
        finally:
            StreamServicer._state.set(None)
    ...
    async def _Messages(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                typed_request = StreamMessagesRequestFromProto(request)
                return StreamMessagesResponseToProto(await instance.Messages(context, typed_request))
        finally:
            StreamServicer._state.set(None)
...
class Stream:
    ...
    class WeakReference(IMPORT_typing.Generic[Stream_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            async def Replay(
                ...
                *,
            ...
            ) -> IMPORT_typing.AsyncIterator[rbt.mcp.v1.stream_pb2.ReplayResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.mcp.v1.stream_pb2.ReplayRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.mcp.v1.stream_pb2.ReplayRequest)
                ...
                __request__ = rbt.mcp.v1.stream_pb2.ReplayRequest(
            ...
            async def Messages(
                ...
                __context__: IMPORT_reboot_aio_external.ExternalContext | IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WorkflowContext,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> IMPORT_typing.AsyncIterator[rbt.mcp.v1.stream_pb2.MessagesResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
        ...
        class _Idempotently(IMPORT_typing.Generic[Stream_IdempotentlyScheduleTypeVar]):
            ...
            async def Put(
                ...
                *,
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.mcp.v1.stream_pb2.PutRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.mcp.v1.stream_pb2.PutRequest)
        ...
        class _Until:
            ...
            def read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> Stream.WeakReference._UntilChangesSatisfies[rbt.mcp.v1.stream_pb2.Stream]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
            ...
            def Replay(
                ...
                *,
                last_event_id: IMPORT_typing.Optional[str] = None,
            ) -> Stream.WeakReference._UntilChangesSatisfies[rbt.mcp.v1.stream_pb2.ReplayResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
            ...
            def Messages(
                ...
                __context__: IMPORT_reboot_aio_contexts.WorkflowContext,
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            ) -> Stream.WeakReference._UntilChangesSatisfies[rbt.mcp.v1.stream_pb2.MessagesResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
        ...
        class _Schedule:
            ...
            async def Put(
                ...
                *,
                ...
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.mcp.v1.stream_pb2.PutRequest(
    ...
    class _Forall:
        ...
        async def Create(
            ...
            __context__: IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
        ) -> list[google.protobuf.empty_pb2.Empty]:
        ...
        async def Put(
            ...
            *,
            ...
            event_id: IMPORT_typing.Optional[str] = None,
            related_request_id: IMPORT_typing.Optional[str] = None,
        ) -> list[rbt.mcp.v1.stream_pb2.PutResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Stream.ref(
                        id
        ...
        async def Replay(
            ...
            *,
            last_event_id: IMPORT_typing.Optional[str] = None,
        ) -> list[rbt.mcp.v1.stream_pb2.ReplayResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Stream.ref(
                        id
        ...
        async def Messages(
            ...
            __context__: IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WriterContext | IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
        ) -> list[rbt.mcp.v1.stream_pb2.MessagesResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Stream.ref(
                        id
