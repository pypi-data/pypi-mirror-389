# similar to: https://git.leximpact.dev/leximpact/simulateur-dotations-communes/leximpact-dotations-back/-/blob/31958c7450e75ddb4be584bea4d486f97140e2ab/leximpact_dotations_back/mapping/criteres_dgcl_2024.py

from leximpact_dotations_back.mapping.criteres_dgcl_2024 import variables_interet_annee_suivante_2024
...
filename_commune_criteres_2025 = "criteres_repartition_2025.csv"

infos_generales_2025 = {
    ...
    "Informations générales - Superficie de l'année N (en Ha)": "superficie",  # nouveau nom DGCL pour 2025
    "Dotation de solidarité rurale - Fraction péréquation - Population 3 à 16 ans": "population_enfants",
}

montants_dotations_2025 = {
...
criteres_2025 = {
    ...
    "Dotation de solidarité urbaine et de cohésion sociale - Revenu fiscal de référence des habitants de la commune": "revenu_total",  # OF - nouveau nom DGCL pour 2025
    ...
    "Dotation de solidarité rurale - Fraction bourg-centre - Commune classée ou bénéficiaire FRR": "zrr",  # OF - nouveau nom DGCL pour 2025
...
variables_openfisca_presentes_fichier_2025 = {
    ...
    "revenu_total": "Dotation de solidarité urbaine et de cohésion sociale - Revenu fiscal de référence des habitants de la commune",  # nouveau nom DGCL pour 2025
    "strate_demographique": "Informations générales - Strate démographique de l'année N",
    "zrr": "Dotation de solidarité rurale - Fraction bourg-centre - Commune classée ou bénéficiaire FRR",  # nouveau nom DGCL pour 2025
    ...
    "superficie": "Informations générales - Superficie de l'année N (en Ha)",  # nouveau nom DGCL pour 2025
...
colonnes_utiles_2025 = {
    ...
    "montant_commune_eligible": "Dotation de solidarité rurale - Fraction bourg-centre - Montant spontané de la commune éligible",   # nouveau nom DGCL pour 2025
...
variables_calculees_presentes_2025 = {
    ...
    "Dotation de solidarité rurale - Fraction bourg-centre - Montant spontané de la commune éligible": "dsr_montant_eligible_fraction_bourg_centre",  # nouveau nom DGCL pour 2025
...
variables_calculees_an_dernier_2025 = variables_interet_annee_suivante_2024


commune_columns_to_keep_2025 = {
    **infos_generales_2025,
    **montants_dotations_2025,
    **criteres_2025,
}
