...
class Migrator(Migrator):
    ...
    def migrate_from_1_1_11(self, globals_dict):
        ...
        def create_courses_courseoffer(id, title, content_id, provider_id,
                                       description):
            kw = dict()
            kw.update(id=id)
    ...
    def migrate_from_1_1_16(self, globals_dict):
        ...
        def create_system_siteconfig(
                id, default_build_method, signer1_id, signer2_id,
                signer1_function_id, signer2_function_id,
                default_event_type_id, site_calendar_id, max_auto_events,
                client_calendar_id, client_guestrole_id, team_guestrole_id,
                next_partner_id, site_company_id, prompt_calendar_id,
                system_note_type_id, propgroup_skills_id,
                propgroup_softskills_id, propgroup_obstacles_id, job_office_id,
                residence_permit_upload_type_id, work_permit_upload_type_id,
                driving_licence_upload_type_id, sector_id, cbss_org_unit,
                ssdn_user_id, ssdn_email, cbss_http_username,
                cbss_http_password):
            kw = dict()
            kw.update(id=id)
