...
def objects():
    ...
    kitchen_course = Course(line=obj,
                            start_date=dd.demo_date(-10),
                            monday=True,
                            start_time="8:00",
                            end_time="12:00",
                            user=ses.get_user(),
    ...
    kw = dict()
    kw.update(dd.str2kw('excerpt_title', _("Request for intervention")))
