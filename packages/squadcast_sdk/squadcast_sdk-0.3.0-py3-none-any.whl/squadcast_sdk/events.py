...
class Events(BaseSDK):
    def get(
        ...
        *,
        ...
        request = models.IncidentsGetIncidentEventsRequest(
        ...
        req = self._build_request(
            method="GET",
            path="/v3/incidents/{incidentID}/events",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="Incidents_getIncidentEvents",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.IncidentsGetIncidentEventsResponse, http_res
            )
