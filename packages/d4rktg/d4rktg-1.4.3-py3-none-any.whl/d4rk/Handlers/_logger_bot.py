...
class LoggerBotUtil:
    ...
    async def _start_command(cls, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            keyboard = [[InlineKeyboardButton("Open Web App", web_app=cls.web_app)]]
            await update.message.reply_text(DEFAULT_START_MESSAGE, reply_markup=InlineKeyboardMarkup(keyboard))
        except Exception as e:
