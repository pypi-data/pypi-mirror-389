"""
Manager for test_device collection.
"""

from typing import Any, Dict, List, Optional, Union

from testzeus_sdk.client import TestZeusClient
from testzeus_sdk.models.test_device import TestDevice

from .base import BaseManager


class TestDeviceManager(BaseManager):
    """
    ...
    def __init__(self, client: TestZeusClient) -> None:
        """
        Initialize the TestDevice manager

        Args:
            client: TestZeus client instance
        """
        super().__init__(client, "test_device", TestDevice)
