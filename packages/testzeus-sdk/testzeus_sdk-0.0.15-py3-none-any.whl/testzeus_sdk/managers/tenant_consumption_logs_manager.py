"""
Manager for tenant_consumption_logs collection.
"""

from typing import Any, Dict, List, Optional, Union

from testzeus_sdk.client import TestZeusClient
from testzeus_sdk.models.tenant_consumption_logs import TenantConsumptionLogs

from .base import BaseManager


class TenantConsumptionLogsManager(BaseManager):
    """
    ...
    def __init__(self, client: TestZeusClient) -> None:
        """
        Initialize the TenantConsumptionLogs manager

        Args:
            client: TestZeus client instance
        """
        super().__init__(client, "tenant_consumption_logs", TenantConsumptionLogs)
