    ...
    while True:
        ...
        if num_valid >= next_window_needed:
            ...
            if all_logits:
                ...
                if pred_tokens:
                    # align to the first committed frame's original timestamp
                    commit_first_frame = window_features[commit_start_rel].get("_frame", frame_count)
                    recognition_results.append({
                        'frame': commit_first_frame,
