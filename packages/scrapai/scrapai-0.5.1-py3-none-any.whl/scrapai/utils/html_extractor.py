...
class HTMLExtractor:
    ...
    def extract_with_beautifulsoup_path(
        self, html: str, path: List[Dict], soup=None
    ) -> Optional[str]:
        """
    ...
    async def render_page_with_captcha_solving(
        ...
        try:
            ...
            while try_count > 0:
                ...
                logger.warning(
                    f"CAPTCHA solving failed, retrying {try_count} more time(s)..."
                )
