        ...
        if service_info:
            ...
            if not self.base_url:
                ...
                if self._enable_logging:
                    logger.info(
                        f"Auto-detected base_url for {self.service_name}: {self.base_url}"
                    )
            ...
            if not self.model:
                ...
                if self._enable_logging:
                    logger.info(
                        f"Auto-detected model for {self.service_name}: {self.model}"
                    )
            ...
            if not self.base_url:
                ...
                if self._enable_logging:
                    logger.info(
                        f"Using custom base_url for unknown service: {self.base_url}"
                    )
