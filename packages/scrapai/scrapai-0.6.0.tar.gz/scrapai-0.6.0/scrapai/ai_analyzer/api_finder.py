...
class APIFinder:
    ...
    async def find_apis(
        ...
        return await self.browser_client.intercept_apis(
            url, search_keywords, wait_after_load=timeout_seconds
        )

    def discover_apis_from_page(
        self, html_content: str, keywords: Optional[List[str]] = None
    ) -> List[Dict]:
        """
