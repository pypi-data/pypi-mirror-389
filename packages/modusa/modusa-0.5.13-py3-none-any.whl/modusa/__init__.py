...
# Plotting related
from modusa.tools import hill_plot, plot, fig
...
__version__ = "0.5.13" # This is dynamically used by the documentation, and pyproject.toml; Only need to change it here; rest gets taken care of.
