...
class InputS3ConnectionTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputS3Connection(BaseModel):
    output: str
...
class InputS3PreprocessTypedDict(TypedDict):
...
class InputS3Preprocess(BaseModel):
...
class InputS3MetadatumTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputS3Metadatum(BaseModel):
    name: str
...
class InputS3CheckpointingTypedDict(TypedDict):
...
class InputS3TypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputS3ConnectionTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[InputS3PqTypedDict]
    ...
    aws_authentication_method: NotRequired[InputS3AuthenticationMethod]
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    ...
    signature_version: NotRequired[InputS3SignatureVersion]
    r"""Signature version to use for signing S3 requests"""
    ...
    metadata: NotRequired[List[InputS3MetadatumTypedDict]]
    ...
    checkpointing: NotRequired[InputS3CheckpointingTypedDict]
...
class InputS3(BaseModel):
    ...
    connections: Optional[List[InputS3Connection]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""

    pq: Optional[InputS3Pq] = None
    ...
    metadata: Optional[List[InputS3Metadatum]] = None
    r"""Fields to add to events from this input"""
    ...
    checkpointing: Optional[InputS3Checkpointing] = None
