...
class InputCrowdstrikeConnectionTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputCrowdstrikeConnection(BaseModel):
    output: str
...
class InputCrowdstrikePreprocessTypedDict(TypedDict):
...
class InputCrowdstrikePreprocess(BaseModel):
...
class InputCrowdstrikeMetadatumTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputCrowdstrikeMetadatum(BaseModel):
    name: str
...
class InputCrowdstrikeTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputCrowdstrikeConnectionTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[InputCrowdstrikePqTypedDict]
    ...
    metadata: NotRequired[List[InputCrowdstrikeMetadatumTypedDict]]
    ...
    tag_after_processing: NotRequired[InputCrowdstrikeTagAfterProcessing]
...
class InputCrowdstrike(BaseModel):
    ...
    connections: Optional[List[InputCrowdstrikeConnection]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""

    pq: Optional[InputCrowdstrikePq] = None
    ...
    metadata: Optional[List[InputCrowdstrikeMetadatum]] = None
    r"""Fields to add to events from this input"""
