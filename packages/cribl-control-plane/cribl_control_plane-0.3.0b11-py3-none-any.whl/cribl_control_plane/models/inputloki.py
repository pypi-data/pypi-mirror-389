...
class InputLokiConnectionTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputLokiConnection(BaseModel):
    output: str
...
class InputLokiMetadatumTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputLokiMetadatum(BaseModel):
    name: str
...
class InputLokiOauthParamTypedDict(TypedDict):
    name: str
...
class InputLokiOauthParam(BaseModel):
    name: str
    r"""OAuth parameter name"""
...
class InputLokiOauthHeaderTypedDict(TypedDict):
    name: str
    r"""OAuth header name"""
    value: str
...
class InputLokiOauthHeader(BaseModel):
    name: str
    r"""OAuth header name"""
...
class InputLokiTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputLokiConnectionTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[InputLokiPqTypedDict]
    host: NotRequired[str]
    r"""Address to bind on. Defaults to 0.0.0.0 (all addresses)."""
    tls: NotRequired[InputLokiTLSSettingsServerSideTypedDict]
    ...
    oauth_params: NotRequired[List[InputLokiOauthParamTypedDict]]
    ...
    oauth_headers: NotRequired[List[InputLokiOauthHeaderTypedDict]]
...
class InputLoki(BaseModel):
    ...
    connections: Optional[List[InputLokiConnection]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""

    pq: Optional[InputLokiPq] = None

    host: Optional[str] = "0.0.0.0"
    r"""Address to bind on. Defaults to 0.0.0.0 (all addresses)."""

    tls: Optional[InputLokiTLSSettingsServerSide] = None
    ...
    metadata: Optional[List[InputLokiMetadatum]] = None
    r"""Fields to add to events from this input"""
    ...
    oauth_params: Annotated[
        Optional[List[InputLokiOauthParam]], pydantic.Field(alias="oauthParams")
    ] = None
    r"""Additional parameters to send in the OAuth login request. @{product} will combine the secret with these parameters, and will send the URL-encoded result in a POST request to the endpoint specified in the 'Login URL'. We'll automatically add the content-type header 'application/x-www-form-urlencoded' when sending this request."""
