...
class InputCriblLakeHTTPConnectionTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputCriblLakeHTTPConnection(BaseModel):
    output: str
...
class InputCriblLakeHTTPMetadatum(BaseModel):
    name: str
...
class InputCriblLakeHTTPTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputCriblLakeHTTPConnectionTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[InputCriblLakeHTTPPqTypedDict]
    host: NotRequired[str]
    r"""Address to bind on. Defaults to 0.0.0.0 (all addresses)."""
    auth_tokens: NotRequired[List[str]]
    r"""Shared secrets to be provided by any client (Authorization: <token>). If empty, unauthorized access is permitted."""
    tls: NotRequired[InputCriblLakeHTTPTLSSettingsServerSideTypedDict]
...
class InputCriblLakeHTTP(BaseModel):
    ...
    connections: Optional[List[InputCriblLakeHTTPConnection]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""

    pq: Optional[InputCriblLakeHTTPPq] = None
    ...
    tls: Optional[InputCriblLakeHTTPTLSSettingsServerSide] = None
