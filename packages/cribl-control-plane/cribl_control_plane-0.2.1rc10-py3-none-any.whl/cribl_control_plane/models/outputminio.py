...
class OutputMinioKeyValueMetadatumTypedDict(TypedDict):
    value: str
    key: NotRequired[str]


class OutputMinioKeyValueMetadatum(BaseModel):
    value: str
...
class OutputMinioTypedDict(TypedDict):
    ...
    aws_authentication_method: NotRequired[OutputMinioAuthenticationMethod]
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    ...
    signature_version: NotRequired[OutputMinioSignatureVersion]
    r"""Signature version to use for signing MinIO requests"""
    object_acl: NotRequired[OutputMinioObjectACL]
    r"""Object ACL to assign to uploaded objects"""
    ...
    format_: NotRequired[OutputMinioDataFormat]
    r"""Format of the output data"""
    ...
    on_backpressure: NotRequired[OutputMinioBackpressureBehavior]
    r"""How to handle events when all receivers are exerting backpressure"""
    ...
    compress: NotRequired[OutputMinioCompression]
    r"""Data compression format to apply to HTTP content before it is delivered"""
    ...
    key_value_metadata: NotRequired[List[OutputMinioKeyValueMetadatumTypedDict]]
...
class OutputMinio(BaseModel):
    ...
    key_value_metadata: Annotated[
        Optional[List[OutputMinioKeyValueMetadatum]],
