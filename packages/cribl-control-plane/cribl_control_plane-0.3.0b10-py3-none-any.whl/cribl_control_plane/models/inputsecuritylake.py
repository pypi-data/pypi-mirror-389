...
class InputSecurityLakeConnectionTypedDict(TypedDict):
    output: str
    pipeline: NotRequired[str]


class InputSecurityLakeConnection(BaseModel):
    output: str
...
class InputSecurityLakePreprocessTypedDict(TypedDict):
...
class InputSecurityLakePreprocess(BaseModel):
...
class InputSecurityLakeMetadatumTypedDict(TypedDict):
    name: str
    value: str
    r"""JavaScript expression to compute field's value, enclosed in quotes or backticks. (Can evaluate to a constant.)"""


class InputSecurityLakeMetadatum(BaseModel):
    name: str
...
class InputSecurityLakeCheckpointingTypedDict(TypedDict):
...
class InputSecurityLakeCheckpointing(BaseModel):
...
class InputSecurityLakeTypedDict(TypedDict):
    ...
    connections: NotRequired[List[InputSecurityLakeConnectionTypedDict]]
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[InputSecurityLakePqTypedDict]
    ...
    aws_authentication_method: NotRequired[InputSecurityLakeAuthenticationMethod]
    r"""AWS authentication method. Choose Auto to use IAM roles."""
    ...
    signature_version: NotRequired[InputSecurityLakeSignatureVersion]
    r"""Signature version to use for signing S3 requests"""
    ...
    preprocess: NotRequired[InputSecurityLakePreprocessTypedDict]
    metadata: NotRequired[List[InputSecurityLakeMetadatumTypedDict]]
    ...
    checkpointing: NotRequired[InputSecurityLakeCheckpointingTypedDict]
    ...
    tag_after_processing: NotRequired[InputSecurityLakeTagAfterProcessing]
...
class InputSecurityLake(BaseModel):
    ...
    connections: Optional[List[InputSecurityLakeConnection]] = None
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""

    pq: Optional[InputSecurityLakePq] = None
    ...
    preprocess: Optional[InputSecurityLakePreprocess] = None

    metadata: Optional[List[InputSecurityLakeMetadatum]] = None
    r"""Fields to add to events from this input"""
    ...
    checkpointing: Optional[InputSecurityLakeCheckpointing] = None
