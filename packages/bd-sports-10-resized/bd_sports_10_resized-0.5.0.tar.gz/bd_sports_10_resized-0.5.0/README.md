...
- **Resized Version (224×224 pixels)** — optimized for ML/DL tasks  
  ...
  🔗 **Access:** [Mendeley Data](https://data.mendeley.com/datasets/rnh3x48nfb/2)
...
**Wazih Ullah Tanzim, Niloy Barua Supta, Shifatun Nur Shifa & Khondaker A. Mamun** (2025). _BD Sports-10 Dataset (224×224 Pixels, Resized Version)_ [Data set]. Mendeley Data, V2. https://doi.org/10.17632/rnh3x48nfb.2
