...
class MasterScene:
    ...
    def _create_audio_mix(self, video_path: str):
        ...
        if len(valid_audio_files) == 1:
            ...
            end_time = audio_element.start_time + audio_element.duration
            loop_count = 1
            ...
            filter_complex = ';'.join(audio_inputs) + f";{mix_inputs}amix=inputs={len(valid_audio_files)}:normalize=0:duration=longest[aout]"
