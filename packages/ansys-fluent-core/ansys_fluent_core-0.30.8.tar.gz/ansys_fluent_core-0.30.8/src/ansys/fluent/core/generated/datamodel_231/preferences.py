...
class Root(PyMenu):
    ...
    class General(PyMenu):
        ...
        def __init__(self, service, rules, path):
            ...
            self.LaplaceAutoPartitionDefault = self.__class__.LaplaceAutoPartitionDefault(service, rules, path + [("LaplaceAutoPartitionDefault", "")])
        ...
        class LaplaceAutoPartitionDefault(PyParameter):
            """
