...
class KlaudiaRcaRequest(BaseModel):
    ...
    issue_id: Optional[StrictStr] = Field(default=None, alias="issueId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KlaudiaRcaRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KlaudiaRcaRequest from a dict"""
        if obj is None:
            return None
