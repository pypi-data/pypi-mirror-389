...
class CreateClusterResponse(BaseModel):
    ...
    api_key: StrictStr = Field(
        description="API key associated with the cluster", alias="apiKey"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateClusterResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateClusterResponse from a dict"""
        if obj is None:
            return None
