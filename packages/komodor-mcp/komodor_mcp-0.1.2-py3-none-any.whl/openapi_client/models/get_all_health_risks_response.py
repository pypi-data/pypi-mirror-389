...
class GetAllHealthRisksResponse(BaseModel):
    ...
    has_more_results: StrictBool = Field(alias="hasMoreResults")
    violations: List[BasicViolation]
    __properties: ClassVar[List[str]] = ["totalResults", "hasMoreResults", "violations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAllHealthRisksResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAllHealthRisksResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "violations": (
                    [BasicViolation.from_dict(_item) for _item in obj["violations"]]
