...
class HttpRequestsMetadata(BaseModel):
    ...
    requests: Annotated[List[HttpRequest], Field(min_length=1, max_length=10)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HttpRequestsMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HttpRequestsMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "requests": (
                    [HttpRequest.from_dict(_item) for _item in obj["requests"]]
