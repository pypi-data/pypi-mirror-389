...
class CertificateExpirationSupportingData(BaseModel):
    ...
    certificates: List[CertificateExpirationData]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CertificateExpirationSupportingData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CertificateExpirationSupportingData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "certificates": (
                    [
                        CertificateExpirationData.from_dict(_item)
