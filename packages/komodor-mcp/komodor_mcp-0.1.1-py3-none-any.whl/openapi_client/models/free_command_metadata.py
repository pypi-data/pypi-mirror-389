...
class FreeCommandMetadata(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FreeCommandMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FreeCommandMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"command": obj.get("command"), "args": obj.get("args")}
        )
        return _obj
