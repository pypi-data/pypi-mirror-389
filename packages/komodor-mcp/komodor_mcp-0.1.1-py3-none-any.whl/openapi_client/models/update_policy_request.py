...
class UpdatePolicyRequest(BaseModel):
    ...
    statements: Optional[List[Optional[Statement]]] = None
    __properties: ClassVar[List[str]] = ["name", "description", "statements"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "statements": (
                    [Statement.from_dict(_item) for _item in obj["statements"]]
