...
class ColoredFormatter(logging.Formatter):
    """Custom formatter to colorize log level and message output."""
...
def create_logger(verbose: bool, name: str | None = None) -> logging.Logger:
    ...
    Args:
        verbose (bool): If True, set log level to DEBUG. Otherwise, CRITICAL.
        name (str, optional): Logger name. If None, root logger is used.
