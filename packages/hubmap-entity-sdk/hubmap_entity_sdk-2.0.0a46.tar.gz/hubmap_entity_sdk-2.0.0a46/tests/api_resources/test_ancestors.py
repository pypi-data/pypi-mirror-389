...
class TestAncestors:
    ...
    def test_method_retrieve(self, client: HubmapEntitySDK) -> None:
        ancestor = client.ancestors.retrieve(
            "id",
        )
        assert_matches_type(AncestorRetrieveResponse, ancestor, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve(self, client: HubmapEntitySDK) -> None:
        response = client.ancestors.with_raw_response.retrieve(
            "id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        ancestor = response.parse()
        assert_matches_type(AncestorRetrieveResponse, ancestor, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_retrieve(self, client: HubmapEntitySDK) -> None:
        with client.ancestors.with_streaming_response.retrieve(
            "id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: HubmapEntitySDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.ancestors.with_raw_response.retrieve(
                "",
            )


class TestAsyncAncestors:
    ...
    async def test_method_retrieve(self, async_client: AsyncHubmapEntitySDK) -> None:
        ancestor = await async_client.ancestors.retrieve(
            "id",
        )
        assert_matches_type(AncestorRetrieveResponse, ancestor, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncHubmapEntitySDK) -> None:
        response = await async_client.ancestors.with_raw_response.retrieve(
            "id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        ancestor = await response.parse()
        assert_matches_type(AncestorRetrieveResponse, ancestor, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncHubmapEntitySDK) -> None:
        async with async_client.ancestors.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncHubmapEntitySDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.ancestors.with_raw_response.retrieve(
                "",
            )
