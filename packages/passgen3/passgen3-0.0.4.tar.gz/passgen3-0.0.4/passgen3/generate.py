from .exceptions import ConfigurationConflictError, InvalidLengthError
import random
import string

def generate(length=8, only_int=False, without_int=False, only_letters=False, upper_letters=False, lower_letters=False, special_symbols=False):
    """
