...
class TrustwiseConfig(BaseModel):
    ...
    def get_safety_url(self, version: str) -> str:
        """Get safety API URL for specified version."""
        return urljoin(self.base_url, f"safety/{version}")
    
    def get_alignment_url(self, version: str) -> str:
        """Get alignment API URL for specified version."""
        return urljoin(self.base_url, f"alignment/{version}")
