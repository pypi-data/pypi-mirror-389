"""
Dummy Data Loading Validation Step Specification.
...
# Dummy Data Loading Validation Step Specification
DUMMY_DATA_LOADING_VALIDATION_SPEC = StepSpecification(
    step_type=get_spec_step_type_with_job_type("DummyDataLoading", "validation"),
    ...
    outputs=[
        OutputSpec(
            ...
            data_type="S3Uri",
            description="Validation data output from dummy data loading",
            semantic_keywords=[
                "validation",
                "val",
                "data",
        ...
        OutputSpec(
            ...
            data_type="S3Uri",
            description="Validation metadata output from dummy data loading",
            semantic_keywords=[
                "validation",
                "val",
                "metadata",
        ...
        OutputSpec(
            ...
            data_type="S3Uri",
            description="Validation signature output from dummy data loading",
            semantic_keywords=[
                "validation",
                "val",
                "signature",
