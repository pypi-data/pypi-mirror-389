"""
Temporal Sequence Normalization Calibration Step Specification.
...
# Temporal Sequence Normalization Calibration Step Specification
TEMPORAL_SEQUENCE_NORMALIZATION_CALIBRATION_SPEC = StepSpecification(
    step_type=get_spec_step_type_with_job_type("TemporalSequenceNormalization", "calibration"),
    ...
    dependencies=[
        DependencySpec(
            ...
            data_type="S3Uri",
            description="Raw calibration temporal sequence data for normalization",
        ),
        DependencySpec(
    ...
    outputs=[
        OutputSpec(
            ...
            data_type="S3Uri",
            description="Normalized calibration temporal sequences with consistent length and format",
        )
    ],
)
