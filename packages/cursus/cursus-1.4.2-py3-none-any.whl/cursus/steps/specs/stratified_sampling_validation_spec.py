"""
Stratified Sampling Validation Step Specification.
...
# Stratified Sampling Validation Step Specification
STRATIFIED_SAMPLING_VALIDATION_SPEC = StepSpecification(
    step_type=get_spec_step_type_with_job_type("StratifiedSampling", "validation"),
