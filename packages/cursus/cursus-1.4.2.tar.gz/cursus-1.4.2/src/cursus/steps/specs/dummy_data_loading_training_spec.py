"""
Dummy Data Loading Training Step Specification.
...
# Dummy Data Loading Training Step Specification
DUMMY_DATA_LOADING_TRAINING_SPEC = StepSpecification(
    step_type=get_spec_step_type_with_job_type("DummyDataLoading", "training"),
    ...
    dependencies=[
        DependencySpec(
            ...
            semantic_keywords=["data", "dataset", "input", "raw_data", "training", "train"],
            data_type="S3Uri",
            description="Training input data to be processed (from local or S3 source)",
        )
    ],
    outputs=[
        OutputSpec(
            ...
            data_type="S3Uri",
            description="Training data output from dummy data loading",
            semantic_keywords=[
                "training",
                "train",
                "data",
        ...
        OutputSpec(
            ...
            data_type="S3Uri",
            description="Training metadata output from dummy data loading",
            semantic_keywords=[
                "training",
                "train",
                "metadata",
        ...
        OutputSpec(
            ...
            data_type="S3Uri",
            description="Training signature output from dummy data loading",
            semantic_keywords=[
                "training",
                "train",
                "signature",
