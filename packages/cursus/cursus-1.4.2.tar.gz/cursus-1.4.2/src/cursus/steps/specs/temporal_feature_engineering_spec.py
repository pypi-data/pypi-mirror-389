"""
Temporal Feature Engineering Step Specification.
...
# Temporal Feature Engineering Step Specification
TEMPORAL_FEATURE_ENGINEERING_SPEC = StepSpecification(
    ...
    dependencies=[
        DependencySpec(
            ...
            data_type="S3Uri",
            description="Normalized temporal sequences for feature engineering",
        )
    ],
    outputs=[
        OutputSpec(
            ...
            data_type="S3Uri",
            description="Temporal feature tensors for machine learning model consumption",
        )
    ],
)
