"""
Temporal Sequence Normalization Testing Step Specification.
...
# Temporal Sequence Normalization Testing Step Specification
TEMPORAL_SEQUENCE_NORMALIZATION_TESTING_SPEC = StepSpecification(
    step_type=get_spec_step_type_with_job_type("TemporalSequenceNormalization", "testing"),
    ...
    dependencies=[
        DependencySpec(
            ...
            data_type="S3Uri",
            description="Raw testing temporal sequence data for normalization",
        ),
        DependencySpec(
    ...
    outputs=[
        OutputSpec(
            ...
            data_type="S3Uri",
            description="Normalized testing temporal sequences with consistent length and format",
        )
    ],
)
