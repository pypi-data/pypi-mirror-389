"""
Temporal Feature Engineering Calibration Step Specification.
...
# Temporal Feature Engineering Calibration Step Specification
TEMPORAL_FEATURE_ENGINEERING_CALIBRATION_SPEC = StepSpecification(
    step_type=get_spec_step_type_with_job_type("TemporalFeatureEngineering", "calibration"),
    ...
    dependencies=[
        DependencySpec(
            ...
            data_type="S3Uri",
            description="Normalized calibration temporal sequences for feature engineering",
        )
    ],
    outputs=[
        OutputSpec(
            ...
            data_type="S3Uri",
            description="Calibration temporal feature tensors for machine learning model consumption",
        )
    ],
)
