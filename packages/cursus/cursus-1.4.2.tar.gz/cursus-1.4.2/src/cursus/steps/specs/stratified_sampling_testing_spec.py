"""
Stratified Sampling Testing Step Specification.
...
# Stratified Sampling Testing Step Specification
STRATIFIED_SAMPLING_TESTING_SPEC = StepSpecification(
    step_type=get_spec_step_type_with_job_type("StratifiedSampling", "testing"),
