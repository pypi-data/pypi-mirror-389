"""
Temporal Feature Engineering Validation Step Specification.
...
# Temporal Feature Engineering Validation Step Specification
TEMPORAL_FEATURE_ENGINEERING_VALIDATION_SPEC = StepSpecification(
    step_type=get_spec_step_type_with_job_type("TemporalFeatureEngineering", "validation"),
    ...
    dependencies=[
        DependencySpec(
            ...
            data_type="S3Uri",
            description="Normalized validation temporal sequences for feature engineering",
        )
    ],
    outputs=[
        OutputSpec(
            ...
            data_type="S3Uri",
            description="Validation temporal feature tensors for machine learning model consumption",
        )
    ],
)
