"""
Risk Table Mapping Testing Step Specification.
...
# Risk Table Mapping Testing Step Specification
RISK_TABLE_MAPPING_TESTING_SPEC = StepSpecification(
    step_type=get_spec_step_type_with_job_type("RiskTableMapping", "testing"),
    ...
    outputs=[
        OutputSpec(
            ...
            aliases=["testing_data", "model_testing_data"],
