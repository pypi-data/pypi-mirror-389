import{U as g,j as o,cJ as y,ee as x,ef as z,eg as w,V as c,cB as P,eh as a,r as k,o as S,ei as L}from"./vendor-BFwRyIVY.js";import{u as R,P as C}from"./vendor-arizeai-CgjGxjER.js";import{L as E,h as I,r as j,i as D,j as A,F,k as T,P as M,l as G,M as t,n as _,D as O,o as V,E as N,p as q,q as B,s as W,t as U,v as d,w as $,x as J,y as K,z as H,B as Q,C as X,G as Y,H as Z,I as oo,J as ao,K as lo,N as m,O as p,Q as ro,U as co,V as go,W as eo,X as bo,Y as no,Z as io,_ as so,$ as to,a0 as mo,a1 as po,a2 as uo,a3 as fo,a4 as vo,a5 as ho,a6 as yo,a7 as u,a8 as xo,a9 as zo,aa as wo,ab as Po,ac as ko,ad as f,ae as v,af as So,ag as Lo,ah as Ro,ai as Co,aj as Eo,ak as Io,al as jo,am as Do,an as Ao,ao as Fo,ap as To,aq as Mo,ar as Go,as as _o,at as Oo,au as Vo,av as No,aw as n,ax as qo,ay as Bo,az as Wo,aA as Uo,aB as $o,aC as Jo,aD as Ko,aE as Ho}from"./pages-C4GJLpK7.js";import{gf as Qo,da as Xo,R as Yo,gg as Zo}from"./components-TxdyRlTR.js";import"./vendor-three-BtCyLs1w.js";import"./vendor-codemirror-CiRyWt7Y.js";import"./vendor-shiki-zLMa6-zt.js";import"./vendor-recharts-CBnx06WR.js";(function(){const b=document.createElement("link").relList;if(b&&b.supports&&b.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const e of r)if(e.type==="childList")for(const i of e.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function h(r){const e={};return r.integrity&&(e.integrity=r.integrity),r.referrerPolicy&&(e.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?e.credentials="include":r.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function s(r){if(r.ep)return;r.ep=!0;const e=h(r);fetch(r.href,e)}})();const oa=g`
  :root,
  .ac-theme {
...
`;function ta(){const{theme:l="dark"}=R();return o(y,{styles:g(la,aa,l==="dark"?ra:ca,ga(l),oa,ea,ba,na,ia,sa)})}const da=x(z(c(a,{path:"/",errorElement:o(n,{}),element:o($o,{}),children:[o(a,{path:"/v1/*",element:o(P,{to:"/",replace:!0})}),o(a,{path:"/login",element:o(E,{})}),o(a,{path:"/logout",element:o(I,{})}),o(a,{path:"/reset-password",element:o(D,{}),loader:j}),o(a,{path:"/reset-password-with-token",element:o(A,{})}),o(a,{path:"/forgot-password",element:o(F,{})}),o(a,{element:o(Uo,{}),loader:T,children:c(a,{element:o(Wo,{}),children:[o(a,{path:"/profile",handle:{crumb:()=>"profile"},element:o(M,{})}),o(a,{index:!0,loader:G}),c(a,{path:"/model",handle:{crumb:()=>"model"},element:o(q,{}),children:[o(a,{index:!0,element:o(t,{})}),o(a,{element:o(t,{}),children:o(a,{path:"dimensions",children:o(a,{path:":dimensionId",element:o(O,{}),loader:_})})}),o(a,{path:"embeddings",children:o(a,{path:":embeddingDimensionId",element:o(N,{}),loader:V,handle:{crumb:l=>l.embedding.name}})})]}),c(a,{path:"/projects",handle:{crumb:()=>"Projects"},element:o(ao,{}),children:[o(a,{index:!0,element:o(B,{})}),c(a,{path:":projectId",loader:W,handle:{crumb:l=>l.project.name},element:o(oo,{}),children:[o(a,{index:!0,element:o(U,{})}),c(a,{element:o(Z,{}),children:[o(a,{path:"traces",element:o($,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"spans",element:o(J,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"sessions",element:o(Q,{}),children:o(a,{path:":sessionId",element:o(H,{}),loader:K})}),o(a,{path:"config",element:o(X,{})}),o(a,{path:"metrics",element:o(Y,{})})]})]})]}),c(a,{path:"/datasets",handle:{crumb:()=>"Datasets"},children:[o(a,{index:!0,element:o(lo,{})}),c(a,{path:":datasetId",loader:m,handle:{crumb:l=>l.dataset.name},children:[c(a,{element:o(io,{}),loader:m,children:[o(a,{index:!0,element:o(p,{})}),o(a,{path:"experiments",element:o(p,{})}),o(a,{path:"examples",element:o(go,{}),loader:ro,children:o(a,{path:":exampleId",element:o(co,{})})}),o(a,{path:"versions",element:o(bo,{}),loader:eo}),o(a,{path:"evaluators",element:o(no,{})})]}),o(a,{path:"compare",element:o(so,{}),handle:{crumb:()=>"compare"}})]})]}),c(a,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(a,{index:!0,element:o(to,{})}),o(a,{path:"spans/:spanId",element:o(po,{}),loader:mo,handle:{crumb:l=>l.span.__typename==="Span"?`span ${l.span.spanId}`:"span unknown"}})]}),c(a,{path:"/prompts",handle:{crumb:()=>"Prompts"},children:[o(a,{index:!0,element:o(fo,{}),loader:uo}),c(a,{path:":promptId",loader:vo,shouldRevalidate:()=>!0,handle:{crumb:l=>l.prompt.__typename==="Prompt"?l.prompt.name:"unknown"},children:[c(a,{element:o(ko,{}),children:[o(a,{index:!0,element:o(ho,{})}),o(a,{path:"versions",loader:yo,element:o(zo,{}),children:o(a,{path:":versionId",loader:u,element:o(xo,{})})}),o(a,{path:"config",element:o(Po,{}),loader:wo})]}),o(a,{path:"versions/:versionId",loader:u,handle:{crumb:l=>l==null?void 0:l.promptVersion.id},children:o(a,{path:"playground",element:o(v,{}),loader:f,handle:{crumb:()=>"playground"}})}),o(a,{path:"playground",element:o(v,{}),loader:f,handle:{crumb:()=>"playground"}})]})]}),o(a,{path:"/apis",element:o(So,{}),handle:{crumb:()=>"APIs"}}),o(a,{path:"/support",element:o(Lo,{}),handle:{crumb:()=>"Support"}}),c(a,{path:"/settings",element:o(Vo,{}),handle:{crumb:()=>"Settings"},children:[o(a,{path:"general",loader:Ro,element:o(Co,{}),handle:{crumb:()=>"General"}}),o(a,{path:"providers",loader:Eo,element:o(Io,{}),handle:{crumb:()=>"AI Providers"}}),o(a,{path:"models",loader:jo,element:o(Do,{}),handle:{crumb:()=>"Models"}}),o(a,{path:"datasets",element:o(Ao,{}),handle:{crumb:()=>"Datasets"}}),o(a,{path:"annotations",loader:Fo,element:o(To,{}),handle:{crumb:()=>"Annotations"}}),o(a,{path:"data",element:o(Go,{}),handle:{crumb:()=>"Data Retention"},loader:Mo}),o(a,{path:"prompts",element:o(Oo,{}),loader:_o,handle:{crumb:()=>"Prompts"}})]}),o(a,{path:"/redirects/spans/:span_otel_id",loader:No,errorElement:o(n,{})}),o(a,{path:"/redirects/traces/:trace_otel_id",loader:qo,errorElement:o(n,{})}),o(a,{path:"/redirects/sessions/:session_id",loader:Bo,errorElement:o(n,{})})]})})]})),{basename:window.Config.basename});function ma(){return o(w,{router:da})}function pa(){return o(Jo,{children:o(Qo,{children:o(ua,{})})})}function ua(){const{theme:l}=Xo();return o(C,{theme:l,mountGlobalStyles:!1,children:c(S.RelayEnvironmentProvider,{environment:Yo,children:[o(ta,{}),o(Ko,{children:o(Zo,{children:o(Ho,{children:o(k.Suspense,{children:o(ma,{})})})})})]})})}const fa=document.getElementById("root"),va=L.createRoot(fa);va.render(o(pa,{}));
