...
class PackageLayout(BaseModel):
    ...
    coordinates: Coordinates = Field(description="The coordinates of the bottom left far corner of the package relative to the bottom left far corner of the parent package.")
    dimensions: Dimensions = Field(description="Overall dimensions and mass of the loaded package.")
