...
"""
Test the afterburner.apps.model_monitor.ModelMonitor2 application with various
config file errors.
"""
...
class TestConfigErrors(unittest.TestCase):
    """
    Test the afterburner.apps.model_monitor2.ModelMonitor2 application with various
    config file errors.
    """
    ...
    def test_no_stashcode(self):
        ...
        self.assertRaises(AppConfigError, ModelMonitor2, args)
    ...
    def test_var_name_without_formula(self):
        ...
        # NB: Test changed since this is not in fact an error.
        self.assertEqual(len(app.diag_names), 1)
    ...
    def test_invalid_data_cache_type(self):
        ...
        _create_app_config_file(self.cfg_file, app_config)
        args = ['-c', self.cfg_file]
        self.assertRaises(ValueError, ModelMonitor2, args)
