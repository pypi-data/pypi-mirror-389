...
# Simulate the cmp() builtin function, which was removed at Python 3.
...
#-------------------------------------------------------------------------------
# START OF CODE FRAGMENT COPIED FROM rose.env MODULE
#-------------------------------------------------------------------------------
...
def env_var_escape(text, match_mode=None):
    ...
    return ret
#-------------------------------------------------------------------------------
# END OF CODE FRAGMENT COPIED FROM rose.env MODULE
#-------------------------------------------------------------------------------
...
def sort_settings(setting_1, setting_2):
    ...
    if (not isinstance(setting_1, string_types) or
            not isinstance(setting_2, string_types)):
