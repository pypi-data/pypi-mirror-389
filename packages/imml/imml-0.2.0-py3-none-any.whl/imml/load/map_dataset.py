...
from torch.utils.data import DistributedSampler, ConcatDataset, DataLoader
from ..classify._vilt.transforms import keys_to_transforms
...
class MAPDataModule(LightningDataModule):
    def __init__(self, dataset, batch_size, vocab_size, num_workers, dist=False):
        super().__init__()
        self.dm = dataset
    ...
    def setup(self, stage):
        ...
        self.collate = functools.partial(
            self.dm.train_dataset.collate, mlm_collator=self.dm.mlm_collator,
        )
