...
[![PyPI version](https://badge.fury.io/py/pytrend.svg)](https://badge.fury.io/py/pytrend)
[![Downloads](https://pepy.tech/badge/pytrend)](https://pepy.tech/project/pytrend)
...
`PyTrend` is a CLI tool that allows you to easily fetch PyPI package download statistics and view trends directly from your terminal.
