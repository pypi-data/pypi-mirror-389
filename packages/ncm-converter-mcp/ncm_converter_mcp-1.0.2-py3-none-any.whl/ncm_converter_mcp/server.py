...
if __name__ == "__main__":
    main()
def _ensure_imghdr() -> None:
    """Ensure 'imghdr' module exists for Python >=3.13 environments."""
    try:
        ...
        pass
    import types
    def _what(file: str, h: bytes | None = None) -> str | None:
        try:
            if h is None:
