...
class TestHealth:
    ...
    @parametrize
    def test_method_check(self, client: Chunkr) -> None:
        health = client.health.check()
        assert_matches_type(str, health, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_check(self, client: Chunkr) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_check(self, client: Chunkr) -> None:
...
class TestAsyncHealth:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_check(self, async_client: AsyncChunkr) -> None:
        health = await async_client.health.check()
        assert_matches_type(str, health, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_check(self, async_client: AsyncChunkr) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_check(self, async_client: AsyncChunkr) -> None:
