...
class MethodTPCreate:
    ...
    Attributes:
        ...
        method_type_id (Literal[13] | Unset):  Default: 13.
    """
    ...
    method_type_id: Literal[13] | Unset = 13
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_type_id = cast(Literal[13] | Unset, d.pop("method_type_id", UNSET))
        if method_type_id != 13 and not isinstance(method_type_id, Unset):
            raise ValueError(f"method_type_id must match const 13, got '{method_type_id}'")
