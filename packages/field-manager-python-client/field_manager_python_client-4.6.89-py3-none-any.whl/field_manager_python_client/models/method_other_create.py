...
class MethodOTHERCreate:
    ...
    Attributes:
        ...
        method_type_id (Literal[23] | Unset):  Default: 23.
    """

    method_id: None | Unset | UUID = UNSET
    name: str | Unset = "OTHER"
    ...
    method_type_id: Literal[23] | Unset = 23
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_type_id = cast(Literal[23] | Unset, d.pop("method_type_id", UNSET))
        if method_type_id != 23 and not isinstance(method_type_id, Unset):
            raise ValueError(f"method_type_id must match const 23, got '{method_type_id}'")
