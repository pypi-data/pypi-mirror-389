...
class MethodRSCreate:
    ...
    Attributes:
        ...
        method_type_id (Literal[9] | Unset):  Default: 9.
    """
    ...
    method_type_id: Literal[9] | Unset = 9
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_type_id = cast(Literal[9] | Unset, d.pop("method_type_id", UNSET))
