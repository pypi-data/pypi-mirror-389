...
class MethodADCreate:
    ...
    Attributes:
        ...
        method_type_id (Literal[17] | Unset):  Default: 17.
    """
    ...
    method_type_id: Literal[17] | Unset = 17
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_type_id = cast(Literal[17] | Unset, d.pop("method_type_id", UNSET))
