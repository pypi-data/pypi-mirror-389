...
class MethodPTCreate:
    ...
    Attributes:
        ...
        method_type_id (Literal[14] | Unset):  Default: 14.
    """
    ...
    method_type_id: Literal[14] | Unset = 14
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_type_id = cast(Literal[14] | Unset, d.pop("method_type_id", UNSET))
