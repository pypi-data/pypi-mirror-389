...
T = TypeVar("T", bound="MethodDEFCreate")


@_attrs_define
class MethodDEFCreate:
    """
    Attributes:
        method_id (None | Unset | UUID):
        name (str | Unset):  Default: 'DEF'.
        ...
        method_type_id (Literal[20] | Unset):  Default: 20.
    """
    ...
    method_type_id: Literal[20] | Unset = 20
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_type_id = cast(Literal[20] | Unset, d.pop("method_type_id", UNSET))
        ...
        method_def_create.additional_properties = d
        return method_def_create
