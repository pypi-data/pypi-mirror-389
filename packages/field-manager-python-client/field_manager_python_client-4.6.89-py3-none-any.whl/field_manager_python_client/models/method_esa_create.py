...
class MethodESACreate:
    ...
    Attributes:
        ...
        method_type_id (Literal[15] | Unset):  Default: 15.
    """
    ...
    method_type_id: Literal[15] | Unset = 15
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_type_id = cast(Literal[15] | Unset, d.pop("method_type_id", UNSET))
