...
class MethodIWCreate:
    ...
    Attributes:
        ...
        method_type_id (Literal[21] | Unset):  Default: 21.
    """
    ...
    method_type_id: Literal[21] | Unset = 21
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_type_id = cast(Literal[21] | Unset, d.pop("method_type_id", UNSET))
        if method_type_id != 21 and not isinstance(method_type_id, Unset):
            raise ValueError(f"method_type_id must match const 21, got '{method_type_id}'")
