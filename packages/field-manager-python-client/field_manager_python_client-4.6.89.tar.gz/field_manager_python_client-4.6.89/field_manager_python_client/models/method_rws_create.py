...
class MethodRWSCreate:
    ...
    Attributes:
        ...
        method_type_id (Literal[7] | Unset):  Default: 7.
    """
    ...
    method_type_id: Literal[7] | Unset = 7
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_type_id = cast(Literal[7] | Unset, d.pop("method_type_id", UNSET))
        if method_type_id != 7 and not isinstance(method_type_id, Unset):
            raise ValueError(f"method_type_id must match const 7, got '{method_type_id}'")
