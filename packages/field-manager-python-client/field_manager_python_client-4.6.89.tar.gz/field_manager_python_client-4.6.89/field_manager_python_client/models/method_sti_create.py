...
T = TypeVar("T", bound="MethodSTICreate")


@_attrs_define
class MethodSTICreate:
    """
    Attributes:
        method_id (None | Unset | UUID):
        name (str | Unset):  Default: 'Sti'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_sti_create.additional_properties = d
        return method_sti_create
