...
class MethodSPTCreate:
    ...
    Attributes:
        ...
        method_type_id (Literal[11] | Unset):  Default: 11.
    """
    ...
    method_type_id: Literal[11] | Unset = 11
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_type_id = cast(Literal[11] | Unset, d.pop("method_type_id", UNSET))
        if method_type_id != 11 and not isinstance(method_type_id, Unset):
            raise ValueError(f"method_type_id must match const 11, got '{method_type_id}'")
