...
class MethodROCreate:
    ...
    Attributes:
        ...
        method_type_id (Literal[18] | Unset):  Default: 18.
    """
    ...
    method_type_id: Literal[18] | Unset = 18
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        method_type_id = cast(Literal[18] | Unset, d.pop("method_type_id", UNSET))
        if method_type_id != 18 and not isinstance(method_type_id, Unset):
            raise ValueError(f"method_type_id must match const 18, got '{method_type_id}'")
