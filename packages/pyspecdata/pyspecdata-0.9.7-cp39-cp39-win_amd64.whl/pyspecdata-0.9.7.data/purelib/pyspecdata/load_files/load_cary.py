...
(under GPL license)
taken from `here <https://github.com/Yohko/importtool/blob/master/Igor\
%20Procedures/import%20tool/import_VARIAN_CARY_BIN.ipf>`_.
    ...
    with open(filename, "rb") as fp:
        ...
        while fp.tell() < file_end - 4:
            ...
            if param["Tstore_type"] == "TContinuumStore":
                ...
                logging.info(
                    strm("skipping block of type", param["Tstore_type"])
                )
                fp.seek(param["blockoffset"] + param["blocklen"], 0)
    retval = {}
