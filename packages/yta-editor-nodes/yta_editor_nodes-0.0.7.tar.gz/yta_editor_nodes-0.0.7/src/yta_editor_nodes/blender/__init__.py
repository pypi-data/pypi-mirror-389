...
class AlphaBlender(_Blender):
    ...
    def __init__(
        ...
        # TODO: Maybe it is better to import it manually...
        # from yta_editor_nodes_cpu.blender import AlphaBlenderCPU
        # from yta_editor_nodes_gpu.blender import AlphaBlenderGPU

        # blender_cpu = AlphaBlenderCPU()
        # blender_gpu = AlphaBlenderGPU(
        #     opengl_context = None,
        #     # TODO: Do not hardcode please...
        #     output_size = (1920, 1080)
        # )
