...
operations.
"""
from yta_editor_nodes.timeline.abstract import Node
...
#     def __init__(self, inside_node: Node, mask_func):
...
"""
# class SplitterCombinerNode(Node):
...
#     """
#     def __init__(self, node: Node, blend_mode="add"):
#         self.node = node
