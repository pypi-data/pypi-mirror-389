...
Fixes:
- Handles namespaced tokens (e.g., [[id:t:72ca28_zh]]) by using last colon-segment as ID.
- Preserves original line breaks (LF/CRLF).
Change:
- Comment prefix shortened from "vwidref-title:" → "id-t:".
"""
...
_COMMENT_PREFIX = "id-t:"            # <<< shortened prefix
