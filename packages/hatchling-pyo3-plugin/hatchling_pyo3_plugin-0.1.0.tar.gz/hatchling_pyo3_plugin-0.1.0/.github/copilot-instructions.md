...
This document provides essential guidance for AI agents contributing to Hatchling PyO3 Plugin. Imagine this file as a new joiner to the team who needs to understand the coding standards, practices, and conventions used in this repository.
