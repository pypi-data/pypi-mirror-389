Hier ist dein Konzept – **unverändert in Struktur & Inhalt**, aber mit dem Bibliotheksnamen **`bitranox_template_py_lib`** durchgängig aktualisiert.
...
* **Dump-API:** `bitranox_template_py_lib.dump(format="text"|"json"|"html", path=None)`
...
**Modulname:** `bitranox_template_py_lib`

```python
import bitranox_template_py_lib as log
...
>
> * Minimal: `pip install bitranox_template_py_lib`
> * Mit Rich: `pip install bitranox_template_py_lib[rich]`
> * Mit Graylog: `pip install bitranox_template_py_lib[gelf]`
> * Komplett: `pip install bitranox_template_py_lib[rich,gelf,journald,eventlog]`
...
Wenn du willst, liefere ich dir als Nächstes ein kleines **Starter-Skeleton** für `bitranox_template_py_lib` (Package-Layout, Handler-Stubs, Rich-Theme, HTML-Dump) – ready to run.
