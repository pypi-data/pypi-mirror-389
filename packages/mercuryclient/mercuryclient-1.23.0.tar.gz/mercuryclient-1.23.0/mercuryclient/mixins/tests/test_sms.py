...
class SMSMixinTest(TestCase):
    ...
    def test_send_sms_request_with_template_id(self):
        client = MercuryApi(
            {
                "username": "username",
                "password": "password",
    ...
    def test_send_sms_ignores_blank_template_id(self):
        client = MercuryApi(
            {
                "username": "username",
                "password": "password",
        ...
        client.send_sms(
            ...
            "some_provider",
            "some_profile",
            template_id="   ",  # blank/whitespace
        )

        # template_id should NOT be in the payload
        self.post_api_mock.assert_called_with(
            "api/v1/sms/",
            data={
                "provider": "some_provider",
