...
def _test() -> None:
    ...
    from pyspark.util import is_dbsql  # Edge

    os.chdir(os.environ["SPARK_HOME"])

    # BEGIN-EDGE
    if is_dbsql():
        del pyspark.pandas.frame.DataFrame.apply.__doc__
        del pyspark.pandas.frame.DataFrame.applymap.__doc__
        del pyspark.pandas.frame.DataFrame.at_time.__doc__
        del pyspark.pandas.frame.DataFrame.map.__doc__
        del pyspark.pandas.frame.DataFrame.query.__doc__
        del pyspark.pandas.frame.DataFrame.rename.__doc__
        del pyspark.pandas.frame.DataFrame.transform.__doc__
    # END-EDGE
