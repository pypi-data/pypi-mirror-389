...
class PythonEnvironment(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def dependencies(
        ...
        """(Optional) List of PyPi dependencies,
        Each dependency is a pip requirement file line
        https://pip.pypa.io/en/stable/reference/requirements-file-format/
        E.g. dependencies: ["foo>=0.0.1", "simplejson==3.19.*"].
        """
    def __init__(
        self,
        *,
    ...
    def ClearField(
        self, field_name: typing_extensions.Literal["dependencies", b"dependencies"]
    ) -> None: ...

global___PythonEnvironment = PythonEnvironment
...
class PythonUDF(google.protobuf.message.Message):
    ...
    @property
    def environment(self) -> global___PythonEnvironment:
    ...
    def __init__(
        ...
        *,
        ...
        environment: global___PythonEnvironment | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
    ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_environment", b"_environment"]
    ) -> typing_extensions.Literal["environment"] | None: ...
