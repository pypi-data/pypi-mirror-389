...
class FramedSerializer(Serializer):
    ...
    def _read_func_from_code_literal(self, stream):
        ...
        if eval_type == PythonEvalType.SQL_SCALAR_PANDAS_ITER_UDF:
            ...
            if handler_name:
                raise PySparkAssertionError("Handler name is not allowed for scalar Python UDFs")
...
def write_structured_exception(error_class, error_message, stack_lines, stream):
    """
