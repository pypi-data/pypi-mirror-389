...
class RetriesExceeded(PySparkException):
    ...
    .. deprecated:: 3.5.0
        RetriesExceeded is deprecated and will be removed in a future version.
        The retry system now throws the original exception instead of wrapping it.
        Use the original exception type for error handling.
    """
...
# BEGIN-EDGE
class PySparkCodeLiteralCompilationException(PySparkException):
    """
    Represents an exception which is thrown from a code literal function.
    """
# END-EDGE
