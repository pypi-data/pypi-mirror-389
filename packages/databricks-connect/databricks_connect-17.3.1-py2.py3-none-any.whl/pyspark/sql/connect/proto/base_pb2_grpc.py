...
class SparkConnectServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DrainSession = channel.unary_unary(
            "/spark.connect.SparkConnectService/DrainSession",
            request_serializer=spark_dot_connect_dot_base__pb2.DrainSessionRequest.SerializeToString,
            response_deserializer=spark_dot_connect_dot_base__pb2.DrainSessionResponse.FromString,
            _registered_method=True,
        )
...
class SparkConnectServiceServicer(object):
    ...
    def DrainSession(self, request, context):
        """BEGIN-EDGE
        DrainSession puts a session into a draining state where only essential requests are accepted.
        Used for live session migration between clusters.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
...
def add_SparkConnectServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "DrainSession": grpc.unary_unary_rpc_method_handler(
            servicer.DrainSession,
            request_deserializer=spark_dot_connect_dot_base__pb2.DrainSessionRequest.FromString,
            response_serializer=spark_dot_connect_dot_base__pb2.DrainSessionResponse.SerializeToString,
        ),
    }
...
class SparkConnectService(object):
    ...
    def DrainSession(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/spark.connect.SparkConnectService/DrainSession",
            spark_dot_connect_dot_base__pb2.DrainSessionRequest.SerializeToString,
            spark_dot_connect_dot_base__pb2.DrainSessionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
