...
class PythonUDTF(google.protobuf.message.Message):
    ...
    @property
    def environment(self) -> pyspark.sql.connect.proto.expressions_pb2.PythonEnvironment:
    ...
    def __init__(
        ...
        *,
        ...
        command: builtins.bytes = ...,
        python_ver: builtins.str = ...,
        environment: pyspark.sql.connect.proto.expressions_pb2.PythonEnvironment | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
