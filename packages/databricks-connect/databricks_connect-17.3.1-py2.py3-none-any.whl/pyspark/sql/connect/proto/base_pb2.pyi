...
class Plan(google.protobuf.message.Message):
    ...
    - OSS (Open Source Spark): 1-799
    - DBR (Databricks Runtime): 800-997
    - Extensions: 998-999 (reserved for protocol extensions like google.protobuf.Any)
    END-EDGE
...
class DrainSessionRequest(google.protobuf.message.Message):
    """BEGIN-EDGE"""
    ...
    SESSION_ID_FIELD_NUMBER: builtins.int
    USER_CONTEXT_FIELD_NUMBER: builtins.int
    LOGICAL_TIMESTAMP_FIELD_NUMBER: builtins.int
    ...
    def user_context(self) -> global___UserContext:
        ...
        server side.
        """
    logical_timestamp: builtins.int
    """(Required)

    Logical timestamp for session draining control. Requests with timestamps <= this value
    will be rejected once draining begins.
    """
    timeout_ms: builtins.int
    """(Optional)

    Timeout in milliseconds for the draining operation. Defaults to 30000ms if not specified.
    """
    client_type: builtins.str
    """Provides optional information about the client sending the request. This field
    can be used for language or version specific information and is only intended for
...
global___DrainSessionRequest = DrainSessionRequest

class DrainSessionResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    class _DrainStatusEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            DrainSessionResponse._DrainStatus.ValueType
        ],
        builtins.type,
    ):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        DRAIN_STATUS_UNSPECIFIED: DrainSessionResponse._DrainStatus.ValueType  # 0
        DRAINING: DrainSessionResponse._DrainStatus.ValueType  # 1
        DRAINED: DrainSessionResponse._DrainStatus.ValueType  # 2
        FAILED: DrainSessionResponse._DrainStatus.ValueType  # 3

    class DrainStatus(_DrainStatus, metaclass=_DrainStatusEnumTypeWrapper): ...
    DRAIN_STATUS_UNSPECIFIED: DrainSessionResponse.DrainStatus.ValueType  # 0
    DRAINING: DrainSessionResponse.DrainStatus.ValueType  # 1
    DRAINED: DrainSessionResponse.DrainStatus.ValueType  # 2
    FAILED: DrainSessionResponse.DrainStatus.ValueType  # 3
    ...
    MESSAGE_FIELD_NUMBER: builtins.int
    session_id: builtins.str
    """Session id of the session on which the drain executed."""
    server_side_session_id: builtins.str
    """Server-side generated idempotency key that the client can use to assert that the server side
    session has not changed.
    """
    status: global___DrainSessionResponse.DrainStatus.ValueType
    """The status of the draining operation."""
    @property
    def session_info(self) -> global___SessionInfo:
        """Optional session information returned when status is DRAINING or FAILED."""
    message: builtins.str
    """Optional message providing additional details, especially when status is FAILED."""
    def __init__(
        self,
        *,
        session_id: builtins.str = ...,
        server_side_session_id: builtins.str | None = ...,
        status: global___DrainSessionResponse.DrainStatus.ValueType = ...,
    ...
    def HasField(
        ...
        field_name: typing_extensions.Literal[
            "_message",
            b"_message",
            "_server_side_session_id",
            b"_server_side_session_id",
            "_session_info",
            b"_session_info",
            "message",
            b"message",
    ...
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal[
            "_server_side_session_id", b"_server_side_session_id"
        ],
    ) -> typing_extensions.Literal["server_side_session_id"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_session_info", b"_session_info"]
    ) -> typing_extensions.Literal["session_info"] | None: ...

global___DrainSessionResponse = DrainSessionResponse

class SessionInfo(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    class _PersistenceStatus:
        ValueType = typing.NewType("ValueType", builtins.int)
        V: typing_extensions.TypeAlias = ValueType

    class _PersistenceStatusEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            SessionInfo._PersistenceStatus.ValueType
        ],
        builtins.type,
    ):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        PERSISTENCE_STATUS_UNSPECIFIED: SessionInfo._PersistenceStatus.ValueType  # 0
        DISABLED: SessionInfo._PersistenceStatus.ValueType  # 1
        PERSISTING: SessionInfo._PersistenceStatus.ValueType  # 2
        PERSISTED: SessionInfo._PersistenceStatus.ValueType  # 3
        FAILED: SessionInfo._PersistenceStatus.ValueType  # 4

    class PersistenceStatus(_PersistenceStatus, metaclass=_PersistenceStatusEnumTypeWrapper): ...
    PERSISTENCE_STATUS_UNSPECIFIED: SessionInfo.PersistenceStatus.ValueType  # 0
    DISABLED: SessionInfo.PersistenceStatus.ValueType  # 1
    PERSISTING: SessionInfo.PersistenceStatus.ValueType  # 2
    PERSISTED: SessionInfo.PersistenceStatus.ValueType  # 3
    FAILED: SessionInfo.PersistenceStatus.ValueType  # 4

    ACTIVE_REQUEST_COUNT_FIELD_NUMBER: builtins.int
    ACTIVE_EXECUTION_COUNT_FIELD_NUMBER: builtins.int
    ACTIVE_STREAMING_QUERY_COUNT_FIELD_NUMBER: builtins.int
    HAS_ABANDONED_EXECUTIONS_FIELD_NUMBER: builtins.int
    PERSISTENCE_STATUS_FIELD_NUMBER: builtins.int
    active_request_count: builtins.int
    """Number of active requests in the session."""
    active_execution_count: builtins.int
    """Number of active executions in the session."""
    active_streaming_query_count: builtins.int
    """Number of active streaming queries in the session."""
    has_abandoned_executions: builtins.bool
    """Whether any executions in the session have been abandoned."""
    persistence_status: global___SessionInfo.PersistenceStatus.ValueType
    """Status of session persistence."""
    def __init__(
        self,
        *,
        active_request_count: builtins.int = ...,
        ...
        active_streaming_query_count: builtins.int = ...,
        has_abandoned_executions: builtins.bool = ...,
        persistence_status: global___SessionInfo.PersistenceStatus.ValueType | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "_persistence_status",
            b"_persistence_status",
            "persistence_status",
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            ...
            b"active_execution_count",
            "active_request_count",
            b"active_request_count",
            "active_streaming_query_count",
            b"active_streaming_query_count",
            "has_abandoned_executions",
            b"has_abandoned_executions",
            "persistence_status",
            b"persistence_status",
        ],
    ) -> None: ...
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_persistence_status", b"_persistence_status"]
    ) -> typing_extensions.Literal["persistence_status"] | None: ...
