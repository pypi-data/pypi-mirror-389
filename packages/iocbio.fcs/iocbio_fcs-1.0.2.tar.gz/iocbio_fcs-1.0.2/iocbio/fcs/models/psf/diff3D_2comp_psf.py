...
# Model: 3D-diffusion - 2 components - PSF
class Diff3D_2comp_psf(AbstractModel):
    ...
    def set_parameters_isotropic(self, concentration1, diffusion1, concentration2, diffusion2, psf_scale=1):
    ...
    def integrate_propagator(self, x, y, z, t):
        ...
        integ = p1 * ((conc1_micrometer * integ1) + (conc2_micrometer * integ2))
        return integ
