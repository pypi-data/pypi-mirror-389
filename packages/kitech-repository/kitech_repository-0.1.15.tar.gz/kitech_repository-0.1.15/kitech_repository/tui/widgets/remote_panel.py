...
class RemotePanel(Container):
    ...
    def on_file_operation_completed(self, message) -> None:
        ...
        logger.info("RemotePanel: File operation completed, refreshing file list")
    ...
    async def action_download_selected(self) -> None:
        ...
        logger.info(
            f"[F2] Selected: {selected_file.name}, current_path: {self.current_path}, full_path: {selected_path}, is_directory: {is_directory}"
        )
