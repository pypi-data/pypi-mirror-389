...
class CameraOperation():
    ...
    def __init__(self, obj_cam, st_device_list, n_connect_num=0, b_open_device=False, b_start_grabbing=False,
                 ...
                 b_thread_closed=False, st_frame_info=None, buf_cache=None, b_exit=False, b_save_bmp=False,
    ...
    def Open_device(self):
        if False == self.b_open_device:
            ...
            # ch:探测网络最佳包大小(只对GigE相机有效) | en:Detection network optimal package size(It only works for the GigE device)
