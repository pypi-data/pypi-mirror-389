<div align="center">
  <img src="https://raw.githubusercontent.com/zamalali/langchain-code/main/assets/logo.png" alt="LangCode Logo" width="180" />
  
  <h1>LangCode</h1>
  <p><em>The only CLI you'll ever need!</em></p>
  
  <img src="https://raw.githubusercontent.com/zamalali/langchain-code/main/assets/cmd.png" alt="LangCode Home Screen" width="100%" />
  
  <p>
    <a href="https://pypi.org/project/langchain-code/"><img src="https://badge.fury.io/py/langchain-code.svg" alt="PyPI version"></a>
    <a href="https://pepy.tech/project/langchain-code"><img src="https://static.pepy.tech/personalized-badge/langchain-code?period=total&units=international_system&left_color=black&right_color=green&left_text=downloads" alt="PyPI Downloads"></a>
    <img src="https://img.shields.io/pypi/pyversions/langchain-code.svg" alt="Python Versions">
    <a href="https://github.com/zamalali/langchain-code/blob/main/LICENSE"><img src="https://img.shields.io/github/license/zamalali/langchain-code" alt="License"></a>
    <a href="https://github.com/zamalali/langchain-code/actions/workflows/docker-build.yml"><img src="https://github.com/zamalali/langchain-code/actions/workflows/docker-build.yml/badge.svg" alt="Docker Build"></a>
    <a href="https://hub.docker.com/r/at384/langchain-code"><img src="https://img.shields.io/docker/pulls/at384/langchain-code" alt="Docker Pulls"></a>
...
**Launch the Interactive Launcher:** Just type `langcode` in your terminal and hit Enter. This opens a user-friendly interactive menu where you can easily configure your session and access various functionalities without needing to remember specific command-line arguments. See the image shown above.
