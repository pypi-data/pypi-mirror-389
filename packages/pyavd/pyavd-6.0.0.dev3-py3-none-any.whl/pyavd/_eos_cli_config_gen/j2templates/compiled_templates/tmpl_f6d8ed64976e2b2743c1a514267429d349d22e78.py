...
name = 'eos/aaa-server-groups-radius.j2'
...
def root(context, missing=missing):
    ...
    pass
    for l_1_aaa_server_group in t_2(context, t_1((undefined(name='aaa_server_groups') if l_0_aaa_server_groups is missing else l_0_aaa_server_groups), 'name'), 'type', 'equalto', 'radius'):
        _loop_vars = {}
        pass
