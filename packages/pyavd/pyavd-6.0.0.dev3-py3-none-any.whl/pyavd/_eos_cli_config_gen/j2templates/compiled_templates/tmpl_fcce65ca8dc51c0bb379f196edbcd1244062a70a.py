...
def root(context, missing=missing):
    ...
    if t_2(environment.getattr((undefined(name='uc_tx_queue') if l_0_uc_tx_queue is missing else l_0_uc_tx_queue), 'bandwidth_percent')):
        ...
        yield '\n'
    elif t_2(environment.getattr((undefined(name='uc_tx_queue') if l_0_uc_tx_queue is missing else l_0_uc_tx_queue), 'bandwidth_guaranteed_percent')):
        pass
    ...
    if t_2(environment.getattr((undefined(name='uc_tx_queue') if l_0_uc_tx_queue is missing else l_0_uc_tx_queue), 'random_detect')):
        ...
        if ((t_2(environment.getattr(environment.getattr(environment.getattr(environment.getattr((undefined(name='uc_tx_queue') if l_0_uc_tx_queue is missing else l_0_uc_tx_queue), 'random_detect'), 'ecn'), 'threshold'), 'min')) and t_2(environment.getattr(environment.getattr(environment.getattr(environment.getattr((undefined(name='uc_tx_queue') if l_0_uc_tx_queue is missing else l_0_uc_tx_queue), 'random_detect'), 'ecn'), 'threshold'), 'max'))) and t_2(environment.getattr(environment.getattr(environment.getattr(environment.getattr((undefined(name='uc_tx_queue') if l_0_uc_tx_queue is missing else l_0_uc_tx_queue), 'random_detect'), 'ecn'), 'threshold'), 'units'))):
            pass
