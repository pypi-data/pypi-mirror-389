...
def root(context, missing=missing):
    ...
    pass
    for l_1_name_server_group in t_2((undefined(name='ip_name_server_groups') if l_0_ip_name_server_groups is missing else l_0_ip_name_server_groups), 'name'):
        ...
        if ((not (undefined(name='flattened_name_servers') if l_1_flattened_name_servers is missing else l_1_flattened_name_servers)) and t_3(environment.getattr(l_1_name_server_group, 'name_servers'))):
            ...
            _loop_vars['flattened_name_servers'] = l_1_flattened_name_servers
        for l_2_server in t_2(t_2(t_2((undefined(name='flattened_name_servers') if l_1_flattened_name_servers is missing else l_1_flattened_name_servers), 'ip_address'), 'vrf'), 'priority', default_value='0'):
