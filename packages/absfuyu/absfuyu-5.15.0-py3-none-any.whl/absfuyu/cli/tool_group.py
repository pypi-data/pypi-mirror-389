...
Version: 5.15.0
Date updated: 05/11/2025 (dd/mm/yyyy)
"""
...
def remove_dup_img(dir_path: str, threshold: bool, recursive_mode: bool, keep_mode: str) -> None:
    ...
    engine.remove_duplicate_images(threshold=threshold, recursive=recursive_mode, keep_mode=keep_mode)
    click.echo("Done")
