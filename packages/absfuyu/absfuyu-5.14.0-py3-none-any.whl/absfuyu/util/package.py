...
class PackageManager(BaseClass):
    ...
    @overload
    def __init__(self, package: str, import_name: str | None = None) -> None: ...
    @overload
    def __init__(
        self, package: str, import_name: str | None = None, auto_upgrade: bool = False, auto_bootstrap: bool = True
    ) -> None: ...
    def __init__(
        self,
        package: str,
