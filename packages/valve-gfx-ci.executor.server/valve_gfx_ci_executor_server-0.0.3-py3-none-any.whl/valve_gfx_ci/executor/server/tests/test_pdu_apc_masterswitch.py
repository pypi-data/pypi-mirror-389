...
def test_driver_ApcMasterswitchPDU_check_OIDs():
    ...
    assert pdu.outlet_labels_oid == "1.3.6.1.4.1.318.1.1.4.4.2.1.4"
    assert pdu.outlet_status_oid(10) == "1.3.6.1.4.1.318.1.1.4.4.2.1.3.10"
    assert pdu.outlet_ctrl_oid(10) == "1.3.6.1.4.1.318.1.1.4.4.2.1.3.10"
