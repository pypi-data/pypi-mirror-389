"""Async Checks resource for ZeroTrue SDK."""
...
class AsyncChecks:
    """Async resource for managing checks."""

    def __init__(self, client: AsyncHTTPClient):
        self._client = client

    async def create(self, params: CreateCheckParams) -> CheckResponse:
        """
    ...
    async def create_from_file(
        ...
        """
        Create a check from a file path asynchronously.
        ...
        with open(file_path, "rb") as f:
            return await self.create_from_buffer(f, filename, options)

    async def create_from_buffer(
        self,
        ...
        """
        Create a check from a buffer asynchronously.
    ...
    async def wait(
        ...
        """
        Wait for a check to complete asynchronously.
        ...
        while True:
            ...
            result = await self.retrieve(check_id)
    ...
    async def create_and_wait(
        ...
        """
        Create a check and wait for completion asynchronously.
        ...
        Returns:
            CheckResult with analysis data
        """
        check = await self.create(params)
        return await self.wait(check["id"], options)
