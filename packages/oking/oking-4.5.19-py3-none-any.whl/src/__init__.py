...
try:
    if exibir_interface_grafica:
        ...
        if token_param:
            ...
            nome_token = input('Informe o nome que deseja para essa integra̤̣o (a sua escolha): ')
            while True:
    ...
    if not is_dev:
        ...
        api_okinghub.post_log(
            Log(
                f'Oking inicializando {client_data["integracao_nome"]} - Verṣo {src.version}',
                'INICIALIZACAO',
                'OKING_INICIALIZACAO',
