...
from .breez_sdk_common import SyncStorage
...
from .breez_sdk_common import _UniffiConverterTypeSyncStorage
...
from .breez_sdk_common import _UniffiRustBuffer as _UniffiRustBufferSyncStorage
...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_breez_sdk_spark_checksum_func_default_storage() != 46285:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_spark_checksum_func_default_sync_storage() != 62413:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_breez_sdk_spark_checksum_method_sdkbuilder_with_payment_observer() != 21617:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_breez_sdk_spark_checksum_method_sdkbuilder_with_real_time_sync_storage() != 36431:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_breez_sdk_spark_fn_func_default_sync_storage.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_breez_sdk_spark_fn_func_default_sync_storage.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_breez_sdk_spark_checksum_func_default_sync_storage.argtypes = (
)
_UniffiLib.uniffi_breez_sdk_spark_checksum_func_default_sync_storage.restype = ctypes.c_uint16
...
class DepositClaimError:
    ...
    class DEPOSIT_CLAIM_FEE_EXCEEDED:
        ...
        def __init__(self,tx: "str", vout: "int", max_fee: "typing.Optional[Fee]", actual_fee: "int"):
            self.tx = tx
            self.vout = vout
            self.max_fee = max_fee
...
# External type SyncStorage is in namespace "breez_sdk_common", crate breez_sdk_common
...
def default_sync_storage(data_dir: "str") -> "SyncStorage":
    _UniffiConverterString.check_lower(data_dir)
    
    return _UniffiConverterTypeSyncStorage.lift(_uniffi_rust_call_with_error(_UniffiConverterTypeSdkError,_UniffiLib.uniffi_breez_sdk_spark_fn_func_default_sync_storage,
        _UniffiConverterString.lower(data_dir)))
