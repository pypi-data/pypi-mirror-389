...
docker run --rm -it registry.gitlab.com/koden8/imgctl:3.0.12
...
# Или из релизов
pip install https://gitlab.com/koden8/imgctl/-/archive/v3.0.12/imgctl-v3.0.12.tar.gz
```
...
#### 4. Установка Windows Executable

Скачайте Windows executable из раздела артефактов релиза в GitLab или используйте прямую ссылку:

```powershell
# Скачать Windows executable (замените VERSION на нужную версию, например 3.0.12)
Invoke-WebRequest -Uri "https://gitlab.com/koden8/imgctl/-/jobs/artifacts/v3.0.12/raw/dist/imgctl.exe?job=build:windows" -OutFile "imgctl.exe"
