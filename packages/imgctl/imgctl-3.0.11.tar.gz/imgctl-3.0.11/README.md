...
docker run --rm -it registry.gitlab.com/koden8/imgctl:3.0.11
...
# Или из релизов
pip install https://gitlab.com/koden8/imgctl/-/archive/v3.0.11/imgctl-v3.0.11.tar.gz
```
