...
class EvaluateApi():
    ...
    def check_container_image_tags(self, host, token, project, results={}):
        ...
        results["container_registry_size"] = 0
        ...
        if project:
            ...
            log.debug(f"Project data has been lost before checking for Container Registries")
        return flag
        ...
        if isinstance(p, dict) and p:
            ...
            try:
                ...
                flags.append(self.handle_check(
                    messages,
                    self.check_x_total_value_update_dict(
                        utils.check_repository_size, p, host, token, None, "statistics/repository_size", "repository_size_over", results),
                    "repository_size",
                ...
                flags.append(self.handle_check(
                    messages,
                    self.check_x_total_value_update_dict(
                        utils.check_storage_size, p, host, token, None, "statistics/storage_size", "storage_size_over", results),
                    "storage_size",
                    limits.STORAGE_SIZE))
                ...
                flags.append(self.handle_check(
                    messages,
                    self.check_x_total_value_update_dict(
                        utils.check_packages_size, p, host, token, None, "statistics/packages_size", "packages_size_over", results),
                    "packages_size",
