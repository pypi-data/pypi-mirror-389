...
*ModelApi* | [**create_positioned_model**](docs/ModelApi.md#create_positioned_model) | **POST** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/positioned-model | Add a child model and it&#39;s position on the model
...
*ModelApi* | [**delete_positioned_model**](docs/ModelApi.md#delete_positioned_model) | **DELETE** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/positioned-model/{id} | Remove a child model and its position from the model
...
*ModelApi* | [**update_positioned_model**](docs/ModelApi.md#update_positioned_model) | **PATCH** /cloud/{cloud_pk}/project/{project_pk}/model/{model_pk}/positioned-model/{id} | Update the position of a child model on the model
...
## Documentation For Models
 ...
 - [ModelOnModelPositionCreationRequest](docs/ModelOnModelPositionCreationRequest.md)
