...
def lazy_import():
    ...
    globals()['PinWithModels'] = PinWithModels


class TopicPin(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, topic_guid, pins, *args, **kwargs):  # noqa: E501
        """TopicPin - a model defined in OpenAPI
