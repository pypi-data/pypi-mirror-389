...
class UnitRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'elements': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            elements (bool, date, datetime, dict, float, int, list, str, none_type): List of constitutive unit elements by id with corresponding exponent (ex: [meterID/1, secondID/-1] for velocity). [optional]  # noqa: E501
