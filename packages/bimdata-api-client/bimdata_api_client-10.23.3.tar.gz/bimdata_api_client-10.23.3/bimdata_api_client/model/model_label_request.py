...
class ModelLabelRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'geometry': ([Geometry2dPointRequest],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, geometry, *args, **kwargs):  # noqa: E501
        """ModelLabelRequest - a model defined in OpenAPI

        Args:
            name (str): Name of the label
            geometry ([Geometry2dPointRequest]):
