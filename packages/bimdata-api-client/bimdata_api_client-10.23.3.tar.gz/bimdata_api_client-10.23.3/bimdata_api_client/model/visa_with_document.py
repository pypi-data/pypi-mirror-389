...
class VisaWithDocument(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'deadline': (date, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, validations, validations_in_error, creator, document_id, status, comments, created_at, updated_at, document, *args, **kwargs):  # noqa: E501
        """VisaWithDocument - a model defined in OpenAPI
        ...
        Args:
            ...
            document_id (int):
            status (str): * `O` - opened * `P` - paused * `C` - closed
        ...
        Keyword Args:
            ...
            description (str, none_type): Description of the visa. [optional]  # noqa: E501
            deadline (date, none_type): [optional]  # noqa: E501
        """
