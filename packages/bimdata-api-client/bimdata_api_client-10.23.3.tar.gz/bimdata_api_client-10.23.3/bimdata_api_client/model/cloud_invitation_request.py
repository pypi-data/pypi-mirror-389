...
class CloudInvitationRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, redirect_uri, *args, **kwargs):  # noqa: E501
        """CloudInvitationRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, redirect_uri, *args, **kwargs):  # noqa: E501
        """CloudInvitationRequest - a model defined in OpenAPI
