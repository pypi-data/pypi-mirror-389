...
class LayerRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, elements, *args, **kwargs):  # noqa: E501
        """LayerRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, elements, *args, **kwargs):  # noqa: E501
        """LayerRequest - a model defined in OpenAPI
