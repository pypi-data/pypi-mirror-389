...
class FolderWithoutChildren(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, type, nature, name, created_at, updated_at, created_by, groups_permissions, user_permission, *args, **kwargs):  # noqa: E501
        """FolderWithoutChildren - a model defined in OpenAPI
