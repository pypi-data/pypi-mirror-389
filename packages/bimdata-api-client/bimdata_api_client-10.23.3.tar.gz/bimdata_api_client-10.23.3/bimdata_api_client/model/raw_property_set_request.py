...
class RawPropertySetRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'properties': ([RawPropertyRequest],),  # noqa: E501
    ...
    def _from_openapi_data(cls, properties, *args, **kwargs):  # noqa: E501
        """RawPropertySetRequest - a model defined in OpenAPI

        Args:
            properties ([RawPropertyRequest]):
