...
class Organization(ModelNormal):
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'name': 'name',  # noqa: E501
        'is_personnal': 'is_personnal',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, is_personnal, created_at, updated_at, *args, **kwargs):  # noqa: E501
