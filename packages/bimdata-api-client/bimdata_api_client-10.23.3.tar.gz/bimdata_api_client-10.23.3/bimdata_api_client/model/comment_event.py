...
def lazy_import():
    ...
    globals()['CommentEventAction'] = CommentEventAction


class CommentEvent(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'comment_guid': (str,),  # noqa: E501
            'author': (str, none_type,),  # noqa: E501
            'date': (datetime,),  # noqa: E501
            'events': ([CommentEventAction],),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'comment_guid': 'comment_guid',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, topic_guid, comment_guid, author, date, events, *args, **kwargs):  # noqa: E501
        """CommentEvent - a model defined in OpenAPI

        Args:
            topic_guid (str):
            comment_guid (str):
            author (str, none_type):
            date (datetime):
            events ([CommentEventAction]):
