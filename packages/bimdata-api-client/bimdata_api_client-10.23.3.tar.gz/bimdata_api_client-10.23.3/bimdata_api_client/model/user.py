...
class User(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, email, firstname, lastname, created_at, updated_at, cloud_role, project_role, provider, sub, profile_picture, *args, **kwargs):  # noqa: E501
