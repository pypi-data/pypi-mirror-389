...
class ComponentsParent(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ComponentsParent - a model defined in OpenAPI
