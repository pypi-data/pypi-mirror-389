...
class VisaValidation(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (int,),  # noqa: E501
            'visa_id': (int,),  # noqa: E501
            'validator': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, visa_id, validator, status, has_commented, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """VisaValidation - a model defined in OpenAPI
