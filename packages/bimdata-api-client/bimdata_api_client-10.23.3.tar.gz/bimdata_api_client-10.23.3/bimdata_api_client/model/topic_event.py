...
def lazy_import():
    ...
    globals()['TopicEventAction'] = TopicEventAction


class TopicEvent(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'events': ([TopicEventAction],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, topic_guid, author, date, events, *args, **kwargs):  # noqa: E501
        """TopicEvent - a model defined in OpenAPI

        Args:
            topic_guid (str):
            author (str, none_type):
            date (datetime):
            events ([TopicEventAction]):
