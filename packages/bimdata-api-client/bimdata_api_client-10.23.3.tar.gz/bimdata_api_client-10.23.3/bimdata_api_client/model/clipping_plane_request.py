...
class ClippingPlaneRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'location': (PointRequest,),  # noqa: E501
            'direction': (DirectionRequest,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, location, direction, *args, **kwargs):  # noqa: E501
        """ClippingPlaneRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, location, direction, *args, **kwargs):  # noqa: E501
        """ClippingPlaneRequest - a model defined in OpenAPI
