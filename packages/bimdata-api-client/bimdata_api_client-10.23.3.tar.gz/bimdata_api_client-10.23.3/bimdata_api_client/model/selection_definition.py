...
class SelectionDefinition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, selection, *args, **kwargs):  # noqa: E501
        """SelectionDefinition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, selection, *args, **kwargs):  # noqa: E501
        """SelectionDefinition - a model defined in OpenAPI
