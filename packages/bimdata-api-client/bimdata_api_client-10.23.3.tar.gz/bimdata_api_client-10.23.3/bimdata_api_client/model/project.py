...
class Project(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (int,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'cloud': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, cloud, created_at, updated_at, root_folder_id, *args, **kwargs):  # noqa: E501
        """Project - a model defined in OpenAPI

        Args:
            id (int):
            name (str): Name of the project
            cloud (bool, date, datetime, dict, float, int, list, str, none_type):
