...
class ModelLabel(ModelNormal):
    ...
    attribute_map = {
        ...
        'human_validated': 'human_validated',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, model, name, geometry, creator, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """ModelLabel - a model defined in OpenAPI

        Args:
            id (int):
            model (int): The model to which the label is attached
            name (str): Name of the label
            geometry ([Geometry2dPoint]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, geometry, *args, **kwargs):  # noqa: E501
        """ModelLabel - a model defined in OpenAPI
