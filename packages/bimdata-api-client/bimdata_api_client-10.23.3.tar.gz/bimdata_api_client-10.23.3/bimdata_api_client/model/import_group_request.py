...
class ImportGroupRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, group_ids, redirect_uri, *args, **kwargs):  # noqa: E501
        """ImportGroupRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, group_ids, redirect_uri, *args, **kwargs):  # noqa: E501
        """ImportGroupRequest - a model defined in OpenAPI
