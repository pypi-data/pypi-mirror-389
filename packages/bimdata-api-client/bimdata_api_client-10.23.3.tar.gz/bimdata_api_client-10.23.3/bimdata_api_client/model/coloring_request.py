...
class ColoringRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'color': (str,),  # noqa: E501
            'components': ([ComponentRequest],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, color, components, *args, **kwargs):  # noqa: E501
        """ColoringRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, color, components, *args, **kwargs):  # noqa: E501
        """ColoringRequest - a model defined in OpenAPI
