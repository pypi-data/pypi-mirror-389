...
def lazy_import():
    ...
    globals()['MaterialOption'] = MaterialOption


class MaterialListComponent(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'option': (MaterialOption,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, option, *args, **kwargs):  # noqa: E501
        """MaterialListComponent - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, option, *args, **kwargs):  # noqa: E501
        """MaterialListComponent - a model defined in OpenAPI
