...
class ShortUser(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, email, firstname, lastname, profile_picture, *args, **kwargs):  # noqa: E501
        """ShortUser - a model defined in OpenAPI
