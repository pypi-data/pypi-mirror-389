...
from bimdata_api_client.exceptions import ApiTypeError, ApiValueError, ApiException
from bimdata_api_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BcfApi()
        api_instance.create_comment  # this is an instance of the class Endpoint
        api_instance.create_comment()  # this invokes api_instance.create_comment.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_comment.callable or self.callable in this class
