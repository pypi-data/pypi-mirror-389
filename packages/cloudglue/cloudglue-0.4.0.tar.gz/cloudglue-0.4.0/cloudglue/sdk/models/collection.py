...
class Collection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "object", "name", "description", "collection_type", "extract_config", "transcribe_config", "describe_config", "default_segmentation_config", "default_thumbnails_config", "created_at", "file_count"]
