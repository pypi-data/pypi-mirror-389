...
class DataMap:
    ...
    def SetExplicationColumn(self, cells: Array[CompositeCell]) -> None:
        this: DataMap = self
        def _arrow713(dc: DataContext, oa: OntologyAnnotation | None=None) -> None:
            DataContext__set_Explication_279AAFF2(dc, oa)

        DataMapAux_setOntologyColumn(_arrow713, cells, this.data_contexts_0040108)
    ...
    def SetUnitColumn(self, cells: Array[CompositeCell]) -> None:
        this: DataMap = self
        def _arrow714(dc: DataContext, oa: OntologyAnnotation | None=None) -> None:
            DataContext__set_Unit_279AAFF2(dc, oa)

        DataMapAux_setOntologyColumn(_arrow714, cells, this.data_contexts_0040108)
    ...
    def SetDataTypeColumn(self, cells: Array[CompositeCell]) -> None:
        this: DataMap = self
        def _arrow715(dc: DataContext, oa: OntologyAnnotation | None=None) -> None:
    ...
    def GetLabelColumn(self, __unit: None=None) -> Array[CompositeCell]:
        this: DataMap = self
        def _arrow716(dc: DataContext) -> str | None:
            return dc.Name

        return DataMapAux_getStringColumn(_arrow716, this.data_contexts_0040108)

    def SetLabelColumn(self, cells: Array[CompositeCell]) -> None:
        this: DataMap = self
        def _arrow717(dc: DataContext, s: str | None=None) -> None:
            dc.Name = s

        DataMapAux_setStringColumn(_arrow717, cells, this.data_contexts_0040108)
    ...
    def SetDescriptionColumn(self, cells: Array[CompositeCell]) -> None:
        this: DataMap = self
        def _arrow718(dc: DataContext, s: str | None=None) -> None:
            DataContext__set_Description_6DFDD678(dc, s)

        DataMapAux_setStringColumn(_arrow718, cells, this.data_contexts_0040108)
    ...
    def get_data_context(row: int, SkipValidation: Any | None=None) -> Callable[[DataMap], DataContext]:
        def _arrow719(dm: DataMap) -> DataContext:
