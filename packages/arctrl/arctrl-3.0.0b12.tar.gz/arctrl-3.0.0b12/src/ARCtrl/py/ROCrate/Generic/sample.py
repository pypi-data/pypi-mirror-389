...
class LDSample:
    ...
    def validate_sample(s: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1580:
            ...
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1579(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Sample", s.AdditionalType, ObjectExpr1580()) if LDSample.validate(s, context) else False
    ...
    def validate_source(s: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1582:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1581(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Source", s.AdditionalType, ObjectExpr1582()) if LDSample.validate(s, context) else False

    @staticmethod
    def validate_material(s: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1584:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1583(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Material", s.AdditionalType, ObjectExpr1584()) if LDSample.validate(s, context) else False
