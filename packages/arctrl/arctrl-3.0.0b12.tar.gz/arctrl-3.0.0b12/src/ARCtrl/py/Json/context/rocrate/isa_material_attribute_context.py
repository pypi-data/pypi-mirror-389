...
IContext_reflection = _expr1738

def _arrow1745(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1739()), ("arc", ObjectExpr1740()), ("MaterialAttribute", ObjectExpr1741()), ("ArcMaterialAttribute", ObjectExpr1742()), ("characteristicType", ObjectExpr1743())])
...
context_jsonvalue: IEncodable = _arrow1745()
