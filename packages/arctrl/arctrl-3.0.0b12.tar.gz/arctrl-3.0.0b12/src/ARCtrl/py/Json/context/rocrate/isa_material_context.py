...
IContext_reflection = _expr1758

def _arrow1766(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1759()), ("bio", ObjectExpr1760()), ("Material", ObjectExpr1761()), ("type", ObjectExpr1762()), ("name", ObjectExpr1763()), ("characteristics", ObjectExpr1764())])
...
context_jsonvalue: IEncodable = _arrow1766()
