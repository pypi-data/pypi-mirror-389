...
IContext_reflection = _expr1746

def _arrow1757(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1747()), ("MaterialAttributeValue", ObjectExpr1748()), ("additionalType", ObjectExpr1749()), ("category", ObjectExpr1750()), ("categoryCode", ObjectExpr1751()), ("value", ObjectExpr1752()), ("valueCode", ObjectExpr1753()), ("unit", ObjectExpr1754()), ("unitCode", ObjectExpr1755())])
    ...
    return ObjectExpr1756()


context_jsonvalue: IEncodable = _arrow1757()
