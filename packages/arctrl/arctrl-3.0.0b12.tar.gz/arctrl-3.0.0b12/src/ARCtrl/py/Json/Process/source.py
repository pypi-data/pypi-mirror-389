...
def ROCrate_encoder(oa: Source) -> IEncodable:
    ...
    def _arrow2644(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    class ObjectExpr2645(IEncodable):
    ...
    def _arrow2648(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2644()), ("@type", list_1_1(singleton(ObjectExpr2645()))), ("additionalType", ObjectExpr2646()), try_include("name", _arrow2648, oa.Name), try_include_list_opt("characteristics", ROCrate_encoder_1, oa.Characteristics), ("@context", context_jsonvalue)]))
...
def _arrow2653(get: IGetters) -> Source:
    ...
    def _arrow2652(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2650(), _arrow2651(), _arrow2652())


ROCrate_decoder: Decoder_1[Source] = object(_arrow2653)
...
def ISAJson_encoder(id_map: Any | None, oa: Source) -> IEncodable:
    def f(oa_1: Source, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2657(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2659(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2660(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2657, ROCrate_genID(oa_1)), try_include("name", _arrow2659, oa_1.Name), try_include_list_opt("characteristics", _arrow2660, oa_1.Characteristics)]))
    ...
    if id_map is not None:
        def _arrow2662(s_1: Source, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2662, f, oa, id_map)
...
def _arrow2666(get: IGetters) -> Source:
    ...
    def _arrow2665(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2663(), _arrow2664(), _arrow2665())


ISAJson_decoder: Decoder_1[Source] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2666)
