...
IContext_reflection = _expr1786

def _arrow1791(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1787()), ("Organization", ObjectExpr1788()), ("name", ObjectExpr1789())])
...
context_jsonvalue: IEncodable = _arrow1791()
