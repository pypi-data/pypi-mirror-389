...
IContext_reflection = _expr1677

def _arrow1687(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1678()), ("Component", ObjectExpr1679()), ("category", ObjectExpr1680()), ("categoryCode", ObjectExpr1681()), ("value", ObjectExpr1682()), ("valueCode", ObjectExpr1683()), ("unit", ObjectExpr1684()), ("unitCode", ObjectExpr1685())])
    ...
    return ObjectExpr1686()


context_jsonvalue: IEncodable = _arrow1687()
