...
IContext_reflection = _expr1827

def _arrow1838(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1828()), ("additionalType", ObjectExpr1829()), ("ProcessParameterValue", ObjectExpr1830()), ("category", ObjectExpr1831()), ("categoryCode", ObjectExpr1832()), ("value", ObjectExpr1833()), ("valueCode", ObjectExpr1834()), ("unit", ObjectExpr1835()), ("unitCode", ObjectExpr1836())])
...
context_jsonvalue: IEncodable = _arrow1838()
