...
def encoder(value: Component) -> IEncodable:
    ...
    def _arrow2521(oa: OntologyAnnotation, value: Any=value) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2522(value_1: Value, value: Any=value) -> IEncodable:
        return encoder_1(None, value_1)

    def _arrow2523(oa_1: OntologyAnnotation, value: Any=value) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("type", _arrow2521, value.ComponentType), try_include("value", _arrow2522, value.ComponentValue), try_include("unit", _arrow2523, value.ComponentUnit)]))
...
def _arrow2527(get: IGetters) -> Component:
    ...
    return Component(_arrow2525(), _arrow2526(), ComponentType)


decoder: Decoder_1[Component] = object(_arrow2527)
...
def ISAJson_encoder(id_map: Any | None, c: Component) -> IEncodable:
    ...
    def _arrow2531(value: str, id_map: Any=id_map, c: Any=c) -> IEncodable:
    ...
    def _arrow2532(oa: OntologyAnnotation, id_map: Any=id_map, c: Any=c) -> IEncodable:
        return OntologyAnnotation_ISAJson_encoder(id_map, oa)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("componentName", _arrow2531, Component__get_ComponentName(c)), try_include("componentType", _arrow2532, c.ComponentType)]))
...
def _arrow2535(get: IGetters) -> Component:
    name: str | None
    object_arg: IOptionalGetter = get.Optional
    ...
    def _arrow2534(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("componentType", OntologyAnnotation_ISAJson_decoder)

    return Component(pattern_input_1[0], pattern_input_1[1], _arrow2534())


ISAJson_decoder: Decoder_1[Component] = object(_arrow2535)
