...
def _arrow1911(__unit: None=None) -> IEncodable:
    class ObjectExpr1909(IEncodable):
        def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
            return helpers.encode_string("https://w3id.org/ro/crate/1.1")

    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("@id", ObjectExpr1909())])
...
conforms_to_jsonvalue: IEncodable = _arrow1911()

def _arrow1919(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1912()), ("arc", ObjectExpr1913()), ("CreativeWork", ObjectExpr1914()), ("about", ObjectExpr1915()), ("conformsTo", ObjectExpr1917())])
...
context_jsonvalue: IEncodable = _arrow1919()
