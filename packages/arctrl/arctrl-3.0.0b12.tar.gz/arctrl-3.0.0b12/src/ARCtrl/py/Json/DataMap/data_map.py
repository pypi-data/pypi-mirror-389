...
def _arrow2863(get: IGetters) -> DataMap:
    def _arrow2861(__unit: None=None) -> Array[DataContext]:
        arg_1: Decoder_1[Array[DataContext]] = resize_array(decoder_1)
        object_arg: IRequiredGetter = get.Required
        return object_arg.Field("dataContexts", arg_1)

    return DataMap(_arrow2861())


decoder: Decoder_1[DataMap] = object(_arrow2863)
