...
IContext_reflection = _expr1854

def _arrow1861(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1855()), ("arc", ObjectExpr1856()), ("ProtocolParameter", ObjectExpr1857()), ("ArcProtocolParameter", ObjectExpr1858()), ("parameterName", ObjectExpr1859())])
...
context_jsonvalue: IEncodable = _arrow1861()
