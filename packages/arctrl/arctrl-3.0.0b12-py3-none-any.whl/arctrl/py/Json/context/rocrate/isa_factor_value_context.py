...
def _arrow1720(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1709()), ("FactorValue", ObjectExpr1710()), ("additionalType", ObjectExpr1711()), ("category", ObjectExpr1712()), ("categoryName", ObjectExpr1713()), ("categoryCode", ObjectExpr1714()), ("value", ObjectExpr1715()), ("valueCode", ObjectExpr1716()), ("unit", ObjectExpr1717()), ("unitCode", ObjectExpr1718())])
...
context_jsonvalue: IEncodable = _arrow1720()
