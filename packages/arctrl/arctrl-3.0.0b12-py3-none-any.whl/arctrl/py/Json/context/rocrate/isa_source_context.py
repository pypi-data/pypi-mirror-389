...
def _arrow1888(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1882()), ("bio", ObjectExpr1883()), ("Source", ObjectExpr1884()), ("name", ObjectExpr1885()), ("characteristics", ObjectExpr1886())])
...
context_jsonvalue: IEncodable = _arrow1888()
