...
def ISAJson_encoder(id_map: Any | None, value: ProtocolParameter) -> IEncodable:
    def f(value_1: ProtocolParameter, id_map: Any=id_map, value: Any=value) -> IEncodable:
        ...
        def _arrow2502(value_2: str, value_1: Any=value_1) -> IEncodable:
        ...
        def _arrow2503(oa: OntologyAnnotation, value_1: Any=value_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2502, ISAJson_genID(value_1)), try_include("parameterName", _arrow2503, value_1.ParameterName)]))
        class ObjectExpr2504(IEncodable):
        ...
        return ObjectExpr2504()

    if id_map is not None:
        def _arrow2505(p_1: ProtocolParameter, id_map: Any=id_map, value: Any=value) -> str:
            return ISAJson_genID(p_1)

        return encode(_arrow2505, f, value, id_map)
...
def _arrow2507(get: IGetters) -> ProtocolParameter:
    ...
    return ProtocolParameter(None, _arrow2506())


ISAJson_decoder: Decoder_1[ProtocolParameter] = object(_arrow2507)
