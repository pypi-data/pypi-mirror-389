...
def encoder(study: ArcStudy) -> IEncodable:
    ...
    def _arrow3179(__unit: None=None, study: Any=study) -> IEncodable:
    ...
    def _arrow3181(value_1: str, study: Any=study) -> IEncodable:
    ...
    def _arrow3183(value_3: str, study: Any=study) -> IEncodable:
    ...
    def _arrow3185(value_5: str, study: Any=study) -> IEncodable:
    ...
    def _arrow3187(value_7: str, study: Any=study) -> IEncodable:
        class ObjectExpr3186(IEncodable):
            def Encode(self, helpers_4: IEncoderHelpers_1[Any]) -> Any:
                return helpers_4.encode_string(value_7)

        return ObjectExpr3186()

    def _arrow3188(oa: Publication, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow3189(person: Person, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow3190(oa_1: OntologyAnnotation, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow3191(table: ArcTable, study: Any=study) -> IEncodable:
        return encoder_7(table)

    def _arrow3192(dm: DataMap, study: Any=study) -> IEncodable:
        return encoder_8(dm)

    def _arrow3194(value_9: str, study: Any=study) -> IEncodable:
        class ObjectExpr3193(IEncodable):
            def Encode(self, helpers_5: IEncoderHelpers_1[Any]) -> Any:
                return helpers_5.encode_string(value_9)

        return ObjectExpr3193()

    def _arrow3195(comment: Comment, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow3179()), try_include("Title", _arrow3181, study.Title), try_include("Description", _arrow3183, study.Description), try_include("SubmissionDate", _arrow3185, study.SubmissionDate), try_include("PublicReleaseDate", _arrow3187, study.PublicReleaseDate), try_include_seq("Publications", _arrow3188, study.Publications), try_include_seq("Contacts", _arrow3189, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow3190, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow3191, study.Tables), try_include("DataMap", _arrow3192, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow3194, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow3195, study.Comments)]))
    ...
    return ObjectExpr3196()


def _arrow3209(get: IGetters) -> ArcStudy:
    def _arrow3197(__unit: None=None) -> str:
    ...
    return ArcStudy(_arrow3197(), _arrow3198(), _arrow3199(), _arrow3200(), _arrow3201(), _arrow3202(), _arrow3203(), _arrow3204(), _arrow3205(), _arrow3206(), _arrow3207(), _arrow3208())


decoder: Decoder_1[ArcStudy] = object(_arrow3209)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, study: ArcStudy) -> IEncodable:
    ...
    def _arrow3213(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        value: str = study.Identifier
    ...
    def _arrow3215(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3217(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3219(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3221(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow3222(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow3223(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow3224(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow3225(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow3226(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow3228(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        class ObjectExpr3227(IEncodable):
            def Encode(self, helpers_5: IEncoderHelpers_1[Any]) -> Any:
                return helpers_5.encode_string(value_9)

        return ObjectExpr3227()

    def _arrow3229(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow3213()), try_include("Title", _arrow3215, study.Title), try_include("Description", _arrow3217, study.Description), try_include("SubmissionDate", _arrow3219, study.SubmissionDate), try_include("PublicReleaseDate", _arrow3221, study.PublicReleaseDate), try_include_seq("Publications", _arrow3222, study.Publications), try_include_seq("Contacts", _arrow3223, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow3224, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow3225, study.Tables), try_include("DataMap", _arrow3226, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow3228, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow3229, study.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcStudy]:
    def _arrow3243(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcStudy:
        def _arrow3231(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)
        ...
        def _arrow3236(__unit: None=None) -> Array[Publication] | None:
            arg_11: Decoder_1[Array[Publication]] = resize_array(decoder_2)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("Publications", arg_11)

        def _arrow3237(__unit: None=None) -> Array[Person] | None:
            arg_13: Decoder_1[Array[Person]] = resize_array(decoder_3)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Contacts", arg_13)

        def _arrow3238(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_15: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("StudyDesignDescriptors", arg_15)

        def _arrow3239(__unit: None=None) -> Array[ArcTable] | None:
            arg_17: Decoder_1[Array[ArcTable]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Tables", arg_17)

        def _arrow3240(__unit: None=None) -> DataMap | None:
            arg_19: Decoder_1[DataMap] = decoder_compressed_2(string_table, oa_table, cell_table)
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("DataMap", arg_19)

        def _arrow3241(__unit: None=None) -> Array[str] | None:
            arg_21: Decoder_1[Array[str]] = resize_array(string)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("RegisteredAssayIdentifiers", arg_21)

        def _arrow3242(__unit: None=None) -> Array[Comment] | None:
            arg_23: Decoder_1[Array[Comment]] = resize_array(decoder_6)
            object_arg_11: IOptionalGetter = get.Optional
            return object_arg_11.Field("Comments", arg_23)

        return ArcStudy(_arrow3231(), _arrow3232(), _arrow3233(), _arrow3234(), _arrow3235(), _arrow3236(), _arrow3237(), _arrow3238(), _arrow3239(), _arrow3240(), _arrow3241(), _arrow3242())

    return object(_arrow3243)
...
def ROCrate_encoder(assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    ...
    def _arrow3247(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3251(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3253(value_4: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3255(value_6: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3257(value_8: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3258(oa: OntologyAnnotation, assays: Any=assays, s: Any=s) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa)

    def _arrow3260(value_10: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3262(value_12: str, assays: Any=assays, s: Any=s) -> IEncodable:
        class ObjectExpr3261(IEncodable):
            def Encode(self, helpers_8: IEncoderHelpers_1[Any]) -> Any:
                return helpers_8.encode_string(value_12)

        return ObjectExpr3261()

    def _arrow3263(oa_1: Publication, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_1(oa_1)

    def _arrow3264(oa_2: Person, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_2(oa_2)

    def _arrow3266(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[Process], IEncodable]:
        study_name: str | None = s.Identifier
        def _arrow3265(oa_3: Process) -> IEncodable:
            return ROCrate_encoder_3(study_name, None, oa_3)

        return _arrow3265

    def _arrow3268(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[ArcAssay], IEncodable]:
        assay_name_1: str | None = s.Identifier
        def _arrow3267(a_1: ArcAssay) -> IEncodable:
            return ROCrate_encoder_4(assay_name_1, a_1)

        return _arrow3267

    def _arrow3269(oa_4: Data, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_5(oa_4)

    def _arrow3270(comment: Comment, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3247()), ("@type", list_1_1(singleton(ObjectExpr3248()))), ("additionalType", ObjectExpr3249()), ("identifier", _arrow3251()), try_include("filename", _arrow3253, file_name), try_include("title", _arrow3255, s.Title), try_include("description", _arrow3257, s.Description), try_include_seq("studyDesignDescriptors", _arrow3258, s.StudyDesignDescriptors), try_include("submissionDate", _arrow3260, s.SubmissionDate), try_include("publicReleaseDate", _arrow3262, s.PublicReleaseDate), try_include_seq("publications", _arrow3263, s.Publications), try_include_seq("people", _arrow3264, s.Contacts), try_include_list("processSequence", _arrow3266(), processes), try_include_seq("assays", _arrow3268(), assays_1), try_include_list("dataFiles", _arrow3269, get_data(processes)), try_include_seq("comments", _arrow3270, s.Comments), ("@context", context_jsonvalue)]))
...
def _arrow3282(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow3272(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Study_tryIdentifierFromFileName, _arrow3272()), create_missing_identifier())
    ...
    def _arrow3278(__unit: None=None) -> Array[Publication] | None:
    ...
    def _arrow3280(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return (ArcStudy(identifier, _arrow3274(), _arrow3275(), _arrow3276(), _arrow3277(), _arrow3278(), _arrow3279(), _arrow3280(), tables, None, assay_identifiers, _arrow3281()), default_arg(assays, empty()))


ROCrate_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = object(_arrow3282)
...
def ISAJson_encoder(id_map: Any | None, assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    def f(s_1: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> IEncodable:
        ...
        def _arrow3283(ps: FSharpList[Process], s_1: Any=s_1) -> IEncodable:
            return encoder_12(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow3283, Option_fromValueWithDefault(empty(), processes))
        encoded_protocols: tuple[str, IEncodable | None]
        value_5: FSharpList[Protocol] = get_protocols(processes)
        def _arrow3285(__unit: None=None, s_1: Any=s_1) -> Callable[[Protocol], IEncodable]:
            study_name: str | None = s_1.Identifier
            def _arrow3284(oa_1: Protocol) -> IEncodable:
                return ISAJson_encoder_1(study_name, None, None, id_map, oa_1)

            return _arrow3284

        encoded_protocols = try_include_list("protocols", _arrow3285(), value_5)
        ...
        def _arrow3289(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3292(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3294(value_9: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3296(value_11: str, s_1: Any=s_1) -> IEncodable:
            class ObjectExpr3295(IEncodable):
                def Encode(self, helpers_4: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_4.encode_string(value_11)

            return ObjectExpr3295()

        def _arrow3298(value_13: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3300(value_15: str, s_1: Any=s_1) -> IEncodable:
            class ObjectExpr3299(IEncodable):
                def Encode(self, helpers_6: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_6.encode_string(value_15)

            return ObjectExpr3299()

        def _arrow3301(oa_2: Publication, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_2)

        def _arrow3302(person_2: Person, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, person_2)

        def _arrow3303(oa_3: OntologyAnnotation, s_1: Any=s_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow3305(__unit: None=None, s_1: Any=s_1) -> Callable[[Process], IEncodable]:
            study_name_1: str | None = s_1.Identifier
            def _arrow3304(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_4(study_name_1, None, id_map, oa_4)

            return _arrow3304

        def _arrow3307(__unit: None=None, s_1: Any=s_1) -> Callable[[ArcAssay], IEncodable]:
            study_name_2: str | None = s_1.Identifier
            def _arrow3306(a_2: ArcAssay) -> IEncodable:
                return ISAJson_encoder_5(study_name_2, id_map, a_2)

            return _arrow3306

        def _arrow3308(comment: Comment, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_6(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3289()), ("filename", ObjectExpr3290()), ("identifier", _arrow3292()), try_include("title", _arrow3294, study.Title), try_include("description", _arrow3296, study.Description), try_include("submissionDate", _arrow3298, study.SubmissionDate), try_include("publicReleaseDate", _arrow3300, study.PublicReleaseDate), try_include_seq("publications", _arrow3301, study.Publications), try_include_seq("people", _arrow3302, study.Contacts), try_include_seq("studyDesignDescriptors", _arrow3303, study.StudyDesignDescriptors), encoded_protocols, encoded_materials, try_include_list("processSequence", _arrow3305(), processes), try_include_seq("assays", _arrow3307(), assays_1), encoded_factors, encoded_characteristics, encoded_units, try_include_seq("comments", _arrow3308, study.Comments)]))
    ...
    if id_map is not None:
        def _arrow3310(s_2: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> str:
            return ROCrate_genID(s_2)

        return encode(_arrow3310, f, s, id_map)
...
def _arrow3321(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow3311(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("identifier", string)
    ...
    def def_thunk(__unit: None=None) -> str:
        ...
        return default_arg(bind(Study_tryIdentifierFromFileName, _arrow3312()), create_missing_identifier())

    identifier: str = default_arg_with(_arrow3311(), def_thunk)
    ...
    def _arrow3319(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return (ArcStudy(identifier, _arrow3314(), _arrow3315(), _arrow3316(), _arrow3317(), _arrow3318(), None if (len(persons) == 0) else persons, _arrow3319(), tables, None, assay_identifiers, _arrow3320()), default_arg(assays, empty()))


ISAJson_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow3321)
