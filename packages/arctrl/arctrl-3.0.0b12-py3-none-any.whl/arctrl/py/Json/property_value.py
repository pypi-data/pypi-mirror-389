...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    if match_value_1 is None:
        ...
        if v.tag == 1:
            ...
            pattern_input_1 = (ObjectExpr2130(), None)
            ...
            def _arrow2133(value_3: str, pv: Any=pv) -> IEncodable:
            ...
            def _arrow2135(value_5: str, pv: Any=pv) -> IEncodable:
            ...
            pattern_input_1 = (map(_arrow2133, oa_1.Name), map(_arrow2135, oa_1.TermAccessionNumber))
            ...
            pattern_input_1 = (ObjectExpr2136(), None)
    ...
    def _arrow2140(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2143(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2145(value_11: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2147(value_13: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2149(value_15: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2151(value_17: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2153(value_19: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2154(x: IEncodable, pv: Any=pv) -> IEncodable:
        return x

    def _arrow2155(x_1: IEncodable, pv: Any=pv) -> IEncodable:
        return x_1

    def _arrow2157(value_21: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2159(value_23: str, pv: Any=pv) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2140()), ("@type", ObjectExpr2141()), ("additionalType", _arrow2143()), try_include("alternateName", _arrow2145, pv.AlternateName()), try_include("measurementMethod", _arrow2147, pv.MeasurementMethod()), try_include("description", _arrow2149, pv.Description()), try_include("category", _arrow2151, pattern_input[0]), try_include("categoryCode", _arrow2153, pattern_input[1]), try_include("value", _arrow2154, pattern_input_1[0]), try_include("valueCode", _arrow2155, pattern_input_1[1]), try_include("unit", _arrow2157, pattern_input_2[0]), try_include("unitCode", _arrow2159, pattern_input_2[1]), ("@context", context_jsonvalue)]))
...
def decoder(create: Callable[[str | None, str | None, str | None, OntologyAnnotation | None, Value_4 | None, OntologyAnnotation | None], _T]) -> Decoder_1[Any]:
    def _arrow2162(get: IGetters, create: Any=create) -> _T:
        ...
        def _arrow2161(__unit: None=None) -> Value_4 | None:
            value: str | None
        ...
        return create(alternate_name, measurement_method, description, category, _arrow2161(), unit)

    return object(_arrow2162)
