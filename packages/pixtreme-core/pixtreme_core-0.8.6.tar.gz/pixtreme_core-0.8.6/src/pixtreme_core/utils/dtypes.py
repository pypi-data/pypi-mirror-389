...
def to_uint8(image: np.ndarray | cp.ndarray) -> np.ndarray | cp.ndarray:
    if image.dtype == "uint8":
        ...
        raise ValueError(
            f"Unsupported dtype {image.dtype} for to_uint8(). Supported: uint8, uint16, float16, float32, float64"
        )
    return image
...
def to_uint16(image: np.ndarray | cp.ndarray) -> np.ndarray | cp.ndarray:
    if image.dtype == "uint16":
        ...
        raise ValueError(
            f"Unsupported dtype {image.dtype} for to_uint16(). Supported: uint8, uint16, float16, float32, float64"
        )
    return image
...
def to_float16(image: np.ndarray | cp.ndarray) -> np.ndarray | cp.ndarray:
    if image.dtype == "float16":
        ...
        raise ValueError(
            f"Unsupported dtype {image.dtype} for to_float16(). Supported: uint8, uint16, float16, float32, float64"
        )
    return image


def to_float32(image: np.ndarray | cp.ndarray, clip: bool = True) -> np.ndarray | cp.ndarray:
    if image.dtype == "float32":
        ...
        raise ValueError(
            f"Unsupported dtype {image.dtype} for to_float32(). Supported: uint8, uint16, float16, float32, float64"
        )
    if clip:
...
def to_float64(image: np.ndarray | cp.ndarray) -> np.ndarray | cp.ndarray:
    if image.dtype == "float64":
        ...
        raise ValueError(
            f"Unsupported dtype {image.dtype} for to_float64(). Supported: uint8, uint16, float16, float32, float64"
        )
    return image
...
def to_dtype(image: np.ndarray | cp.ndarray, dtype: str) -> np.ndarray | cp.ndarray:
    if dtype == "uint8":
        ...
        raise ValueError(
            f"Unsupported dtype '{dtype}' for to_dtype(). Supported: 'uint8', 'uint16', 'float16', 'float32'"
        )
    return image
