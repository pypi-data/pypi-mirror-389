#!/usr/bin/env python3
"""
DcisionAI MCP Server - FastMCP Cloud Entry Point
================================================

Production deployment: https://dcisionai.fastmcp.app/mcp

For use with:
- platform.dcisionai.com (Vercel frontend)
- Cursor IDE
- Claude Desktop
...
- POLYGON_API_KEY, ALPHA_VANTAGE_API_KEY (optional, for external data)
"""
