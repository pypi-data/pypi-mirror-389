...
if "SUPABASE_URL" not in os.environ:
    os.environ["SUPABASE_URL"] = "https://fflzcxqyabtcmbxrlhpr.supabase.co"
if "SUPABASE_KEY" not in os.environ:
    os.environ["SUPABASE_KEY"] = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZmbHpjeHF5YWJ0Y21ieHJsaHByIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzA1NjY0NjgsImV4cCI6MjA0NjE0MjQ2OH0.Kn9qp7YHB6H8WqYn6rJOCHe7rOBXaVHn4EhqxQm5h7Y"
