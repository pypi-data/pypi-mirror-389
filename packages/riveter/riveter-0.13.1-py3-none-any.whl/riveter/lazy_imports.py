...
class LazyImporter:
    ...
    def lazy_import_with_timing(self, module_name: str, attribute: Optional[str] = None) -> Any:
    ...
    def _try_binary_fallbacks(
        self, module_name: str, attribute: Optional[str] = None
    ) -> Optional[Any]:
