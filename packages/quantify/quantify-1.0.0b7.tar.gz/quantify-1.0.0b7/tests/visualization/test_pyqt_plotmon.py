...
def test_basic_1d_plot(plotmon_instance):
    ...
    # FIXME: This dataset gives (under Windows, but not if pytest executes only this
    # module): ValueError: unrecognized engine netcdf4 must be one of: ['h5netcdf',
    # 'scipy', 'store'], although the file type is netCDF3 like the other ones
