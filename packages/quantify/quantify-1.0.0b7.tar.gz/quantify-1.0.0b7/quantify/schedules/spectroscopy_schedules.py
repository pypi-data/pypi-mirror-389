...
from quantify.operations.gate_library import Measure, Reset
from quantify.operations.nv_native_library import ChargeReset, CRCount
from quantify.operations.pulse_library import (
    IdlePulse,
    SetClockFrequency,
    SquarePulse,
)
from quantify.operations.shared_native_library import SpectroscopyOperation
...
def heterodyne_spec_sched_nco(
    ...
    .. admonition:: Example use of the ``heterodyne_spec_sched_nco`` schedule
        ...
        .. jupyter-execute::
            ...
            from quantify.schedules.spectroscopy_schedules import heterodyne_spec_sched_nco
...
def nv_dark_esr_sched_nco(
    ...
    for idx, spec_freq in enumerate(spec_frequencies):
        ...
        sched.add(
            SpectroscopyOperation(device_element),
            label=f"Spectroscopy ({spec_freq:e} Hz)",
        )
