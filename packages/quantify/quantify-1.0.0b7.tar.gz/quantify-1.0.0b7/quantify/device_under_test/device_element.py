...
from quantify.json_utils import JSONSerializable
from quantify.yaml_utils import YAMLSerializable

if TYPE_CHECKING:
    from quantify.backends.graph_compilation import DeviceCompilationConfig
...
class DeviceElement(YAMLSerializable, JSONSerializable, Instrument):
    ...
    def __init__(self, name: str, **kwargs) -> None:
        """Initialize the DeviceElement object."""
    ...
    def from_yaml(cls, constructor: ry.Constructor, node: ry.MappingNode) -> Instrument:
        ...
        # The name attribute needs to be passed explicitly
        # and separately to this `Instrument`.
