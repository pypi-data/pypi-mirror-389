...
from quantify.device_under_test.transmon_element import (
...
class PortsChargeSensor(InstrumentChannel):
    ...
    def __init__(
        ...
        *,
        ...
        gate
            Name of the gate port.
        readout
            Name of the readout port.
...
class ClocksFrequenciesSensor(InstrumentChannel):
    """Submodule containing clock frequencies specifying transitions to address."""
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize ClocksFrequenciesSensor.
...
class ClocksFrequenciesSpin(ClocksFrequenciesSensor):
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize ClocksFrequenciesSpin.
    ...
    def __init__(
        ...
        *,
        ...
        reference_magnitude_dBm
            Reference magnitude in dBm.
        reference_magnitude_V
            Reference magnitude in V.
        reference_magnitude_A
            Reference magnitude in A.
...
class DispersiveMeasurementSpin(DispersiveMeasurement):
    ...
    :func:`~quantify.operations.measurement_factories.dispersive_measurement_spin`.
    """

    def __init__(
        self, parent: InstrumentBase, name: str, *, gate_pulse_amp: float = 0, **kwargs
    ) -> None:
        """Initialize DispersiveMeasurementSpin.
        ...
        **kwargs
        ...
        # TODO: this should be refactored when we redesign how quantify
        # supports different qubits.
        # See QTFY-738.
        self.integration_time.remove_validator()
        self.integration_time.add_validator(
            vals=validators.Numbers(min_value=0, max_value=10e-3)
        )
...
class BasicSpinElement(DeviceElement):
    ...
    .. admonition:: Examples
        ...
        .. jupyter-execute::
            ...
            from quantify.device_under_test.spin_element import BasicSpinElement
    ...
    def _generate_config(self) -> dict[str, dict[str, OperationCompilationConfig]]:
        """
        Generate device configuration for a single qubit trapped in a quantum
        dot. A resonator to perform dispersive readout is attached to the gate
        to perform charge sensing.
            ...
            f"{self.name}": {
                ...
                "Rxy": OperationCompilationConfig(
                    ...
                    factory_kwargs={
                        ...
                        "reference_magnitude": (
                            pulse_library.ReferenceMagnitude.from_parameter(
                ...
                "measure": OperationCompilationConfig(
                    ...
                    factory_kwargs={
                        ...
                        "acq_weights_sampling_rate": (
                            self.measure.acq_weights_sampling_rate()
                        ),
                ...
                "pulse_compensation": OperationCompilationConfig(
                    ...
                    factory_kwargs={
                        ...
                        "max_compensation_amp": (
                            self.pulse_compensation.max_compensation_amp()
                        ),
    ...
    def generate_device_config(self) -> DeviceCompilationConfig:
        ...
        The config will be used for the quantify making use of the
...
class ChargeSensor(DeviceElement):
    """
    A device element representing a Charge Sensor connected to a tank circuit
    to perform dispersive readout.
    ...
    .. admonition:: Examples
        ...
        .. jupyter-execute::
            ...
            from quantify.device_under_test.spin_element import ChargeSensor
    ...
    def __init__(self, name: str, **kwargs: Any) -> None:  # noqa: ANN401
        """Initialize ChargeSensor.

        Parameters
        ----------
        name
            The name of the charge sensor.
        **kwargs
            Additional keyword arguments for submodules.
        ...
        """Submodule :class:`~.PortsChargeSensor`."""
        self.clock_freqs: ClocksFrequenciesSensor
        """Submodule :class:`~.ClocksFrequenciesSensor`."""
