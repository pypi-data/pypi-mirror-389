...
r"""
Module representing the Q-Profile quantum control electronics profiler.
...
from quantify.instrument_coordinator.instrument_coordinator import (
...
if TYPE_CHECKING:
    ...
    from quantify.instrument_coordinator.components import (
...
class ProfiledInstrumentCoordinator(InstrumentCoordinator):
    ...
    timing results. Time results are stored in
    ...
    def __init__(  # noqa: D107
        self, name: str, parent_ic: InstrumentCoordinator
    ) -> None:
    ...
    @profiler
    def stop(self, allow_failure: bool = False) -> None:  # noqa: ARG002, D102
        self.parent_ic.stop()

    @profiler
    def retrieve_acquisition(self) -> Dataset:  # noqa: D102
        return self.parent_ic.retrieve_acquisition()

    @profiler
    def wait_done(self, timeout_sec: int = 10) -> None:  # noqa: D102
