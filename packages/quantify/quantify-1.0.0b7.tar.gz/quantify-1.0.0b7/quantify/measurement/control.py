...
class MeasurementControl(Instrument):  # pylint: disable=too-many-instance-attributes
    ...
    def __repr__full__(self):  # noqa: ANN204, D105
    ...
    def _reshape_data(
        ...
        if acq_protocol == "ThresholdedAcquisition":
            # Not type-casted. The type will be determined by quantify as it
            # depends on the bin mode.
            return [vals.real]
        if acq_protocol in (
            "Trace",
    ...
    def _reset(self, save_data=True) -> None:  # noqa: ANN001
    ...
    def _init(self, name) -> None:  # noqa: ANN001
    ...
    def run_adaptive(
        ...
        name,  # noqa: ANN001
        params,  # noqa: ANN001
        lazy_set: bool | None = None,  # noqa: ANN001
    ) -> xr.Dataset:
        """
        ...
        def measure(vec) -> float:  # noqa: ANN001
            """
    ...
    def _build_data(self, new_data, old_data):  # noqa: ANN001, ANN202
        if self._soft_avg == 1:
    ...
    def print_progress(self, progress_message: str = None) -> None:
        """
        ...
        if self.verbose() and not hasattr(self, "pbar") and progress_message is None:
            ...
            custom_bar_format = "{l_bar}{bar} [ elapsed time: {elapsed} | time left: {remaining} ] {unit}"  # noqa: E501
    ...
    def settables(self, settable_pars) -> None:  # noqa: ANN001
        """
    ...
    def setpoints(self, setpoints: np.ndarray) -> None:
        """
    ...
    def setpoints_grid(self, setpoints: Iterable[np.ndarray]) -> None:
        """
    ...
    def gettables(self, gettable_pars) -> None:  # noqa: ANN001
        """
    ...
    def attach_plotmon(self, ui_tool: UITool = QuantifyUI()) -> None:
        """Attaches plotmon and start its server."""
        self._client = MeasurementClient(self, ui_tool=ui_tool)
        self._init = self._client._init
        self._update = self._client._update
        self._finish = self._client._finish
...
Handler = Callable[[int, types.FrameType | None], Any]
