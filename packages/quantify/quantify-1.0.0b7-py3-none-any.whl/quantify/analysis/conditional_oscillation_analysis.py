...
class ConditionalOscillationAnalysis(ba.BaseAnalysis):
    ...
    .. admonition:: Example
        ...
        .. jupyter-execute::
            ...
            from quantify.analysis.conditional_oscillation_analysis import (
    ...
    def analyze_fit_results(self) -> None:
        ...
        self.quantities_of_interest["phi_2q_deg"] = ufloat(
            np.mod(self.quantities_of_interest["phi_2q_deg"].nominal_value, 360.0),
            self.quantities_of_interest["phi_2q_deg"].std_dev,
        )
