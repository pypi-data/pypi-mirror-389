...
example_transmon_cfg = {
    "compilation_passes": [
        {
            ...
            "compilation_func": "quantify.backends.circuit_to_device.compile_circuit_to_device_with_config_validation",  # noqa: E501, line too long
        }
    ],
    "clocks": {
        "q0.01": 6020000000.0,
    ...
    "elements": {
        "q0": {
            "reset": {
                "factory_func": "quantify.operations.pulse_library.IdlePulse",
                "factory_kwargs": {"duration": 0.0002},
            },
            "Rxy": {
                "factory_func": "quantify.operations."
            ...
            "Rz": {
                "factory_func": "quantify.operations." + "pulse_factories.phase_shift",
