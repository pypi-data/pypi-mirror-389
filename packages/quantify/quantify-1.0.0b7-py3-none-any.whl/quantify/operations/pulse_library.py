...
class ReferenceMagnitude:
    ...
    @classmethod
    def from_parameter(cls, parameter: InstrumentChannel):  # noqa: ANN206, ANN102
...
class SetClockFrequency(Operation):
    ...
    def __init__(  # noqa: D107
        self, clock: str, clock_freq_new: float | None, t0: float = 0
    ) -> None:
        super().__init__(name=self.__class__.__name__)
        self.data["pulse_info"] = [
            {
...
class MarkerPulse(Operation):
    ...
    Marker pulse is played on marker output.
