...
"""Standard control flow operations for use with the quantify."""
...
class LoopOperation(ControlFlowOperation):
    ...
    def __init__(
        ...
        """Initialize a loop control flow specification."""
...
class ConditionalOperation(ControlFlowOperation):
    ...
    .. jupyter-execute::
        ...
        # relevant imports
        from quantify.schedules.schedule import Schedule
        from quantify.operations import ConditionalOperation, Measure, X
    ...
    def __init__(
        ...
        """Initialize a conditional control flow specification."""
