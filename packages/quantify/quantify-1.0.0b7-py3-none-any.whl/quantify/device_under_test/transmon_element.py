...
class ClocksFrequencies(InstrumentChannel):
    """
    Submodule containing the clock frequencies specifying the transitions
    to address.
    """
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize ClocksFrequencies submodule."""
        super().__init__(parent=parent, name=name)
...
class IdlingReset(InstrumentChannel):
    ...
    def __init__(
        self, parent: InstrumentBase, name: str, *, duration: float = 200e-6
    ) -> None:
        """Initialize IdlingReset submodule."""
        super().__init__(parent=parent, name=name)
...
class PulseCompensationModule(InstrumentChannel):
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize PulseCompensationModule submodule."""
        super().__init__(parent=parent, name=name)
...
class DispersiveMeasurement(InstrumentChannel):
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize DispersiveMeasurement submodule."""
        super().__init__(parent=parent, name=name)
        # Use reference magnitude arguments to initialize submodule
        self.add_submodule(
            name="reference_magnitude",
            submodule=ReferenceMagnitude(
                parent=self,
        ...
        # Avoid duplicate submodule registration if already added earlier
        if "reference_magnitude" not in self.submodules:
            self.add_submodule(
                name="reference_magnitude",
                submodule=ReferenceMagnitude(
                    parent=self,
        ...
        more details see
        :class:`~quantify.operations.acquisition_library.ThresholdedAcquisition`."""
...
class ReferenceMagnitude(InstrumentChannel):
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize ReferenceMagnitude submodule."""
        super().__init__(parent=parent, name=name)
...
class BasicTransmonElement(DeviceElement):
    ...
    def __init__(self, name: str, **kwargs) -> None:
        """Initialize BasicTransmonElement."""
        submodules_to_add = {
            "reset": IdlingReset,
            "rxy": RxyDRAG,
            ...
            f"{self.name}": {
                ...
                "Rxy": OperationCompilationConfig(
                    ...
                    factory_kwargs={
                        ...
                        "reference_magnitude": pulse_library.ReferenceMagnitude.from_parameter(  # noqa: E501
                ...
                "pulse_compensation": OperationCompilationConfig(
                    ...
                    factory_kwargs={
                        "port": self.ports.microwave(),
                        "clock": f"{self.name}.01",
                        "max_compensation_amp": self.pulse_compensation.max_compensation_amp(),  # noqa: E501
                ...
                "measure": OperationCompilationConfig(
                    ...
                    factory_kwargs={
                        ...
                        "acq_weights_sampling_rate": self.measure.acq_weights_sampling_rate(),  # noqa: E501
