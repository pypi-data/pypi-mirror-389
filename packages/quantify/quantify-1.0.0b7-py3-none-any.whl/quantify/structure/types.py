...
#  The last version that supported Python 3.9 is 3.2.1, which however has a different
#  function signature for `node_data_link()`. For this reason, we must pass different
#  parameters to the serialization function depending on the package version.
...
class NDArray(np.ndarray):
    ...
    def __get_pydantic_core_schema__(
        ...
        """Get the Pydantic core schema for the array."""
...
class Graph(nx.Graph):
    ...
    def __get_pydantic_core_schema__(
        ...
        return core_schema.no_info_plain_validator_function(
            cls.validate,
            serialization=core_schema.plain_serializer_function_ser_schema(
                lambda g: nx.node_link_data(g, **NODE_LINK_DATA_KWARGS),
                when_used="always",
            ),
        )
