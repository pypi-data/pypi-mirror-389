...
## Release Notes
  ...
  #### release 0.2.9
    - Added fix for handling invalid characters in mcp tool name

  #### release 0.2.8
    - Implemented overrides for the list_tools and call_tools methods in the updated FastMcp framework.