...
class FabricManagerV2:
    ...
    def clear_cached_id_token(self, *, path: str) -> None:
        self.credmgr.clear_cached_id_token(path=path)
    ...
    def list_slivers(
        ...
        return self.orch.slices(token=id_token, slice_id=slice_id, as_self=as_self, return_fmt=return_fmt)
