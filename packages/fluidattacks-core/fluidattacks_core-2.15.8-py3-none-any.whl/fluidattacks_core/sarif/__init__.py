...
#   timestamp: 2025-11-05T13:24:39+00:00
...
class ReportingConfiguration(BaseModel):
    ...
    enabled: bool | None = Field(
        default=True, description="Specifies whether the report may be produced during the scan.",
    )
    ...
    parameters: PropertyBag | None = Field(
        default=None, description="Contains configuration information specific to a report.",
    )
...
class ToolComponentReference(BaseModel):
    ...
    index: conint(ge=-1) | None = Field(
        default=-1, description="An index into the referenced toolComponent in tool.extensions.",
    )
    guid: (
        constr(
            pattern=r"^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-5][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$",
        ...
        | None
    ) = Field(default=None, description="The 'guid' property of the referenced toolComponent.")
    properties: PropertyBag | None = Field(
        default=None,
...
class Address(BaseModel):
    ...
    name: str | None = Field(
        default=None, description="A name that is associated with the address, e.g., '.text'.",
    )
...
class ReportingDescriptorReference1(BaseModel):
    ...
    guid: (
        ...
        | None
    ) = Field(default=None, description="A guid that uniquely identifies the descriptor.")
...
class ReportingDescriptorReference(
    ...
    root: (
        ...
        | ReportingDescriptorReference2
        | ReportingDescriptorReference3
    ) = Field(..., description="Information about how to locate a relevant reporting descriptor.")
...
class ReportingDescriptorRelationship(BaseModel):
    ...
    description: Message | None = Field(
        default=None, description="A description of the reporting descriptor relationship.",
    )
    properties: PropertyBag | None = Field(
        default=None,
        description="Key/value pairs that provide additional information about the reporting descriptor reference.",
...
class ArtifactLocation(BaseModel):
    ...
    uri: str | None = Field(
        default=None, description="A string containing a valid relative or absolute URI.",
    )
...
class Edge(BaseModel):
    ...
    label: Message | None = Field(default=None, description="A short description of the edge.")
...
class EdgeTraversal(BaseModel):
    ...
    message: Message | None = Field(
        default=None, description="A message to display to the user as the edge is traversed.",
    )
...
class Region(BaseModel):
    ...
    char_length: conint(ge=0) | None = Field(
        default=None, alias="charLength", description="The length of the region in characters.",
    )
    ...
    byte_length: conint(ge=0) | None = Field(
        default=None, alias="byteLength", description="The length of the region in bytes.",
    )
    snippet: ArtifactContent | None = Field(
        default=None,
        description="The portion of the artifact contents within the specified region.",
    )
    message: Message | None = Field(default=None, description="A message relevant to the region.")
...
class ReportingDescriptor(BaseModel):
    ...
    name: str | None = Field(
        default=None, description="A report identifier that is understandable to an end user.",
    )
...
class ToolComponent(BaseModel):
    ...
    guid: (
        ...
        default=None, description="A unique identifer for the tool component in the form of a GUID.",
    )
    name: str = Field(..., description="The name of the tool component.")
    organization: str | None = Field(
        default=None, description="The organization or company that produced the tool component.",
    )
    ...
    language: constr(pattern=r"^[a-zA-Z]{2}|^[a-zA-Z]{2}-[a-zA-Z]{2}]?$") | None = Field(
        default="en-US",
...
class WebRequest(BaseModel):
    ...
    protocol: str | None = Field(default=None, description="The request protocol. Example: 'http'.")
    version: str | None = Field(default=None, description="The request version. Example: '1.1'.")
    ...
    headers: dict[str, str] | None = Field(default=None, description="The request headers.")
    parameters: dict[str, str] | None = Field(default=None, description="The request parameters.")
    body: ArtifactContent | None = Field(default=None, description="The body of the request.")
    properties: PropertyBag | None = Field(
        default=None,
...
class WebResponse(BaseModel):
    ...
    version: str | None = Field(default=None, description="The response version. Example: '1.1'.")
    status_code: int | None = Field(
        default=None, alias="statusCode", description="The response status code. Example: 451.",
    )
    reason_phrase: str | None = Field(
        default=None, alias="reasonPhrase", description="The response reason. Example: 'Not found'.",
    )
    headers: dict[str, str] | None = Field(default=None, description="The response headers.")
    body: ArtifactContent | None = Field(default=None, description="The body of the response.")
...
class Artifact(BaseModel):
    ...
    mime_type: constr(pattern=r"[^/]+/.+") | None = Field(
        default=None, alias="mimeType", description="The MIME type (RFC 2045) of the artifact.",
    )
...
class Attachment(BaseModel):
    ...
    description: Message | None = Field(
        default=None, description="A message describing the role played by the attachment.",
    )
    artifact_location: ArtifactLocation = Field(
...
class PhysicalLocation1(BaseModel):
    ...
    artifact_location: ArtifactLocation | None = Field(
        default=None, alias="artifactLocation", description="The location of the artifact.",
    )
    region: Region | None = Field(default=None, description="Specifies a portion of the artifact.")
...
class PhysicalLocation2(BaseModel):
    ...
    address: Address | None = Field(default=None, description="The address of the location.")
    artifact_location: ArtifactLocation = Field(
...
class Location(BaseModel):
    ...
    physical_location: PhysicalLocation | None = Field(
        default=None, alias="physicalLocation", description="Identifies the artifact and region.",
    )
    ...
    message: Message | None = Field(default=None, description="A message relevant to the location.")
    annotations: list[Region] | None = Field(
        default=[], description="A set of regions relevant to the location.", min_length=0,
    )
...
class Node(BaseModel):
    ...
    label: Message | None = Field(default=None, description="A short description of the node.")
...
class StackFrame(BaseModel):
    ...
    thread_id: int | None = Field(
        default=None, alias="threadId", description="The thread identifier of the stack frame.",
    )
    parameters: list[str] | None = Field(
        default=[], description="The parameters of the call that is executing.", min_length=0,
    )
    properties: PropertyBag | None = Field(
        default=None,
...
class Suppression(BaseModel):
    ...
    state: State | None = Field(
        default=None, description="A string that indicates the state of the suppression.",
    )
    justification: str | None = Field(
        default=None, description="A string representing the justification for the suppression.",
    )
    location: Location | None = Field(
        default=None, description="Identifies the location associated with the suppression.",
    )
    properties: PropertyBag | None = Field(
        default=None,
...
class Graph(BaseModel):
    ...
    description: Message | None = Field(default=None, description="A description of the graph.")
...
class ThreadFlowLocation(BaseModel):
    ...
    module: str | None = Field(
        default=None, description="The name of the module that contains the code that is executing.",
    )
...
class Exception(BaseModel):
    ...
    message: str | None = Field(default=None, description="A message that describes the exception.")
    stack: Stack | None = Field(
        default=None, description="The sequence of function calls leading to the exception.",
    )
...
class Notification(BaseModel):
    ...
    locations: list[Location] | None = Field(
        default=[], description="The locations relevant to this notification.", min_length=0,
    )
    message: Message = Field(
        ..., description="A message that describes the condition that was encountered.",
    )
    level: Level | None = Field(
        default="warning", description="A value specifying the severity level of the notification.",
    )
    thread_id: int | None = Field(
        default=None,
        alias="threadId",
    ...
    exception: Exception | None = Field(
        default=None, description="The runtime exception, if any, relevant to this notification.",
    )
...
class Invocation(BaseModel):
    ...
    command_line: str | None = Field(
        default=None, alias="commandLine", description="The command line used to invoke the tool.",
    )
    arguments: list[str] | None = Field(
        default=None,
    ...
    exit_code_description: str | None = Field(
        default=None, alias="exitCodeDescription", description="The reason for the process exit.",
    )
    ...
    account: str | None = Field(default=None, description="The account that ran the analysis tool.")
    process_id: int | None = Field(
        default=None, alias="processId", description="The process id for the analysis tool run.",
    )
...
class Result(BaseModel):
    ...
    kind: Kind | None = Field(
        default="fail", description="A value that categorizes results by evaluation state.",
    )
    level: Level | None = Field(
        default="warning", description="A value specifying the severity level of the result.",
    )
    message: Message = Field(
        ...,
    ...
    guid: (
        ...
        default=None, description="A stable, unique identifer for the result in the form of a GUID.",
    )
    correlation_guid: (
        constr(
            pattern=r"^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-5][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$",
    ...
    stacks: list[Stack] | None = Field(
        default=[], description="An array of 'stack' objects relevant to the result.", min_length=0,
    )
    ...
    suppressions: list[Suppression] | None = Field(
        default=None, description="A set of suppressions relevant to this result.", min_length=0,
    )
    ...
    rank: confloat(ge=-1.0, le=100.0) | None = Field(
        default=-1.0, description="A number representing the priority or importance of the result.",
    )
    attachments: list[Attachment] | None = Field(
        default=[], description="A set of artifacts relevant to the result.", min_length=0,
    )
    ...
    provenance: ResultProvenance | None = Field(
        default=None, description="Information about how and when the result was detected.",
    )
    ...
    web_request: WebRequest | None = Field(
        default=None, alias="webRequest", description="A web request associated with this result.",
    )
    web_response: WebResponse | None = Field(
        default=None, alias="webResponse", description="A web response associated with this result.",
    )
    properties: PropertyBag | None = Field(
        default=None,
        description="Key/value pairs that provide additional information about the result.",
...
class ExternalProperties(BaseModel):
    ...
    version: Version | None = Field(
        default=None, description="The SARIF format version of this external properties object.",
    )
    guid: (
        constr(
            pattern=r"^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-5][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$",
    ...
    conversion: Conversion | None = Field(
        default=None, description="A conversion object that will be merged with a separate run.",
    )
    graphs: list[Graph] | None = Field(
        default=[],
    ...
    addresses: list[Address] | None = Field(
        default=[], description="Addresses that will be merged with a separate run.", min_length=0,
    )
...
class Run(BaseModel):
    ...
    invocations: list[Invocation] | None = Field(
        default=[], description="Describes the invocation of the analysis tool.", min_length=0,
    )
    conversion: Conversion | None = Field(
        default=None,
    ...
    artifacts: list[Artifact] | None = Field(
        default=None, description="An array of artifact objects relevant to the run.", min_length=0,
    )
    logical_locations: list[LogicalLocation] | None = Field(
        default=[],
        alias="logicalLocations",
    ...
    addresses: list[Address] | None = Field(
        default=[], description="Addresses associated with this run instance, if any.", min_length=0,
    )
    translations: list[ToolComponent] | None = Field(
        default=[],
