...
from rlquantdata.DateUtilities.Date_enum import TimeUnits
from rlquantdata.DateUtilities.Asserts import require, ensureRaise
...
class Period(object):
    ...
    def __init__(self, reprStr=None, length=0, units=0):
        ...
        if reprStr:
            ...
            self._length = n
            self._units = _unitsDict[unitsStr]
        else:
            self._length = length
            self._units = units
