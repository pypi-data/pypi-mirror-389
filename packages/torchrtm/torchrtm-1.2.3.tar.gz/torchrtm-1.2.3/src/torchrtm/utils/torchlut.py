...
def Torchlut(model = [], table_size=500000, std=0, batch=10000, wavelength=None,d = None,sensor_name = 'LANDSAT4-TM',sail_prospect = 'prospectd',use_atom = False):
    ...
    for ii_index in tqdm(range(num_iterations), desc="Processing Batches"):
        ...
        if param_type in ['prospectd', 'prospect5b']:
            ...
            if param_type=='prosail':
                ...
                print(spec_data[2].shape,PARdiro.shape,PARdifo.shape)
