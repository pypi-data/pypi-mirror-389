...
CREATE INDEX idx_employee_org_path ON employees USING GIST (org_path);

-- Sample organization data
INSERT INTO employees (name, title, department, salary, org_path, hire_date) VALUES
-- Executive Level
...
UPDATE employees SET manager_id = (
    SELECT id FROM employees e2 WHERE e2.org_path = subpath(employees.org_path, 0, nlevel(employees.org_path) - 1)
