...
**📍 You are here: Main FraiseQL Framework (v1.2.0) - Production Stable**
...
|---------|----------|--------|---------|------------|
| **v1.1.7** | Root level | Production Stable | Latest stable release | ✅ Recommended |
| **Rust Pipeline** | [`fraiseql_rs/`](fraiseql_rs/) | Integrated | Included in v1.0+ | ✅ Stable |
| **v1.1.6** | Superseded | Legacy | Use v1.1.7 | ⚠️ Migrate |
