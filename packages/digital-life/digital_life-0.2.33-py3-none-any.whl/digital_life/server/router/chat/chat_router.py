...
from digital_life.server.router.chat.chat import Interviews
...
async def update_deepmodel(
    ...
    logger.critical("update_deepmodel called")
    ...
    try:
        ...
        logger.critical("update_deepmodel - before chat_with_deepmodel")
