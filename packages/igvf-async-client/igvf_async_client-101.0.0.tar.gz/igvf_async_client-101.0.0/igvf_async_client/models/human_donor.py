...
"""
    ...
    The version of the OpenAPI document: 101.0.0
...
class HumanDonor(BaseModel):
    ...
    supersedes: Optional[List[StrictStr]] = Field(default=None, description="The donor(s) that this donor supersedes by virtue of being newer, better, or a fixed version of etc. than the one(s) it supersedes.")
    ...
    superseded_by: Optional[List[StrictStr]] = Field(default=None, description="Donor(s) this donor is superseded by virtue of those donor(s) being newer, better, or a fixed version of etc. than this one.")
