...
from dharitri_py_sdk.core.base_factory import BaseFactory
from dharitri_py_sdk.core.errors import BadUsageError
from dharitri_py_sdk.core.interfaces import IGasLimitEstimator
...
Once the token is registered, you can unset this role by calling "unsetBurnRoleGlobally" (in a separate transaction)."""
    ...
    def create_transaction_for_creating_nft(
        ...
        self.set_gas_limit(
            transaction=transaction,
            config_gas_limit=self._config.gas_limit_dcdt_nft_create + storage_gas_limit,
        )
    ...
    def create_transaction_for_local_minting(
        ...
        self.set_payload(transaction, parts)
        self.set_gas_limit(transaction=transaction, config_gas_limit=self._config.gas_limit_dcdt_local_mint)
    ...
    def create_transaction_for_local_burning(
        ...
        self.set_payload(transaction, parts)
        self.set_gas_limit(transaction=transaction, config_gas_limit=self._config.gas_limit_dcdt_local_burn)
    ...
    def create_transaction_for_updating_attributes(
        ...
        self.set_payload(transaction, parts)
        self.set_gas_limit(transaction=transaction, config_gas_limit=self._config.gas_limit_dcdt_nft_update_attributes)
    ...
    def create_transaction_for_adding_quantity(
        ...
        self.set_payload(transaction, parts)
        self.set_gas_limit(transaction=transaction, config_gas_limit=self._config.gas_limit_dcdt_nft_add_quantity)
    ...
    def create_transaction_for_burning_quantity(
        ...
        self.set_payload(transaction, parts)
        self.set_gas_limit(transaction=transaction, config_gas_limit=self._config.gas_limit_dcdt_nft_burn)
    ...
    def create_transaction_for_modifying_royalties(
        ...
        self.set_payload(transaction, parts)
        self.set_gas_limit(transaction=transaction, config_gas_limit=self._config.gas_limit_dcdt_modify_royalties)
    ...
    def create_transaction_for_modifying_creator(
        ...
        self.set_payload(transaction, parts)
        self.set_gas_limit(transaction=transaction, config_gas_limit=self._config.gas_limit_dcdt_modify_creator)
    ...
    def create_transaction_for_updating_metadata(
        ...
        self.set_payload(transaction, parts)
        self.set_gas_limit(transaction=transaction, config_gas_limit=self._config.gas_limit_dcdt_metadata_update)
    ...
    def create_transaction_for_changing_sft_to_meta_dcdt(
        ...
        self.set_payload(transaction, parts)
        self.set_gas_limit(transaction=transaction, config_gas_limit=self._config.gas_limit_change_sft_to_meta_dcdt)
    ...
    def create_transaction_for_adding_uris(
        ...
        self.set_payload(transaction, parts)
        self.set_gas_limit(transaction=transaction, config_gas_limit=self._config.gas_limit_dcdt_nft_add_uri)
