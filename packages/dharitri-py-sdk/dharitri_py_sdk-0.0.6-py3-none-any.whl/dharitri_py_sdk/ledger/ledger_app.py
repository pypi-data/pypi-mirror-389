...
from dharitri_py_sdk.ledger.config import LedgerAppConfiguration
from dharitri_py_sdk.ledger.errors import LedgerError
    ...
    def __init__(self) -> None:
        try:
            ...
            raise ImportError(
                ...
                "pip install dharitri_py_sdk[ledger]."
            ) from e
