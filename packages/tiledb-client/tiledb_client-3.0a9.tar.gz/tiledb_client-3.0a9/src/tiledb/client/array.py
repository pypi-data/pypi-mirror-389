...
def apply_base(
    ...
    **kwargs: Any,
    ...
    :param teamspace: The teamspace to execute the UDF under.
    ...
    **Example**
    ...
    >>> tiledb.cloud.array.apply_base("tiledb://TileDB-Inc./teamspace/quickstart_dense", "teamspace", median, [(0,5), (0,5)], attrs=["a", "b", "c"]).result
    2.0
    """  # noqa: E501
    del v2  # unused
...
def exec_multi_array_udf_base(
    ...
    **kwargs,
    ...
    >>> res = array.exec_multi_array_udf("teamspace", median, array_list)
