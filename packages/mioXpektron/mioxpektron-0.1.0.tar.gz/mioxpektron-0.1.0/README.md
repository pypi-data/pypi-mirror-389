...
```bash
git clone https://github.com/julhashkazi/mioXpektron.git
cd mioXpektron
pip install -e .
```
...
@software{mioxpektron,
  ...
  year = {2025},
  url = {https://github.com/julhashkazi/mioXpektron}
}
```
...
- **Issues**: https://github.com/julhashkazi/mioXpektron/issues
- **Documentation**: https://github.com/julhashkazi/mioXpektron#readme
