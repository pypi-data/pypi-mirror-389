...
class cli:
    ...
    class find_import:
        ...
        def animate_rgb_text(self, text, delay=0.01):
            import time
            from SeleniumTwo import DK_ORANGE
            hue = 0
        ...
        def main(self, return_=False):
            ...
            import_data = {
                ...
                "capmonstercloudclient": "SeleniumTwo[capmonstercloudclient]",
                "capmonstercloud_client": "SeleniumTwo[capmonstercloudclient]",
                ...
                "psutil": "SeleniumTwo[psutil]",
                "screeninfo": "SeleniumTwo[screeninfo]", "get_monitors": "SeleniumTwo[screeninfo]",
                "pynput": "SeleniumTwo[pynput]", "pynput.mouse": "SeleniumTwo[pynput]",
                "pynput.keyboard": "SeleniumTwo[pynput]",
                "pywinauto": "SeleniumTwo[pywinauto]",
                "pdfplumber": "pdfplumber",
                "twocaptcha": "SeleniumTwo[twocaptcha]", "TwoCaptcha": "SeleniumTwo[twocaptcha]",
            }
            ...
            from SeleniumTwo import DK_ORANGE, ORANGE, RESET
            if self.imports:
                if not return_:
