...
from ...models.create_app_metafield_body import CreateAppMetafieldBody as Body
...
async def call(
    ...
    To create app metafield attached to specific product
    
    Path: POST /products/{product_id}/app_metafields
    """
    # 构建请求 URL
