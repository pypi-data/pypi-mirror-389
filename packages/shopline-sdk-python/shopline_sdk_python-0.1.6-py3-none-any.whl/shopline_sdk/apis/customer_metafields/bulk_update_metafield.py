...
async def call(
    ...
    bulk update information of metafield attached to specific customer
    
    Path: PUT /customers/{customer_id}/metafields/bulk
    """
    # 构建请求 URL
    url = f"customers/{customer_id}/metafields/bulk"
