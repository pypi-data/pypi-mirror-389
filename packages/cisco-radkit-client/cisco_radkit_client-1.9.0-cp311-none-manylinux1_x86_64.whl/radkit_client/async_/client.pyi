...
class AsyncClient:
    ...
    @classmethod
    def create(cls, *, radkit_directory: str | Path | None = None, init_logging: bool = False, log_level: nglog.LogLevel | None = None, tracebacks: bool = False, settings_file: Path | None = None, extra_settings: Mapping[str, str] | None = None, default_domain: Domain | str | None = None) -> AbstractAsyncContextManager[Self]: ...
    @classmethod
    @asynccontextmanager
