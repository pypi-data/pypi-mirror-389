...
class Client(SyncWrapper[AsyncClient]):
    ...
    @classmethod
    @contextmanager
    def create(cls, default_domain: Domain | None | str = None, *, radkit_directory: str | Path | None = None, settings_file: Path | None = None, extra_settings: Mapping[str, str] | None = None, init_logging: bool = False, log_level: nglog.LogLevel | None = None, tracebacks: bool = False) -> Generator[Self]: ...
    @classmethod
    @contextmanager
