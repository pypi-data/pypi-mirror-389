...
@contextmanager
def connect_to_service(radkit_directory: Path | None, service_sn: str, sso_email: str | None = None, cert_identity: str | None = None, ca_path: str | None = None, cert_path: str | None = None, key_path: str | None = None, domain: str | None = None, tracebacks: bool = False) -> Iterator[tuple[Client, Service]]: ...
