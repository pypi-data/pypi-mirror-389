...
3.  Clone the Git repo of this project and switch to its working directory:
    ...
    ```
    git clone https://github.com/andy-maier/ansible-collection-path
    cd ansible-collection-path
    ```
...
2.  Check for any
    `dependabot alerts <https://github.com/andy-maier/ansible-collection-path/security/dependabot>`_.
...
10. Verify the publishing
    ...
    https://github.com/andy-maier/ansible-collection-path/actions/workflows/publish.yml

    Then, perform the following verifications:

    * Verify that the new version is available on PyPI at
      https://pypi.python.org/pypi/ansible-collection-path/

    * Verify that the new version has a release on Github at
      https://github.com/andy-maier/ansible-collection-path/releases
...
This description assumes that you are authorized to push to the remote repo
at https://github.com/andy-maier/ansible-collection-path and that the remote repo
