...
- The [latest released version on Pypi](https://pypi.org/project/ansible-collection-path/)
...
[Security Advisories](https://github.com/andy-maier/ansible-collection-path/security/advisories)
