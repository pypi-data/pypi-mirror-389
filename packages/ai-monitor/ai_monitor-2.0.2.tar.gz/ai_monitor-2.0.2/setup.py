...
setup(
    ...
    description="Ultra-lightweight AI monitoring - pure Python, no compilation required! Docker-friendly.",
    ...
    python_requires=">=3.8",
    install_requires=[
        # Only pure Python packages (no compilation required!)
        "numpy>=1.20.0",
        "requests>=2.25.0",
        "httpx>=0.24.0",
        "tiktoken>=0.5.0",
        "psutil>=5.9.0",
        # REMOVED: scikit-learn (requires C++ compilation)
        # REMOVED: scipy (requires Fortran compilation)
    ...
    extras_require={
        ...
        # Heavy ML dependencies (requires compilation)
        "ml": [
            "scikit-learn>=1.0.0",
            "scipy>=1.7.0",
        ],
        ...
        "all": [
            ...
            "flask>=2.0.0",
            "flask-cors>=3.0.0",
            # Note: Heavy ML excluded from [all] for Docker compatibility
            # Use [ml] or [transformers] extras if needed
        ],
        "dev": [
            "pytest>=7.0.0",
            "pytest-cov>=4.0.0",
