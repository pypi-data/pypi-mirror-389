...
setup(
    ...
    description="Enterprise-grade AI monitoring and observability toolkit for LLM applications - Lightweight edition (NO TORCH!)",
    ...
    install_requires=[
        ...
        "tiktoken>=0.5.0",
        "psutil>=5.9.0",
        # Lightweight ML for semantic analysis (NO TORCH!)
        "scikit-learn>=1.0.0",
        "scipy>=1.7.0",
    ],
    extras_require={
