...
class PaginatedTelegramSourceList(BaseModel):
    """
    PaginatedTelegramSourceList
    """ # noqa: E501
    pagination: Pagination
    results: List[TelegramSource]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [TelegramSource.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
