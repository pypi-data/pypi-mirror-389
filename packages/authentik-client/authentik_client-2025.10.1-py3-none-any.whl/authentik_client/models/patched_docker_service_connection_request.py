...
class PatchedDockerServiceConnectionRequest(BaseModel):
    ...
    tls_verification: Optional[UUID] = Field(default=None, description="CA which the endpoint's Certificate is verified against. Can be left empty for no validation.")
    tls_authentication: Optional[UUID] = Field(default=None, description="Certificate/Key used for authentication. Can be left empty for no authentication.")
