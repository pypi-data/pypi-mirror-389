...
class Outpost(BaseModel):
    ...
    service_connection: Optional[UUID] = Field(default=None, description="Select Service-Connection authentik should use to manage this outpost. Leave empty if authentik should not handle the deployment.")
