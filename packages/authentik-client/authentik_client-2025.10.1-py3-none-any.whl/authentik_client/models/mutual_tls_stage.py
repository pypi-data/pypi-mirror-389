...
class MutualTLSStage(BaseModel):
    ...
    certificate_authorities: Optional[List[UUID]] = Field(default=None, description="Configure certificate authorities to validate the certificate against. This option has a higher priority than the `client_certificate` option on `Brand`.")
