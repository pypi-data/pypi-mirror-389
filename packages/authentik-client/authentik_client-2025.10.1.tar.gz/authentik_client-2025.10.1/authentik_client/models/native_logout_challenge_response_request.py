...
class NativeLogoutChallengeResponseRequest(BaseModel):
    """
    Response for native browser logout
    """ # noqa: E501
    component: Optional[Annotated[str, Field(min_length=1, strict=True)]] = 'ak-provider-saml-native-logout'
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "component": obj.get("component") if obj.get("component") is not None else 'ak-provider-saml-native-logout'
        })
        return _obj
