...
class TelegramLoginChallenge(BaseModel):
    """
    Base login challenge for Identification stage
    """ # noqa: E501
    flow_info: Optional[ContextualFlowInfo] = None
    component: Optional[StrictStr] = 'ak-source-telegram'
    response_errors: Optional[Dict[str, List[ErrorDetail]]] = None
    bot_username: StrictStr = Field(description="Telegram bot username")
    request_message_access: StrictBool
    __properties: ClassVar[List[str]] = ["flow_info", "component", "response_errors", "bot_username", "request_message_access"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "component": obj.get("component") if obj.get("component") is not None else 'ak-source-telegram',
