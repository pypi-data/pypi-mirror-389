...
class LDAPSource(BaseModel):
    ...
    peer_certificate: Optional[UUID] = Field(default=None, description="Optionally verify the LDAP Server's Certificate against the CA Chain in this keypair.")
    client_certificate: Optional[UUID] = Field(default=None, description="Client certificate to authenticate against the LDAP Server's Certificate.")
    ...
    sync_parent_group: Optional[UUID] = None
