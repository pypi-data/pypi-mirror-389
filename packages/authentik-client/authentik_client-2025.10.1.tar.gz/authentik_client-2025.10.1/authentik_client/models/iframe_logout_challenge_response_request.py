...
class IframeLogoutChallengeResponseRequest(BaseModel):
    """
    Response for iframe logout
    """ # noqa: E501
    component: Optional[Annotated[str, Field(min_length=1, strict=True)]] = 'ak-provider-iframe-logout'
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "component": obj.get("component") if obj.get("component") is not None else 'ak-provider-iframe-logout'
        })
        return _obj
