...
class VSCodeServer(
    ...
    def __init__(
        ...
        *,
        ...
        asset_zip_s3_path: typing.Optional[builtins.str] = None,
        auto_create_certificate: typing.Optional[builtins.bool] = None,
        branch_zip_s3_path: typing.Optional[builtins.str] = None,
        ...
        folder_zip_s3_path: typing.Optional[builtins.str] = None,
        ...
        :param asset_zip_s3_path: (experimental) S3 path to a zip file containing assets to extract into the home folder. The zip contents will be extracted to the user's home folder and committed to git. Use this to provide workshop materials, sample data, or configuration files. Default: - no assets downloaded
        ...
        :param branch_zip_s3_path: (experimental) S3 path to a zip file containing git branches to create in the home folder repository. Each top-level folder in the zip becomes a separate git branch with that folder's contents. Ideal for creating step-by-step workshop branches (e.g., step-1, step-2, solution). Default: - no branches created
        ...
        :param folder_zip_s3_path: (experimental) S3 path to a zip file containing multiple folders to create as separate git repositories. Each top-level folder in the zip becomes a separate subfolder in the parent directory, initialized as its own git repository. Useful for multi-project workshops. Default: - no folders created
        ...
        :param instance_operating_system: (experimental) VSCode Server EC2 operating system. Default: - Ubuntu-24
        ...
        :param repo_url: (experimental) Remote git repository URL to clone into the home folder. If provided, the repository will be cloned into the user's home folder during instance setup. Useful for pre-populating workshop environments with starter code. Default: - no repo cloned
...
class VSCodeServerProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument asset_zip_s3_path", value=asset_zip_s3_path, expected_type=type_hints["asset_zip_s3_path"])
            ...
            check_type(argname="argument branch_zip_s3_path", value=branch_zip_s3_path, expected_type=type_hints["branch_zip_s3_path"])
            ...
            check_type(argname="argument folder_zip_s3_path", value=folder_zip_s3_path, expected_type=type_hints["folder_zip_s3_path"])
        ...
        if asset_zip_s3_path is not None:
            self._values["asset_zip_s3_path"] = asset_zip_s3_path
        if auto_create_certificate is not None:
            self._values["auto_create_certificate"] = auto_create_certificate
        if branch_zip_s3_path is not None:
            self._values["branch_zip_s3_path"] = branch_zip_s3_path
        ...
        if folder_zip_s3_path is not None:
            self._values["folder_zip_s3_path"] = folder_zip_s3_path
    ...
    @builtins.property
    def asset_zip_s3_path(self) -> typing.Optional[builtins.str]:
        '''(experimental) S3 path to a zip file containing assets to extract into the home folder.
        ...
        '''
        result = self._values.get("asset_zip_s3_path")
    ...
    @builtins.property
    def branch_zip_s3_path(self) -> typing.Optional[builtins.str]:
        '''(experimental) S3 path to a zip file containing git branches to create in the home folder repository.
        ...
        '''
        result = self._values.get("branch_zip_s3_path")
        return typing.cast(typing.Optional[builtins.str], result)
    ...
    @builtins.property
    def folder_zip_s3_path(self) -> typing.Optional[builtins.str]:
        '''(experimental) S3 path to a zip file containing multiple folders to create as separate git repositories.
        ...
        '''
        result = self._values.get("folder_zip_s3_path")
        return typing.cast(typing.Optional[builtins.str], result)
    ...
    def repo_url(self) -> typing.Optional[builtins.str]:
        '''(experimental) Remote git repository URL to clone into the home folder.
