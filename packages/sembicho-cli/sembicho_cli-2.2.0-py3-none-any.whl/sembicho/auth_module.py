...
class SemBichoAuth:
    ...
    def login(self, username: str, password: str, api_url: Optional[str] = None) -> bool:
        """Login to SemBicho backend"""
        config = self.get_config()
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if token:
                    ...
                    # Update config with new API URL if provided
    ...
    def test_connection(self, api_url: Optional[str] = None) -> bool:
        """Test connection to SemBicho backend"""
        config = self.get_config()
        base_url = api_url or config.get("api_url", self.default_api_url)
