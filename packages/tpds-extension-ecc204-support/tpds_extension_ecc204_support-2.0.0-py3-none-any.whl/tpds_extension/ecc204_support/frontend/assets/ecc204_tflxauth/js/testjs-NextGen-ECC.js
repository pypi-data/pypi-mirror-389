...
function certVerify() {
    if (this.value == "Verify") {
        ...
        if(document.getElementById(this.id.replace("verify", "certyear")) != null){
            ...
            if (parseInt(certValidity) <= 127 && parseInt(certValidity) >= 0) {
                certDataValid2 = true;
            } else {
                alert("Error: Certificate validity can be 0 to 127 years, entering 0 will set the certificate expiry date to year 9999");
