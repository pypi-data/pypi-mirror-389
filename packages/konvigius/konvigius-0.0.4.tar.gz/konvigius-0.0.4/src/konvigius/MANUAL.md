# Konvigius, a Dynamic Configuration System with Validation and Metadata

This package provides a flexible and extensible system for defining,
...
def fn_multiple_of_5(value, cfg):
    if values % 5 != 0:
        raise ConfigValidationError("Value Must be a multiple of 5")
...
# Parse the CLI arguments from the terminal, --help shows all config-option from schema:
