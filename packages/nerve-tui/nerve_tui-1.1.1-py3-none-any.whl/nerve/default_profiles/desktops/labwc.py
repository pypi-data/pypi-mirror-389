...
class LabwcProfile(XorgProfile):
    def __init__(self) -> None:
        super().__init__(name='Labwc', profile_type=ProfileType.WindowMgr)
    ...
    def _ask_seat_access(self) -> None:
        ...
        header: str = tr('labwc needs access to your seat (collection of hardware devices i.e. keyboard, mouse, etc)') + '\n'
        header += tr('Choose an option to give labwc access to your hardware') + '\n'
