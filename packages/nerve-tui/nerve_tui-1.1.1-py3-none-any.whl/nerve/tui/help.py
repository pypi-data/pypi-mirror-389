...
class Help:
    # the groups need to be classmethods not static methods
    ...
    def general() -> HelpGroup:
        return HelpGroup(group_id=HelpTextGroupId.GENERAL, group_entries=[
    ...
    def navigation() -> HelpGroup:
        return HelpGroup(group_id=HelpTextGroupId.NAVIGATION, group_entries=[
    ...
    def selection() -> HelpGroup:
        return HelpGroup(group_id=HelpTextGroupId.SELECTION, group_entries=[
    ...
    def search() -> HelpGroup:
        return HelpGroup(group_id=HelpTextGroupId.SEARCH, group_entries=[
    ...
    def get_help_text() -> str:
        ...
        max_desc_width: int = max([_help.get_desc_width() for _help in help_texts]) + 2
        max_key_width:  int = max([_help.get_key_width()  for _help in help_texts])

        for help_group in help_texts:
            help_output += str(help_group.group_id.value) + '\n'
            divider_len: int = max_desc_width + max_key_width
