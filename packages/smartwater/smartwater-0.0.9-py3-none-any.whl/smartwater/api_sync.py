...
class SmartWaterApi:
    ...
    def __init__(self, username, password, client:httpx.Client|None = None, diagnostics_collect:bool = False):
            ...
            try:
                match method:
                    ...
                    case LoginMethod.GOOGLE_APIS:
                        ...
                        success = self._login_google_apis()
    ...
    def _login_google_apis(self) -> bool:
