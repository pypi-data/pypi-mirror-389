...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hidden", "prn", "pulp_labels", "content_guard", "pulp_href", "pulp_last_updated", "no_content_change_since", "pulp_created", "base_path", "base_url", "name"]
