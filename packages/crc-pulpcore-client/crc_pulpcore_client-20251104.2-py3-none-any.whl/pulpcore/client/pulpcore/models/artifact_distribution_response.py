...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "prn", "hidden", "pulp_labels", "base_url", "base_path", "name", "pulp_created", "pulp_last_updated", "content_guard", "pulp_href"]
