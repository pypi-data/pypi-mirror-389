...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "pulp_created", "prn", "base_url", "base_path", "hidden", "pulp_href", "pulp_last_updated", "pulp_labels", "content_guard", "name"]
