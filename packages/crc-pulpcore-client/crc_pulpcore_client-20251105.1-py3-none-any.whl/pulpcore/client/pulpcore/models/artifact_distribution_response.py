...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hidden", "pulp_labels", "content_guard", "name", "pulp_last_updated", "no_content_change_since", "pulp_href", "base_path", "pulp_created", "prn", "base_url"]
