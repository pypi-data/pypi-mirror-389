...
class FormulasApi(object):
    ...
    def experimental(self, **kwargs):
        """
        Run an experimental Seeq Formula. This endpoint is experimental and may change in future releases.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
    ...
    def formula_explainer(self, **kwargs):
        """
        Compile a Seeq Formula and show details about the execution plan. This endpoint is experimental and may change in future releases.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.formula_explainer(id=id_value, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: ID of the item to explain. (required)
        :return: FormulaGenericOutputV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: FormulaGenericOutputV1
    ...
    def formula_explainer_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.formula_explainer_with_http_info(id=id_value, callback=callback_function)
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `formula_explainer`")
        ...
        return self.api_client.call_api('/formulas/explainer/{id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
