...
class EnableAppRequest:
    ...
    Attributes:
        app_id (UUID):
        settings (Union['EnableAppRequestSettingsType0', None, Unset]):
    """

    app_id: UUID
    settings: Union["EnableAppRequestSettingsType0", None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_settings(data: object) -> Union["EnableAppRequestSettingsType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union["EnableAppRequestSettingsType0", None, Unset], data)
