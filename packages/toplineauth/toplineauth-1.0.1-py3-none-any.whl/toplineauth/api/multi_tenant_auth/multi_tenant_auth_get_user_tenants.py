...
) -> Optional[Union[HTTPValidationError, UserTenantsResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, UserTenantsResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[HTTPValidationError, UserTenantsResponse]
    """
