...
) -> Optional[Union[Any, HTTPValidationError, List["TenantResponse"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, HTTPValidationError, List["TenantResponse"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        include_deleted (Union[Unset, bool]): 是否包含已删除的租户 Default: False.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, HTTPValidationError, List['TenantResponse']]
    """
