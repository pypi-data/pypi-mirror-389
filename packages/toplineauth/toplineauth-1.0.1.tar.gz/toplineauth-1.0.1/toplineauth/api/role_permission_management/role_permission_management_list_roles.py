...
def _get_kwargs(
    *,
    ...
    json_tenant_id: Union[None, Unset, str]
...
) -> Optional[Union[HTTPValidationError, List["RolePublic"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, List["RolePublic"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        app_id (Union[None, UUID, Unset]): 按应用ID筛选
        tenant_id (Union[None, UUID, Unset]): 按租户ID筛选
        include_deleted (Union[Unset, bool]): 是否包含已删除的角色 Default: False.
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, List['RolePublic']]
    """
