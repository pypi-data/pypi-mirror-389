...
T = TypeVar("T", bound="DataContractODCS")


@_attrs_define
class DataContractODCS:
    """
    Attributes:
    ...
    schema: list[Schema] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _schema is not UNSET:
            ...
            for schema_item_data in _schema:
                schema_item = Schema.from_dict(schema_item_data)

                schema.append(schema_item)

        data_contract_odcs = cls(
            id=id,
            version=version,
            name=name,
            status=status,
        ...
        data_contract_odcs.additional_properties = d
        return data_contract_odcs
