...
class DataConsumer:
    ...
    Attributes:
        role (DataConsumerRole | Unset):  Example: DataConsumer.
        server (ApiServer | CustomServer | S3Server | Unset): Data source details of where data is physically stored.
        settings (DataConsumerSettings | Unset):
    """

    role: DataConsumerRole | Unset = UNSET
    server: ApiServer | CustomServer | S3Server | Unset = UNSET
    settings: DataConsumerSettings | Unset = UNSET
