...
T = TypeVar("T", bound="AbstractSchema")
...
class AbstractSchema:
    ...
    Attributes:
        ...
        logical_type (AbstractSchemaLogicalType | Unset): The logical element data type.
        physical_name (str | Unset): Physical name. Example: ['table_1_2_0'].
        data_granularity_description (str | Unset): Granular level of the data in the object. Example: ['Aggregation by
            country'].
    """
    ...
    logical_type: AbstractSchemaLogicalType | Unset = UNSET
    physical_name: str | Unset = UNSET
    data_granularity_description: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        logical_type: AbstractSchemaLogicalType | Unset
        ...
        abstract_schema.additional_properties = d
