...
class PbOperateComputeResponse(BaseModel):
    """
    PbOperateComputeResponse
    """ # noqa: E501
    compute_data: VirtualCompute = Field(alias="computeData")
    compute_operation_output_data: Optional[Dict[str, StrictStr]] = Field(default=None, description="Set of output values depending on the type of operation. For instance, when a snapshot operation is requested, this field provides information about the identifier of the snapshot and its location.", alias="computeOperationOutputData")
    __properties: ClassVar[List[str]] = ["computeData", "computeOperationOutputData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "computeOperationOutputData": obj.get("computeOperationOutputData")
        })
        return _obj
