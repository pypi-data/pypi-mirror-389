...
class PbCreateComputeResourceAffinityOrAntiAffinityConstraintsGroupResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groupId": Identifier.from_dict(obj["groupId"]) if obj.get("groupId") is not None else None
        })
        return _obj
