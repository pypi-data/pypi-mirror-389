...
class NetworkSubnetData(BaseModel):
    """
    ...
    is_dhcp_enabled: Optional[StrictBool] = Field(default=None, description="True when DHCP is to be enabled for this network/subnetwork, or false otherwise.", alias="isDhcpEnabled")
    address_pool: Optional[IPAddressPool] = Field(default=None, alias="addressPool")
    metadata: Optional[Metadata] = None
    __properties: ClassVar[List[str]] = ["networkId", "ipVersion", "gatewayIp", "cidr", "isDhcpEnabled", "addressPool", "metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of address_pool
        if self.address_pool:
            _dict['addressPool'] = self.address_pool.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addressPool": IPAddressPool.from_dict(obj["addressPool"]) if obj.get("addressPool") is not None else None,
