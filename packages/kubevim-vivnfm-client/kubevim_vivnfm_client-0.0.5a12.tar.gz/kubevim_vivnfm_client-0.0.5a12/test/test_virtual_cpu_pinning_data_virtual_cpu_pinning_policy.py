...
class TestVirtualCpuPinningDataVirtualCpuPinningPolicy(unittest.TestCase):
    ...
    def testVirtualCpuPinningDataVirtualCpuPinningPolicy(self):
        """Test VirtualCpuPinningDataVirtualCpuPinningPolicy"""
        # inst = VirtualCpuPinningDataVirtualCpuPinningPolicy()
