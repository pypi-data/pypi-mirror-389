...
class TestVirtualComputeFlavour(unittest.TestCase):
    """VirtualComputeFlavour unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VirtualComputeFlavour:
        """Test VirtualComputeFlavour
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualComputeFlavour`
        """
        model = VirtualComputeFlavour()
        if include_optional:
    ...
    def testVirtualComputeFlavour(self):
        """Test VirtualComputeFlavour"""
