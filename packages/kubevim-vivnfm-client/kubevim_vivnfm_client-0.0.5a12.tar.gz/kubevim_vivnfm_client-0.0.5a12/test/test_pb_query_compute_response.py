...
class TestPbQueryComputeResponse(unittest.TestCase):
    """PbQueryComputeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PbQueryComputeResponse:
        """Test PbQueryComputeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PbQueryComputeResponse`
        """
        model = PbQueryComputeResponse()
        if include_optional:
    ...
    def testPbQueryComputeResponse(self):
        """Test PbQueryComputeResponse"""
