...
class TestPbOperateComputeResponse(unittest.TestCase):
    """PbOperateComputeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PbOperateComputeResponse:
        """Test PbOperateComputeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PbOperateComputeResponse`
        """
        model = PbOperateComputeResponse()
        if include_optional:
            return PbOperateComputeResponse(
    ...
    def testPbOperateComputeResponse(self):
        """Test PbOperateComputeResponse"""
