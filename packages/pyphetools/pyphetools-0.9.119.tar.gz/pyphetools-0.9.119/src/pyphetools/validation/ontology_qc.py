    ...
    def _fix_redundancies(self,
        ...
        for term in all_terms:
            for term2 in all_terms:
                if term.observed and term2.observed:
                ...
                elif not term.observed and not term2.observed:
                    # The excluded ancestor, e.g. Seizure comes first, the other term, e.g. Clonic seizure, second
                    # in the following function call.
                    # Exclusion of Clonic seizure is redundant when Seizure is excluded.
                    if self._ontology.graph.is_ancestor_of(term2.id, term.id):
                        redundant_term_d[term] = term2
                else:
                    # One is present and the other is excluded.
                    # No redundancy is possible and we do not check for logical inconsistencies here.
                    pass
