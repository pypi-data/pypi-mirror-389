...
class OnsetCalculator:
    ...
    def _get_hpo_onset_term_from_iso8601(self, isostring: str):
        ...
        if match:
            ...
            if hpo_id is None:
                raise ValueError(f"Cannot calculate Onset with None hpo id for label '{label}'")
    ...
    def get_pmid_to_onset_d(self)-> typing.Dict[str, typing.List[HpTerm]]:
