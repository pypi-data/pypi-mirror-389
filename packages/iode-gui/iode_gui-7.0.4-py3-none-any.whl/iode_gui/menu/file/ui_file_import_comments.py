...
class Ui_MenuFileImportComments(object):
    def setupUi(self, MenuFileImportComments):
        ...
        self.openButton.clicked.connect(MenuFileImportComments.import_comments)

        QMetaObject.connectSlotsByName(MenuFileImportComments)
    # setupUi

    def retranslateUi(self, MenuFileImportComments):
        MenuFileImportComments.setWindowTitle(QCoreApplication.translate("MenuFileImportComments", u"IMPORT  FILE  BY  RULE (COMMENTS)", None))
        ...
        self.label_format.setText(QCoreApplication.translate("MenuFileImportComments", u"Format", None))
