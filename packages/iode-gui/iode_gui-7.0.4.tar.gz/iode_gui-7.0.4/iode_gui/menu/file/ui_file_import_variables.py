...
class Ui_MenuFileImportVariables(object):
    def setupUi(self, MenuFileImportVariables):
        ...
        self.gridLayout.addWidget(self.label_rule_file, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.fileChooser_input_file, 1, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.fileChooser_rule_file, 2, 1, 1, 2)
        ...
        self.label_format = QLabel(self.layoutWidget)
        self.label_format.setObjectName(u"label_format")

        self.gridLayout.addWidget(self.label_format, 0, 0, 1, 1)

        self.comboBox_format = QComboBox(self.layoutWidget)
        self.comboBox_format.setObjectName(u"comboBox_format")
        self.comboBox_format.setMinimumSize(QSize(180, 0))

        self.gridLayout.addWidget(self.comboBox_format, 0, 1, 1, 1)
        ...
        self.openButton.clicked.connect(MenuFileImportVariables.import_variables)

        QMetaObject.connectSlotsByName(MenuFileImportVariables)
    # setupUi

    def retranslateUi(self, MenuFileImportVariables):
        MenuFileImportVariables.setWindowTitle(QCoreApplication.translate("MenuFileImportVariables", u"IMPORT  FILE  BY  RULE (VARIABLES)", None))
        ...
        self.label_format.setText(QCoreApplication.translate("MenuFileImportVariables", u"Format", None))
