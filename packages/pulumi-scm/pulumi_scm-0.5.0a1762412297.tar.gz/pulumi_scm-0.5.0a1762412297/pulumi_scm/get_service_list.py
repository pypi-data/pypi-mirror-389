...
class GetServiceListResult:
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetServiceListDataResult']:
        """
        The Data param.
        """
...
def get_service_list(device: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getServiceList:getServiceList', __args__, opts=opts, typ=GetServiceListResult).value
...
def get_service_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getServiceList:getServiceList', __args__, opts=opts, typ=GetServiceListResult)
