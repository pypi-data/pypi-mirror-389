...
__all__ = [
    'GetVariableListResult',
    'AwaitableGetVariableListResult',
    'get_variable_list',
    'get_variable_list_output',
]

@pulumi.output_type
class GetVariableListResult:
    """
...
class AwaitableGetVariableListResult(GetVariableListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVariableListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_variable_list(device: Optional[_builtins.str] = None,
                      folder: Optional[_builtins.str] = None,
                      limit: Optional[_builtins.int] = None,
                      name: Optional[_builtins.str] = None,
                      offset: Optional[_builtins.int] = None,
                      snippet: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVariableListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getVariableList:getVariableList', __args__, opts=opts, typ=GetVariableListResult).value

    return AwaitableGetVariableListResult(
...
def get_variable_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                             name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             offset: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                             snippet: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVariableListResult]:
    """
    Retrieves a listing of config items.
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getVariableList:getVariableList', __args__, opts=opts, typ=GetVariableListResult)
    return __ret__.apply(lambda __response__: GetVariableListResult(
