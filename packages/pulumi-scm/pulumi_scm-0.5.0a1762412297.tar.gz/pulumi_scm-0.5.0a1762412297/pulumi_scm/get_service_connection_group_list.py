...
def get_service_connection_group_list(folder: Optional[_builtins.str] = None,
...
def get_service_connection_group_list_output(folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
