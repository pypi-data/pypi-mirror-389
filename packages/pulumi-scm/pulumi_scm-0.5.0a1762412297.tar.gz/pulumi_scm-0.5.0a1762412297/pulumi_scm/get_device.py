...
def get_device(serial: Optional[_builtins.str] = None,
    ...
    :param _builtins.str serial: The Serial param.
    """
    __args__ = dict()
...
def get_device_output(serial: Optional[pulumi.Input[_builtins.str]] = None,
