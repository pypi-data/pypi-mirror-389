...
__all__ = [
    'GetScepProfileListResult',
    'AwaitableGetScepProfileListResult',
    'get_scep_profile_list',
    'get_scep_profile_list_output',
]

@pulumi.output_type
class GetScepProfileListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetScepProfileListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetScepProfileListResult(GetScepProfileListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetScepProfileListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_scep_profile_list(device: Optional[_builtins.str] = None,
                          folder: Optional[_builtins.str] = None,
                          limit: Optional[_builtins.int] = None,
                          name: Optional[_builtins.str] = None,
                          offset: Optional[_builtins.int] = None,
                          snippet: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetScepProfileListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getScepProfileList:getScepProfileList', __args__, opts=opts, typ=GetScepProfileListResult).value

    return AwaitableGetScepProfileListResult(
...
def get_scep_profile_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getScepProfileList:getScepProfileList', __args__, opts=opts, typ=GetScepProfileListResult)
    return __ret__.apply(lambda __response__: GetScepProfileListResult(
