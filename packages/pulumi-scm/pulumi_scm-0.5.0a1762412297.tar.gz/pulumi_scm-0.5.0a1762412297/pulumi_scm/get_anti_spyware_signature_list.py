...
__all__ = [
    'GetAntiSpywareSignatureListResult',
    'AwaitableGetAntiSpywareSignatureListResult',
    'get_anti_spyware_signature_list',
    'get_anti_spyware_signature_list_output',
]

@pulumi.output_type
class GetAntiSpywareSignatureListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetAntiSpywareSignatureListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetAntiSpywareSignatureListResult(GetAntiSpywareSignatureListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAntiSpywareSignatureListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_anti_spyware_signature_list(device: Optional[_builtins.str] = None,
                                    folder: Optional[_builtins.str] = None,
                                    limit: Optional[_builtins.int] = None,
                                    name: Optional[_builtins.str] = None,
                                    offset: Optional[_builtins.int] = None,
                                    snippet: Optional[_builtins.str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAntiSpywareSignatureListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getAntiSpywareSignatureList:getAntiSpywareSignatureList', __args__, opts=opts, typ=GetAntiSpywareSignatureListResult).value

    return AwaitableGetAntiSpywareSignatureListResult(
...
def get_anti_spyware_signature_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
