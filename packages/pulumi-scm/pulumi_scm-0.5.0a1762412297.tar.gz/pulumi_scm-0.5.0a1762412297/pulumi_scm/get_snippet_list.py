...
class GetSnippetListResult:
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetSnippetListDataResult']:
        """
        The Data param.
        """
...
def get_snippet_list(limit: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getSnippetList:getSnippetList', __args__, opts=opts, typ=GetSnippetListResult).value
...
def get_snippet_list_output(limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
