...
__all__ = [
    'GetLabelListResult',
    'AwaitableGetLabelListResult',
    'get_label_list',
    'get_label_list_output',
]

@pulumi.output_type
class GetLabelListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetLabelListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetLabelListResult(GetLabelListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLabelListResult(
            datas=self.datas,
            id=self.id,
            limit=self.limit,
            name=self.name,
...
def get_label_list(limit: Optional[_builtins.int] = None,
                   name: Optional[_builtins.str] = None,
                   offset: Optional[_builtins.int] = None,
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLabelListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getLabelList:getLabelList', __args__, opts=opts, typ=GetLabelListResult).value

    return AwaitableGetLabelListResult(
...
def get_label_list_output(limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
