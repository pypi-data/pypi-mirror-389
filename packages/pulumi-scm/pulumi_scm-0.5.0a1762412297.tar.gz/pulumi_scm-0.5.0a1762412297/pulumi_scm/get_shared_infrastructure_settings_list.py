...
def get_shared_infrastructure_settings_list(limit: Optional[_builtins.int] = None,
...
def get_shared_infrastructure_settings_list_output(limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
