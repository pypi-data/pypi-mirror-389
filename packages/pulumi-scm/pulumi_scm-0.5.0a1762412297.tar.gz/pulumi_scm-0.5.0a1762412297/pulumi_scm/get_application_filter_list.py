...
__all__ = [
    ...
    'AwaitableGetApplicationFilterListResult',
    'get_application_filter_list',
    'get_application_filter_list_output',
]

@pulumi.output_type
class GetApplicationFilterListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetApplicationFilterListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetApplicationFilterListResult(GetApplicationFilterListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApplicationFilterListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_application_filter_list(device: Optional[_builtins.str] = None,
                                folder: Optional[_builtins.str] = None,
                                limit: Optional[_builtins.int] = None,
                                name: Optional[_builtins.str] = None,
                                offset: Optional[_builtins.int] = None,
                                snippet: Optional[_builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApplicationFilterListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getApplicationFilterList:getApplicationFilterList', __args__, opts=opts, typ=GetApplicationFilterListResult).value

    return AwaitableGetApplicationFilterListResult(
...
def get_application_filter_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getApplicationFilterList:getApplicationFilterList', __args__, opts=opts, typ=GetApplicationFilterListResult)
    return __ret__.apply(lambda __response__: GetApplicationFilterListResult(
