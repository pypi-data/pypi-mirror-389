...
__all__ = [
    'GetRadiusServerProfileListResult',
    'AwaitableGetRadiusServerProfileListResult',
    'get_radius_server_profile_list',
    'get_radius_server_profile_list_output',
]

@pulumi.output_type
class GetRadiusServerProfileListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetRadiusServerProfileListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetRadiusServerProfileListResult(GetRadiusServerProfileListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRadiusServerProfileListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_radius_server_profile_list(device: Optional[_builtins.str] = None,
                                   folder: Optional[_builtins.str] = None,
                                   limit: Optional[_builtins.int] = None,
                                   name: Optional[_builtins.str] = None,
                                   offset: Optional[_builtins.int] = None,
                                   snippet: Optional[_builtins.str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRadiusServerProfileListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getRadiusServerProfileList:getRadiusServerProfileList', __args__, opts=opts, typ=GetRadiusServerProfileListResult).value

    return AwaitableGetRadiusServerProfileListResult(
...
def get_radius_server_profile_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getRadiusServerProfileList:getRadiusServerProfileList', __args__, opts=opts, typ=GetRadiusServerProfileListResult)
    return __ret__.apply(lambda __response__: GetRadiusServerProfileListResult(
