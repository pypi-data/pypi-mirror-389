...
__all__ = [
    ...
    'AwaitableGetApplicationListResult',
    'get_application_list',
    'get_application_list_output',
]

@pulumi.output_type
class GetApplicationListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetApplicationListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetApplicationListResult(GetApplicationListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetApplicationListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_application_list(device: Optional[_builtins.str] = None,
                         folder: Optional[_builtins.str] = None,
                         limit: Optional[_builtins.int] = None,
                         name: Optional[_builtins.str] = None,
                         offset: Optional[_builtins.int] = None,
                         snippet: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApplicationListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getApplicationList:getApplicationList', __args__, opts=opts, typ=GetApplicationListResult).value

    return AwaitableGetApplicationListResult(
...
def get_application_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                offset: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                snippet: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApplicationListResult]:
    """
    Retrieves a listing of config items.
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getApplicationList:getApplicationList', __args__, opts=opts, typ=GetApplicationListResult)
    return __ret__.apply(lambda __response__: GetApplicationListResult(
