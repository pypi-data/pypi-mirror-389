...
__all__ = [
    'GetDecryptionRuleListResult',
    'AwaitableGetDecryptionRuleListResult',
    'get_decryption_rule_list',
    'get_decryption_rule_list_output',
]

@pulumi.output_type
class GetDecryptionRuleListResult:
    """
...
class AwaitableGetDecryptionRuleListResult(GetDecryptionRuleListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDecryptionRuleListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_decryption_rule_list(device: Optional[_builtins.str] = None,
    ...
    return AwaitableGetDecryptionRuleListResult(
...
def get_decryption_rule_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDecryptionRuleListResult(
