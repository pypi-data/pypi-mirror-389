...
__all__ = [
    'GetTrafficSteeringRuleListResult',
    'AwaitableGetTrafficSteeringRuleListResult',
    'get_traffic_steering_rule_list',
    'get_traffic_steering_rule_list_output',
]

@pulumi.output_type
class GetTrafficSteeringRuleListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetTrafficSteeringRuleListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetTrafficSteeringRuleListResult(GetTrafficSteeringRuleListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetTrafficSteeringRuleListResult(
            datas=self.datas,
            folder=self.folder,
            id=self.id,
            limit=self.limit,
...
def get_traffic_steering_rule_list(folder: Optional[_builtins.str] = None,
                                   limit: Optional[_builtins.int] = None,
                                   name: Optional[_builtins.str] = None,
                                   offset: Optional[_builtins.int] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTrafficSteeringRuleListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getTrafficSteeringRuleList:getTrafficSteeringRuleList', __args__, opts=opts, typ=GetTrafficSteeringRuleListResult).value

    return AwaitableGetTrafficSteeringRuleListResult(
...
def get_traffic_steering_rule_list_output(folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
