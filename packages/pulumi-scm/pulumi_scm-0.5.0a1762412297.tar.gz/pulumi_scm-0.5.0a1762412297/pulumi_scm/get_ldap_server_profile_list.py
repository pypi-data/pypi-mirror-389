...
__all__ = [
    'GetLdapServerProfileListResult',
    'AwaitableGetLdapServerProfileListResult',
    'get_ldap_server_profile_list',
    'get_ldap_server_profile_list_output',
]

@pulumi.output_type
class GetLdapServerProfileListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetLdapServerProfileListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetLdapServerProfileListResult(GetLdapServerProfileListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLdapServerProfileListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_ldap_server_profile_list(device: Optional[_builtins.str] = None,
                                 folder: Optional[_builtins.str] = None,
                                 limit: Optional[_builtins.int] = None,
                                 name: Optional[_builtins.str] = None,
                                 offset: Optional[_builtins.int] = None,
                                 snippet: Optional[_builtins.str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLdapServerProfileListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getLdapServerProfileList:getLdapServerProfileList', __args__, opts=opts, typ=GetLdapServerProfileListResult).value

    return AwaitableGetLdapServerProfileListResult(
...
def get_ldap_server_profile_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
