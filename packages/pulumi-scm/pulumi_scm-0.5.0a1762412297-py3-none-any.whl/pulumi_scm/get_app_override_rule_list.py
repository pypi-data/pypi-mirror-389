...
__all__ = [
    'GetAppOverrideRuleListResult',
    'AwaitableGetAppOverrideRuleListResult',
    'get_app_override_rule_list',
    'get_app_override_rule_list_output',
]

@pulumi.output_type
class GetAppOverrideRuleListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetAppOverrideRuleListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetAppOverrideRuleListResult(GetAppOverrideRuleListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAppOverrideRuleListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_app_override_rule_list(device: Optional[_builtins.str] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAppOverrideRuleListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getAppOverrideRuleList:getAppOverrideRuleList', __args__, opts=opts, typ=GetAppOverrideRuleListResult).value

    return AwaitableGetAppOverrideRuleListResult(
...
def get_app_override_rule_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAppOverrideRuleListResult]:
    """
    Retrieves a listing of config items.
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getAppOverrideRuleList:getAppOverrideRuleList', __args__, opts=opts, typ=GetAppOverrideRuleListResult)
    return __ret__.apply(lambda __response__: GetAppOverrideRuleListResult(
