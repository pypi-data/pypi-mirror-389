...
def get_kerberos_server_profile_list(device: Optional[_builtins.str] = None,
...
def get_kerberos_server_profile_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                            folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                            limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                            name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                            offset: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                            snippet: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetKerberosServerProfileListResult]:
    """
    Retrieves a listing of config items.
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getKerberosServerProfileList:getKerberosServerProfileList', __args__, opts=opts, typ=GetKerberosServerProfileListResult)
    return __ret__.apply(lambda __response__: GetKerberosServerProfileListResult(
