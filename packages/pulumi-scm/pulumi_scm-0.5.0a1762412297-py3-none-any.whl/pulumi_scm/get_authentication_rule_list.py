...
__all__ = [
    'GetAuthenticationRuleListResult',
    'AwaitableGetAuthenticationRuleListResult',
    'get_authentication_rule_list',
    'get_authentication_rule_list_output',
]

@pulumi.output_type
class GetAuthenticationRuleListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetAuthenticationRuleListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetAuthenticationRuleListResult(GetAuthenticationRuleListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAuthenticationRuleListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_authentication_rule_list(device: Optional[_builtins.str] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAuthenticationRuleListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getAuthenticationRuleList:getAuthenticationRuleList', __args__, opts=opts, typ=GetAuthenticationRuleListResult).value

    return AwaitableGetAuthenticationRuleListResult(
...
def get_authentication_rule_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getAuthenticationRuleList:getAuthenticationRuleList', __args__, opts=opts, typ=GetAuthenticationRuleListResult)
    return __ret__.apply(lambda __response__: GetAuthenticationRuleListResult(
