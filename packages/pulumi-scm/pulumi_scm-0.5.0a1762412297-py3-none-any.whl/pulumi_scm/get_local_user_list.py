...
__all__ = [
    'GetLocalUserListResult',
    'AwaitableGetLocalUserListResult',
    'get_local_user_list',
    'get_local_user_list_output',
]

@pulumi.output_type
class GetLocalUserListResult:
    """
...
class AwaitableGetLocalUserListResult(GetLocalUserListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLocalUserListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_local_user_list(device: Optional[_builtins.str] = None,
                        folder: Optional[_builtins.str] = None,
                        limit: Optional[_builtins.int] = None,
                        name: Optional[_builtins.str] = None,
                        offset: Optional[_builtins.int] = None,
                        snippet: Optional[_builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLocalUserListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getLocalUserList:getLocalUserList', __args__, opts=opts, typ=GetLocalUserListResult).value

    return AwaitableGetLocalUserListResult(
...
def get_local_user_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                               name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               offset: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                               snippet: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLocalUserListResult]:
    """
    Retrieves a listing of config items.
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getLocalUserList:getLocalUserList', __args__, opts=opts, typ=GetLocalUserListResult)
    return __ret__.apply(lambda __response__: GetLocalUserListResult(
