...
__all__ = [
    'GetQosProfileListResult',
    'AwaitableGetQosProfileListResult',
    'get_qos_profile_list',
    'get_qos_profile_list_output',
]

@pulumi.output_type
class GetQosProfileListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetQosProfileListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetQosProfileListResult(GetQosProfileListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetQosProfileListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_qos_profile_list(device: Optional[_builtins.str] = None,
                         folder: Optional[_builtins.str] = None,
                         limit: Optional[_builtins.int] = None,
                         name: Optional[_builtins.str] = None,
                         offset: Optional[_builtins.int] = None,
                         snippet: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetQosProfileListResult:
    """
    ...
    example = scm.get_qos_profile_list(folder="Shared")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getQosProfileList:getQosProfileList', __args__, opts=opts, typ=GetQosProfileListResult).value

    return AwaitableGetQosProfileListResult(
...
def get_qos_profile_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getQosProfileList:getQosProfileList', __args__, opts=opts, typ=GetQosProfileListResult)
    return __ret__.apply(lambda __response__: GetQosProfileListResult(
