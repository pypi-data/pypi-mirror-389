...
__all__ = [
    'GetSecurityRuleListResult',
    'AwaitableGetSecurityRuleListResult',
    'get_security_rule_list',
    'get_security_rule_list_output',
]

@pulumi.output_type
class GetSecurityRuleListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetSecurityRuleListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetSecurityRuleListResult(GetSecurityRuleListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSecurityRuleListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_security_rule_list(device: Optional[_builtins.str] = None,
    ...
    return AwaitableGetSecurityRuleListResult(
...
def get_security_rule_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
