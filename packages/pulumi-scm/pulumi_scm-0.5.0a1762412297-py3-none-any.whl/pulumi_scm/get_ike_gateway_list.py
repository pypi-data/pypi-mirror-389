...
__all__ = [
    'GetIkeGatewayListResult',
    'AwaitableGetIkeGatewayListResult',
    'get_ike_gateway_list',
    'get_ike_gateway_list_output',
]

@pulumi.output_type
class GetIkeGatewayListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetIkeGatewayListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetIkeGatewayListResult(GetIkeGatewayListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIkeGatewayListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_ike_gateway_list(device: Optional[_builtins.str] = None,
                         folder: Optional[_builtins.str] = None,
                         limit: Optional[_builtins.int] = None,
                         name: Optional[_builtins.str] = None,
                         offset: Optional[_builtins.int] = None,
                         snippet: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIkeGatewayListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getIkeGatewayList:getIkeGatewayList', __args__, opts=opts, typ=GetIkeGatewayListResult).value

    return AwaitableGetIkeGatewayListResult(
...
def get_ike_gateway_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                offset: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                snippet: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIkeGatewayListResult]:
    """
    Retrieves a listing of config items.
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getIkeGatewayList:getIkeGatewayList', __args__, opts=opts, typ=GetIkeGatewayListResult)
    return __ret__.apply(lambda __response__: GetIkeGatewayListResult(
