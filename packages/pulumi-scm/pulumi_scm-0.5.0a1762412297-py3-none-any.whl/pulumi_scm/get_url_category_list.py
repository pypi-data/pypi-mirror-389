...
__all__ = [
    'GetUrlCategoryListResult',
    'AwaitableGetUrlCategoryListResult',
    'get_url_category_list',
    'get_url_category_list_output',
]

@pulumi.output_type
class GetUrlCategoryListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetUrlCategoryListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetUrlCategoryListResult(GetUrlCategoryListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetUrlCategoryListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_url_category_list(device: Optional[_builtins.str] = None,
                          folder: Optional[_builtins.str] = None,
                          limit: Optional[_builtins.int] = None,
                          name: Optional[_builtins.str] = None,
                          offset: Optional[_builtins.int] = None,
                          snippet: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetUrlCategoryListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getUrlCategoryList:getUrlCategoryList', __args__, opts=opts, typ=GetUrlCategoryListResult).value

    return AwaitableGetUrlCategoryListResult(
...
def get_url_category_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                 name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 offset: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                 snippet: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetUrlCategoryListResult]:
    """
    Retrieves a listing of config items.
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getUrlCategoryList:getUrlCategoryList', __args__, opts=opts, typ=GetUrlCategoryListResult)
    return __ret__.apply(lambda __response__: GetUrlCategoryListResult(
