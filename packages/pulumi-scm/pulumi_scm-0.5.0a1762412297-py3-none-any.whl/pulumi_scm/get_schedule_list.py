...
__all__ = [
    ...
    'AwaitableGetScheduleListResult',
    'get_schedule_list',
    'get_schedule_list_output',
]

@pulumi.output_type
class GetScheduleListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetScheduleListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetScheduleListResult(GetScheduleListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetScheduleListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_schedule_list(device: Optional[_builtins.str] = None,
                      folder: Optional[_builtins.str] = None,
                      limit: Optional[_builtins.int] = None,
                      name: Optional[_builtins.str] = None,
                      offset: Optional[_builtins.int] = None,
                      snippet: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetScheduleListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getScheduleList:getScheduleList', __args__, opts=opts, typ=GetScheduleListResult).value

    return AwaitableGetScheduleListResult(
...
def get_schedule_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                             name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             offset: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                             snippet: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetScheduleListResult]:
    """
    Retrieves a listing of config items.
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getScheduleList:getScheduleList', __args__, opts=opts, typ=GetScheduleListResult)
    return __ret__.apply(lambda __response__: GetScheduleListResult(
