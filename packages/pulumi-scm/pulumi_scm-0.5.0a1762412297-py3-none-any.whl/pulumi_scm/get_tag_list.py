...
class GetTagListResult:
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetTagListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetTagListResult(GetTagListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetTagListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_tag_list(device: Optional[_builtins.str] = None,
                 folder: Optional[_builtins.str] = None,
                 limit: Optional[_builtins.int] = None,
                 name: Optional[_builtins.str] = None,
                 offset: Optional[_builtins.int] = None,
                 snippet: Optional[_builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTagListResult:
    """
    ...
    example = scm.get_tag_list(folder="Shared")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getTagList:getTagList', __args__, opts=opts, typ=GetTagListResult).value

    return AwaitableGetTagListResult(
...
def get_tag_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                        folder: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                        limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                        name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                        offset: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                        snippet: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTagListResult]:
    """
    Retrieves a listing of config items.
    ...
    __ret__ = pulumi.runtime.invoke_output('scm:index/getTagList:getTagList', __args__, opts=opts, typ=GetTagListResult)
    return __ret__.apply(lambda __response__: GetTagListResult(
