...
__all__ = [
    'GetQosPolicyRuleListResult',
    'AwaitableGetQosPolicyRuleListResult',
    'get_qos_policy_rule_list',
    'get_qos_policy_rule_list_output',
]

@pulumi.output_type
class GetQosPolicyRuleListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetQosPolicyRuleListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetQosPolicyRuleListResult(GetQosPolicyRuleListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetQosPolicyRuleListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_qos_policy_rule_list(device: Optional[_builtins.str] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetQosPolicyRuleListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getQosPolicyRuleList:getQosPolicyRuleList', __args__, opts=opts, typ=GetQosPolicyRuleListResult).value

    return AwaitableGetQosPolicyRuleListResult(
...
def get_qos_policy_rule_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
