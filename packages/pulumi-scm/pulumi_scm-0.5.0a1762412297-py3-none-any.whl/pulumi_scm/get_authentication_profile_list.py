...
__all__ = [
    'GetAuthenticationProfileListResult',
    'AwaitableGetAuthenticationProfileListResult',
    'get_authentication_profile_list',
    'get_authentication_profile_list_output',
]

@pulumi.output_type
class GetAuthenticationProfileListResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def datas(self) -> Sequence['outputs.GetAuthenticationProfileListDataResult']:
        """
        The Data param.
        """
...
class AwaitableGetAuthenticationProfileListResult(GetAuthenticationProfileListResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAuthenticationProfileListResult(
            datas=self.datas,
            device=self.device,
            folder=self.folder,
            id=self.id,
...
def get_authentication_profile_list(device: Optional[_builtins.str] = None,
                                    folder: Optional[_builtins.str] = None,
                                    limit: Optional[_builtins.int] = None,
                                    name: Optional[_builtins.str] = None,
                                    offset: Optional[_builtins.int] = None,
                                    snippet: Optional[_builtins.str] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAuthenticationProfileListResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('scm:index/getAuthenticationProfileList:getAuthenticationProfileList', __args__, opts=opts, typ=GetAuthenticationProfileListResult).value

    return AwaitableGetAuthenticationProfileListResult(
...
def get_authentication_profile_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
