...
__all__ = [
    'GetDecryptionExclusionResult',
    'AwaitableGetDecryptionExclusionResult',
    'get_decryption_exclusion',
    'get_decryption_exclusion_output',
]

@pulumi.output_type
class GetDecryptionExclusionResult:
    """
...
class AwaitableGetDecryptionExclusionResult(GetDecryptionExclusionResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDecryptionExclusionResult(
...
def get_decryption_exclusion(id: Optional[_builtins.str] = None,
    ...
    example = scm.get_decryption_exclusion(id="1234-56-789")
    ```
    ...
    return AwaitableGetDecryptionExclusionResult(
        description=pulumi.get(__ret__, 'description'),
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'),
        tfid=pulumi.get(__ret__, 'tfid'))
def get_decryption_exclusion_output(id: Optional[pulumi.Input[_builtins.str]] = None,
