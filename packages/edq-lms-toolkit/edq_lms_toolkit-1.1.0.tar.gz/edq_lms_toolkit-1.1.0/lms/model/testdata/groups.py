...
COURSE_GROUP_MEMBERSHIPS: typing.Dict[str, typing.Dict[str, typing.Dict[str, lms.model.groups.GroupMembership]]] = {}

COURSE_GROUP_MEMBERSHIPS['Extra Course'] = {
    'Group Set 1': {
        'extra-course-student-1': lms.model.groups.GroupMembership(
        ...
        'extra-course-student-2': lms.model.groups.GroupMembership(
            groupset = lms.model.testdata.groupsets.COURSE_GROUPSETS['Extra Course']['Group Set 1'].to_query(),
            group = COURSE_GROUPS['Extra Course']['Group 1-1'].to_query(),
            user = lms.model.testdata.users.COURSE_USERS['Extra Course']['extra-course-student-2'].to_query(),
        ),
        'extra-course-student-3': lms.model.groups.GroupMembership(
            groupset = lms.model.testdata.groupsets.COURSE_GROUPSETS['Extra Course']['Group Set 1'].to_query(),
        ...
        'extra-course-student-4': lms.model.groups.GroupMembership(
            groupset = lms.model.testdata.groupsets.COURSE_GROUPSETS['Extra Course']['Group Set 1'].to_query(),
            group = COURSE_GROUPS['Extra Course']['Group 1-2'].to_query(),
