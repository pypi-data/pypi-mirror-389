...
class WoosStorage:
    ...
    def get(self, collection: str, item_id: str) -> Optional[StorageData]:
        ...
        """
        response = self.client.get(f"/api/storage/{collection}/{item_id}")
        if response and "data" in response:
            return StorageData(**response["data"])
        return None
    ...
    def update(self, collection: str, item_id: str, data: Dict[str, Any]) -> bool:
        ...
        response = self.client.put(
            f"/api/storage/{collection}/{item_id}",
            json={"data": data}
        )
    ...
    def delete(self, collection: str, item_id: str) -> bool:
        ...
        Returns:
            True if successful
        """
        response = self.client.delete(f"/api/storage/{collection}/{item_id}")
        return response.get("success", False)    
