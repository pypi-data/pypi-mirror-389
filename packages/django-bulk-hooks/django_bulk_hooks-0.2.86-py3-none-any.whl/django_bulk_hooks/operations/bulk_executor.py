            ...
            for field_group in plan.field_groups:
                ...
                for field_name in field_group.fields:
                    ...
                    for pk, obj in zip(root_pks, plan.objects):
                        ...
                        logger.debug(f"MTI_UPDATE_VALUE_CONVERTED: obj_pk={obj_pk}, field_name={field_name}, converted_value={value}, converted_type={type(value)}")
                ...
                if case_statements:
                    ...
                    try:
                        ...
                        logger.debug(f"MTI_UPDATE_QUERY: Query SQL: {query_qs.query}")
