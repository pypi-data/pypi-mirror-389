...
class PagedResultsIAMBindingControllerApiBindingDetail(BaseModel):
    """
    PagedResultsIAMBindingControllerApiBindingDetail
    """ # noqa: E501
    results: List[IAMBindingControllerApiBindingDetail]
    total: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [IAMBindingControllerApiBindingDetail.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "total": obj.get("total")
        })
