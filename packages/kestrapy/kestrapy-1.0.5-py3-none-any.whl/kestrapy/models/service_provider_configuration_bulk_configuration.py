...
class ServiceProviderConfigurationBulkConfiguration(BaseModel):
    """
    ServiceProviderConfigurationBulkConfiguration
    """ # noqa: E501
    supported: Optional[StrictBool] = None
    max_operations: Optional[StrictInt] = Field(default=None, alias="maxOperations")
    max_payload_size: Optional[StrictInt] = Field(default=None, alias="maxPayloadSize")
