...
class TestSuiteServiceRunByQueryRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeChildNamespaces": obj.get("includeChildNamespaces") if obj.get("includeChildNamespaces") is not None else True
        })
