...
# ================================================================
"""Flow – ניהול שיחות ומיפוי שלוחות עם תמיכה ב-async כמו yemot-router2."""
...
class Flow:
    ...
    def handle_request(self, params: dict) -> str:
        ...
        try:
            # בדיקה אם השיחה במצב המתנה לקלט
            if hasattr(call, '_handler_state') and call._handler_state == "waiting_input":
                # יש כבר קלט חדש - נריץ שוב את ה-handler
