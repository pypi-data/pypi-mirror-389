...
class DTIdentity:
    ...
    def get_dt_introduction(self) -> str:
        ...
        return (
            f"I am the Digital Twin assistant for {name}. "
            f"I have full access to {name}'s execution node and can use all available tools. "
            f"I act with {name}'s authority to provide intelligent assistance."
        )
