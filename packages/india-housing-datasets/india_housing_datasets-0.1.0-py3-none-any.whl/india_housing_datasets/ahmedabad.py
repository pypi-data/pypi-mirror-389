...
def fetch_ahmedabad_housing(as_frame=True):
    """
    Fetch the Ahmedabad housing dataset.
    ...
    data_path = Path(__file__).resolve().parent / "data" / "ahmedabad_housing.csv"
