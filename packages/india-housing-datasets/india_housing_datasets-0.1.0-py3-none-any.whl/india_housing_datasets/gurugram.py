...
def fetch_gurugram_housing(as_frame=True):
    """
    Fetch the Gurugram housing dataset.
    ...
    data_path = Path(__file__).resolve().parent / "data" / "gurugram_housing.csv"
