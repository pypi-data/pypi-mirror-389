...
def create_tool_from_spec(spec: Dict[str, Any]) -> StructuredTool:
    ...
    # Import client class from market_data_sdk.tradingeconomics.clients
    client_class = _import_class(
        "market_data_sdk.tradingeconomics.clients",
        client_class_name
    )

    # Import request model from market_data_sdk.tradingeconomics.models.requests
    request_model = _import_class(
        "market_data_sdk.tradingeconomics.models.requests",
        request_model_name
    )
