...
def create_tool_from_spec(spec: Dict[str, Any]) -> StructuredTool:
    ...
    # Import client class from epoch_polygon.clients
    # All agent clients are exported there
    client_class = _import_class(
        "epoch_polygon.clients",
        client_class_name
    )

    # Import request model from epoch_polygon.models.requests
    request_model = _import_class(
        "epoch_polygon.models.requests",
        request_model_name
    )
