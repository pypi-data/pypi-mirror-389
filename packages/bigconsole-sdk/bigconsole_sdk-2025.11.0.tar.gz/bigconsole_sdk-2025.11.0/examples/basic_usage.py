...
async def main():
    ...
    config = BigconsoleSDKConfig(
        endpoint="https://api.example.com/graphql", api_key="your-api-key-here"  # Optional
    )
    ...
    try:
        ...
        sdk.set_tokens(access_token="your-access-token", refresh_token="your-refresh-token")
