...
class FlowsRules(BaseModel):
    ...
    FlowsRules
    """ # noqa: E501
    view: Optional[StrictBool] = Field(default=False, description="view permission for flows")
    edit: Optional[StrictBool] = Field(default=False, description="edit permission for flows")
