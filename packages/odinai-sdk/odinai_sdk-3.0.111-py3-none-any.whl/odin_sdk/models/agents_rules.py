...
class AgentsRules(BaseModel):
    ...
    AgentsRules
    """ # noqa: E501
    view: Optional[StrictBool] = Field(default=False, description="view permission for agents")
    edit: Optional[StrictBool] = Field(default=False, description="edit permission for agents")
