...
class RoutesToolsToolsModelsExecutionHistoryResponse(BaseModel):
    """
    RoutesToolsToolsModelsExecutionHistoryResponse
    """ # noqa: E501
    runs: List[WorkflowExecutionResponse] = Field(description="List of execution runs")
    total_count: StrictInt = Field(description="Total number of runs available")
    page: StrictInt = Field(description="Current page number")
    page_size: StrictInt = Field(description="Number of runs per page")
    __properties: ClassVar[List[str]] = ["runs", "total_count", "page", "page_size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "runs": [WorkflowExecutionResponse.from_dict(_item) for _item in obj["runs"]] if obj.get("runs") is not None else None,
