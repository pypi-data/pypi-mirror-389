...
class SettingsRules(BaseModel):
    ...
    SettingsRules
    """ # noqa: E501
    view: Optional[StrictBool] = Field(default=False, description="view permission for settings")
    edit: Optional[StrictBool] = Field(default=False, description="edit permission for settings")
