...
class RolesRules(BaseModel):
    ...
    RolesRules
    """ # noqa: E501
    view: Optional[StrictBool] = Field(default=False, description="view permission for roles")
    edit: Optional[StrictBool] = Field(default=False, description="edit permission for roles")
