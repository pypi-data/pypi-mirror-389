...
class AssistantRules(BaseModel):
    ...
    AssistantRules
    """ # noqa: E501
    edit: Optional[StrictBool] = Field(default=False, description="create permission for assistant")
    view: Optional[StrictBool] = Field(default=False, description="view permission for assistants")
