...
class AddMembersRules(BaseModel):
    ...
    AddMembersRules
    """ # noqa: E501
    view: Optional[StrictBool] = Field(default=False, description="view permission for add_members")
    edit: Optional[StrictBool] = Field(default=False, description="edit permission for add_members")
