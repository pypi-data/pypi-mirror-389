...
class AnalyticsRules(BaseModel):
    ...
    AnalyticsRules
    """ # noqa: E501
    view: Optional[StrictBool] = Field(default=False, description="view permission for analytics")
    edit: Optional[StrictBool] = Field(default=False, description="edit permission for analytics")
