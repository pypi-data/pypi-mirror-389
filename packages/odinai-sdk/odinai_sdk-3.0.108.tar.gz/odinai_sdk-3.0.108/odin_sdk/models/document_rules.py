...
class DocumentRules(BaseModel):
    ...
    DocumentRules
    """ # noqa: E501
    edit: Optional[StrictBool] = Field(default=False, description="create permission for document")
    view: Optional[StrictBool] = Field(default=False, description="view permission for documents")
