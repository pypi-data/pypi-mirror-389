...
from qtpy.QtWidgets import QHBoxLayout, QLabel, QWidget, QToolButton
...
class Typography:
    def __init__(self, id, align, children, text: Optional[Union[str, State, Callable]], color: str, value: object, classes, gutterBottom, wrap, width: Optional[int], paragraph, onClick: Callable, sx: Optional[Union[Callable, str, Dict]], variant: str, typography: str, *args, **kwargs): ...
    def _init_ui(self): ...
