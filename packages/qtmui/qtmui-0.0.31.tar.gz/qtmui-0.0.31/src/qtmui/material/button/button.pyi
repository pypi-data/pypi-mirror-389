...
from qtpy.QtCore import Qt, QPoint, Signal, QTimer, QEvent, QSize
...
class Button:
    ...
    def _get_stylesheet(cls, _variant: str, _size: str, _color: str, _theme_mode: str, _componentType: str): ...
    def _setIcon(self): ...
