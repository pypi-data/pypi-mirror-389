...
ocni:next-hop[ocni:index="NH_1"]/ocni:config/ocni:metric',
    ...
    def test_get_payload_with_mutiple_leaf_list(self):
        """Test get_payload with multiple leaf-list entries"""
        payload_min = self.rpcbld_minimal.get_payload([{
            'xpath': '/ocni:network-instances/ocni:network-instance/ocni:name',
            'value': 'red11',
        }, {
            'xpath': '/ocni:network-instances/ocni:network-instance[ocni:name="red11"]/\
ocni:config/ocni:enabled-address-families',
            'value': 'oc-types:IPV4'
        }, {
            'xpath': '/ocni:network-instances/ocni:network-instance[ocni:name="red11"]/\
ocni:config/ocni:enabled-address-families',
            ...
            'xpath': '/ocni:network-instances/ocni:network-instance[ocni:name="red11"]/\
ocni:inter-instance-policies/ocni:apply-policy/ocni:config/ocni:import-policy',
            'value': 'policy1',
        }, {
            'xpath': '/ocni:network-instances/ocni:network-instance[ocni:name="red11"]/\
ocni:inter-instance-policies/ocni:apply-policy/ocni:config/ocni:export-policy',
            'value': 'policy2',
        }, {
            'xpath': '/ocni:network-instances/ocni:network-instance[ocni:name="red11"]/\
ocni:inter-instance-policies/ocni:import-export-policy/\
ocni:config/ocni:export-route-target',
            'value': '1:1',
        }, {
            'xpath': '/ocni:network-instances/ocni:network-instance[ocni:name="red11"]/\
ocni:inter-instance-policies/ocni:import-export-policy/\
ocni:config/ocni:export-route-target',
            ...
            'xpath': '/ocni:network-instances/ocni:network-instance[ocni:name="red11"]/\
ocni:inter-instance-policies/ocni:import-export-policy/\
ocni:config/ocni:import-route-target',
            'value': '2:2',
        }, {
            'xpath': '/ocni:network-instances/ocni:network-instance[ocni:name="red11"]/\
ocni:inter-instance-policies/ocni:import-export-policy/\
...
oc-types:IPV4</enabled-address-families>
        <enabled-address-families \
xmlns:oc-types="http://openconfig.net/yang/openconfig-types">\
oc-types:IPV6</enabled-address-families>
      </config>
      <inter-instance-policies>
        ...
        <import-export-policy>
          <config>
            <export-route-target>1:1</export-route-target>
            <export-route-target>2:2</export-route-target>
            <import-route-target>2:2</import-route-target>
            <import-route-target>3:3</import-route-target>
          </config>
        </import-export-policy>
      </inter-instance-policies>
    </network-instance>
