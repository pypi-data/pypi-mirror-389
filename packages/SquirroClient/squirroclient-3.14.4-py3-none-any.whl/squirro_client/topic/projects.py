...
class ProjectsMixin:
    ...
    def get_user_projects(self):
        ...
        url = f"{self.topic_api_url}/{self.version}/{self.tenant}/projects"
    ...
    def get_project(self, project_id):
        ...
        url = f"{self.topic_api_url}/{self.version}/{self.tenant}/projects/{project_id}"
    ...
    def new_project(
        ...
        :param project_type: Optional string parameter (`normal`, `monitoring`) to
        ...
        if locator is not None:
            data["locator"] = _dumps(locator)
        if default_sort is not None:
            data["default_sort"] = _dumps(default_sort)
    ...
    def new_project_from_template(
        ...
        :returns: A dictionary which contains the project identifier.
        :param import_agents: Boolean. Whether to include the agents, defaults to `True`.
        ...
        url = (
            f"{self.topic_api_url}/{self.version}/{self.tenant}/projects_from_template"
        )
        ...
        data["import_options"] = _dumps(import_options)
    ...
    def reset_project(
        ...
        url = f"{self.topic_api_url}/{self.version}/{self.tenant}/projects/{project_id}/reset"
    ...
    def export_project(
        ...
        :param export_items_config: Dict. Containing the query parameters that
            ...
            `query`, `count` and `fields` parameters are supported.
        :param export_ais_published_models: Boolean. Whether to include
            the published ml models, defaults to `True`.
        :param export_agents: Boolean. Whether to include the agents, defaults to `True`.
        ...
        url = f"{self.topic_api_url}/{self.version}/{self.tenant}/projects/{project_id}/export"
    ...
    def import_project(
        ...
        url = f"{self.topic_api_url}/{self.version}/{self.tenant}/projects/{project_id}/import"
    ...
    def delete_project_search_caches(self, project_id):
        """Delete a project's search caches.

        :param project_id: Project identifier.

        Example::

            >>> client.delete_project_search_caches('gd9eIipOQ-KobU0SwJ8VcQ')

        """

        url = f"{self.topic_api_url}/{self.version}/{self.tenant}/projects/{project_id}/search_caches"
