...
class XGAArePromptBuilder(XGAPromptBuilder):
    def __init__(self, general_system_prompt: Optional[str] = None):
        system_prompt = self.build_general_prompt(general_system_prompt)
        super().__init__(system_prompt)


    def build_general_prompt(self, _system_prompt: str)-> str:
