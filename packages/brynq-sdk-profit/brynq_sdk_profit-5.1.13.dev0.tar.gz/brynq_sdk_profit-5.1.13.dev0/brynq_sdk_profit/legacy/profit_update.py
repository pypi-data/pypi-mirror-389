...
class UpdateConnector(BrynQ):
    ...
    def update_subscription(self, data: dict, method: str, custom_fields: dict = None, custom_fields_lines: dict = None) -> requests.Response:
        ...
        """
        required_fields = []
        allowed_fields = ['subscription_id', 'start_date_subscription', 'end_date_subscription', 'item_type_id', 'item_code', 'amount', 'subscription_line_id', 'invoice_cycle',
        ...
        if method == 'DELETE':
            ...
            if any(field in data.keys() for field in allowed_fields):
                fields_to_update = {}
                fields_to_update.update({"SuNr": data['subscription_id']}) if 'subscription_id' in data else fields_to_update
    ...
    def new_employee_with_first_contract(self, data: dict, overload_fields: dict = None) -> requests.Response:
        ...
        fields_to_update_person.update({"BcCo": data['person_id']}) if 'person_id' in data else fields_to_update_person
