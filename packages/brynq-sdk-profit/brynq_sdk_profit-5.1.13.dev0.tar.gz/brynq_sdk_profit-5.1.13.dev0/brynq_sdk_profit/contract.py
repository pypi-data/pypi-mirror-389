...
from .schemas.contract import ContractCreate#,ContractGetSchema

#TODO: this class is deprecated.
#pleae make it such that it is easy to uopdate employees
class Contract:
    ...
    def update(self, data: dict, overload_fields: dict = None, only_contract: bool = False) -> Optional[
        ...
        try:
            try:
                # Data validation
                valid_data = ContractCreate(**data).model_dump()
