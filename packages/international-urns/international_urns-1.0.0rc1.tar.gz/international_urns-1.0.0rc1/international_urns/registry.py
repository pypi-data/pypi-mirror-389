...
_registry = URNRegistry()


def get_registry() -> URNRegistry:
    """Get the global URN registry instance.

    :return: The singleton URNRegistry instance
    :rtype: URNRegistry
    """
    return _registry


__all__ = ["ValidatorFunc", "URNRegistry", "get_registry"]
