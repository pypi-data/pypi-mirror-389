...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/v1/external-resource/flush-elasticache/{account}/{identifier}",
    }
...
@app.command(
    help="""Flush an ElastiCache instance.
...
def external_resource_flush_elasticache(
    ...
    result = sync(account=account, identifier=identifier, client=ctx.obj["client"])
