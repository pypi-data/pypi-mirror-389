...
def test_split_trees_recipe():
    ...
    assert split_job["application"] == "lb-conda/default/2025-11-05"
...
def test_split_trees_recipe_configured_method():
    ...
    assert configured_job["application"] == "lb-conda/default/2025-11-05"
...
def test_filter_trees_recipe():
    ...
    # After recipe processing, the job should be transformed
    assert filter_job["application"] == "lb-conda/default/2025-11-05"
    assert (
