...
def main(database_url, version, list_commands):
    ...
    if list_commands:
        ...
        console.print("    PYARCHINIT_API_HOST        Host to bind (default: 0.0.0.0)")
        console.print("    PYARCHINIT_API_PORT        Port number (default: 8000)")
        console.print("    PYARCHINIT_API_RELOAD      Enable reload (default: false)")
        console.print("  [dim]Example:[/dim] PYARCHINIT_API_PORT=5000 pyarchinit-mini-api\n")

        console.print("[green]pyarchinit-mini-web[/green]")
        console.print("  Web interface on port 5001")
        console.print("  [dim]Environment variables:[/dim]")
        console.print("    PYARCHINIT_WEB_HOST        Host to bind (default: 0.0.0.0)")
        console.print("    PYARCHINIT_WEB_PORT        Port number (default: 5001)")
        console.print("    PYARCHINIT_WEB_DEBUG       Enable debug mode (default: true)")
        console.print("  [dim]Example:[/dim] PYARCHINIT_WEB_PORT=8080 PYARCHINIT_WEB_DEBUG=false pyarchinit-mini-web\n")
        ...
        console.print("  [dim]Options:[/dim]")
        console.print("    --non-interactive          Create admin with default credentials (admin/admin)")
        console.print("  [dim]Examples:[/dim]")
        console.print("    pyarchinit-mini-init                    # Interactive setup")
        console.print("    pyarchinit-mini-init --non-interactive  # Use defaults\n")
        ...
        console.print("  [dim]Options:[/dim]")
        console.print("    --silent                   No output")
        console.print("    --force                    Overwrite existing configuration")
        console.print("  [dim]Examples:[/dim]")
        console.print("    pyarchinit-mini-configure-claude")
        console.print("    pyarchinit-mini-configure-claude --force  # Force reconfigure\n")
        ...
        console.print("  [dim]Environment variables:[/dim]")
        console.print("    MCP_HOST                   Host to bind (default: localhost)")
        console.print("    MCP_PORT                   Port number (default: 8080)")
        console.print("    MCP_TRANSPORT              Transport type (default: sse)")
        console.print("  [dim]Example:[/dim] MCP_PORT=9000 pyarchinit-mini-mcp-http\n")
        ...
        console.print("    FILE_PATH                  Excel or CSV file with Harris Matrix data")
        console.print("  [dim]Options:[/dim]")
        console.print("    -s, --site TEXT            Site name (required)")
        console.print("    -g, --export-graphml       Export to GraphML format after import")
        console.print("    -d, --export-dot           Export to DOT format after import")
        console.print("    -o, --output-dir TEXT      Output directory for exports (default: current dir)")
        console.print("    --db TEXT                  Database URL (default: from environment)")
        console.print("  [dim]File structure:[/dim]")
        console.print("    Sheet 1 (NODES): us_number, unit_type, description, area, period, phase")
        console.print("    Sheet 2 (RELATIONSHIPS): from_us, to_us, relationship")
        console.print("  [dim]Examples:[/dim]")
        console.print("    pyarchinit-harris-import matrix.xlsx -s \"Pompei\"")
        console.print("    pyarchinit-harris-import matrix.csv -s \"Rome\" -g -d -o ./exports\n")

        console.print("[green]pyarchinit-harris-template[/green]")
        console.print("  Generate Harris Matrix Excel/CSV template")
        console.print("  [dim]Options:[/dim]")
        console.print("    -f, --format [xlsx|csv]    Template format (default: xlsx)")
        console.print("    -o, --output TEXT          Output filename WITHOUT extension (default: harris_matrix_template)")
        console.print("    -e, --with-examples        Include example data (default: yes)")
        console.print("  [dim]Workflow:[/dim]")
        console.print("    1. Generate template:      pyarchinit-harris-template -o my_template")
        console.print("    2. Fill in your data:      Edit my_template.xlsx with your US data")
        console.print("    3. Import to database:     pyarchinit-harris-import my_template.xlsx -s \"Site Name\"")
        console.print("  [dim]Example:[/dim] pyarchinit-harris-template -f xlsx -o metro_c_template\n")
