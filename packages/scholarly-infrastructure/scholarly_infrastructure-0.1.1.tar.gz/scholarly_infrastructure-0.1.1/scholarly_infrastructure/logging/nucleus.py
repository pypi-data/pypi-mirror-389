...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../src/notebooks/02_logging (richuru).ipynb.

# %% auto 0
__all__ = ["rich_console", "logger", "original_print", "print"]

# %% ../../src/notebooks/02_logging (richuru).ipynb 3
...
# %% ../../src/notebooks/02_logging (richuru).ipynb 5
