...
``tendril-connector-stytch`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install tendril-connector-stytch
...
`github releases <https://github.com/tendril-framework/tendril-connector-stytch/releases>`_.
...
``tendril-connector-stytch``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-connector-stytch.git
    $ cd tendril-connector-stytch
    $ pip install -e .
