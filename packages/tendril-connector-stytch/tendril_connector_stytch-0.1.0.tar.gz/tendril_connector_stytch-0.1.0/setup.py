...
setup(
    name='tendril-connector-stytch',
    use_scm_version={"root": ".", "relative_to": __file__},
    author="Chintalagiri Shashank",
    author_email="shashank@chintal.in",
    description="Stytch Connector for Tendril",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-connector-stytch',
    project_urls={
        'Documentation': 'https://tendril-connector-stytch.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-connector-stytch/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-connector-stytch',
    },
