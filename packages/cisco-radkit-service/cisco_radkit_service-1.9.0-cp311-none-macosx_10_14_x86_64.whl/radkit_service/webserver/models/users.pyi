...
class StoredAdmin(RADKitBaseModel):
    ...
    @classmethod
    def from_db_admin(cls, user: DbAdmin, with_role: bool = False) -> StoredAdmin: ...
...
class NewAdmin(RADKitBaseModel):
    ...
    roleId: int | None
    @classmethod
    def validate_role_fields(cls, data: dict[str, Any]) -> dict[str, Any]: ...
...
class UpdateAdmin(RADKitBaseModel):
    ...
    fullname: UpdateField[str]
    description: UpdateField[str]
    role: UpdateField[str | None]
    roleId: UpdateField[int | None]
    @classmethod
    def validate_role_fields(cls, data: dict[str, Any]) -> dict[str, Any]: ...
