...
from typing import Any, Generic, Literal, Protocol, TypeAlias, TypeGuard
...
class BulkResult(BaseModel, Generic[_T]):
    ...
    def transform(self, transform: Callable[[_T], _U | Error], result_type: type[_U], order: Iterable[int] | bool = True) -> BulkResult[_U]: ...
    @computed_field
    @property
    def count(self) -> int: ...
    @computed_field
    ...
    def enumerate_all(self, order: bool | Iterable[int] = True) -> Generator[tuple[int, APIResult[_T]]]: ...
    def successful_results(self, order: bool | Iterable[int] = True) -> Generator[_T]: ...
    def error_results(self, order: bool | Iterable[int] = True) -> Generator[Error]: ...
    def enumerate_results(self, order: bool | Iterable[int] = True) -> Generator[tuple[int, _T]]: ...
    def results_index_map(self, order: bool | Iterable[int] = True) -> list[int]: ...
    def enumerate_all_errors(self, order: bool | Iterable[int] = True) -> Generator[tuple[int, Error]]: ...
    def enumerate_pass_errors(self, order: bool | Iterable[int] = True) -> Generator[tuple[int, Error]]: ...
