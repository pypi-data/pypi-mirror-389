...
from radkit_service.control.settings import AllControlSettings
from radkit_service.control.transports._types import RequestContent
from radkit_service.permissions import Claim as Claim
...
from radkit_service.webserver.models.roles import NewRole as NewRole, StoredRole as StoredRole, UpdateRole as UpdateRole
...
class ControlAPI:
    ...
    @classmethod
    @contextmanager
    def create(cls, base_url: str, settings: AllControlSettings | None = None, admin_name: str | None = None, admin_password: str | None = None, request_timeout: float | None = 5.0, http_client_kwargs: dict[str, Any] | None = None, proxy_url: str | None = None, proxy_username: str | None = None, proxy_password: str | None = None) -> Generator[Self]: ...
    @classmethod
    ...
    def update_devices_uniform(self, devices: UpdateDevicesUniform) -> BulkResult[StoredDeviceWithMetadata | StoredDevice]: ...
    ...
    def create_admin(self, enabled: bool, admin_name: str, password: CustomSecretStr, email: str, full_name: str, description: str, role: int | str | None = None) -> APIResult[StoredAdmin]: ...
    def create_admins(self, admins: Sequence[NewAdmin]) -> BulkResult[StoredAdmin]: ...
    def update_admin(self, admin_name: str, email: str | DontUpdate = ..., full_name: str | DontUpdate = ..., description: str | DontUpdate = ..., enabled: bool | DontUpdate = ..., role: int | str | DontUpdate | None = ...) -> APIResult[StoredAdmin]: ...
    ...
    def list_roles(self) -> APIResult[list[StoredRole]]: ...
    def create_role(self, name: str, description: str | None = None, claims: frozenset[Claim] | None = None) -> APIResult[StoredRole]: ...
    def update_role(self, role_id: int, name: str | DontUpdate | None = ..., description: str | DontUpdate | None = ..., replace_claims: frozenset[Claim] | None = None, add_claims: frozenset[Claim] | None = None, remove_claims: frozenset[Claim] | None = None, is_sysadmin: bool | DontUpdate | None = ...) -> APIResult[StoredRole]: ...
    def delete_role(self, role_id: int) -> APIResult[StoredRole]: ...
