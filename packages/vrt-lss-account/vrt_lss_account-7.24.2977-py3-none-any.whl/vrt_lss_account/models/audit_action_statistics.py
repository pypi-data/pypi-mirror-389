...
class AuditActionStatistics(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request_points_count": obj.get("request_points_count") if obj.get("request_points_count") is not None else None,
            "result_elements_count": obj.get("result_elements_count") if obj.get("result_elements_count") is not None else None,
