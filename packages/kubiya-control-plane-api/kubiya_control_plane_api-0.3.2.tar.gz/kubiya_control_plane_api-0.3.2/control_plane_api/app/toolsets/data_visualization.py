...
class DataVisualizationToolSet(ToolSetDefinition):
    """Data visualization and diagramming toolset"""

    @property
    def type(self) -> ToolSetType:
        return ToolSetType.DATA_VISUALIZATION
...
register_toolset(DataVisualizationToolSet())
