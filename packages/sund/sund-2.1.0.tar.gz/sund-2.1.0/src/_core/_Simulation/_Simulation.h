...
PyObject *getActivityOutputNames(SimulationObject *self);

PyObject *getActivityManipulationNames(SimulationObject *self);
...
PyObject *getActivityOutputs(SimulationObject *self, PyObject *args,
                             PyObject *kwds);

PyObject *getActivityManipulations(SimulationObject *self, PyObject *args,
                                   PyObject *kwds);
} // namespace SIMULATION
...
static PyGetSetDef Simulation_getsetters[] = {
    ...
    {"activity_output_names", (getter)SIMULATION::getActivityOutputNames, NULL,
     "Activity output names from all activities", NULL},
    {"activity_manipulation_names",
     (getter)SIMULATION::getActivityManipulationNames, NULL,
     "Activity manipulation names from all activities", NULL},
    {NULL} /* Sentinel */
};
...
static PyMethodDef Simulation_methods[] = {
    ...
    {"activity_outputs_as_dict", (PyCFunction)SIMULATION::getActivityOutputs,
     METH_VARARGS | METH_KEYWORDS,
     "Get outputs from a specific activity by name or index"},
    {"activity_manipulations_as_dict",
     (PyCFunction)SIMULATION::getActivityManipulations,
     METH_VARARGS | METH_KEYWORDS,
     "Get manipulations from a specific activity by name or index"},
    {NULL} /* Sentinel */
};
