...
class AccountHTTP(HTTPManager):
    """
    HTTP client for BitMEX account-related API endpoints.

    This class provides methods to interact with BitMEX account APIs,
    including wallet information retrieval and account management.
    """
    ...
    async def get_wallet_summary(
        ...
        Returns:
            dict: Wallet summary data containing balance information
