...
class WorldPoint2D(TypedDict):
    """Represents a two-dimensional point in physical space/world co-ordinates. The world co-ordinates are calculated using :attr:`redbrick.types.task.VoxelPoint` and the DICOM Image Plane Module."""
...
class BoundingBox(TypedDict):
    ...
    #: Top left corner in world co-ordinates.
    absolutePoint1: NotRequired[WorldPoint2D]

    #: Bottom right corner in world co-ordinates.
    absolutePoint2: NotRequired[WorldPoint2D]
