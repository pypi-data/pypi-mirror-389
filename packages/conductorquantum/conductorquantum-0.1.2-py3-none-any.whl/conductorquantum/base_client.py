...
class BaseConductorQuantum:
    ...
    def __init__(
        ...
        *,
        ...
        self._model_results: typing.Optional[ModelResultsClient] = None
    ...
    def model_results(self):
        if self._model_results is None:
            from .model_results.client import ModelResultsClient  # noqa: E402

            self._model_results = ModelResultsClient(client_wrapper=self._client_wrapper)
...
class AsyncBaseConductorQuantum:
    ...
    def __init__(
        ...
        *,
        ...
        self._model_results: typing.Optional[AsyncModelResultsClient] = None
    ...
    def model_results(self):
        if self._model_results is None:
            from .model_results.client import AsyncModelResultsClient  # noqa: E402

            self._model_results = AsyncModelResultsClient(client_wrapper=self._client_wrapper)
        return self._model_results
