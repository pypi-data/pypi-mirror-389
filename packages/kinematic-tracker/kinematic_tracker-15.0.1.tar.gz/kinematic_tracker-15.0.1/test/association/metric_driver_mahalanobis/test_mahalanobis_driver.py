...
def test_compute_metric(det_rz: list[np.ndarray], filters: list[cv2.KalmanFilter]) -> None:
    """."""
    driver = MetricMahalanobis(100, 500, 1.0, 12, 6)
...
def test_compute_metric_wrong_inv(det_rz: list[np.ndarray]) -> None:
    """."""
    driver = MetricMahalanobis(100, 500, 1.0, 12, 6)
