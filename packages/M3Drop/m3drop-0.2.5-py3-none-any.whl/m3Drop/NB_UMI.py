...
def hidden_calc_vals(
    ...
    if cupy is None:
        raise RuntimeError(
            "CuPy is not installed. GPU acceleration is required for this function.\n"
            "Please install CuPy for your CUDA version:\n"
            "  - For CUDA 12.x: pip install cupy-cuda12x\n"
            "  - For CUDA 11.x: pip install cupy-cuda11x\n"
            "  - Or use: pip install 'M3Drop[gpu]' for CUDA 12.x\n"
            "  - Or use: pip install 'M3Drop[gpu-cuda11]' for CUDA 11.x"
        )
