...
class HeartbeatTopicsConfig(BaseModel):
    heartbeat: Annotated[
        TopicConfig,
        Field(
            DEFAULT_HEARTBEAT_TOPIC_CONFIG,
            description="Heartbeat topics config",
        ),
    ] = DEFAULT_HEARTBEAT_TOPIC_CONFIG
...
class InfraTopicsConfig(BaseModel):
    heartbeat: Annotated[
        HeartbeatTopicsConfig,
        Field(HeartbeatTopicsConfig(), description="Heartbeat's topics config"),
    ] = HeartbeatTopicsConfig()
    resource: Annotated[
