...
class TestSpendPermissionResponseObject(unittest.TestCase):
    """SpendPermissionResponseObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpendPermissionResponseObject:
        """Test SpendPermissionResponseObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpendPermissionResponseObject`
        """
    ...
    def testSpendPermissionResponseObject(self):
        """Test SpendPermissionResponseObject"""
