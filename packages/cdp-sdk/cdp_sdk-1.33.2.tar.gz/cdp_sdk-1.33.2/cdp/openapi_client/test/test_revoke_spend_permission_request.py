...
class TestRevokeSpendPermissionRequest(unittest.TestCase):
    """RevokeSpendPermissionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevokeSpendPermissionRequest:
        """Test RevokeSpendPermissionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevokeSpendPermissionRequest`
        """
    ...
    def testRevokeSpendPermissionRequest(self):
        """Test RevokeSpendPermissionRequest"""
