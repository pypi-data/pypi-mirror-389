...
class V1GetSuntimesResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1GetSuntimesResponse:
        """Create an instance of V1GetSuntimesResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1GetSuntimesResponse:
        """Create an instance of V1GetSuntimesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1GetSuntimesResponse.parse_obj(obj)

        _obj = V1GetSuntimesResponse.parse_obj({
