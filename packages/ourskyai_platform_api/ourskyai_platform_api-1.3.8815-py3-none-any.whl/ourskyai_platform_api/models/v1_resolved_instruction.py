...
class V1ResolvedInstruction(BaseModel):
    """
    Resolved Observation Instruction with additional resolution fields  # noqa: E501
    """
    id: StrictStr = Field(...)
    ...
    crop_size_width_px: Optional[StrictInt] = Field(None, alias="cropSizeWidthPx", description="x size of the square cropped area, in pixels")
    crop_size_height_px: Optional[StrictInt] = Field(None, alias="cropSizeHeightPx", description="y size of the square cropped area, in pixels")
    resolved_image_auto_exposure: StrictBool = Field(..., alias="resolvedImageAutoExposure", description="Whether the resolved image should be auto-exposed")
    __properties = ["id", "noradId", "orbitType", "imageSetId", "targetId", "trackingType", "exposureDuration", "binning", "gain", "gainMode", "gainOffset", "ra", "dec", "captureStart", "captureEnd", "preCaptureWait", "startSlewAt", "cameraMode", "tleName", "tleLine1", "tleLine2", "tleOffsetDec", "tleOffsetRa", "blackoutBoxes", "plateSolveParameters", "uploadPriority", "satellitePassEphemeris", "ascomAxisRates", "cropSizeWidthPx", "cropSizeHeightPx", "resolvedImageAutoExposure"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1ResolvedInstruction:
        """Create an instance of V1ResolvedInstruction from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1ResolvedInstruction:
        """Create an instance of V1ResolvedInstruction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1ResolvedInstruction.parse_obj(obj)

        _obj = V1ResolvedInstruction.parse_obj({
            "id": obj.get("id"),
            ...
            "crop_size_width_px": obj.get("cropSizeWidthPx"),
            "crop_size_height_px": obj.get("cropSizeHeightPx"),
            "resolved_image_auto_exposure": obj.get("resolvedImageAutoExposure")
        })
        return _obj
