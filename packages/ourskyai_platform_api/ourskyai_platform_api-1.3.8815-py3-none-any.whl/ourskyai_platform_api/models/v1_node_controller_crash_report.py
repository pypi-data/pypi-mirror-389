...
class V1NodeControllerCrashReport(BaseModel):
    """
    edge controller crash report details  # noqa: E501
    """
    id: StrictStr = Field(...)
    ...
    __properties = ["id", "lineageId", "fileSha", "fileSizeMb", "softwareVersion", "componentName", "kernelVersion", "backtrace", "completedAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V1NodeControllerCrashReport:
        """Create an instance of V1NodeControllerCrashReport from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V1NodeControllerCrashReport:
        """Create an instance of V1NodeControllerCrashReport from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V1NodeControllerCrashReport.parse_obj(obj)

        _obj = V1NodeControllerCrashReport.parse_obj({
            "id": obj.get("id"),
