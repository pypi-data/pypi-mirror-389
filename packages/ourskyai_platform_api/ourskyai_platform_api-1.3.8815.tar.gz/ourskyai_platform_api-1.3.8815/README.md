...
- API version: 1.3.8815
- Package version: 1.3.8815
...
with ourskyai_platform_api.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.admin_v1_get_node_controller_crash_report(id)
        print("The response of DefaultApi->admin_v1_get_node_controller_crash_report:\n")
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->admin_v1_get_node_controller_crash_report: %s\n" % e)
