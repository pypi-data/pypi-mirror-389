...
from ourskyai_platform_api.models.v1_resolved_instruction import V1ResolvedInstruction  # noqa: E501

class TestV1ResolvedInstruction(unittest.TestCase):
    """V1ResolvedInstruction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ResolvedInstruction:
        """Test V1ResolvedInstruction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ResolvedInstruction`
        """
        model = V1ResolvedInstruction()  # noqa: E501
        if include_optional:
            return V1ResolvedInstruction(
                id = '',
                norad_id = '',
                ...
                crop_size_width_px = 56,
                crop_size_height_px = 56,
                resolved_image_auto_exposure = True
            )
        else:
            return V1ResolvedInstruction(
                id = '',
    ...
    def testV1ResolvedInstruction(self):
        """Test V1ResolvedInstruction"""
