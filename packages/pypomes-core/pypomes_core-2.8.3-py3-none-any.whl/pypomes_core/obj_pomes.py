...
def func_get_defaulted_params() -> list[str]:
    """
    Retrieve the parameters not explicitly passed, but defaulted, parameters to the invoking function.

    :return: the not explicitly passed, bud defaulted, parameters as a list of names
    """
    # get the caller's frame
    frame: FrameType = inspect.currentframe().f_back
