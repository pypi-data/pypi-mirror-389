# Vibecontrols SDK - Complete Publishing Guide
...
The Vibecontrols SDK Python package is automatically published to PyPI using GitHub Actions workflows. This guide provides complete instructions for publishing packages, managing versions, and verifying deployments.

### Package Information

- **Package Name**: `vibecontrols-sdk`
- **PyPI URL**: https://pypi.org/project/vibecontrols-sdk/
...
**Main Package Page**:
https://pypi.org/project/vibecontrols-sdk/

**Release History**:
https://pypi.org/project/vibecontrols-sdk/#history

**Download Statistics**:
https://pypistats.org/packages/vibecontrols-sdk
...
curl -s https://pypi.org/pypi/vibecontrols-sdk/json | jq .

# Get latest version
curl -s https://pypi.org/pypi/vibecontrols-sdk/json | jq -r '.info.version'

# Get all versions
curl -s https://pypi.org/pypi/vibecontrols-sdk/json | jq -r '.releases | keys[]'
```

### 4. Check GitHub Releases

**All Releases**:
https://github.com/Algoshred/vibecontrols-sdk-python/releases
...
**Workflow Runs**:
https://github.com/Algoshred/vibecontrols-sdk-python/actions
...
|---------|------|----------------|---------|----------|
| 2025.11.0a20251103074441 | Alpha | 2025-11-03 | Latest Alpha | [PyPI](https://pypi.org/project/vibecontrols-sdk/2025.11.0a20251103074441/) |
| 1.0.0 | Stable | 2025-10-17 | Latest Stable | [PyPI](https://pypi.org/project/vibecontrols-sdk/1.0.0/) |
| 1.0.0a20251017103722 | Alpha | 2025-10-17 | Archived | [PyPI](https://pypi.org/project/vibecontrols-sdk/1.0.0a20251017103722/) |
| 1.0.0a20251017101704 | Alpha | 2025-10-17 | Archived | [PyPI](https://pypi.org/project/vibecontrols-sdk/1.0.0a20251017101704/) |
...
# Check PyPI status
curl -s https://pypi.org/pypi/vibecontrols-sdk/json | jq '.info.version'
```

### Issue: Import Fails After Install

**Problem**: `import vibecontrols_sdk` fails
...
pip show --files vibecontrols-sdk

# Reinstall
pip uninstall vibecontrols-sdk
pip install vibecontrols-sdk
...
### Install Package
```bash
pip install vibecontrols-sdk              # Latest stable
pip install --pre vibecontrols-sdk        # Latest alpha
pip install vibecontrols-sdk==2025.11.0   # Specific version
```
...
- **PyPI**: https://pypi.org/project/vibecontrols-sdk/
- **CI/CD**: https://github.com/Algoshred/vibecontrols-sdk-python/actions
