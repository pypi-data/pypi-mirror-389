"""
Activity Client for Bigconsole SDK.
...
class ActivityModule:
    ...
    async def get_workspace_activities(
        ...
        """
        query = """
            query GetWorkspaceActivities($workspaceId: ID!, $limit: Int, $offset: Int) {
                getWorkspaceActivities(workspaceId: $workspaceId, limit: $limit, offset: $offset) {  # noqa: E501
                    id
                    action
                    productId
                    workspaceId
    ...
    async def get_activity_stats(
        ...
        """
        query = """
            query GetActivityStats($workspaceId: ID!, $startDate: String, $endDate: String) {  # noqa: E501
                getActivityStats(workspaceId: $workspaceId, startDate: $startDate, endDate: $endDate) {  # noqa: E501
                    totalActivities
                    activitiesByAction
                    activitiesByUser
                    activitiesByProduct
