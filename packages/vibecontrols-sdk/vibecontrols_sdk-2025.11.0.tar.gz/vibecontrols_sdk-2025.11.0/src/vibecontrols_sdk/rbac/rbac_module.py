...
class RbacModule:
    ...
    async def get_actor_permissions(
        self, actor_id: str, token: str
    ) -> List[ActorPermission]:
        """
    ...
    async def remove_role_from_actor(
        self, actor_id: str, role_id: str, token: str
    ) -> bool:
    ...
    async def get_delegated_permissions(
