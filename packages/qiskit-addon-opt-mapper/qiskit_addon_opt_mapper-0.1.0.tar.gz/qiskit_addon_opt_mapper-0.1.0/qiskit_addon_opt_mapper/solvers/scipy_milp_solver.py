...
"""The SciPy MILP solver wrapped to be used within the addon."""
...
class ScipyMilpSolver(OptimizationSolver):
    """The MILP optimizer from Scipy wrapped as a Qiskit :class:`OptimizationSolver`.
    ...
    def _generate_problem(self, problem: OptimizationProblem):
