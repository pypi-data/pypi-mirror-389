...
modindex_common_prefix = ["qiskit_addon_opt_mapper."]
...
redirects = {
    "apidocs/qiskit_addon_opt_mapper": "./index.html",
    "apidocs/qiskit_addon_opt_mapper.transpiler": "./index.html",
    **{
...
def linkcode_resolve(domain, info):
    ...
    if module is None or "qiskit_addon_opt_mapper" not in module_name:
        return None
    ...
    try:
        ...
        return None
    if full_file_name is None or "/qiskit_addon_opt_mapper/" not in full_file_name:
        return None
    file_name = full_file_name.split("/qiskit_addon_opt_mapper/")[-1]
    ...
    return f"https://github.com/Qiskit/qiskit-addon-opt-mapper/tree/{GITHUB_BRANCH}/qiskit_addon_opt_mapper/{file_name}{linespec}"
