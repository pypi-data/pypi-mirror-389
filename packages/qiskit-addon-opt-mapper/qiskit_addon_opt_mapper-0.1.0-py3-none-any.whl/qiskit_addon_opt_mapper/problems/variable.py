...
class Variable(OptimizationProblemElement):
    ...
    def __init__(  # pylint: disable=too-many-positional-arguments
        ...
        The variables is exposed by the top-level `OptimizationProblem` class
        in `OptimizationProblem.variables`.  This constructor is not meant to be used
        externally.
        ...
        if lowerbound > upperbound:
            raise OptimizationError("Lowerbound is greater than upperbound!")
    ...
    def upperbound(self, upperbound: float | int) -> None:
        ...
        Raises:
            OptimizationError: if upperbound is smaller than lowerbound.
        """
