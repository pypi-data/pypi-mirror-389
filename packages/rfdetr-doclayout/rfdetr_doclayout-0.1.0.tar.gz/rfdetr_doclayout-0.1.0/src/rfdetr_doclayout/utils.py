...
WEIGHTS_URL = "https://huggingface.co/neka-nat/rfdetr-doclaynet-onnx/resolve/main/checkpoint_best_total.onnx"


def download_model_to_cache(app_name: str, url: str = WEIGHTS_URL) -> str:
    ...
    print(f"Downloading model weights from {url} to {cache_dir}...")
