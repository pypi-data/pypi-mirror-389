...
from orion.databases.db_empatia.repositories.repository_for_geospatial_calculations import distance_between_geometries, lugares_a_500m, property_within_sector, test_geometries  # noqa: F401
...
from orion.scripts.init_dbs import create_schemas_bellatrix, create_schemas_empatia  # noqa: F401
...
def main():
    ...
    #     # insertar propiedades nuevas o que estaban desactivadas en softin
