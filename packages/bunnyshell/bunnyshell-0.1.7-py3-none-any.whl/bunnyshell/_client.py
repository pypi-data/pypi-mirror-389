...
class HTTPClient:
    ...
    def __init__(
        ...
        self.api_key = api_key or os.environ.get("BUNNYSHELL_API_KEY")
        if not self.api_key:
            raise ValueError(
                "API key required. Pass api_key parameter or set BUNNYSHELL_API_KEY environment variable.\n"
                "Get your API key at: https://dashboard.bunnyshell.com"
            )
