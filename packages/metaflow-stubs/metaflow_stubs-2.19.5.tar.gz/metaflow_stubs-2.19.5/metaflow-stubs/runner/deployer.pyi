...
# MF version: 2.19.5                                                                                 #
# Generated on 2025-11-05T19:51:27.639270                                                            #
######################################################################################################
...
def generate_fake_flow_file_contents(flow_name: str, param_info: dict, project_name: str | None = None):
    ...
...
class Deployer(object, metaclass=DeployerMeta):
    ...
    **kwargs : Any
    ...
    def __init__(self, flow_file: str, show_output: bool = True, profile: str | None = None, env: typing.Dict | None = None, cwd: str | None = None, file_read_timeout: int = 3600, **kwargs):
        ...
    def argo_workflows(self, *, name: str | None = None) -> "metaflow.plugins.argo.argo_workflows_deployer.ArgoWorkflowsDeployer":
        """
        ...
        """
        ...
    def step_functions(self, *, name: str | None = None) -> "metaflow.plugins.aws.step_functions.step_functions_deployer.StepFunctionsDeployer":
        """
...
class TriggeredRun(object, metaclass=type):
    ...
    """
    def wait_for_run(self, check_interval: int = 5, timeout: int | None = None):
        """
...
class DeployedFlow(object, metaclass=DeployedFlowMeta):
    ...
    def __annotate_func__(format):
        ...
    @classmethod
    def from_deployment(cls, *, identifier: str, metadata: str | None = None, impl: str | None = 'given by METAFLOW_DEFAULT_FROM_DEPLOYMENT_IMPL') -> ForwardRef('metaflow.plugins.argo.argo_workflows_deployer_objects.ArgoWorkflowsDeployedFlow') | ForwardRef('metaflow.plugins.aws.step_functions.step_functions_deployer_objects.StepFunctionsDeployedFlow'):
        """
        ...
        Returns
        -------
        ForwardRef('metaflow.plugins.argo.argo_workflows_deployer_objects.ArgoWorkflowsDeployedFlow') | ForwardRef('metaflow.plugins.aws.step_functions.step_functions_deployer_objects.StepFunctionsDeployedFlow')
        A `DeployedFlow` object
        """
        ...
    @classmethod
    def list_deployed_flows(cls, flow_name: str | None = None, impl: str = 'argo_workflows'):
        """
        ...
        ...
    @classmethod
    def get_triggered_run(cls, identifier: str, run_id: str, metadata: str | None = None, impl: str = 'argo_workflows') -> TriggeredRun:
        """
        ...
        ...
    @classmethod
    def from_argo_workflows(cls, *, identifier: str, metadata: str | None = None) -> "metaflow.plugins.argo.argo_workflows_deployer_objects.ArgoWorkflowsDeployedFlow":
        """
        ...
        ...
    @classmethod
    def list_argo_workflows(cls, flow_name: str | None = None):
        ...
    @classmethod
    def get_triggered_argo_workflows_run(cls, identifier: str, run_id: str, metadata: str | None = None):
        ...
    @classmethod
    def from_step_functions(cls) -> "metaflow.plugins.aws.step_functions.step_functions_deployer_objects.StepFunctionsDeployedFlow":
        ...
        ...
    @classmethod
    def list_step_functions(cls, flow_name: str | None = None):
        ...
    @classmethod
    def get_triggered_step_functions_run(cls, identifier: str, run_id: str, metadata: str | None = None):
        ...
    ...
