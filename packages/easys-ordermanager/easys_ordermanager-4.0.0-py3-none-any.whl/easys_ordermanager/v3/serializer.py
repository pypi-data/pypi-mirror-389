...
from easys_ordermanager.validators import (
    DomainNameValidator,
    HexColorValidator,
    age_range_validator,
    comma_separated_period_validator,
)
...
SEO_LANDING_PAGE_CHOICES = Choices(
    ...
    (
        ...
        "existing_stroer_lp",
        _("Existing Stroer Landing Page"),
    ),
)
...
PRODUCT_TYPE_ORDER_ATTRIBUTES_MAPPING = {
    ...
    PRODUCT_TYPE_DISPLAY_NATIVE: {"detail_display_native"},
...
WEBSITE_BASIC_TEMPLATE_MALIT = 1
WEBSITE_BASIC_TEMPLATE_KONA = 2
WEBSITE_BASIC_TEMPLATE_RHEA = 3
WEBSITE_BASIC_TEMPLATE_JOYA = 4
WEBSITE_BASIC_TEMPLATE_NARA = 5
WEBSITE_BASIC_TEMPLATE_PICA = 6
WEBSITE_BASIC_TEMPLATE_CALI = 7
WEBSITE_BASIC_TEMPLATE_IBA = 8
WEBSITE_BASIC_TEMPLATE_CHOICES = Choices(
    (WEBSITE_BASIC_TEMPLATE_MALIT, "Malit"),
    (WEBSITE_BASIC_TEMPLATE_KONA, "Kona"),
    (WEBSITE_BASIC_TEMPLATE_RHEA, "Rhea"),
    (WEBSITE_BASIC_TEMPLATE_JOYA, "Joya"),
    (WEBSITE_BASIC_TEMPLATE_NARA, "Nara"),
    (WEBSITE_BASIC_TEMPLATE_PICA, "Pica"),
    (WEBSITE_BASIC_TEMPLATE_CALI, "Cali"),
    (WEBSITE_BASIC_TEMPLATE_IBA, "Iba"),
)
...
OPENING_HOURS_MODE_CHOICES = Choices(
    ...
    (
        ...
        "open_morning_afternoon",
        _("Morning and afternoon"),
    ),
...
FACEBOOK_MARKETING_TARGET_CHOICES = Choices(
    ...
    (
        FACEBOOK_MARKETING_TARGET_RETARGETING,
        "retargeting_via_facebook",
        _("Retargeting via Facebook"),
    ),
    (
        FACEBOOK_MARKETING_TARGET_EVENT_PROMOTION,
        "event_promotion",
        _("Event promotion"),
    ),
    (
        FACEBOOK_MARKETING_TARGET_BRAND,
        "strengthen_the_brand",
        _("Strengthen the brand"),
    ),
    (FACEBOOK_MARKETING_TARGET_WIN_FANS, "win_fans", _("Win fans")),
    (
        FACEBOOK_MARKETING_TARGET_PROMOTE_ARTICLES,
        "promote_articles",
        _("Promote articles"),
    ),
)
...
INAPP_BANNER_TEMPLATE_CHOICES = Choices(
    ...
    (
        INAPP_BANNER_TEMPLATE_SOCIAL_SHARING_AD,
        "social_sharing_ad",
        _("Social sharing Ad"),
    ),
...
INAPP_GENDER_INDIFFERENT = 1
INAPP_GENDER_MALE = 2
INAPP_GENDER_FEMALE = 3
INAPP_GENDER_CHOICES = Choices(
    (INAPP_GENDER_INDIFFERENT, "indifferent", _("Indifferent")),
    (INAPP_GENDER_MALE, "male", _("Male")),
    (INAPP_GENDER_FEMALE, "female", _("Female")),
)
...
DISPLAY_TYPE_CHOICES = Choices(
    (
        DISPLAY_TYPE_WEB_MOBILE,
        "web_and_mobile",
        _("Web and mobile display advertisement"),
    ),
...
DISPLAY_AGE_14_29: int  # DEPRECATED - use DISPLAY_AGE_18_29
DISPLAY_AGE_18_29 = 8
DISPLAY_AGE_30_39 = 3
DISPLAY_AGE_40_49 = 4
DISPLAY_AGE_50_59 = 5
...
DISPLAY_AGE_CHOICES = Choices(
    (7, "14_29", _("14-29 years")),
    (DISPLAY_AGE_18_29, "18_29", _("18-29 years")),
...
DISPLAY_GENDER_INDIFFERENT = INAPP_GENDER_INDIFFERENT
DISPLAY_GENDER_MALE = INAPP_GENDER_MALE
DISPLAY_GENDER_FEMALE = INAPP_GENDER_FEMALE
DISPLAY_GENDER_CHOICES = INAPP_GENDER_CHOICES

# DEPRECATED - get valid versions from interest-targeting API:
# /api/ordermanager/easys/v3/display-premium/interest-targeting/
DISPLAY_TARGETING_ART: int
DISPLAY_TARGETING_RECRUITING: int
DISPLAY_TARGETING_TRAVEL: int
DISPLAY_TARGETING_TECH: int
DISPLAY_TARGETING_DESIGN: int
DISPLAY_TARGETING_FASHION: int
DISPLAY_TARGETING_SPORTS: int
DISPLAY_TARGETING_AUTOMOBILE: int
DISPLAY_TARGETING_LUXURY: int
...
DISPLAY_CHANNEL_CHOICES = Choices(
    ...
    (
        DISPLAY_CHANNEL_CONSTRUCTION_AND_LIVING,
        "construction_and_living",
        _("Construction & Living"),
    ),
...
INAPP_AUDIENCE_CHOICES = Choices(
    ...
    (
        INAPP_AUDIENCE_GEBRAUCHTWAGEN_INTERESSENTEN,
        "gebrauchtwagen_interessenten",
        _("Interested in used cars"),
    ),
    ...
    (
        INAPP_AUDIENCE_ENTERTAINMENT_LOVER,
        "entertainment_lover",
        _("Entertainment lovers"),
    ),
    ...
    (
        INAPP_AUDIENCE_HIGH_END_FASHIONISTA,
        "high_end_fashionista",
        _("High end fashionista"),
    ),
    (
        INAPP_AUDIENCE_LOW_BUDGET_FASHIONISTAS,
        "low_budget_fashionistas",
        _("Low budget fashionista"),
    ),
    ...
    (
        INAPP_AUDIENCE_STUDENTEN_UND_ABSOLVENTEN,
        "studenten_und_absolventen",
        _("Students and alumni"),
    ),
    (
        INAPP_AUDIENCE_FRAUEN_MIT_KINDERWUNSCH,
        "frauen_mit_kinderwunsch",
        _("Women whishing for children"),
    ),
    (
        INAPP_AUDIENCE_KRANKE_MENSCHEN_SCHNIEFNASEN,
        "kranke_menschen_schniefnasen",
        _("Sick people / runny noses"),
    ),
    (
        INAPP_AUDIENCE_GESUNDHEITSINTERESSIERTE,
        "gesundheitsinteressierte",
        _("Interested in health"),
    ),
    (
        INAPP_AUDIENCE_SCHONHEITS_OP_INTERESSIERTE,
        "schonheits_op_interessierte",
        _("Interested in cosmetic surgery"),
    ),
    (INAPP_AUDIENCE_FOTOKUNSTLER, "fotokunstler", _("Photo artists")),
    (
        INAPP_AUDIENCE_REISENDE_REISEAFFINE,
        "reisende_reiseaffine",
        _("Travelers / Travel afficionados"),
    ),
    ...
    (
        INAPP_AUDIENCE_HAUSBESITZER_VLL_ANGEHENDE_HB,
        "hausbesitzer_vll_angehende_hb",
        _("House owners (or future ones)"),
    ),
    (INAPP_AUDIENCE_JOBSUCHENDE, "jobsuchende", _("Job seakers")),
    (
        INAPP_AUDIENCE_YOUNG_PROFESSIONALS,
        "young_professionals",
        _("Young professionals"),
    ),
    (
        INAPP_AUDIENCE_KULTURINTERESSIERTE,
        "kulturinteressierte",
        _("Cultural interested"),
    ),
    (
    ...
    (
        INAPP_AUDIENCE_HIGH_INCOME_RICH_PEOPLE,
        "high_income_rich_people",
        _("High income / rich people"),
    ),
...
DISPLAY_NATIVE_INTERESTS_TYPES = Choices(
    ...
    (
        DISPLAY_NATIVE_BOOKS_AND_LITERATURE,
        "books_and_literature",
        _("Books & Literature"),
    ),
    (DISPLAY_NATIVE_EAT_AND_DRINK, "eat_and_drink", _("Eat & Drink")),
    (
        DISPLAY_NATIVE_FAMILY_AND_RELATIONSHIP,
    ...
    (
        DISPLAY_NATIVE_BUSINESS_AND_FINANCE,
    ...
    (
        DISPLAY_NATIVE_HOBBIES_AND_INTERESTS,
    ...
    (
        DISPLAY_NATIVE_RELIGION_AND_SPIRITUALITY,
        "religion_and_spirituality",
        _("Religion & Spirituality"),
    ),
    ...
    (
        DISPLAY_NATIVE_TECHNOLOGY_AND_COMPUTER,
        "technology_and_computer",
        _("Technology & Computer"),
    ),
    (
        DISPLAY_NATIVE_EVENTS_AND_ATTRACTIONS,
        "events_and_attractions",
        _("Events & Attractions"),
    ),
...
class AccountSerializer(serializers.Serializer):
    ...
    branch_codes = serializers.ListField(
        child=serializers.CharField(max_length=16, required=True),
        required=True,
        allow_empty=False,
    )
...
class ContactSerializer(serializers.Serializer):
    ...
    """
    will this contact receive review notifications?
    """
    opt_in_reviews = serializers.BooleanField(required=False)

    """
    will this contact receive listing reminders?
    """
    opt_in_listing_reminders = serializers.BooleanField(required=False)
...
class AccountLocationSerializer(serializers.Serializer):
    ...
    """
    Invoice recipient's company name
    """
...
class DisplayNativeCreativeSerializer(serializers.Serializer):
    ...
    """
    DEPRECATED - use customer_wishes instead
    """
    # TODO: remove field in next version
    info_for_webdesign = serializers.CharField(max_length=1000, required=False)
    """
    document any additional desires the customer may have expressed for this product
    """
    customer_wishes = serializers.CharField(max_length=1000, allow_blank=True, required=False)

    def validate(self, data):
        required_message = "This field is required."
        info_and_wishes_message = "Cannot use deprecated info_for_webdesign while new customer_wishes is also used."

        errors = []
        if data.get("ad_type") == NATIVE_AD_TYPES.native_ad_in and not data.get("advertorial"):
            errors.append({"advertorial": required_message})
        if "info_for_webdesign" in data:
            if "customer_wishes" in data:
                errors.append({"info_for_webdesign": info_and_wishes_message})
            else:
                warn(
                    "Field info_for_webdesign is deprecated. Please use customer_wishes instead.",
                    DeprecationWarning,
                    stacklevel=2,
                )
...
class OrderLineDisplayNativeSerializer(serializers.Serializer):
    ...
    """
    target_url = serializers.URLField(max_length=2000, allow_blank=True, required=False)
    ...
    geo_targeting = serializers.ListField(
        child=serializers.CharField(max_length=10, required=True),
        allow_empty=True,
        required=True,
    )
    ...
    def validate(self, data):
        ...
        try:
            age_range_validator(data, "age_group_from", "age_group_to")
        except DjangoValidationError as e:
            errors.append({key: value[0] for key, value in e.message_dict.items()})
...
class OrderLineDisplayPremiumSerializer(serializers.Serializer):
    ...
    channel_targeting = serializers.MultipleChoiceField(
        choices=DISPLAY_CHANNEL_CHOICES,
        required=True,
        allow_empty=True,
    )
    ...
    list of interests the ad will be targeted on
    """
    interest_targeting = serializers.ListField(child=serializers.IntegerField(), required=False, allow_empty=True)
...
class OrderLineInAppSerializer(serializers.Serializer):
    ...
    """
    gender_targeting = serializers.ChoiceField(choices=INAPP_GENDER_CHOICES, allow_blank=True, required=False)

    """
    age (from) selection the ad should be targeted on

    """
    age_targeting_from = serializers.IntegerField(min_value=0, allow_null=True, required=False)

    """
    age (to) selection the ad should be targeted on

    """
    age_targeting_to = serializers.IntegerField(min_value=0, allow_null=True, required=False)
    ...
    """
    creatives_template = serializers.ChoiceField(choices=INAPP_BANNER_TEMPLATE_CHOICES, required=True, allow_null=True)
    ...
    def validate(self, data):
        ...
        if data.get("creatives_creator") != INAPP_BANNERS_CREATOR_CUSTOMER and data.get("creatives_template") is None:
            raise serializers.ValidationError("creatives_template has to be set if creatives_creator is not customer")

        try:
            age_range_validator(data, "age_targeting_from", "age_targeting_to")
        except DjangoValidationError as e:
            raise serializers.ValidationError({key: value[0] for key, value in e.message_dict.items()}) from e
...
class OrderLineListingSerializer(serializers.Serializer):
    ...
    """
    company name (will default to customer name if not provided)
    ...
    """
    opening_hours_description = serializers.CharField(max_length=255, allow_blank=True, required=False)
    ...
    keywords = serializers.ListField(
        child=serializers.CharField(max_length=55, required=True),
        allow_empty=True,
        required=True,
    )
...
class OrderLineSeoSerializer(serializers.Serializer):
    ...
    """
    names of the physical locations the optimization should be deasys for
    """
    ...
    regions = serializers.ListField(
        child=serializers.CharField(max_length=100, required=False, allow_blank=True),
        required=False,
    )
...
class OrderLineWebsiteSerializer(serializers.Serializer):
    ...
    design_preference_minimalistic_embellished = serializers.ChoiceField(
        choices=WEBSITE_DESIGN_PREFERENCE_MINIMALISTIC_EMBELLISHED,
        allow_null=True,
        required=False,
    )
    ...
    design_preference_modern_classic = serializers.ChoiceField(
        choices=WEBSITE_DESIGN_PREFERENCE_MODERN_CLASSIC,
        allow_null=True,
        required=False,
    )
    ...
    design_preference_simple_striking = serializers.ChoiceField(
        choices=WEBSITE_DESIGN_PREFERENCE_SIMPLE_STRIKING,
        allow_null=True,
        required=False,
    )
    ...
    design_preference_text_picture = serializers.ChoiceField(
        choices=WEBSITE_DESIGN_PREFERENCE_TEXT_PICTURE,
        allow_null=True,
        required=False,
    )
    ...
    """
    what template should the new website use?
    may and must only be supplied if the website product_level is basic

    """
    basic_template = serializers.ChoiceField(choices=WEBSITE_BASIC_TEMPLATE_CHOICES, allow_null=False, required=False)
...
class Serializer(serializers.Serializer):
    ...
    def validate_productfee_commissions(self, data):
        for orderline in data["orderlines"]:
            if (
                orderline["product_type"] in [PRODUCT_TYPE_GOOGLE_ADS]
                and orderline["product_level"]
                in [
                    PRODUCT_LEVEL_BASIC,
                ]
                and orderline.get("commission") != Decimal(40)
            ):
                raise serializers.ValidationError(
    ...
    def validate_seller_shares(self, data):
        ...
        for order in data["orders"]:
            ...
            if sellershare_sum != EXPECTED_SELLER_SHARE_SUM:
                raise serializers.ValidationError(
                    "summed up seller shares of order {} are {}, must be exactly {}".format(
                        order["easys_id"],
                        sellershare_sum,
                        EXPECTED_SELLER_SHARE_SUM,
                    ),
                )
    ...
    def validate_productdetail_exists(self, data):
        for orderline in data["orderlines"]:
            if orderline[
                "product_type"
            ] in PRODUCT_TYPE_ORDER_ATTRIBUTES_MAPPING and not PRODUCT_TYPE_ORDER_ATTRIBUTES_MAPPING[
                orderline["product_type"]
            ].intersection(orderline.keys()):
                raise serializers.ValidationError(
            ...
            if account_location["easys_account_id"] != account_id:
                raise serializers.ValidationError(
                    "account id {} of account location {} is not known".format(
                        account_location["easys_account_id"],
                        account_location["easys_id"],
                    ),
                )
            ...
            if orderline["easys_account_location_id"] not in account_location_ids:
                raise serializers.ValidationError(
                    "account location id {} of orderline {} is not known".format(
                        orderline["easys_account_location_id"],
                        orderline["easys_id"],
                    ),
                )
    ...
    def validate_domain_products_exist(self, data):
        ...
        for orderline in data["orderlines"]:
            ...
            if "easys_orderline_domain_id" in details and details["easys_orderline_domain_id"] not in domain_ids:
                raise serializers.ValidationError(
                    "domain id {} of orderline {} is not known".format(
                        details["easys_orderline_domain_id"],
                        orderline["easys_id"],
                    ),
                )
...
_DEPRECATED_CONSTS = {
    ...
    "DISPLAY_TARGETING_CHOICES": Choices(
        (1, "art", _("Art / Culture")),
        (2, "recruiting", _("Job / Recruiting")),
        (3, "travel", _("Travel")),
        (4, "tech", _("Tech")),
        (5, "design", _("Design")),
        (6, "fashion", _("Fashion")),
        (7, "sports", _("Sports")),
        (8, "automobile", _("Automobile")),
        (9, "luxury", _("Luxury")),
    ),
}
...
def __getattr__(name: str):
    if name not in _DEPRECATED_CONSTS:
        raise AttributeError(f"module '{__name__}' has no attribute '{name}'")
    warn(
        f"Constant '{name}' is deprecated. Check '{__name__}' for alternatives.",
        DeprecationWarning,
        stacklevel=2,
    )
    return _DEPRECATED_CONSTS[name]
