from etiket_client.sync.backends.quantify.live_sync import XArrayReplicator, is_dataset_live
...
from etiket_client.sync.backends.quantify.utility import to_gridded_dataset
...
class QuantifySync(SyncSourceFileBase):
    ...
    def checkLiveDataset(configData: QuantifyConfigData, syncIdentifier: sync_item, maxPriority: bool) -> bool:
        ...
        dataset_dir = Path(os.path.join(configData.quantify_directory, syncIdentifier.dataIdentifier))
                ...
                if file.endswith(".hdf5") or file.endswith(".h5"):
                    ...
                    if is_dataset_live(file_path) is False:
                        ...
                        try:
                            ...
                            print(f"Error converting dataset to gridded dataset: {e}")
