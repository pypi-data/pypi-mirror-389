...
```bash
pip install rubberize_lsp_override
```
...
```bash
pip uninstall rubberize_lsp_override
```
...
# Change directory to the rubberize_lsp_override directory
...
folder is located. Then you can remove the symlink named `rubberize-lsp-override` within that folder.
