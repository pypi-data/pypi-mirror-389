...
{ 
  ...
  protected:
    ...
    Array<Vec<3>> points;
    Array<ArrayMem<int,ELEMENT_MAXPOINTS+1>> cells;
  ...
  public:
    ...
    void FillReferenceHex(Array<IntegrationPoint> & ref_coords,Array<ArrayMem<int,ELEMENT_MAXPOINTS+1>> & ref_elems); 
    void FillReferencePrism(Array<IntegrationPoint> & ref_coords,Array<ArrayMem<int,ELEMENT_MAXPOINTS+1>> & ref_elems);    
