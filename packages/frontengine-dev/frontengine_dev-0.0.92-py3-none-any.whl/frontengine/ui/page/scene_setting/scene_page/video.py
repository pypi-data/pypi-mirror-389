...
class VideoSceneSettingUI(QWidget):
    def __init__(self, script_ui: SceneManagerUI):
        front_engine_logger.info(f"[VideoSceneSettingUI] Init | script_ui={script_ui}")
        super().__init__()
    ...
    def get_video(self) -> None:
        front_engine_logger.info("[VideoSceneSettingUI] get_video")
