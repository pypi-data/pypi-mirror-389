...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_last_updated", "hidden", "pulp_labels", "name", "base_url", "pulp_href", "pulp_created", "content_guard", "base_path", "no_content_change_since", "prn"]
