...
class HTTPTransport:
    ...
    def __init__(self, base_url: Optional[str] = None):
        ...
        self._message_handler: Optional[Callable[[AISMessage], Awaitable[AISMessage]]] = None
    ...
    def set_message_handler(self, handler: Callable[[AISMessage], Awaitable[AISMessage]]) -> None:
        """
                ...
                if msg.type == WSMsgType.TEXT:
                    try:
                        ...
                        try:
                            ...
                            # WebSocket may be closed, ignore error notification failure
                            pass
...
class CombinedTransport:
    ...
    async def __aenter__(self) -> "CombinedTransport":
        """Async context manager entry."""
        return self
