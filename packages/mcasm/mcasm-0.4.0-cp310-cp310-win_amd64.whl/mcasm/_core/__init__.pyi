...
class Streamer:
    ...
    def change_section(
        ...
        state: ParserState,
        section: mc.Section,
        # Make `subsection` optional.
        # pybind11-stubgen originally generates `subsection: mc.Expr,`
        # but it doesn't current support emitting Optional[...] types.
        # We therefore edit this stub manually to use Optional[mc.Expr].
    ...
    def emit_linker_options(
        self, state: ParserState, kind: list[str]
    ) -> None: ...
