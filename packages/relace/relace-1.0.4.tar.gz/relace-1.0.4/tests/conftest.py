...
from relace import Relace, AsyncRelace, DefaultAioHttpClient
from relace._utils import is_dict
...
def client(request: FixtureRequest) -> Iterator[Relace]:
    ...
    with Relace(base_url=base_url, api_key=api_key, _strict_response_validation=strict) as client:
        yield client
