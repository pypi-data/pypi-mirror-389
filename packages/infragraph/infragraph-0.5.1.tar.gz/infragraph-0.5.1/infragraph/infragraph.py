...
class Link(OpenApiObject):
    ...
    def physical(self):
        ...
        Defines the physical properties of network link, including bandwidth and latency characteristics.Defines the physical properties of network link, including bandwidth and latency characteristics.Defines the physical properties of network link, including bandwidth and latency characteristics.A container for physical properties.
...
class LinkPhysical(OpenApiObject):
    ...
    def bandwidth(self):
        ...
        A container for specific Link physical Properties.A container for specific Link physical Properties.A container for specific Link physical Properties.Specifies the bandwidth capacity of the physical link.
    ...
    def latency(self):
        ...
        A container for specific Link latency properties.A container for specific Link latency properties.A container for specific Link latency properties.Specifies the latency characteristics of the physical link.
...
class LinkPhysicalBandwidth(OpenApiObject):
    ...
    def choice(self):
        ...
        Choice of bandwidth unit between gigabits_per_second (Gbps), gigabytes_per_second (GBps), or gigatransfers_per_second (GT/s).
...
class DeviceEdge(OpenApiObject):
    ...
    def ep1(self):
        ...
        Describes an endpoint consisting of device and its component, including optional device name and component slice.Describes an endpoint consisting of device and its component, including optional device name and component slice.Describes an endpoint consisting of device and its component, including optional device name and component slice.An optional device and component that is the other endpoint of the edge
...
class DeviceEdgeIter(OpenApiIter):
    ...
    def edge(self, scheme=None, link=None):
        ...
        Represents an edge connecting two device endpoints, describing the link and edge scheme.
...
class InstanceIter(OpenApiIter):
    ...
    def instance(self, name=None, description=None, device=None, count=None):
        ...
        Defines an instance alias referring to device and specifying how many copies (count) exist for graph modeling.
...
class InfrastructureEdge(OpenApiObject):
    ...
    def ep1(self):
        ...
        Defines an endpoint referencing an infrastructure instance and its component with slice indexing.Defines an endpoint referencing an infrastructure instance and its component with slice indexing.Defines an endpoint referencing an infrastructure instance and its component with slice indexing.A device and component that is one endpoint of the edge
    ...
    def ep2(self):
        ...
        Defines an endpoint referencing an infrastructure instance and its component with slice indexing.Defines an endpoint referencing an infrastructure instance and its component with slice indexing.Defines an endpoint referencing an infrastructure instance and its component with slice indexing.A device and component that is the other endpoint of the edge
...
class InfrastructureEdgeIter(OpenApiIter):
    ...
    def edge(self, scheme=None, link=None):
        ...
        Represents an edge between two infrastructure endpoints with an associated link and edge scheme.
...
class QueryNodeFilterIter(OpenApiIter):
    ...
    def querynodefilter(self, name=None):
        ...
        Defines filter on nodes, either by attributes or by node IDs.
...
class NameValueIter(OpenApiIter):
    ...
    def namevalue(self, name=None, value=None):
        ...
        Represents generic name and value pair attribute.
...
class QueryResponseItemIter(OpenApiIter):
    ...
    def queryresponseitem(self, id=None):
        ...
        Represents single item returned from query, identified by an id and associated attributes.
...
class QueryShortestPathItemIter(OpenApiIter):
    ...
    def queryshortestpathitem(self, name=None, nodes=None):
        ...
        Represents shortest path result containing name and an ordered list of nodes on the path.
...
class AnnotationNodeIter(OpenApiIter):
    ...
    def node(self, name=None, attribute=None, value=None):
        ...
        Defines an annotation to be applied to graph node.
...
class AnnotationEdgeIter(OpenApiIter):
    ...
    def edge(self, ep1=None, ep2=None, attribute=None, value=None):
        ...
        Defines an annotation to be applied to graph edge.
...
class Api(object):
    ...
    def __init__(self, **kwargs):
        ...
        self._version_meta.api_spec_version = "0.5.1"
