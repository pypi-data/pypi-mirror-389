"""
# utils.py
# Módulo de utilidades para manejo de errores en DAOs asíncronos
...
def error_handler(func):
    """
    Decorador para manejo de errores consistente en métodos DAO async.
...
async def load_relationships_from_dto(session: AsyncSession, instance: Any, dto: BaseModel, included: set=set()) -> set[str]:
    """
