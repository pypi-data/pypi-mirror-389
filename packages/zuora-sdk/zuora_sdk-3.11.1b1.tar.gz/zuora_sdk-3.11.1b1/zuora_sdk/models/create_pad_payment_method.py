...
class CreatePADPaymentMethod(BaseModel):
    ...
    bank_account_type: Optional[PaymentMethodPADBankAccountType] = Field(default=None, alias="bankAccountType")
    ...
    __properties: ClassVar[List[str]] = ["accountKey", "paymentMethodNumber", "paymentGatewayNumber", "screeningAmount", "authGateway", "gatewayOptions", "ipAddress", "makeDefault", "processingOptions", "skipValidation", "type", "currencyCode", "tokenize", "tokens", "accountNumber", "bankCode", "branchCode", "bankAccountType", "accountHolderInfo", "mandateInfo"]
