...
class CommitmentInput(BaseModel):
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "periods": [CommitmentPeriodInput.from_dict(_item) for _item in obj["periods"]] if obj.get("periods") is not None else None
        }
        return _obj
