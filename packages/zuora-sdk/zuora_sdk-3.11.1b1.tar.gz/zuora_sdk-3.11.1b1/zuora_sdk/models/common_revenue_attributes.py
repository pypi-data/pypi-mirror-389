...
class CommonRevenueAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountingCode", "adjustmentLiabilityAccountingCode", "adjustmentRevenueAccountingCode", "contractAssetAccountingCode", "contractLiabilityAccountingCode", "contractRecognizedRevenueAccountingCode", "deferredRevenueAccountingCode", "excludeItemBillingFromRevenueAccounting", "isAllocationEligible", "isUnbilled", "recognizedRevenueAccountingCode", "revenueRecognitionRule", "accountReceivableAccountingCode", "unbilledReceivablesAccountingCode", "revenueRecognitionTiming", "revenueAmortizationMethod"]
