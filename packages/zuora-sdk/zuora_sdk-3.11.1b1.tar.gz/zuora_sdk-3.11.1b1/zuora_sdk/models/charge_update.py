...
class ChargeUpdate(BaseModel):
    ...
    is_dimensional_price: Optional[StrictBool] = Field(default=None, description="Indicates whether the charge uses dimensional pricing.  **Note**: This field is only available in response payloads. ", alias="isDimensionalPrice")
    pricing_attributes: Optional[Dict[str, Any]] = Field(default=None, description="Container for pricing attributes used in dynamic pricing.  **Note**: This field requires the DynamicPricing permission to be accessible. ", alias="pricingAttributes")
    negotiated_price_table: Optional[Dict[str, Any]] = Field(default=None, description="Container for negotiated price table information.  **Note**: This field requires the NegotiatedPriceTable permission to be accessible. ", alias="negotiatedPriceTable")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["billing", "chargeNumber", "estimatedStartDate", "newRatePlanChargeId", "customFields", "description", "effectiveDate", "pricing", "uniqueToken", "isDimensionalPrice", "pricingAttributes", "negotiatedPriceTable"]
