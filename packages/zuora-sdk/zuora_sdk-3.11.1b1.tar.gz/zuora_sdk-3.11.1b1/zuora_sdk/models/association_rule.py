...
class AssociationRule(BaseModel):
    ...
    object_type: Optional[StrictStr] = Field(default=None, description="The target object type of the condition. ", alias="objectType")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["condition", "objectType"]
    ...
    def object_type_validate_enum(cls, value):
        ...
        if value not in set(['RatePlanCharge']):
            raise ValueError("must be one of enum values ('RatePlanCharge')")
        return value
