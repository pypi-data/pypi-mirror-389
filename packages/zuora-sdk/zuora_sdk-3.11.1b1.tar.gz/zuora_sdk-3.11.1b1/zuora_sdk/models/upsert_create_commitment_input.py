...
class UpsertCreateCommitmentInput(BaseModel):
    ...
    priority: Optional[StrictInt] = Field(default=None, description="It defines the evaluation order of the commitment, the lower the number, the higher the priority. when two commitments have the same priority, the one with the earlier created one time will be evaluated first.")
    association_rules: Optional[List[AssociationRule]] = Field(default=None, alias="associationRules")
    ...
    accounting_code: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="The accounting code for the Commitment. ", alias="accountingCode")
    ...
    currency: StrictStr
    periods: List[UpsertCreateCommitmentInputAllOfPeriods] = Field(description="The new periods are required when creating a new Commitment.")
    action: ActionType
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["commitmentNumber", "name", "type", "description", "priority", "associationRules", "customFields", "accountingCode", "adjustmentLiabilityAccountingCode", "adjustmentRevenueAccountingCode", "contractAssetAccountingCode", "contractLiabilityAccountingCode", "contractRecognizedRevenueAccountingCode", "deferredRevenueAccountingCode", "excludeItemBillingFromRevenueAccounting", "isAllocationEligible", "isUnbilled", "recognizedRevenueAccountingCode", "revenueRecognitionRule", "accountReceivableAccountingCode", "unbilledReceivablesAccountingCode", "revenueRecognitionTiming", "revenueAmortizationMethod", "taxable", "taxCode", "taxMode", "currency", "periods", "action"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in association_rules (list)
        _items = []
        if self.association_rules:
            for _item_association_rules in self.association_rules:
                if _item_association_rules:
                    _items.append(_item_association_rules.to_dict())
            _dict['associationRules'] = _items
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "associationRules": [AssociationRule.from_dict(_item) for _item in obj["associationRules"]] if obj.get("associationRules") is not None else None,
            ...
            "periods": [UpsertCreateCommitmentInputAllOfPeriods.from_dict(_item) for _item in obj["periods"]] if obj.get("periods") is not None else None,
