...
class ExpandedBundle(BaseModel):
    """
    ExpandedBundle
    """ # noqa: E501
    # avoid validation
    ...
    bundle_config: Optional[StrictStr] = Field(default=None, alias="bundleConfig")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "createdById", "createdDate", "updatedById", "updatedDate", "bundleId", "componentId", "componentType", "bundleConfig"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "bundleConfig": obj.get("bundleConfig")
        }
        return _obj
