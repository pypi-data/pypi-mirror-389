...
**currency** | **str** |  | 
**periods** | [**List[UpsertCreateCommitmentInputAllOfPeriods]**](UpsertCreateCommitmentInputAllOfPeriods.md) | The new periods are required when creating a new Commitment. | 
