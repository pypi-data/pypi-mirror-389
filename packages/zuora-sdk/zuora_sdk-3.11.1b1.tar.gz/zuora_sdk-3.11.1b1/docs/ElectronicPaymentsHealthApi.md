# zuora_sdk.ElectronicPaymentsHealthApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_system_health_payment_volume_summary**](ElectronicPaymentsHealthApi.md#get_system_health_payment_volume_summary) | **GET** /system-health/payments/volume-summary | List payment volume summary records


# **get_system_health_payment_volume_summary**
> GetPaymentVolumeSummaryResponse get_system_health_payment_volume_summary(start_time, end_time, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, payment_gateway_type=payment_gateway_type, payment_method_type=payment_method_type, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = zuora_sdk.ElectronicPaymentsHealthApi(api_client)
    ...
    end_time = '2013-10-20T19:20:30+01:00' # datetime | End time of the volume summary.  Format: `yyyy-MM-dd'T'HH:mmZ` Example: `2022-09-22T09:07+0800`.
    ...
    payment_gateway_type = 'payment_gateway_type_example' # str | Filters the volume summary by payment gateway type. Example: `Adyen`. (optional)
    payment_method_type = 'payment_method_type_example' # str | Filters the volume summary by payment method type. Example: `CreditCard`. (optional)
    ...
    try:
        # List payment volume summary records
        api_response = api_instance.get_system_health_payment_volume_summary(start_time, end_time, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, payment_gateway_type=payment_gateway_type, payment_method_type=payment_method_type, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of ElectronicPaymentsHealthApi->get_system_health_payment_volume_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ElectronicPaymentsHealthApi->get_system_health_payment_volume_summary: %s\n" % e)
```
 ...
 **end_time** | **datetime**| End time of the volume summary.  Format: &#x60;yyyy-MM-dd&#39;T&#39;HH:mmZ&#x60; Example: &#x60;2022-09-22T09:07+0800&#x60;. | 
 ...
 **payment_gateway_type** | **str**| Filters the volume summary by payment gateway type. Example: &#x60;Adyen&#x60;. | [optional] 
 **payment_method_type** | **str**| Filters the volume summary by payment method type. Example: &#x60;CreditCard&#x60;. | [optional] 
...
[**GetPaymentVolumeSummaryResponse**](GetPaymentVolumeSummaryResponse.md)
