# zuora_sdk.ProductRatePlanChargeTiersApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_product_rate_plan_charge_tier**](ProductRatePlanChargeTiersApi.md#get_product_rate_plan_charge_tier) | **GET** /v1/object/product-rate-plan-charge-tier/{id} | CRUD: Retrieve a product rate plan charge tier
[**update_product_rate_plan_charge_tier**](ProductRatePlanChargeTiersApi.md#update_product_rate_plan_charge_tier) | **PUT** /v1/object/product-rate-plan-charge-tier/{id} | CRUD: Update a product rate plan charge tier


# **get_product_rate_plan_charge_tier**
> GetProductRatePlanChargeTierResponse get_product_rate_plan_charge_tier(id, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, fields=fields, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = zuora_sdk.ProductRatePlanChargeTiersApi(api_client)
    ...
    try:
        # CRUD: Retrieve a product rate plan charge tier
        api_response = api_instance.get_product_rate_plan_charge_tier(id, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, fields=fields, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of ProductRatePlanChargeTiersApi->get_product_rate_plan_charge_tier:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductRatePlanChargeTiersApi->get_product_rate_plan_charge_tier: %s\n" % e)
```
...
[**GetProductRatePlanChargeTierResponse**](GetProductRatePlanChargeTierResponse.md)
...
# **update_product_rate_plan_charge_tier**
> ProxyCreateOrModifyResponse update_product_rate_plan_charge_tier(id, modify_request, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, reject_unknown_fields=reject_unknown_fields, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    modify_request = zuora_sdk.UpdateProductRatePlanChargeTierRequest() # UpdateProductRatePlanChargeTierRequest | 
    accept_encoding = 'accept_encoding_example' # str | Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it.  (optional)
    content_encoding = 'content_encoding_example' # str | Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload.  (optional)
    authorization = 'authorization_example' # str | The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken).  (optional)
    ...
    try:
        # CRUD: Update a product rate plan charge tier
        api_response = api_instance.update_product_rate_plan_charge_tier(id, modify_request, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, reject_unknown_fields=reject_unknown_fields, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of ProductRatePlanChargeTiersApi->update_product_rate_plan_charge_tier:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProductRatePlanChargeTiersApi->update_product_rate_plan_charge_tier: %s\n" % e)
```
 ...
 **modify_request** | [**UpdateProductRatePlanChargeTierRequest**](UpdateProductRatePlanChargeTierRequest.md)|  | 
 **accept_encoding** | **str**| Include the &#x60;Accept-Encoding: gzip&#x60; header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a &#x60;Content-Encoding&#x60; header with the compression algorithm so that your client can decompress it.  | [optional] 
 **content_encoding** | **str**| Include the &#x60;Content-Encoding: gzip&#x60; header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload.  | [optional] 
 **authorization** | **str**| The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken).  | [optional] 
