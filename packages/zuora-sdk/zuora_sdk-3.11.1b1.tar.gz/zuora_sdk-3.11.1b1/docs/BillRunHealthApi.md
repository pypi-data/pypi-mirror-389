# zuora_sdk.BillRunHealthApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_system_health_billing_doc_volume_summary**](BillRunHealthApi.md#get_system_health_billing_doc_volume_summary) | **GET** /system-health/billing-documents/volume-summary | List billing document volume summary records


# **get_system_health_billing_doc_volume_summary**
> GetBillingDocVolumeSummaryResponse get_system_health_billing_doc_volume_summary(start_time, end_time, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = zuora_sdk.BillRunHealthApi(api_client)
    ...
    try:
        # List billing document volume summary records
        api_response = api_instance.get_system_health_billing_doc_volume_summary(start_time, end_time, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of BillRunHealthApi->get_system_health_billing_doc_volume_summary:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BillRunHealthApi->get_system_health_billing_doc_volume_summary: %s\n" % e)
```
...
[**GetBillingDocVolumeSummaryResponse**](GetBillingDocVolumeSummaryResponse.md)
