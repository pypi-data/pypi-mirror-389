...
create_account_contact_instance = CreateAccountContact.from_json(json)
# print the JSON string representation of the object
print(CreateAccountContact.to_json())

# convert the object into a dict
create_account_contact_dict = create_account_contact_instance.to_dict()
# create an instance of CreateAccountContact from a dict
create_account_contact_from_dict = CreateAccountContact.from_dict(create_account_contact_dict)
```
