# zuora_sdk.PaymentTransactionLogsApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_payment_transaction_log**](PaymentTransactionLogsApi.md#get_payment_transaction_log) | **GET** /v1/object/payment-transaction-log/{id} | CRUD: Retrieve a payment transaction log


# **get_payment_transaction_log**
> PaymentTransactionLogResponse get_payment_transaction_log(id, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = zuora_sdk.PaymentTransactionLogsApi(api_client)
    ...
    try:
        # CRUD: Retrieve a payment transaction log
        api_response = api_instance.get_payment_transaction_log(id, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_entity_ids=zuora_entity_ids, zuora_track_id=zuora_track_id, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of PaymentTransactionLogsApi->get_payment_transaction_log:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PaymentTransactionLogsApi->get_payment_transaction_log: %s\n" % e)
```
...
[**PaymentTransactionLogResponse**](PaymentTransactionLogResponse.md)
