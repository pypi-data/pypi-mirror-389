# zuora_sdk.RefundsApi

All URIs are relative to *https://rest.zuora.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**cancel_refund**](RefundsApi.md#cancel_refund) | **PUT** /v1/refunds/{refundKey}/cancel | Cancel a refund
[**delete_refund**](RefundsApi.md#delete_refund) | **DELETE** /v1/refunds/{refundKey} | Delete a refund
[**get_refund**](RefundsApi.md#get_refund) | **GET** /v1/refunds/{refundKey} | Retrieve a refund
[**get_refund_item_part**](RefundsApi.md#get_refund_item_part) | **GET** /v1/refunds/{refundKey}/parts/{refundPartId}/item-parts/{itemPartId} | Retrieve a refund part item
[**get_refund_item_parts**](RefundsApi.md#get_refund_item_parts) | **GET** /v1/refunds/{refundKey}/parts/{refundPartId}/item-parts | List all refund part items
[**get_refund_part**](RefundsApi.md#get_refund_part) | **GET** /v1/refunds/{refundKey}/parts/{refundPartId} | Retrieve a refund part
[**get_refund_parts**](RefundsApi.md#get_refund_parts) | **GET** /v1/refunds/{refundKey}/parts | List all parts of a refund
[**get_refunds**](RefundsApi.md#get_refunds) | **GET** /v1/refunds | List refunds
[**update_refund**](RefundsApi.md#update_refund) | **PUT** /v1/refunds/{refundId} | Update a refund


# **cancel_refund**
> RefundResponse cancel_refund(refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = zuora_sdk.RefundsApi(api_client)
    refund_key = 'refund_key_example' # str | The unique ID of a refund or the refund number. For example, 4028905f5a87c0ff015a889e590e00c9.       
    ...
    try:
        # Cancel a refund
        api_response = api_instance.cancel_refund(refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
------------- | ------------- | ------------- | -------------
 **refund_key** | **str**| The unique ID of a refund or the refund number. For example, 4028905f5a87c0ff015a889e590e00c9.        | 
...
# **delete_refund**
> CommonResponse delete_refund(refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a refund
        api_response = api_instance.delete_refund(refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of RefundsApi->delete_refund:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_refund**
> RefundResponse get_refund(refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve a refund
        api_response = api_instance.get_refund(refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
> GetRefundItemPartResponse get_refund_item_part(item_part_id, refund_part_id, refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = zuora_sdk.RefundsApi(api_client)
    item_part_id = 'item_part_id_example' # str | The unique ID of a specific refund part item. You can get the refund part item ID from the response of [Get refund part items](https://www.zuora.com/developer/api-references/api/operation/Get_RefundItemParts).
    refund_part_id = 'refund_part_id_example' # str | The unique ID of a specific refund part. You can get the refund part ID from the response of [List all parts of a refund](https://www.zuora.com/developer/api-references/api/operation/Get_RefundParts).
    refund_key = 'refund_key_example' # str | The number or unique ID of a refund. For example, 4028905f5a87c0ff015a889e590e00c9.
    accept_encoding = 'accept_encoding_example' # str | Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it.  (optional)
    content_encoding = 'content_encoding_example' # str | Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload.  (optional)
    authorization = 'authorization_example' # str | The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken).  (optional)
    zuora_track_id = 'zuora_track_id_example' # str | A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`).  (optional)
    ...
    try:
        # Retrieve a refund part item
        api_response = api_instance.get_refund_item_part(item_part_id, refund_part_id, refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of RefundsApi->get_refund_item_part:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RefundsApi->get_refund_item_part: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **item_part_id** | **str**| The unique ID of a specific refund part item. You can get the refund part item ID from the response of [Get refund part items](https://www.zuora.com/developer/api-references/api/operation/Get_RefundItemParts). | 
 **refund_part_id** | **str**| The unique ID of a specific refund part. You can get the refund part ID from the response of [List all parts of a refund](https://www.zuora.com/developer/api-references/api/operation/Get_RefundParts). | 
 **refund_key** | **str**| The number or unique ID of a refund. For example, 4028905f5a87c0ff015a889e590e00c9. | 
 **accept_encoding** | **str**| Include the &#x60;Accept-Encoding: gzip&#x60; header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a &#x60;Content-Encoding&#x60; header with the compression algorithm so that your client can decompress it.  | [optional] 
 **content_encoding** | **str**| Include the &#x60;Content-Encoding: gzip&#x60; header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload.  | [optional] 
 **authorization** | **str**| The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken).  | [optional] 
 **zuora_track_id** | **str**| A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  | [optional] 
...
[**GetRefundItemPartResponse**](GetRefundItemPartResponse.md)
...
> GetRefundItemPartsResponse get_refund_item_parts(refund_part_id, refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, page=page, page_size=page_size, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List all refund part items
        api_response = api_instance.get_refund_item_parts(refund_part_id, refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, page=page, page_size=page_size, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of RefundsApi->get_refund_item_parts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RefundsApi->get_refund_item_parts: %s\n" % e)
```
...
[**GetRefundItemPartsResponse**](GetRefundItemPartsResponse.md)
...
# **get_refund_part**
> GetRefundPartResponse get_refund_part(refund_part_id, refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve a refund part
        api_response = api_instance.get_refund_part(refund_part_id, refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of RefundsApi->get_refund_part:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RefundsApi->get_refund_part: %s\n" % e)
```
...
[**GetRefundPartResponse**](GetRefundPartResponse.md)
...
# **get_refund_parts**
> GetRefundPartsResponse get_refund_parts(refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        # List all parts of a refund
        api_response = api_instance.get_refund_parts(refund_key, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of RefundsApi->get_refund_parts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RefundsApi->get_refund_parts: %s\n" % e)
```
...
[**GetRefundPartsResponse**](GetRefundPartsResponse.md)
...
# **get_refunds**
> GetRefundsResponse get_refunds(accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, page=page, page_size=page_size, account_id=account_id, amount=amount, created_by_id=created_by_id, created_date=created_date, method_type=method_type, number=number, payment_id=payment_id, refund_date=refund_date, status=status, type=type, updated_by_id=updated_by_id, updated_date=updated_date, sort=sort, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    method_type = zuora_sdk.PaymentMethodType() # PaymentMethodType | This parameter filters the response based on the `methodType` field. (optional)
    ...
    try:
        # List refunds
        api_response = api_instance.get_refunds(accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, page=page, page_size=page_size, account_id=account_id, amount=amount, created_by_id=created_by_id, created_date=created_date, method_type=method_type, number=number, payment_id=payment_id, refund_date=refund_date, status=status, type=type, updated_by_id=updated_by_id, updated_date=updated_date, sort=sort, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
 ...
 **method_type** | **PaymentMethodType**| This parameter filters the response based on the &#x60;methodType&#x60; field. | [optional] 
...
[**GetRefundsResponse**](GetRefundsResponse.md)
...
# **update_refund**
> RefundResponse update_refund(refund_id, body, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    body = zuora_sdk.UpdateRefundRequest() # UpdateRefundRequest | 
    accept_encoding = 'accept_encoding_example' # str | Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it.  (optional)
    content_encoding = 'content_encoding_example' # str | Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload.  (optional)
    authorization = 'authorization_example' # str | The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken).  (optional)
    zuora_track_id = 'zuora_track_id_example' # str | A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`).  (optional)
    ...
    try:
        # Update a refund
        api_response = api_instance.update_refund(refund_id, body, accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
 ...
 **body** | [**UpdateRefundRequest**](UpdateRefundRequest.md)|  | 
 **accept_encoding** | **str**| Include the &#x60;Accept-Encoding: gzip&#x60; header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a &#x60;Content-Encoding&#x60; header with the compression algorithm so that your client can decompress it.  | [optional] 
 **content_encoding** | **str**| Include the &#x60;Content-Encoding: gzip&#x60; header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload.  | [optional] 
 **authorization** | **str**| The value is in the &#x60;Bearer {token}&#x60; format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken).  | [optional] 
 **zuora_track_id** | **str**| A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (&#x60;:&#x60;), semicolon (&#x60;;&#x60;), double quote (&#x60;\&quot;&#x60;), and quote (&#x60;&#39;&#x60;).  | [optional] 
