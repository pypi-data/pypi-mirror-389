...
# **get_hosted_pages**
> HostedPagesResponse get_hosted_pages(accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, version_number=version_number, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
...
with zuora_sdk.ApiClient(configuration) as api_client:
    ...
    api_instance = zuora_sdk.HostedPagesApi(api_client)
    ...
    version_number = 'version_number_example' # str | Version of the Payment Pages for which you want to retrieve the configuration information. Specify 2 for Payment Pages 2.0. (optional)
    ...
    try:
        # List hosted pages
        api_response = api_instance.get_hosted_pages(accept_encoding=accept_encoding, content_encoding=content_encoding, authorization=authorization, zuora_track_id=zuora_track_id, zuora_entity_ids=zuora_entity_ids, version_number=version_number, zuora_version=zuora_version, zuora_org_ids=zuora_org_ids)
        print("The response of HostedPagesApi->get_hosted_pages:\n")
        pprint(api_response)
 ...
 **version_number** | **str**| Version of the Payment Pages for which you want to retrieve the configuration information. Specify 2 for Payment Pages 2.0. | [optional] 
...
[**HostedPagesResponse**](HostedPagesResponse.md)
