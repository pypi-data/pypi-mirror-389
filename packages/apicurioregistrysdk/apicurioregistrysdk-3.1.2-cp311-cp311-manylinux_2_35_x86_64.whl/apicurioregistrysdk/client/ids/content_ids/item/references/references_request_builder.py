...
class ReferencesRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[list[ArtifactReference]]:
        """
    ...
    @dataclass
    class ReferencesRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
