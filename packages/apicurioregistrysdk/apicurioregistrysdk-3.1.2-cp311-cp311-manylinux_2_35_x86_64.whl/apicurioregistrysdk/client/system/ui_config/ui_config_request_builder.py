...
class UiConfigRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[UserInterfaceConfig]:
        """
    ...
    def with_url(self,raw_url: str) -> UiConfigRequestBuilder:
        """
    ...
    @dataclass
    class UiConfigRequestBuilderGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
