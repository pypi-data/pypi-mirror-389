...
class RoleMappingsRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[RoleMappingsRequestBuilderGetQueryParameters]] = None) -> Optional[RoleMappingSearchResults]:
        """
    ...
    async def post(self,body: RoleMapping, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> None:
        """
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[RoleMappingsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Gets a list of all role mappings configured in the registry (if any).This operation can fail for the following reasons:* A server error occurred (HTTP error `500`)
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_post_request_information(self,body: RoleMapping, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Creates a new mapping between a user/principal and a role.This operation can fail for the following reasons:* A server error occurred (HTTP error `500`)
        param body: The mapping between a user/principal and their role.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> RoleMappingsRequestBuilder:
        """
    ...
    @dataclass
    class RoleMappingsRequestBuilderGetRequestConfiguration(RequestConfiguration[RoleMappingsRequestBuilderGetQueryParameters]):
        """
    ...
    @dataclass
    class RoleMappingsRequestBuilderPostRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
