...
class Ui_ChannelInfo(object):
    def setupUi(self, ChannelInfo):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 295, 529))
        ...
        self.channel_label.setTextInteractionFlags(Qt.TextInteractionFlag.LinksAccessibleByMouse|Qt.TextInteractionFlag.TextSelectableByKeyboard|Qt.TextInteractionFlag.TextSelectableByMouse)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 294, 529))
        ...
        self.conversion_label.setTextInteractionFlags(Qt.TextInteractionFlag.LinksAccessibleByMouse|Qt.TextInteractionFlag.TextSelectableByKeyboard|Qt.TextInteractionFlag.TextSelectableByMouse)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 295, 529))
