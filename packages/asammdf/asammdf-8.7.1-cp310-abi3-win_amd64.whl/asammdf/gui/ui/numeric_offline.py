...
class Ui_NumericDisplay(object):
    def setupUi(self, NumericDisplay):
        ...
        self.controls = QGroupBox(NumericDisplay)
        self.controls.setObjectName(u"controls")
        self.controls.setFlat(True)
        ...
        self.controls_label = QLabel(self.controls)
        self.controls_label.setObjectName(u"controls_label")

        self.gridLayout_2.addWidget(self.controls_label, 0, 0, 1, 1)

        self.float_precision = QComboBox(self.controls)
        ...
        self.gridLayout_2.addItem(self.controls_spacer, 0, 2, 1, 1)

        self.gridLayout_2.setColumnStretch(2, 1)

        self.verticalLayout.addLayout(self.gridLayout_2)

        self.time_group = QGroupBox(self.controls)
        ...
        self.verticalLayout.addWidget(self.time_group)

        self.search_group = QGroupBox(self.controls)
    ...
    def retranslateUi(self, NumericDisplay):
        ...
        self.controls_label.setText(QCoreApplication.translate("NumericDisplay", u"Precision", None))
