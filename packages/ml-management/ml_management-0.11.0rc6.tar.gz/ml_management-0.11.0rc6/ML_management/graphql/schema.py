...
class JobCodeParameters(sgqlc.types.Input):
    __schema__ = schema
    __field_names__ = ('additional_system_packages', 'bash_commands', 'code_id', 'env_variables', 'experiment_name', 'image_name', 'is_distributed', 'job_name', 'resources', 'visibility')
...
class CodeJob(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('artifacts', 'available_metrics', 'code_job', 'end_timestamp', 'experiment', 'git_info', 'id', 'latest_metrics', 'list_params', 'list_result_model_version', 'message', 'metric_history', 'name', 'owner', 'params', 'registration_timestamp', 'show_metrics', 'start_timestamp', 'status', 'visibility')
...
class CustomImage(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'is_active', 'name')
    id = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='id')
...
class DatasetLoaderVersionInfo(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('aggr_id', 'artifacts', 'creation_timestamp', 'dataset_loader', 'dataset_loader_method_schema_names', 'dataset_loader_method_schemas', 'description', 'get_conda_env', 'git_info', 'hash_artifacts', 'last_updated_timestamp', 'list_deployed_jobs', 'list_requirements', 'name', 'owner', 'pagination_deployed_jobs', 'tags', 'version', 'visibility')
    aggr_id = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='aggrId')
...
class LocalJob(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('artifacts', 'available_metrics', 'end_timestamp', 'experiment', 'id', 'latest_metrics', 'list_params', 'list_result_model_version', 'message', 'metric_history', 'name', 'owner', 'registration_timestamp', 'show_metrics', 'start_timestamp', 'status', 'visibility')
    artifacts = sgqlc.types.Field(sgqlc.types.non_null(Artifacts), graphql_name='artifacts')
...
class MLMJob(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('artifacts', 'available_metrics', 'end_timestamp', 'experiment', 'id', 'latest_metrics', 'list_params', 'list_result_model_version', 'message', 'metric_history', 'name', 'owner', 'params', 'registration_timestamp', 'show_metrics', 'start_timestamp', 'status', 'visibility')
    artifacts = sgqlc.types.Field(sgqlc.types.non_null(Artifacts), graphql_name='artifacts')
...
class ModelVersionInfo(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('aggr_id', 'artifacts', 'available_collectors', 'available_dataset_loader_versions', 'available_dataset_loaders', 'available_executor_versions', 'available_executors', 'build_job', 'creation_timestamp', 'description', 'experiment', 'get_conda_env', 'git_info', 'group_secret_uuid', 'hash_artifacts', 'last_updated_timestamp', 'list_deployed_jobs', 'list_job', 'list_requirements', 'model', 'model_method_schemas', 'name', 'owner', 'pagination_available_collectors', 'pagination_available_dataset_loader_versions', 'pagination_available_dataset_loaders', 'pagination_available_executor_versions', 'pagination_available_executors', 'pagination_deployed_jobs', 'pagination_job', 'parent_job', 'root_model_version', 'source_executor_version', 'source_model_version', 'tags', 'upload_model_type', 'venv_build_job', 'version', 'visibility')
    aggr_id = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='aggrId')
...
class Mutation(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('add_custom_code_job', 'add_image', 'add_ml_job', 'cancel_build_job_for_executor_version', 'cancel_build_job_for_model_version', 'cancel_job', 'cancel_venv_build_job_for_model_version', 'create_experiment', 'create_local_job', 'delete_experiment_tag', 'delete_finished_jobs', 'delete_object_tag', 'delete_object_version_tag', 'delete_object_versions', 'delete_objects', 'log_metric', 'log_metrics', 'log_param', 'log_params', 'rebuild_model_version_image', 'rebuild_no_model_executor_version_image', 'rename_experiment', 'reset_experiment_tags', 'reset_object_tags', 'reset_object_version_tags', 'serve_model', 'set_experiment_tags', 'set_object_tags', 'set_object_version_tags', 'start_job', 'stop_job', 'stop_model_serving', 'update_experiment', 'update_job', 'update_object', 'update_object_version')
    ...
    * `form` (`JobCodeParameters!`)None
    ...
    add_image = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='addImage', args=sgqlc.types.ArgDict((
