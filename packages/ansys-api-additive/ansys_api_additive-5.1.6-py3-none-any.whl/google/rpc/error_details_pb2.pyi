...
class BadRequest(google.protobuf.message.Message):
    ...
    class FieldViolation(google.protobuf.message.Message):
        ...
        DESCRIPTION_FIELD_NUMBER: builtins.int
        REASON_FIELD_NUMBER: builtins.int
        LOCALIZED_MESSAGE_FIELD_NUMBER: builtins.int
        field: typing.Text = ...
        ...
        * `emailAddresses[3].type[2]` for a violation in the second `type`
        ...
        def __init__(self,
            *,
            ...
            description : typing.Text = ...,
            reason : typing.Text = ...,
            localized_message : typing.Optional[global___LocalizedMessage] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["localized_message",b"localized_message"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["description",b"description","field",b"field","localized_message",b"localized_message","reason",b"reason"]) -> None: ...
