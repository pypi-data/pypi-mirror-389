...
class ViggoCoreTest(object):

    def setUp(self):
        super(ViggoCoreTest, self).setUp()
        app = viggocorev2.SystemFlask()
...
class CreateTest(ViggoCoreTest):
...
class RetrieveTest(ViggoCoreTest):
...
class UpdateTest(ViggoCoreTest):
...
class DeleteTest(ViggoCoreTest):
