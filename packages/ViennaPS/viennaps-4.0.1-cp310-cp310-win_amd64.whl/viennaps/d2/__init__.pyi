...
class DenseCellSet:
    ...
    def fromLevelSets(
        self,
        levelSets: collections.abc.Sequence[viennals.d2.Domain],
...
class Domain:
    ...
    def getBoundaryConditions(
        self,
    ) -> typing.Annotated[list[viennals._core.BoundaryConditionEnum], "FixedSize(2)"]:
        """
    ...
    def insertNextLevelSet(
        self, levelset: viennals.d2.Domain, wrapLowerLevelSet: bool = True
    ) -> None:
        """
...
class DomainSetup:
    ...
    def boundaryCons(
        ...
        list[viennals._core.BoundaryConditionEnum], "FixedSize(2)"
    ]: ...
    def bounds(self) -> typing.Annotated[list[float], "FixedSize(4)"]: ...
    def check(self) -> None: ...
    def grid(self) -> viennals.d2.hrleGrid: ...
...
class GeometryFactory:
    ...
    def makeSubstrate(self, base: typing.SupportsFloat) -> viennals.d2.Domain: ...
