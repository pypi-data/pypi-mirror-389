...
class LabelApi:
    ...
    def delete_label(
        self,
        project_id: Annotated[StrictInt, Field(description="Workspace ID (parameter name is project_id)")],
        ...
        :param project_id: Workspace ID (parameter name is project_id) (required)
        :type project_id: int
