...
class Builder:
    ...
    def with_gradient(self, obj: typing.Any) -> Builder:
        ...
        """
    def with_parameter(self, name: builtins.str, initial_value: builtins.float, bounds: typing.Optional[tuple[builtins.float, builtins.float]] = None) -> Builder:
        r"""
...
class CMAES:
    ...
    def with_seed(self, seed: builtins.int) -> CMAES:
        ...
        """
    def run(self, problem: Problem, initial: typing.Sequence[builtins.float]) -> OptimisationResults:
        r"""
...
class DiffsolBuilder:
    ...
    def with_parallel(self, parallel: builtins.bool) -> DiffsolBuilder:
        ...
        """
    def with_config(self, config: typing.Mapping[builtins.str, builtins.float]) -> DiffsolBuilder: ...
    ...
    def with_atol(self, atol: builtins.float) -> DiffsolBuilder:
        ...
        """
    def with_parameter(self, name: builtins.str, initial_value: builtins.float, bounds: typing.Optional[tuple[builtins.float, builtins.float]] = None) -> DiffsolBuilder:
        r"""
        Register a named optimisation variable in the order it appears in vectors.
        """
...
class NelderMead:
    ...
    def with_max_evaluations(self, max_evaluations: builtins.int) -> NelderMead:
        ...
        """
    def with_coefficients(self, alpha: builtins.float, gamma: builtins.float, rho: builtins.float, sigma: builtins.float) -> NelderMead:
        r"""
...
class Problem:
    ...
    def evaluate(self, x: typing.Sequence[builtins.float]) -> builtins.float:
        ...
        """
    def evaluate_gradient(self, x: typing.Sequence[builtins.float]) -> typing.Optional[builtins.list[builtins.float]]:
        r"""
        Evaluate the gradient of the objective function at `x` if available.
        """
    def optimize(self, initial: typing.Optional[typing.Sequence[builtins.float]] = None, optimiser: typing.Optional[NelderMead | CMAES] = None) -> OptimisationResults:
        r"""
    ...
    def dimension(self) -> builtins.int:
        ...
        """
    def parameters(self) -> builtins.list[tuple[builtins.str, builtins.float, typing.Optional[tuple[builtins.float, builtins.float]]]]:
        r"""
