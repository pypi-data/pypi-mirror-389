...
class Binomial(Distribution):
    ...
    def calculate_stdev(self):
        ...
        """
        self.std_dev = math.sqrt(self.n * self.p * (1 - self.p))
        return self.std_dev
    ...
    def replace_stats_with_data(self):
        ...
        self.std_dev = self.calculate_stdev()
    ...
    def pdf(self, k):
        ...
        """
        a = math.factorial(self.n) / (math.factorial(int(k)) * math.factorial(self.n - int(k)))
    ...
    def __add__(self, other):
        ...
        result = Binomial()  # added binomial object
        result.n = self.n + other.n
        result.p = self.p  # since both p are equal
    ...
    def __repr__(self):
        ...
        return "mean {}, standard deviation {}, p {}, n {}".format(self.mean, self.std_dev, self.p, self.n)
