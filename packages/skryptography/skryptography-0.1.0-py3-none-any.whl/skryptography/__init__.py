...
class HillCipher:
    ...
    def hill_decrypt(self, ciphertext: str):
        n = self.key.shape[0]
...
class DESCipher:
    ...
    def encode(self, msg: str) -> str:
        return self.c.encrypt(pad(msg.encode('utf-8'), 8)).decode('utf-8')
    
    def decode(self, msg: str) -> str:
        return unpad(self.c.decrypt(msg.encode('utf-8')), 8).decode('utf-8')
...
class AESCipher:
    ...
    def encode(self, msg: str) -> str:
        return self.c.encrypt(pad(msg.encode('utf-8'), 16)).decode('utf-8')
    
    def decode(self, msg: str) -> str:
        return unpad(self.c.decrypt(msg.encode('utf-8')), 16).decode('utf-8')

class RSACipher:
    def __init__(self, key) -> None:
        self.c = PKCS1_OAEP.new(key.publickey())

    @staticmethod
    def generate_key(n, e):
        return RSA.generate(n, e=e)
    
    @staticmethod
    def print_key_dets(key):
        print(f"{key.n=}\n{key.e=}\n{key.p=}{key.d=}")
    
    def encode(self, msg: str) -> str:
        return self.c.encrypt(msg.encode('utf-8')).decode('utf-8')
    
    def decode(self, msg: str) -> str:
        return self.c.decrypt(msg.encode('utf-8')).decode('utf-8')
...
class ECCCipher:
    ...
    def encode(self, receiver: 'ECCCipher', plaintext: str):
