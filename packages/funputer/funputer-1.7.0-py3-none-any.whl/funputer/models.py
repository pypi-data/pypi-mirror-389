...
# Fields that can be auto-inferred from data (21 fields)
INFERRABLE_FIELDS = ALL_METADATA_FIELDS  # All 21 fields are inferrable
...
class ColumnMetadata:
    ...
    This model contains 21 fields that can be automatically inferred:

    AUTOMATICALLY INFERRABLE (21 fields):
