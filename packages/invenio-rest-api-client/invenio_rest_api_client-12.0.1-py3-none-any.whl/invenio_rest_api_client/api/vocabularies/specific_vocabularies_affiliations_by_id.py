...
from ...models.specific_vocabularies_affiliations_by_id_response_200 import (
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, SpecificVocabulariesAffiliationsByIdResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, SpecificVocabulariesAffiliationsByIdResponse200]
    """
