...
) -> Optional[Union[Any, SpecificVocabulariesAwardsResponse200]]:
    if response.status_code == 200:
        response_200 = SpecificVocabulariesAwardsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, SpecificVocabulariesAwardsResponse200]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, SpecificVocabulariesAwardsResponse200]
    """
