...
from ...models.submit_a_comment_on_a_request_body import SubmitACommentOnARequestBody
...
def _get_kwargs(
    request_id: str,
    *,
    body: SubmitACommentOnARequestBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/requests/{request_id}/comments".format(
