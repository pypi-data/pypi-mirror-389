...
) -> Optional[Union[Any, GetAVocabularyRecordByIdResponse200]]:
    if response.status_code == 200:
        response_200 = GetAVocabularyRecordByIdResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetAVocabularyRecordByIdResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, GetAVocabularyRecordByIdResponse200]
    """
