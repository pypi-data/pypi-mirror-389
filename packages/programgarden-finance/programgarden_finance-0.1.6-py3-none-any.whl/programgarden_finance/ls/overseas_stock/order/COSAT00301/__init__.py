...
class TrCOSAT00301(TROrderAbstract):
    def __init__(self, request_data: COSAT00301Request):
        ...
        self._generic: GenericTR[COSAT00301Response] = GenericTR[COSAT00301Response](self.request_data, self._build_response, url=URLS.ORDER_URL)
    ...
    def _build_response(self, resp: Optional[object], resp_json: Optional[Dict[str, Any]], resp_headers: Optional[Dict[str, Any]], exc: Optional[Exception]) -> COSAT00301Response:
        ...
        block1_data = resp_json.get("COSAT00301OutBlock1")
        block2_data = resp_json.get("COSAT00301OutBlock2")
        ...
        if exc is None and not is_error_status:
            if block1_data is not None:
                parsed_block1 = COSAT00301OutBlock1.model_validate(block1_data)
            if block2_data is not None:
                parsed_block2 = COSAT00301OutBlock2.model_validate(block2_data)
