...
_OUTPUT_KIND_FOR_SIMULATE = (
    ...
    | _quantities.ANY_SHOCK_OR_SHOCK_VALUE
)
...
def mixin(klass: type, ) -> type:
    ...
    klass.slatables_for_vary_stds = slatables_for_vary_stds
    return klass
    #]
...
def _slatable_for_simulate_or_kalman_filter(
    ...
    **kwargs,
    ...
    #
    shock_names = model.get_names(kind=_quantities.ANY_SHOCK_OR_SHOCK_VALUE, )
    shock_name_to_value = {
