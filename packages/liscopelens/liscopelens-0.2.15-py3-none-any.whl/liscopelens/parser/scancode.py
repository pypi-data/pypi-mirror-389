...
class ScancodeParser(BaseParser):
    ...
    def __call__(
        ...
        Steps:
            ...
            - If --file-shadow is provided, apply shadow rules afterwards.
        ...
        if getattr(self.args, "file_shadow", None):
            print("Parsing shadow license (from __call__)...")
            self.parse_shadow(self.args.file_shadow, gm)
    ...
    def parse(
        ...
        if getattr(self.args, "file_shadow", None):
            ...
            self.parse_shadow(self.args.file_shadow, context)
