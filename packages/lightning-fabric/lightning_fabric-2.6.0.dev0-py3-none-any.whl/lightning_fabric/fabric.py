...
class Fabric:
    ...
    def setup_module(
        ...
        Returns:
            The wrapped model as a :class:`~lightning_fabric.wrappers._FabricModule`.
    ...
    def backward(self, tensor: Tensor, *args: Any, model: Optional[_FabricModule] = None, **kwargs: Any) -> None:
        ...
        lightning_fabric.wrappers._in_fabric_backward = True
        try:
            self._strategy.backward(tensor, module, *args, **kwargs)
        finally:
            lightning_fabric.wrappers._in_fabric_backward = False
