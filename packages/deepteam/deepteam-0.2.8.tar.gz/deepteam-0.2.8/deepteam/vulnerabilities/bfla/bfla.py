...
from deepteam.metrics import BFLAMetric, BaseRedTeamingMetric
...
class BFLA(BaseVulnerability):
    ...
    def assess(
        ...
        results: Dict[BFLAType, List[RTTestCase]] = {}
        res: Dict[BFLAType, BFLAMetric] = {}
    ...
    def simulate_attacks(
        ...
        for type in self.types:
            ...
            templates[type].append(
                BFLATemplate.generate_baseline_attacks(
