...
import numpy as np
# Use Noverraz if available (new improved engine), fallback to optimized Julia, then standard
try:
...
class FractalEncoder:
    ...
    def compute_fractal_point(self, z0: complex, c: complex) -> int:
        ...
        if self.noverraz is not None:
            ...
            return self.noverraz.compute_fractal_point(z0, c)
        else:
            # Fallback to Julia
