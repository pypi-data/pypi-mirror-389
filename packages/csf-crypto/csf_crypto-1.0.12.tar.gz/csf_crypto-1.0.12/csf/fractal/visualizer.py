...
class FractalSignature:
    ...
    def __init__(self, width: int = 256, height: int = 256):
        ...
        Args:
            width: Image width (reduced from 512 to 256 for performance)
            height: Image height (reduced from 512 to 256 for performance)
        """
        self.width = width
        self.height = height
        self.julia = ConstantTimeJulia(iterations=50)  # Use optimized iterations
