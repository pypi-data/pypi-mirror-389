...
class Logger:
    ...
    async def get_instance(
        cls, config: LoggerConfig | None = None
    ) -> "Logger":
        """
...
class PerformanceTracker:
    ...
    def __init__(
        self, metrics: MetricsCollector, logger: Logger | None = None
    ):
        """
...
class HealthChecker:
    ...
    async def check(self) -> HealthCheckResult:
        ...
        check_tasks: dict[str, asyncio.Task[dict[str, Any]]] = {
            name: asyncio.create_task(
                cast(Coroutine[Any, Any, dict[str, Any]], check())
            )
