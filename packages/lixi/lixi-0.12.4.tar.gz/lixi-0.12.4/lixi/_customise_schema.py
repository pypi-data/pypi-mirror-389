...
def CustomiseSingleSchema(
    ...
    namespaces,
    include_customisation_json=True,
):
    """
    ...
    Args:
        ...
        include_customisation_json (bool, optional): Flag to include lx:CustomisationJSON. Defaults to True.
...
def execute_customisation_instructions(
    schema_etree, instructions, output_name=None, include_customisation_json=True
):
    """
