...
if platform.system() != "Windows":
    logger.info('Using default event loop for better compatibility')
...
# Using default encoding detection for better compatibility
logger.info('Using default encoding detection')
