...
class UtilityAgent(BaseModel):
    ...
    x402_enabled: bool = Field(default=False, description="Whether x402 payments are enabled")
    x402_config: Optional[Dict[str, Any]] = Field(None, description="X402 payment configuration")
...
class UtilityAgentRegistryEntry(BaseModel):
    ...
    contract_address: Optional[str] = Field(None, description="On-chain utility agent contract address")
    x402_enabled: bool = Field(default=False, description="Whether x402 payments are enabled")
    x402_payment_info: Optional[Dict[str, Any]] = Field(None, description="X402 payment information")
