"""X402 client for IATP agent-to-agent payments."""
...
class X402IATPClient:
    """Client for making x402 payments in IATP protocol.
    
    This wraps the Coinbase x402 client and provides IATP-specific functionality,
    ...
    def __init__(
        ...
        """Initialize the x402 IATP client.
        ...
        # Initialize the underlying x402 client
    ...
    def create_payment_header(
        ...
        """
        return self.x402_client.create_payment_header(
    ...
    def select_payment_requirements(
        ...
        """
        return self.x402_client.select_payment_requirements(
            accepts=accepts,
    ...
    def get_payment_info_for_agent_card(self, agent_card: dict) -> Optional[Dict[str, Any]]:
        """Extract x402 payment information from an agent card.
...
def create_iatp_payment_client(
    ...
    Example:
        ...
        # Use with httpx
        from x402.clients.httpx import Httpx402Client
        http_client = Httpx402Client(client)
