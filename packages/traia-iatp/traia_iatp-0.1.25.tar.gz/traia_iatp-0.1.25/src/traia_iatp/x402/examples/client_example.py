...
async def example_crewai_integration():
    ...
    print(f"X402 Enabled: {agent_info.x402_enabled}")
...
async def example_multiple_agents():
    ...
    paid_agents = [a for a in agents if a.x402_enabled]
...
async def example_check_agent_pricing():
    ...
    if agent_info and agent_info.x402_enabled:
        payment_info = agent_info.x402_payment_info
