"""Custom x402 facilitator that interfaces with IATP Settlement Layer."""
...
class IATPSettlementFacilitator:
    """Custom x402 facilitator that settles payments through IATP Settlement Layer.
    
    This facilitator verifies x402 payment headers and then submits settlement
    ...
    async def list(self, request: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """List discoverable IATP services that accept x402 payments.
        
        This queries the Traia registry for utility agents with x402 enabled.
...
def create_iatp_facilitator(
    ...
    Example:
        ...
        # Use in x402 middleware
        from traia_iatp.x402 import X402Config, require_iatp_payment
