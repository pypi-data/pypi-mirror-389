...
class IMMailingCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["organization_id", "insurance_id", "im_insurer_id", "im_sro_id", "dispatch_at", "email_search_status", "invoice_status", "status", "result", "insurance_premium"]
