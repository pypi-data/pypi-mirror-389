...
class IMMailingOutInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "organization_id", "insurance_id", "im_insurer_id", "im_sro_id", "dispatch_at", "email_search_status", "invoice_status", "status", "result", "insured_sum", "insurance_premium", "has_invoice", "invoice", "organization", "insurance", "insurer", "sro"]
