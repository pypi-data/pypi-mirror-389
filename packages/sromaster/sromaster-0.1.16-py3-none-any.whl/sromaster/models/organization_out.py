...
class OrganizationOut(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["id", "source_registry", "inn", "ogrn", "legal_form", "name_full", "name_short", "address", "director_name", "registered_at", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationOut from a dict"""
        if obj is None:
            return None
