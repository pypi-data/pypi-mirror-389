...
class CheckOut(BaseModel):
    ...
    type_: Optional[CheckType] = None
    result: Optional[CheckResult] = None
    disciplinary_action: Optional[CheckDisciplinaryAction] = None
    __properties: ClassVar[List[str]] = ["id", "registry_id", "started_at", "type_", "result", "disciplinary_action"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if type_ (nullable) is None
        # and model_fields_set contains the field
        if self.type_ is None and "type_" in self.model_fields_set:
            _dict['type_'] = None
