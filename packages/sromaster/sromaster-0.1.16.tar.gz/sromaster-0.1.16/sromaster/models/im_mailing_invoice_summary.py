...
class IMMailingInvoiceSummary(BaseModel):
    """
    ...
    created_at: datetime
    __properties: ClassVar[List[str]] = ["id", "filename", "content_type", "size", "created_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IMMailingInvoiceSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IMMailingInvoiceSummary from a dict"""
        if obj is None:
            return None
