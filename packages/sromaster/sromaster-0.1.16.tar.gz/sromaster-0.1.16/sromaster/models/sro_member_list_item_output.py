...
class SROMemberListItemOutput(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SROMemberListItemOutput from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of current_insurance
        if self.current_insurance:
            _dict['current_insurance'] = self.current_insurance.to_dict()
        # override the default output from pydantic by calling `to_dict()` of last_check
        if self.last_check:
            _dict['last_check'] = self.last_check.to_dict()
        ...
        # set to None if current_insurance (nullable) is None
        # and model_fields_set contains the field
        if self.current_insurance is None and "current_insurance" in self.model_fields_set:
            _dict['current_insurance'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SROMemberListItemOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "current_insurance": InsuranceOut.from_dict(obj["current_insurance"]) if obj.get("current_insurance") is not None else None,
            "last_check": CheckOut.from_dict(obj["last_check"]) if obj.get("last_check") is not None else None
        })
        return _obj
