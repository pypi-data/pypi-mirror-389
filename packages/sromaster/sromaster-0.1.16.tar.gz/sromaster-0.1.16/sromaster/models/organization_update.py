...
class OrganizationUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["source_registry", "inn", "ogrn", "legal_form", "name_full", "name_short", "address", "director_name", "registered_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if source_registry (nullable) is None
        # and model_fields_set contains the field
        if self.source_registry is None and "source_registry" in self.model_fields_set:
            _dict['source_registry'] = None
