...
class SROMemberDetailsOutput(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SROMemberDetailsOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SROMemberDetailsOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "insurances": [InsuranceOut.from_dict(_item) for _item in obj["insurances"]] if obj.get("insurances") is not None else None,
            "checks": [CheckOut.from_dict(_item) for _item in obj["checks"]] if obj.get("checks") is not None else None
        })
        return _obj
