...
class Continue1Model:
    def __init__(self, model_name='SVECTOR-CORPORATION/Continue-1-OSS', dtype=torch.bfloat16, tokenizer='SVECTOR-CORPORATION/Continue-1-OSS', **engine_kwargs):
        self.model_name = model_name
        self.dtype = dtype
        self.engine_kwargs = engine_kwargs  # vLLM engine kwargs
        self.engine = self._setup_engine()
        self.available_voices = ["nova", "aurora", "stellar", "atlas", "orion", "luna", "phoenix", "ember"]
    ...
    def _format_prompt(self, prompt, voice="nova", model_type="larger"):
