...
def run_local(agent: str, input_json: str):
    ...
    if a is None:
        ...
        try:
            ...
            from evenage.core.config import EvenAgeConfig, AgentConfig  # type: ignore
