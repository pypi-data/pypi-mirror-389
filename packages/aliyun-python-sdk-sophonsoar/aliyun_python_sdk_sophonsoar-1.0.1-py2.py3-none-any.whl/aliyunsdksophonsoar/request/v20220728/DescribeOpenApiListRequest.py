...
class DescribeOpenApiListRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'sophonsoar', '2022-07-28', 'DescribeOpenApiList')
		self.set_protocol_type('https')
		self.set_method('GET')

	def get_PopCode(self): # String
		return self.get_query_params().get('PopCode')

	def set_PopCode(self, PopCode):  # String
		self.add_query_param('PopCode', PopCode)
