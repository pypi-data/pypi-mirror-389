...
class DescribeSoarRecordsRequest(RpcRequest):
	...
	def get_CompletedEndTime(self): # Long
		return self.get_query_params().get('CompletedEndTime')

	def set_CompletedEndTime(self, CompletedEndTime):  # Long
		self.add_query_param('CompletedEndTime', CompletedEndTime)
	...
	def get_QueryValue(self): # String
		return self.get_query_params().get('QueryValue')

	def set_QueryValue(self, QueryValue):  # String
		self.add_query_param('QueryValue', QueryValue)
	...
	def get_CompletedBeginTime(self): # Long
		return self.get_query_params().get('CompletedBeginTime')

	def set_CompletedBeginTime(self, CompletedBeginTime):  # Long
		self.add_query_param('CompletedBeginTime', CompletedBeginTime)
